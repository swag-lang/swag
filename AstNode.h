...
extern thread_local Pool<AstNode, 128>          g_Pool_astNode;
extern thread_local Pool<AstAttrDecl>           g_Pool_astAttrDecl;
extern thread_local Pool<AstAttrUse>            g_Pool_astAttrUse;
extern thread_local Pool<AstVarDecl>            g_Pool_astVarDecl;
extern thread_local Pool<AstFuncDecl>           g_Pool_astFuncDecl;
extern thread_local Pool<AstIdentifier, 128>    g_Pool_astIdentifier;
extern thread_local Pool<AstIdentifierRef, 128> g_Pool_astIdentifierRef;
extern thread_local Pool<AstFuncCallParam>      g_Pool_astFuncCallParam;
extern thread_local Pool<AstIf>                 g_Pool_astIf;
...
extern thread_local Pool<AstBreakContinue>      g_Pool_astBreakContinue;
extern thread_local Pool<AstTypeExpression>     g_Pool_astTypeExpression;
extern thread_local Pool<AstTypeLambda>         g_Pool_astTypeLambda;
extern thread_local Pool<AstPointerDeRef>       g_Pool_astPointerDeref;
extern thread_local Pool<AstProperty>           g_Pool_astProperty;
extern thread_local Pool<AstExpressionList>     g_Pool_astExpressionList;
extern thread_local Pool<AstStruct>             g_Pool_astStruct;
extern thread_local Pool<AstImpl>               g_Pool_astImpl;
extern thread_local Pool<AstInit>               g_Pool_astInit;
extern thread_local Pool<AstDrop>               g_Pool_astDrop;
extern thread_local Pool<AstInline>             g_Pool_astInline;
extern thread_local Pool<AstReturn>             g_Pool_astReturn;
