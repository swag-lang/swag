...
REM %MSBUILD% "..\bin\std\modules\freetype\vendor\freetype-2.13.2\builds\windows\vc2010\freetype.sln" /p:Configuration="Release Static" /p:Platform=x64 -m -verbosity:m
REM xcopy "..\bin\std\modules\freetype\vendor\freetype-2.13.2\objs\x64\release static\freetype.lib" "..\bin\std\modules\freetype\publish\windows-x86_64\freetype.static.lib" /y
