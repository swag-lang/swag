...
<a href="https://github.com/swag-lang/swag/blob/master/bin/std/modules/audio\src\driver\xaudio2.swg#L319" class="src">[src]</a></td>
</tr>
</table>
</p>
...
<table class="table-enumeration">
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Bus_create">create</a></span></td>
<td>Creates an audio bus. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Bus_destroy">destroy</a></span></td>
<td>Destroy the bus (immediatly). </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Bus_getVolume">getVolume</a></span></td>
<td>Returns the actual volume. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Bus_getVolumeDB">getVolumeDB</a></span></td>
<td>Returns the actual volume, in DB. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Bus_setVolume">setVolume</a></span></td>
<td>Set the playing bus volume between [0..1]. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Bus_setVolumeDB">setVolumeDB</a></span></td>
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">destroy</span>(<span class="SKwd">using</span> <span class="STpe">self</span>) <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<td class="api-item-title-src-ref">
<a href="https://github.com/swag-lang/swag/blob/master/bin/std/modules/audio\src\driver\xaudio2.swg#L368" class="src">[src]</a></td>
</tr>
</table>
</p>
<p>Returns the actual volume. </p>
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">getVolume</span>(<span class="SKwd">using</span> <span class="STpe">self</span>)-&gt;<span class="STpe">f32</span> <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">getVolumeDB</span>(<span class="SKwd">using</span> <span class="STpe">self</span>)-&gt;<span class="STpe">f32</span> <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<td class="api-item-title-src-ref">
<a href="https://github.com/swag-lang/swag/blob/master/bin/std/modules/audio\src\driver\xaudio2.swg#L357" class="src">[src]</a></td>
</tr>
</table>
</p>
<p>Set the playing bus volume between [0..1]. </p>
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">setVolume</span>(<span class="SKwd">using</span> <span class="STpe">self</span>, volume: <span class="STpe">f32</span>, batchID: <span class="STpe">u32</span> = <span class="SNum">0</span>) <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">setVolumeDB</span>(<span class="SKwd">using</span> <span class="STpe">self</span>, volumeDB: <span class="STpe">f32</span>, batchID: <span class="STpe">u32</span> = <span class="SNum">0</span>) <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<table class="table-enumeration">
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_SoundFile_load">load</a></span></td>
...
<table class="table-enumeration">
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_create">create</a></span></td>
<td>Creates a new voice for a given sound file. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_destroy">destroy</a></span></td>
<td>Destroy the voice. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_getVolume">getVolume</a></span></td>
<td>Returns the actual volume. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_getVolumeDB">getVolumeDB</a></span></td>
<td>Returns the actual volume, in DB. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_isPlaying">isPlaying</a></span></td>
<td>Returns true if the voice is currently playing. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_pause">pause</a></span></td>
...
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_play">play</a></span><span class="SCde">(<span class="STpe">self</span>, <span class="SCst">VoicePlayFlags</span>)</span></td>
<td>Plays a voice. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_setFrequencyRatio">setFrequencyRatio</a></span></td>
<td>Set the playing pitch. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_setRooting">setRooting</a></span></td>
<td>Root a voice to a given list of buses. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_setVolume">setVolume</a></span></td>
<td>Set the playing voice volume between [0..1]. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_setVolumeDB">setVolumeDB</a></span></td>
<td>Set the playing voice volume. </td>
</tr>
<tr>
<td class="code-type"><span class="SFct"><a href="#Audio_Voice_stop">stop</a></span></td>
...
<td class="api-item-title-src-ref">
<a href="https://github.com/swag-lang/swag/blob/master/bin/std/modules/audio\src\driver\xaudio2.swg#L261" class="src">[src]</a></td>
</tr>
</table>
</p>
<p>Returns the actual volume. </p>
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">isPlaying</span>(<span class="SKwd">using</span> <span class="STpe">self</span>)-&gt;<span class="STpe">bool</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">pause</span>(<span class="SKwd">using</span> <span class="STpe">self</span>) <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<p>Plays a voice. </p>
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">play</span>(<span class="SKwd">using</span> <span class="STpe">self</span>, playFlags = <span class="SCst"><a href="#Audio_VoicePlayFlags">VoicePlayFlags</a></span>.<span class="SCst">Zero</span>) <span class="SKwd">throw</span></span></div>
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">setFrequencyRatio</span>(<span class="SKwd">using</span> <span class="STpe">self</span>, ratio: <span class="STpe">f32</span>, batchID: <span class="STpe">u32</span> = <span class="SNum">0</span>) <span class="SKwd">throw</span></span></div>
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">setRooting</span>(<span class="SKwd">using</span> <span class="STpe">self</span>, buses: <span class="SKwd">const</span> [..] *<span class="SCst"><a href="#Audio_Bus">Bus</a></span>) <span class="SKwd">throw</span></span></div>
...
<td class="api-item-title-src-ref">
<a href="https://github.com/swag-lang/swag/blob/master/bin/std/modules/audio\src\driver\xaudio2.swg#L250" class="src">[src]</a></td>
</tr>
</table>
</p>
...
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">stop</span>(<span class="SKwd">using</span> <span class="STpe">self</span>) <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
...
<p>Load a wav file. </p>
<div class="code-block"><span class="SCde"><span class="SKwd">func</span> <span class="SFct">loadFile</span>(<span class="SKwd">using</span> file: *<span class="SCst"><a href="#Audio_SoundFile">SoundFile</a></span>, stream: *<span class="SCst">File</span>.<span class="SCst">FileStream</span>, loadDatas = <span class="SKwd">true</span>, loadMetaDatas = <span class="SKwd">false</span>) <span class="SKwd">throw</span></span></div>
<p>
<table class="api-item">
<tr>
<td class="api-item">
