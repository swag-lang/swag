...
<p>First, you have to initialize the audio engine by calling [[Audio.createEngine]]. </p>
...
<p>Once you have a sound file, the simplest way to play it is by calling [[Voice.play]]. The sound will be played once, until the end, and will be destroyed. </p>
<div class="code-block"><span class="SCde"><span class="SCst">Voice</span>.<span class="SFct">play</span>(soundFile)</span></div>
<p>To have more control, you could also use [[Voice.create]] then [[Voice.Play]] on the created sound. That way you will recieve a [[Voice]] object you can play with. </p>
