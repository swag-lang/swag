...
<p></p>
<p><h2 id="LLVM">LLVM</h2></p>
<p></p>
<p>Swag has two backends, a <code>x86_64</code> custom backend written for fast compile, but with far from optimal generated code, and <code>llvm</code> for optimized builds.</p>
<p>The <a href="https://releases.llvm.org/download.html">LLVM</a> source tree is included in the Swag source tree for convenience. Version is <code>15.0.7</code>.</p>
...
<p></p>
<p>If LLVM has been compiled once, you can also use the <code>Swag.sln</code> workspace in the <code>build</code> subfolder.</p>
<p><h2 id="Windows SDK">Windows SDK</h2></p>
<p>The path to the SDK version is defined in <code>vs_build_cfg.bat</code>.</p>
<p>The Swag <b>runtime</b> contains a copy of some libraries from the SDK (<code>kernel32.lib</code>, <code>ucrt.lib</code>, <code>dbghelp.lib</code> and <code>user32.lib</code>). You will find them in <code>bin/runtime/windows-x86-64</code>.</p>
...
<p>The standard modules (in <code>bin/std/modules</code>) can also have dependencies to some other libraries from the SDK. You will find those dependencies in the <code>publish</code> folder of the corresponding modules.</p>
</div>
</div>
