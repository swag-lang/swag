...
<p><h3 id="Create a workspace and a test module">Create a workspace and a test module</h3></p>
<p></p>
<p>First create a workspace with the <code>--test</code> option.</p>
<p></p>
<pre><code><span style="color:#0">$ swag new -w:myWorkspace --test</span></code></pre><p></p>
<p>This will also create a test module <code>myWorkspace</code> located in <code>myWorkspace\tests</code>.</p>
<p>You can then compile and run the tests with the <code>test</code> command.</p>
<p></p>
<pre><code><span style="color:#0">$ swag test -w:myWorkspace</span></code></pre><p></p>
<p>To force the build, add <code>--rebuild</code>.</p>
<p><h3 id="Write tests">Write tests</h3></p>
<p></p>
<p></p>
