...
<div class="container">
<p><h1 id="Contribute to the test suite">Contribute to the test suite</h1></p>
<p></br>
You can help by writing small tests to debug the compiler (and the compiler alone).</br>
<h3 id="Create a workspace and a test module">Create a workspace and a test module</h3></p>
<p></br>
First create a workspace with the <code>--test</code> option.</br>
</p>
<pre><code><span style="color:#0">$ swag new -w:myWorkspace --test</span></code></pre><p></br>
This will also create a test module <code>myWorkspace</code> located in <code>myWorkspace\tests</code>.</br>
You can then compile and run the tests with the <code>test</code> command.</br>
</p>
<pre><code><span style="color:#0">$ swag test -w:myWorkspace</span></code></pre><p></br>
To force the build, add <code>--rebuild</code>.</br>
<h3 id="Write tests">Write tests</h3></p>
<p></br>
</p>
<ul><li>Tests should be small, located in different <b>small files</b>.</li>
