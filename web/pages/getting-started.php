...
<p>
You will also find some small examples (mostly written for tests) in <code class="incode">swag/bin/examples/modules</code>.To build and run one of them from the console, go to the workspace folder (<code class="incode">/examples</code>) and type for example <code class="incode">swag run -m:wnd</code>.</p>
</div>
</div>
</div>
</body>
