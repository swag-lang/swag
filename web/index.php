...
<blockquote><p>There's <b>no official</b> release yet.
...
<p>
<p align="center" style="padding-top:30px;"> <img src="imgs/swag_logo.png" width=50%> </p> 
...
This is my third compiler (the other ones were developed for AAA game engines), but that one is by far the most advanced. </td> </p>
<p>
<td width=33% style="vertical-align:top;padding-left:30px;;padding-right:30px;"> 
...
Imagine C++, but where everything could be <i>constexpr</i>. </td> </p>
<p>
<td width=33% style="vertical-align:top;padding-left:30px;;padding-right:30px;"> 
<h2>Modern</h2> 
...
<p></p></p>
<blockquote><p>To take a look at the language, this is <a href="doc/language.php">here</a>.

To take a look at the standard list of modules, this is <a href="pages/std.php">here</a>.

To use Swag as a scripting language, this is <a href="pages/swag-as-script.php">here</a>.
</p></blockquote>
</div>
</div>
</div>
