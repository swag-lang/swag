...
<h2 id="000_introduction">Introduction</h2><p>
This <code class="incode">swag-lang/swag/bin/reference/language</code> module provides a brief explanation of the language basic syntax and usage without the need of the <a href="libraries.php">Swag standard modules</a> (<code class="incode">Std</code>).</p>
<p>
...
<p>
As <code class="incode">reference/language</code> is written as a test module, you can run it with :</p>
<p class="code">
...
<p>
This will run all the test modules of the specified workspace (including this one). You can also omit the <code class="incode">--workspace</code> parameter (or <code class="incode">-w</code> in its short form) if you run Swag directly from the workspace folder.</p>
<p>
Note that if you want to compile and run a single module in the workspace, you can specify it with the <code class="incode">--module</code> (<code class="incode">-m</code>) parameter.</p>
<p class="code">
...
<p>
A <code class="incode">#run</code> block is executed at <b>compile time</b>, and can make Swag behaves like a kind of a <b>scripting language</b>.So in the following example, the famous message will be printed by the compiler during compilation.</p>
<p class="code">
...
</span><span class="SyntaxCompiler">#main</span><span class="SyntaxCode">
{
    ...
    </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Msg</span><span class="SyntaxCode"> = #run </span><span class="SyntaxFunction">mySillyFunction</span><span class="SyntaxCode">()
    </span><span class="SyntaxConstant">Console</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">print</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">Msg</span><span class="SyntaxCode">)
}
...
<h2 id="002_source_code_organization">Source code organization</h2><p>
All source files in Swag have the <code class="incode">.swg</code> extension, except if you write a simple script with the <code class="incode">.swgs</code> extension.They must be encoded in <b>UTF8</b>.</p>
<p>
In Swag you cannot compile a single file (with the exception of <code class="incode">.swgs</code> script files). The source code is organized in a <b>workspace</b> which contains one or multiple <b>modules</b>.</p>
<p>
For example, <code class="incode">Std</code> is a workspace that contains all the Swag standard modules.</p>
<p>
A module is a <code class="incode">dll</code> (under windows) or an executable, and a workspace can include many of them.So a workspace will contain the modules you write (like your main executable) but also all your dependencies (some external modules you use).</p>
<p>
...
<h2 id="004_identifiers">Identifiers</h2><p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> thisIsAValidIdentifier0   = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// const __this_is_invalid = 0</span><span class="SyntaxCode"></code>
</p>
<p>
Note that some identifiers may start with <code class="incode">#</code>. This indicates a <b>compiler special keyword</b>.</p>
<p class="code">
...
<p>
Some identifiers can also start with <code class="incode">@</code>. This indicates an <b>intrinsic</b> function which can be compile time only or also available at runtime (this depends on the intrinsic).</p>
<p class="code">
...
<h2 id="005_keywords">Keywords</h2><p>
...
#ast
</span><span class="SyntaxCompiler">#drop</span><span class="SyntaxCode">
</span><span class="SyntaxCompiler">#init</span><span class="SyntaxCode">
</span><span class="SyntaxCompiler">#main</span><span class="SyntaxCode">
...
@alias0
@alias1
@alias2 </span><span class="SyntaxComment">// and more generally @aliasN</span><span class="SyntaxCode">
...
@mixin0
@mixin1
@mixin2 </span><span class="SyntaxComment">// and more generally @mixinN</span><span class="SyntaxCode">
...
x, y += </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">;</code>
</p>
<p>
Semicolons can be usefull if you want to do multiple things on the same line.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Two instructions on the same line separated with ';'</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">); </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>

<h2 id="007_global_declaration_order">Global declaration order</h2><p>
The order of all <b>top level</b> declarations does not matter.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Here we declare a constant 'A' and initialize it with 'B', which is not</span><span class="SyntaxCode">
...
<p>
In this test, we call the function <code class="incode">functionDeclaredLater</code> before it is known. This is fine.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// First, call a unknown function named 'functionDeclaredLater'</span><span class="SyntaxCode">
#run
{
...
<h2 id="010_basic_types">Basic types</h2><p>
These are all signed integers types <code class="incode">s8</code>, <code class="incode">s16</code>, <code class="incode">s32</code> and <code class="incode">s64</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">s8</span><span class="SyntaxCode">  = -</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">     </span><span class="SyntaxComment">// 8 bits signed integer</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(d) == </span><span class="SyntaxNumber">8</span><span class="SyntaxCode">)</code>
</p>
<p>
These are all unsigned integers types <code class="incode">u8</code>, <code class="incode">u16</code>, <code class="incode">u32</code> and <code class="incode">u64</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">u8</span><span class="SyntaxCode">  = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">      </span><span class="SyntaxComment">// 8 bits unsigned integer</span><span class="SyntaxCode">
...
<p>
These are all floating point types <code class="incode">f32</code> and <code class="incode">f64</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">f32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">3.14</span><span class="SyntaxCode">       </span><span class="SyntaxComment">// 32 bits floating point value</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(b) == </span><span class="SyntaxNumber">8</span><span class="SyntaxCode">)</code>
</p>
<p>
The boolean type <code class="incode">bool</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">bool</span><span class="SyntaxCode"> = </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">      </span><span class="SyntaxComment">// Stored in 1 byte</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(b) == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
The <code class="incode">string</code> type. Strings are <b>UTF8</b>, and are stored as two 64 bits (the pointer to the value and the string length in bytes). Note that a string literal also ends with a null byte like in C.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">string</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"string 是"</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"> * </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(*</span><span class="SyntaxType">void</span><span class="SyntaxCode">))</code>
</p>
<p>
The <code class="incode">rune</code> type is a 32 bits unicode code point.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">rune</span><span class="SyntaxCode"> = </span><span class="SyntaxString">`是`</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p>
You can use <code class="incode">@decltype</code> to create a type based on an expression.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">                   </span><span class="SyntaxComment">// 'a' is inferred to have the 's32' type</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxType">s32</span><span class="SyntaxCode"></code>
</p>
<p>
Short notice that types are also values, at compile time and at runtime.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x = </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxType">s32</span><span class="SyntaxCode">)   </span><span class="SyntaxComment">// 'x' is now a variable that contains a type</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxType">bool</span><span class="SyntaxCode">)</code>
</p>

<h2 id="011_number_literals">Number literals</h2><p>
Integers in <i>decimal</i>, <i>hexadecimal</i> or <i>binary</i> forms.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">123456</span><span class="SyntaxCode">           </span><span class="SyntaxComment">// Decimal</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(c == </span><span class="SyntaxNumber">15</span><span class="SyntaxCode">)</code>
</p>
<p>
You can separate the digits with the <code class="incode">_</code> character.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">123_456</span><span class="SyntaxCode">
...
<p>
The default type of an hexadecimal number or a binary number is <code class="incode">u32</code> or <code class="incode">u64</code> depending on its value.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// The compiler will deduce that the type of 'a' is 'u32'.</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(d) == </span><span class="SyntaxType">u64</span><span class="SyntaxCode"></code>
</p>
<p>
A boolean is <code class="incode">true</code> or <code class="incode">false</code>. Note again that as constants are known at compile time, we can  use <code class="incode">#assert</code> to check the values.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">
...
#assert c == </span><span class="SyntaxKeyword">false</span><span class="SyntaxCode"></code>
</p>
<p>
A floating point value has the usual C/C++ form.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">1.5</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(e == -</span><span class="SyntaxNumber">0.1</span><span class="SyntaxCode">)</code>
</p>
<p>
By default, a floating point value is <code class="incode">f32</code>, not <code class="incode">f64</code> (aka <code class="incode">double</code>) like in C/C++.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">1.5</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">1.5</span><span class="SyntaxCode">)
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxType">f32</span><span class="SyntaxCode">
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(a) != </span><span class="SyntaxType">f64</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Declare 'a' to be a 'f64' variable assigned to '1.5'</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(c) == </span><span class="SyntaxType">u32</span><span class="SyntaxCode"></code>
</p>

<h2 id="012_string">String</h2><p>
In Swag, strings are encoded in UTF8.</p>
<p>
They also can be compared.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">"this is a chinese character: 是"</span><span class="SyntaxCode">
...
#assert b == </span><span class="SyntaxString">"these are some cyrillic characters: ӜИ"</span><span class="SyntaxCode"></code>
</p>
<p>
A rune is an unicode codepoint, and is 32 bits.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">rune</span><span class="SyntaxCode"> = </span><span class="SyntaxString">`是`</span><span class="SyntaxCode">
...
#assert c[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] != </span><span class="SyntaxString">`X`</span><span class="SyntaxCode"> </span><span class="SyntaxComment">// False because the byte number 1 is not the character 'X'</span><span class="SyntaxCode"></code>
</p>
<p>
Multiple adjacent strings are compiled as one.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">"this is "</span><span class="SyntaxCode">   </span><span class="SyntaxString">"a"</span><span class="SyntaxCode">   </span><span class="SyntaxString">" string"</span><span class="SyntaxCode">
#assert a == </span><span class="SyntaxString">"this is a string"</span><span class="SyntaxCode"></code>
</p>
<p>
You can concatenate some values if the values are known at compile time. Use the <code class="incode">++</code> operator for that.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">"the devil number is "</span><span class="SyntaxCode"> ++ </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(d == </span><span class="SyntaxString">"they are 4 apples in 4 baskets"</span><span class="SyntaxCode">)</code>
</p>
<p>
A string can be <code class="incode">null</code> if not defined.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">string</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxKeyword">null</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> char0 = </span><span class="SyntaxString">`a`</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">`0`</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(e) == </span><span class="SyntaxType">rune</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p>
An escape sequence starts with a backslash <code class="incode">\</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">"this is code ascii 0x00:   \0"</span><span class="SyntaxCode">   </span><span class="SyntaxComment">// null</span><span class="SyntaxCode">
...
</span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> l = </span><span class="SyntaxString">"this is code ascii 0x5C:   \\"</span><span class="SyntaxCode">   </span><span class="SyntaxComment">// backslash</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p>
A raw string starts and ends with the character <code class="incode">@</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">@"\u2F46"@</span><span class="SyntaxCode">
#assert a != </span><span class="SyntaxString">"⽆"</span><span class="SyntaxCode">
#assert a == </span><span class="SyntaxString">@"\u2F46"@</span><span class="SyntaxCode"></code>
</p>
<p>
This are equivalent</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">"\\hello \\world"</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">@"this is
            a
            string
            "@</span><span class="SyntaxCode"></code>
</p>
<p>
Every blanks <b>before</b> the ending mark <code class="incode">"@</code> will be removed from every other lines, so the string before is equivalent to :</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// this is</span><span class="SyntaxCode">
</span><span class="SyntaxComment">// a</span><span class="SyntaxCode">
</span><span class="SyntaxComment">// string</span><span class="SyntaxCode"></code>
</p>
<p>
<h3 id="Multiline string">Multiline string</h3></p>
<p>
A multiline string starts and ends with <code class="incode">"""</code>. Unlike raw strings, they still evaluate escape sequences.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">""</span><span class="SyntaxCode"></span><span class="SyntaxString">"this is
             a
             string
...
<p>
In a multiline or a raw string, if you end a line with <code class="incode">\</code>, the following "eol" will <b>not</b> be part of the string.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a = </span><span class="SyntaxString">""</span><span class="SyntaxCode"></span><span class="SyntaxString">"\
          this is
          a
          string
          "</span><span class="SyntaxCode"></span><span class="SyntaxString">""</span><span class="SyntaxCode">
...
<p>
You can use the instrinsic <code class="incode">@stringof</code> to return at compile time the result of a constant expression as a string.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">X</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@stringof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">X</span><span class="SyntaxCode"> + </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">) == </span><span class="SyntaxString">"11"</span><span class="SyntaxCode"></code>
</p>
<p>
You can also use <code class="incode">@nameof</code> to return the name of a variable, function etc.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">X</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
#assert </span><span class="SyntaxIntrinsic">@nameof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">X</span><span class="SyntaxCode">) == </span><span class="SyntaxString">"X"</span><span class="SyntaxCode"></code>
</p>

<h2 id="013_variables">Variables</h2><p>
To declare a variable, use the <code class="incode">let</code> or <code class="incode">var</code> keyword, followed by <code class="incode">:</code> and then the type.</p>
<p>
<code class="incode">let</code> is used for a variable that cannot be changed after the initial affectation.</p>
<p>
<code class="incode">var</code> is used for a variable that can be changed again after the initial affectation.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Variable 'a' is of type 'u32' and its value is '1'. It cannot be changed.</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(c == </span><span class="SyntaxNumber">43</span><span class="SyntaxCode">)</code>
</p>
<p>
We have already seen that we can declare multiple variables on the same line.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a, b: </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">123</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(b == </span><span class="SyntaxNumber">123</span><span class="SyntaxCode">)</code>
</p>
<p>
Or</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">12</span><span class="SyntaxCode">, b: </span><span class="SyntaxType">f32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">1.5</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(c == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
But if you really do not want the variable to be initialized, you can assign it with <code class="incode">undefined</code>. To use with care, of course, but this is sometimes necessary to avoid the initialization cost.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">bool</span><span class="SyntaxCode"> = </span><span class="SyntaxKeyword">undefined</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> b: </span><span class="SyntaxType">string</span><span class="SyntaxCode"> = </span><span class="SyntaxKeyword">undefined</span><span class="SyntaxCode"></code>
</p>
<p>
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(c) == </span><span class="SyntaxType">f64</span><span class="SyntaxCode"></code>
</p>
<p>
The same goes for multiple variables.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a, b = </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">)
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(d) == </span><span class="SyntaxType">string</span><span class="SyntaxCode"></code>
</p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> a: [</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
...
#assert a[</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"></code>
</p>
<p>
An example of a multidimensional array as a constant. We will detail arrays later.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">M4x4</span><span class="SyntaxCode">: [</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">] </span><span class="SyntaxType">f32</span><span class="SyntaxCode"> = [
...
<p>
So the difference between <code class="incode">let</code> and <code class="incode">const</code> is that the value of a constant should be known at compile time, where the value of a <code class="incode">let</code> can be dynamic. Other than that, both must be assigned once and only once.</p>

<h2 id="015_operators">Operators</h2><p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
...
x = x % </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"></code>
</p>
<p>
...
x = x &gt;&gt; </span><span class="SyntaxNumber">1</span><span class="SyntaxCode"></code>
</p>
<p>
<h3 id="Assignment operators">Assignment operators</h3></p>
<p>
All the arithmetic and bitwise operators have an <code class="incode">affect</code> version.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
...
x &= </span><span class="SyntaxNumber">0b0000_0001</span><span class="SyntaxCode">
x &lt;&lt;= </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
x &gt;&gt;= </span><span class="SyntaxNumber">1</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxNumber">0b1111_1110</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p>
This is <b>not</b> <code class="incode">&&</code> and <code class="incode">||</code> like in C/C++, but <code class="incode">and</code> and <code class="incode">or</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a = </span><span class="SyntaxKeyword">false</span><span class="SyntaxCode">
...
a = (</span><span class="SyntaxNumber">1</span><span class="SyntaxCode"> &gt; </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">) </span><span class="SyntaxLogic">or</span><span class="SyntaxCode"> (</span><span class="SyntaxNumber">10</span><span class="SyntaxCode"> &lt; </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="Ternary operator">Ternary operator</h3></p>
<p>
The ternary operator will test an expression, and will return a value depending on the result of the test.<code class="incode">A = Expression ? B : C</code> will return <code class="incode">B</code> if the expression is true, and will return <code class="incode">C</code> if the expression is false.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Returns 1 because the expression 'true' is... true.</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="Spaceshift operator">Spaceshift operator</h3></p>
<p>
Operator <code class="incode">&lt;=&gt;</code> will return -1, 0 or 1 if the expression on the left is <b>lower</b>, <b>equal</b> or <b>greater</b> than the expression on the right. The returned type is <code class="incode">s32</code>.</p>
<p class="code">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(c == </span><span class="SyntaxString">"string2"</span><span class="SyntaxCode">)</code>
</p>
<p>
Works also for basic types like integers.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(c == b)</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode"> + </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">)  == </span><span class="SyntaxType">u8</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">'</span><span class="SyntaxType">s8</span><span class="SyntaxCode"> + </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">'</span><span class="SyntaxType">u16</span><span class="SyntaxCode">) == </span><span class="SyntaxType">u16</span><span class="SyntaxCode">   </span><span class="SyntaxComment">// Priority to bigger type also</span><span class="SyntaxCode"></code>
</p>
<p>
This means that a 8/16 bits operation (like an addition) can more easily <b>overflow</b> if you do not take care.In that case, you can use the <code class="incode">,up</code> <b>modifier</b> on the operation, which will promote the type to at least 32 bits. The operation will be done accordingly.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">255</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode"> +,up </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">) == </span><span class="SyntaxType">u32</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Multiplication before addition</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(((</span><span class="SyntaxNumber">10</span><span class="SyntaxCode"> & </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">) &lt;&lt; </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>

<h2 id="016_cast">Cast</h2><p>
<h3 id="Explicit cast">Explicit cast</h3></p>
<p>
Sometimes it can be necessary to change the type of a value.Use <code class="incode">cast(type)</code> to cast from one type to another.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// 'x' is a float</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="acast">acast</h3></p>
<p>
<code class="incode">acast</code> stands for <code class="incode">automatic</code> cast. Use it to let the compiler automatically cast to the expression on the left.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">f32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode">
...
<p>
Use <code class="incode">cast,bit</code> to convert a native type to another without converting the value. Works only if the two types are of the same size.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">f32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxKeyword">cast</span><span class="SyntaxCode">,</span><span class="SyntaxFunction">bit</span><span class="SyntaxCode">(</span><span class="SyntaxType">f32</span><span class="SyntaxCode">) </span><span class="SyntaxNumber">0x3f800000</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// An implicit cast is done if there's no loss of precision. In that case, you can affect different types.</span><span class="SyntaxCode">
...
<h2 id="020_array">Array</h2><p>
Remember that dynamic arrays are part of the <code class="incode">Std.Core</code> module. Here we are only talking about native static arrays.</p>
<p>
A static array is declared with <code class="incode">[N]</code> followed by the type, where <code class="incode">N</code> is the dimension.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">{
...
<p>
You can get the number of elements of an array with <code class="incode">@countof</code>, and the size in bytes with <code class="incode">@sizeof</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(array) == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"> * </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxType">s32</span><span class="SyntaxCode">)</code>
</p>
<p>
You can get the address of the array with <code class="incode">@dataof</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(array[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
An <b>array literal</b> has the form <code class="incode">[A, B, ...]</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> arr = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">] </span><span class="SyntaxComment">// An array of four s32</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(arr) == </span><span class="SyntaxType">#type</span><span class="SyntaxCode"> [</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"></code>
</p>
<p>
The size of the array can be deduced from the initialisation expression.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Here the dimension is not specified, but as the array is initialized with 2 elements, it can be deduced.</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(array1) == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode"></code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(array[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
But for speed, you can force the array to be not initialized with <code class="incode">undefined</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">100</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxKeyword">undefined</span><span class="SyntaxCode"></code>
</p>
<p>
A static array (with compile time values) can be stored as a constant.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> array = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">]
...
#assert array[</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">4</span><span class="SyntaxCode"></code>
</p>
<p>
If the type of the array is not specified, the type of the <b>first</b> literal value will be used for all other members.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> arr = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">'</span><span class="SyntaxType">f64</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">]    </span><span class="SyntaxComment">// Every values are forced to be 'f64'</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(arr[</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">4.0</span><span class="SyntaxCode">)</code>
</p>
<p>
Of course an array can have multiple dimensions.</p>
<p>
Syntax is <code class="incode">[X, Y, Z...]</code> where <code class="incode">X</code>, <code class="incode">Y</code> and <code class="incode">Z</code> are dimensions.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">   </span><span class="SyntaxComment">// Declare a 2x2 array</span><span class="SyntaxCode">
...
array[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] = </span><span class="SyntaxNumber">4</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">][</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">]
...
#assert </span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(array1) == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// The whole array is initialized with 'true'</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(arr1[</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">9</span><span class="SyntaxCode">] == </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">)</code>
</p>

<h2 id="021_slice">Slice</h2><p>
A slice is a pointer on a buffer of datas, and a <code class="incode">u64</code> to count the number of elements. Unlike a static array, its value can be changed at runtime.</p>
<p>
It is declared with <code class="incode">[..]</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a: [..] </span><span class="SyntaxType">bool</span><span class="SyntaxCode">    </span><span class="SyntaxComment">// Slice of bools</span><span class="SyntaxCode">
#assert </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(*</span><span class="SyntaxType">void</span><span class="SyntaxCode">) + </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxType">u64</span><span class="SyntaxCode">)</code>
</p>
<p>
You can initialize a slice like an array.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> [..] </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">50</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
At runtime, <code class="incode">@dataof</code> will return the address of the values, <code class="incode">@countof</code> the number of elements.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> [..] </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">50</span><span class="SyntaxCode">]
...
a = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
You can create a slice with your own <code class="incode">pointer</code> and <code class="incode">count</code> using <code class="incode">@mkslice</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">] </span><span class="SyntaxType">u32</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(array[</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">314</span><span class="SyntaxCode">)</code>
</p>
<p>
For a string, the slice must be <code class="incode">const</code> because a string is immutable.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> str = </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(strSlice[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxString">`t`</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p>
Instead of <code class="incode">@mkslice</code>, you can slice something with the <code class="incode">..</code> operator. For example you can slice a string.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> str = </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(slice == </span><span class="SyntaxString">"tri"</span><span class="SyntaxCode">)</code>
</p>
<p>
The upper limit is <b>included</b> by default. If you want to exclude it, use <code class="incode">..&lt;</code> insteand of <code class="incode">..</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> str = </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> slice = str[</span><span class="SyntaxNumber">1.</span><span class="SyntaxCode">.&lt;</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">]
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(slice == </span><span class="SyntaxString">"tr"</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(slice == </span><span class="SyntaxString">"ring"</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(slice1 == </span><span class="SyntaxString">"st"</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also slice an array.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> arr = [</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(slice1) == </span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(arr))</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(slice2[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(slice) == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>

<h2 id="022_pointers">Pointers</h2><p>
<h3 id="Single value pointers">Single value pointers</h3></p>
<p>
</p>
<p>
A pointer to a <b>single element</b> is declared with <code class="incode"><i></code>.</i></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> ptr1: *</span><span class="SyntaxType">u8</span><span class="SyntaxCode">   </span><span class="SyntaxComment">// This is a pointer to one single 'u8'</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> ptr2: **</span><span class="SyntaxType">u8</span><span class="SyntaxCode">  </span><span class="SyntaxComment">// This is a pointer to one other pointer to one single 'u8'</span><span class="SyntaxCode"></code>
</p>
<p>
A pointer can be <code class="incode">null</code> (i know some of you will collapse here).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> ptr1: *</span><span class="SyntaxType">u8</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(ptr1 == </span><span class="SyntaxKeyword">null</span><span class="SyntaxCode">)</code>
</p>
<p>
You can take the address of something with <code class="incode">&</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> arr = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(ptr) == *</span><span class="SyntaxType">s32</span><span class="SyntaxCode">)</code>
</p>
<p>
You can get the pointed value with <code class="incode">dref</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> arr = </span><span class="SyntaxNumber">42</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> ptr = &arr
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">dref</span><span class="SyntaxCode"> ptr == </span><span class="SyntaxNumber">42</span><span class="SyntaxCode">)</code>
</p>
<p>
Pointers can be <code class="incode">const</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> str = </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">dref</span><span class="SyntaxCode"> ptr == </span><span class="SyntaxString">`s`</span><span class="SyntaxCode">)</code>
</p>
<p>
You can be weird, but is this necessary ?</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> ptr:  *</span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> *</span><span class="SyntaxType">u8</span><span class="SyntaxCode">        </span><span class="SyntaxComment">// Normal pointer to a const pointer</span><span class="SyntaxCode">
...
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> ptr2: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> **</span><span class="SyntaxType">u8</span><span class="SyntaxCode">        </span><span class="SyntaxComment">// Const pointer to a normal pointer</span><span class="SyntaxCode"></code>
</p>
<p>
<h3 id="Multiple values pointers">Multiple values pointers</h3></p>
<p>
If you want to enable <b>pointer arithmetic</b>, and make a pointer to <b>multiple values</b>, declare your pointer with <code class="incode">^</code> instead of <code class="incode"><i></code>.</i></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// `ptr` is a pointer to a memory block of `u8`.</span><span class="SyntaxCode">
...
ptr = ptr - </span><span class="SyntaxNumber">1</span><span class="SyntaxCode"></code>
</p>
<p>
Taking the address of an array element enables pointer arithmetic.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: [</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(ptr) == ^</span><span class="SyntaxType">s32</span><span class="SyntaxCode"></code>
</p>
<p>
As pointer arithmetic is enabled, you can dereference that kind of pointer by index.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> arr = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">]
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(value) == </span><span class="SyntaxType">s32</span><span class="SyntaxCode"></code>
</p>

<h2 id="023_references">References</h2><p>
Swag has also <b>references</b>, which are pointers that behave like values.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">42</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(myRef == </span><span class="SyntaxNumber">42</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxNumber">66</span><span class="SyntaxCode">)</code>
</p>
<p>
But unlike C++, you can change the reference (reassign it) and not the pointed value if you want.You must then use <code class="incode">ref</code> in the affectation.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(myRef == </span><span class="SyntaxNumber">1000</span><span class="SyntaxCode">)</code>
</p>
<p>
Most of the time, you have to take the address of a variable to make a reference to it. The only exception are function parameters, if the reference is <code class="incode">const</code>. In that case, taking the address is not necessary</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// We can pass a literal because the parameter 'x' of 'toto' is 'const ref' and not just 'ref'.</span><span class="SyntaxCode">
</span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">(x: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">ref</span><span class="SyntaxCode"> </span><span class="SyntaxType">s32</span><span class="SyntaxCode">)
{
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode"> {x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> }  </span><span class="SyntaxComment">// Our first little struct !</span><span class="SyntaxCode"></code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxFunction">titi0</span><span class="SyntaxCode">({</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">})
...
</span><span class="SyntaxFunction">titi2</span><span class="SyntaxCode">({</span><span class="SyntaxNumber">5</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">})</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">titi0</span><span class="SyntaxCode">(param: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">ref</span><span class="SyntaxCode"> {x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">})
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">cast</span><span class="SyntaxCode">(</span><span class="SyntaxType">bool</span><span class="SyntaxCode">) a == </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">)</code>
</p>
<p>
<code class="incode">any</code> is in fact a pointer to the value, and a <code class="incode">typeinfo</code>. <code class="incode">@dataof</code> can be used to retrieve the pointer to the value.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">any</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">dref</span><span class="SyntaxCode"> ptr == </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">)</code>
</p>
<p>
<code class="incode">@typeof</code> will give you the type <code class="incode">any</code>, but <code class="incode">@kindof</code> will give you the real underlying type. In that case, <code class="incode">@kindof</code> is evaluted at runtime.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a: </span><span class="SyntaxType">any</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">
...
a = </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@kindof</span><span class="SyntaxCode">(a) == </span><span class="SyntaxType">bool</span><span class="SyntaxCode">)</code>
</p>
<p>
You can declare an array with multiple types, with <code class="incode">any</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [] </span><span class="SyntaxType">any</span><span class="SyntaxCode"> = [</span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3.0</span><span class="SyntaxCode">, </span><span class="SyntaxString">"4"</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">cast</span><span class="SyntaxCode">(</span><span class="SyntaxType">string</span><span class="SyntaxCode">) array[</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">] == </span><span class="SyntaxString">"4"</span><span class="SyntaxCode">)</code>
</p>
<p>
An <code class="incode">any</code> can be set to null, and tested against null.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">any</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxKeyword">null</span><span class="SyntaxCode">)</code>
</p>

<h2 id="025_tuple">Tuple</h2><p>
A tuple is an anonymous structure, aka a struct literal. Syntax is <code class="incode">{}</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> tuple1 = {</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">}
</span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> tuple2 = {</span><span class="SyntaxString">"string"</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">}</code>
</p>
<p>
Tuple values have default names to access them, in the form of <code class="incode">itemX</code> where <code class="incode">X</code> is the field rank.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> tuple = {</span><span class="SyntaxString">"string"</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(tuple.item2 == </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">)</code>
</p>
<p>
But you can specify your own names.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> tuple = {x = </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode">, y = </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(tuple.item1 == </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">)</code>
</p>
<p>
When creating a tuple literal with variables, the tuple fields will take the name of the variables (except if specified).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">555</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(t.item1 == t.y)</code>
</p>
<p>
Even if two tuples do not have the same field names, they can be assigned to each other if the field types are the same.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: {a: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, b: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">}
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(x) != </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(y)</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> tuple1 = {x = </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode">, y = </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(value == </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">)</code>
</p>
<p>
You can ignore a tuple field by naming the variable <code class="incode">?</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> tuple1 = {x = </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode">, y = </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">)</code>
</p>

<h2 id="030_enum">Enum</h2><p>
Enums values, unlike C/C++, can end with <code class="incode">;</code> or <code class="incode">,</code> or an <code class="incode">eol</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Values0</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Values5</span><span class="SyntaxCode"> { </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">; </span><span class="SyntaxConstant">B</span><span class="SyntaxCode"> }</code>
</p>
<p>
By default, an enum is of type <code class="incode">s32</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Values</span><span class="SyntaxCode"> { </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">, </span><span class="SyntaxConstant">B</span><span class="SyntaxCode"> }
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">Values</span><span class="SyntaxCode">) == </span><span class="SyntaxConstant">Values</span><span class="SyntaxCode"></code>
</p>
<p>
<code class="incode">@kindof</code> will return the underlying type of the enum.</p>
<p class="code">
...
#assert </span><span class="SyntaxIntrinsic">@kindof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">) == </span><span class="SyntaxType">s32</span><span class="SyntaxCode"></code>
</p>
<p>
You can specify your own type after the enum name.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Values1</span><span class="SyntaxCode">: </span><span class="SyntaxType">s64</span><span class="SyntaxCode"> </span><span class="SyntaxComment">// Forced to be 's64' instead of 's32'</span><span class="SyntaxCode">
{
    </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">B</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">Values1</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">A</span><span class="SyntaxCode">) == </span><span class="SyntaxConstant">Values1</span><span class="SyntaxCode"></code>
</p>
<p>
Enum values, if not specified, start at 0 and are increased by 1 at each new value.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">: </span><span class="SyntaxType">s64</span><span class="SyntaxCode">
{
    </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">B</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">C</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"></code>
</p>
<p>
...
#assert </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">30</span><span class="SyntaxCode"></code>
</p>
<p>
If you omit one value, it will be assigned to the previous value + 1.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">: </span><span class="SyntaxType">u32</span><span class="SyntaxCode">
{
    </span><span class="SyntaxConstant">A</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">12</span><span class="SyntaxCode"></code>
</p>
<p>
For non integer types, you <b>must</b> specify the values as they cannot be deduced.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Value1</span><span class="SyntaxCode">: </span><span class="SyntaxType">string</span><span class="SyntaxCode">
{
...
#assert </span><span class="SyntaxConstant">Value2</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">6</span><span class="SyntaxCode"></code>
</p>
<p>
<code class="incode">@countof</code> returns the number of values of an enum.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">: </span><span class="SyntaxType">string</span><span class="SyntaxCode">
{
    </span><span class="SyntaxConstant">A</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"string 1"</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">B</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"string 2"</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"string 3"</span><span class="SyntaxCode">
...
#assert </span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode"></code>
</p>
<p>
You can use the keyword <code class="incode">using</code> for an enum.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">
{
    </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">B</span><span class="SyntaxCode">
    </span><span class="SyntaxConstant">C</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="Enum as flags">Enum as flags</h3></p>
<p>
An enum can be a set of flags if you declare it with the <code class="incode">#<a href="swag.runtime.html#Swag_EnumFlags">Swag.EnumFlags</a></code> <b>attribute</b>. Its type should be <code class="incode">u8</code>, <code class="incode">u16</code>, <code class="incode">u32</code> or <code class="incode">u64</code>.</p>
<p>
That kind of enum starts by default at 1, and not 0, and each value should be a power of 2.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.EnumFlags]</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(value & </span><span class="SyntaxConstant">MyFlags</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode"> == </span><span class="SyntaxConstant">MyFlags</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode">)</code>
</p>
<p>
...
#assert </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Value</span><span class="SyntaxCode">: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> [..] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
{
    </span><span class="SyntaxConstant">A</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == y)</code>
</p>
<p>
The enum type is not necessary in a <code class="incode">case</code> expression of a <code class="incode">switch</code> block (it is deduced from the switch expression).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Values</span><span class="SyntaxCode"> { </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">; </span><span class="SyntaxConstant">B</span><span class="SyntaxCode">; }
...
<p>
In an expression, and if the enum name can be deduced, you can omit it and use the <code class="incode">.Value</code> syntax.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Values</span><span class="SyntaxCode"> { </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">, </span><span class="SyntaxConstant">B</span><span class="SyntaxCode"> }
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x != .</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">((x & .</span><span class="SyntaxConstant">A</span><span class="SyntaxCode">) </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> (x & .</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">))</code>
</p>
<p>
...
</span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">(.</span><span class="SyntaxConstant">A</span><span class="SyntaxCode">, .</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<h2 id="031_impl">Impl</h2><p>
<code class="incode">impl</code> can be used to declare some stuff in the scope of an enum. The keyword <code class="incode">self</code> represents the enum value.</p>
<p class="code">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">isRed</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">R</span><span class="SyntaxCode">))
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(!</span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">G</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">isRedOrBlue</span><span class="SyntaxCode">())</code>
</p>

<h2 id="035_namespace">Namespace</h2><p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">namespace</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">
{
...
<p>
You can also specify more than one name. Here <code class="incode">C</code> will be a namespace inside <code class="incode">B</code> which is itself inside <code class="incode">A</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">namespace</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode">
{
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">A</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">a</span><span class="SyntaxCode">() == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">A</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">C</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">a</span><span class="SyntaxCode">() == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also put <code class="incode">using</code> in front of the namespace to be able to access the content without scoping in the <b>current</b> file.</p>
<p class="code">
...
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
    ...
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also at the same time declare and test one variable in an <code class="incode">if</code> expression. <code class="incode">var</code>, <code class="incode">let</code> or <code class="incode">const</code> is mandatory in that case.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This will declare a variable 'a', and test it against 0.</span><span class="SyntaxCode">
...
</span><span class="SyntaxLogic">if</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
{
    ...
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">false</span><span class="SyntaxCode">)</code>
</p>

<h2 id="051_loop">Loop</h2><p>
<code class="incode">loop</code> are used to iterate a given amount of time.</p>
<p>
The loop expression value is evaluated <b>once</b>, and must be a <b>positive value</b>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
    ...
    cpt += </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)</code>
</p>
<p>
The intrinsic <code class="incode">@index</code> returns the current index of the loop (starting at 0).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">'</span><span class="SyntaxType">u64</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">20</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">30</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">40</span><span class="SyntaxCode">)</code>
</p>
<p>
</p>
<blockquote><p>
<b>Warning !</b>On a string, it will loop for each byte, <b>not</b> runes (if a rune is encoded in more than one byte). If you want to iterate on all runes, you will have to use the <code class="incode">Std.Core</code> module.</p></blockquote>
<p>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="break, continue">break, continue</h3></p>
<p>
<code class="incode">break</code> and <code class="incode">continue</code> can be used inside a loop.</p>
<p>
You can exit a loop with <code class="incode">break</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">)</code>
</p>
<p>
You can force to return to the loop evaluation with <code class="incode">continue</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> x: </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">9</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p>
Syntax is <code class="incode">lower bound..upper bound</code></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> count = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(count == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
With a range, you can loop in reverse order.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Loop from 5 to 0</span><span class="SyntaxCode">
...
<p>
You can exclude the last value with the <code class="incode">..&lt;</code> syntax.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Will loop from 1 to 2 and **not** 1 to 3</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="Infinite loop">Infinite loop</h3></p>
<p>
A loop without an expression but with a block is infinite. This is equivalent to <code class="incode">while true {}</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxLogic">loop</span><span class="SyntaxCode">
{
...
<h2 id="052_visit">Visit</h2><p>
<code class="incode">visit</code> is used to visit all the elements of a collection.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Here we visit every bytes of the string.</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxLogic">visit</span><span class="SyntaxCode"> value, index: </span><span class="SyntaxString">"ABC"</span><span class="SyntaxCode">
{
...
<p>
Both names are optional. In that case, you can use <code class="incode">@alias0</code> and <code class="incode">@alias1</code>. <code class="incode">@alias0</code> for the value, and <code class="incode">@alias1</code> for the index.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxLogic">visit</span><span class="SyntaxCode"> </span><span class="SyntaxString">"ABC"</span><span class="SyntaxCode">
{
    </span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = @alias1    </span><span class="SyntaxComment">// This is the index</span><span class="SyntaxCode">
    ...
    {
    </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">: </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias0 == </span><span class="SyntaxString">`A`</span><span class="SyntaxCode">)
    </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">: </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias0 == </span><span class="SyntaxString">`B`</span><span class="SyntaxCode">)
    </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">: </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias0 == </span><span class="SyntaxString">`C`</span><span class="SyntaxCode">)
    }
}</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array = [</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(result == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">20</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">30</span><span class="SyntaxCode">)</code>
</p>
<p>
Works also for multi dimensional arrays.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = [[</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">], [</span><span class="SyntaxNumber">30</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">]]

</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> result = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">visit</span><span class="SyntaxCode"> it: array
    result += it

</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(result == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">20</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">30</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">40</span><span class="SyntaxCode">)</code>
</p>
<p>
You can visit with a pointer to the value, and not the value itself, by adding <code class="incode">&</code> before the value name.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> array: [</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = [[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">], [</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">]]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(array[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">555</span><span class="SyntaxCode">)</code>
</p>

<h2 id="053_for">For</h2><p>
<code class="incode">for</code> accepts a <i>start statement</i>, an <i>expression to test</i>, and an <i>ending statement</i>. This is in fact the same as the C/C++ <code class="incode">for</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
<p>
Like <code class="incode">loop</code>, <code class="incode">visit</code> and <code class="incode">while</code>, you have access to <code class="incode">@index</code>, the <b>current loop index</b>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">'</span><span class="SyntaxType">u64</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt1 == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>

<h2 id="054_while">While</h2><p>
<code class="incode">while</code> is a loop that runs <b>until the expression is false</b>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> i = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
    ...
    i += </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(i == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also <code class="incode">break</code> and <code class="incode">continue</code> inside a <code class="incode">while</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> i = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">while</span><span class="SyntaxCode"> i &lt; </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(i == </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">)</code>
</p>
...
<p>
You can put multiple values on the same <code class="incode">case</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> value = </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">switch</span><span class="SyntaxCode"> value
{
...
<p>
<code class="incode">switch</code> works with every types that accept the <code class="incode">==</code> operator. So you can switch on strings for example.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> value = </span><span class="SyntaxString">"myString"</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">switch</span><span class="SyntaxCode"> value
{
...
<p>
If you want to pass from one case to another like in C/C++, use <code class="incode">fallthrough</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> value = </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">switch</span><span class="SyntaxCode"> value
{
...
<p>
<code class="incode">break</code> can be used to exit the current <code class="incode">case</code> statement.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> value = </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">switch</span><span class="SyntaxCode"> value
{
...
<p>
A <code class="incode">case</code> statement cannot be empty. Use <code class="incode">break</code> if you want to do nothing.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> value = </span><span class="SyntaxNumber">6</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">switch</span><span class="SyntaxCode"> value
{
...
<p>
<code class="incode">switch</code> can be marked with <code class="incode">Swag.Complete</code> to force all the cases to be covered. If one or more values are missing, an error will be raised by the compiler.</p>
<p class="code">
...
<p>
When used on an <code class="incode">any</code> variable, switch is done on the underlying variable type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">any</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"value"</span><span class="SyntaxCode">
...
<p>
A <code class="incode">switch</code> can also be used with a (constant) range of values.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> success = </span><span class="SyntaxKeyword">false</span><span class="SyntaxCode">
...
<h2 id="056_break">Break</h2><p>
We have already seen than <code class="incode">break</code> is used to exit a <code class="incode">loop</code>, <code class="incode">visit</code>, <code class="incode">while</code>, <code class="incode">for</code>, <code class="incode">switch</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
    </span><span class="SyntaxLogic">break</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">for</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> i = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">; i &lt; </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">; i += </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
    </span><span class="SyntaxLogic">break</span><span class="SyntaxCode">
    ...
    </span><span class="SyntaxLogic">break</span><span class="SyntaxCode"></code>
</p>
<p>
By default, <code class="incode">break</code> will exit the parent scope only.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
<p>
But you can <b>name a scope</b> with the <code class="incode">#scope</code> compiler keyword, and exit to the end of it with a <code class="incode">break</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
#scope
{
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">#scope </span><span class="SyntaxConstant">Up</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
{
    </span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
    {
...
<h3 id="061_001_declaration">Declaration</h3><p>
This is a <code class="incode">struct</code> declaration. <code class="incode">var</code> is not necessary for the fields.</p>
<p class="code">
...
<p>
Variables can also be separated with <code class="incode">;</code> or <code class="incode">,</code>. The last one is not mandatory.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">{name: </span><span class="SyntaxType">string</span><span class="SyntaxCode">, val1: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">}
</span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct1</span><span class="SyntaxCode">{x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; y, z: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; val: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">; myS: </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">}</code>
</p>
<p>
A struct can be anonymous when declared as a variable type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> tuple: </span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(tuple.y == </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">)</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.y == </span><span class="SyntaxString">"454"</span><span class="SyntaxCode">)</code>
</p>
<p>
You can initialize a struct variable in different ways.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// At fields declaration</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v3.y == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)</code>
</p>
<p>
...
#assert </span><span class="SyntaxConstant">X</span><span class="SyntaxCode">.y == </span><span class="SyntaxString">"value"</span><span class="SyntaxCode"></code>
</p>
<p>
A function can take an argument of type <code class="incode">struct</code>.No copy is done (this is equivalent to a const reference in C++).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Struct3</span><span class="SyntaxCode">
{
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Call with a struct literal</span><span class="SyntaxCode">
...
</span><span class="SyntaxFunction">titi</span><span class="SyntaxCode">({x = </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">, z = </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">}) </span><span class="SyntaxComment">// Here y will stay to the default value, which is 666</span><span class="SyntaxCode"></code>
</p>

<h3 id="062_002_impl">Impl</h3><p>
Like for an enum, <code class="incode">impl</code> is used to declare some stuff in the scope of a struct.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.ExportType("methods")]</span><span class="SyntaxCode">   </span><span class="SyntaxComment">// See later, used to export 'methods' in type reflection</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
...
<p>
So to access the constant and the function, you have to use the <code class="incode">MyStruct</code> namespace.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">MyConst</span><span class="SyntaxCode">)
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">returnTrue</span><span class="SyntaxCode">())</code>
</p>
<p>
You can have multiple <code class="incode">impl</code> blocks. The difference with a namespace is that <code class="incode">self</code> and <code class="incode">Self</code> are defined inside an <code class="incode">impl</code> block. They refere to the corresponding type.</p>
<p class="code">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> c: </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(c.</span><span class="SyntaxFunction">returnZ</span><span class="SyntaxCode">() == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)</code>
</p>
<p>
All functions in an <code class="incode">impl</code> block can be retrieved by reflection, as long as the struct is declared with <code class="incode">#<a href="swag.runtime.html#Swag_ExportType("methods")">Swag.ExportType("methods")</a></code> (by default, methods are not exported).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Creates a type alias named 'Lambda'</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">fnZ</span><span class="SyntaxCode">(v) == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)</code>
</p>

<h3 id="063_003_special_functions">Special functions</h3><p>
A struct can have special operations in the <code class="incode">impl</code> block. This operations are predefined, and known by the compiler.This is the way to go to <b>overload operators</b> for example.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Struct</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxKeyword">impl</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Struct</span><span class="SyntaxCode">
{
    ...
    {
        </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(ptr: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">opVisit</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">using</span><span class="SyntaxCode"> self, stmt: code) {}
        </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(ptr: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">opVisitWhatever</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">using</span><span class="SyntaxCode"> self, stmt: code) {}
...
<h3 id="064_004_affectation">Affectation</h3><p>
<code class="incode">opAffect</code> is a way of assigning to a struct with <code class="incode">=</code>.You can have more the one <code class="incode">opAffect</code> with different types.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Struct</span><span class="SyntaxCode">
{
    x, y, z: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This will initialize v and then call opAffect(s32) with '4'</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v1.y == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
If <code class="incode">opAffect</code> is supposed to initialize the full content of the struct, you can add <code class="incode">#<a href="swag.runtime.html#Swag_Complete">Swag.Complete</a></code>. This will avoid every variables to be initialized to the default values, then changed later with the <code class="incode">opAffect</code> call.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">impl</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Struct</span><span class="SyntaxCode">
{
    </span><span class="SyntaxAttribute">#[Swag.Complete]</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.z == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">(v: </span><span class="SyntaxConstant">Struct</span><span class="SyntaxCode">)
{
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.x == </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">)
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.y == </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">)
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.z == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">)
...
</span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">5</span><span class="SyntaxCode">'</span><span class="SyntaxType">u16</span><span class="SyntaxCode">)</code>
</p>
<p>
A structure can be converted to a constant by a call to <code class="incode">opAffect</code> if the function is marked with <code class="incode">Swag.ConstExpr</code>.</p>
<p class="code">
...
<p>
You can loop on a struct value if <code class="incode">opCount</code> has been defined.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> v = </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">{}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a = </span><span class="SyntaxConstant">Vector3</span><span class="SyntaxCode">{}
...
a =,moveraw b
a =,nodrop,moveraw b</code>
</p>
<p>
<h4 id="moveref">moveref</h4></p>
<p>
<code class="incode">moveref</code> can be used instead of <code class="incode">ref</code> in a function parameter to declare a <b>move semantic</b> intention.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This is the 'move' version of 'assign'. With 'moveref', we tell the compiler that this version will take the owership on 'from'.</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a.x == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> a.y == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> a.z == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">)</code>
</p>
...
<p>
You can visit a struct variable if a macro <code class="incode">opVisit</code> has been defined. This is the equivalent of an <b>iterator</b>.</p>
<p>
<code class="incode">opVisit</code> is a macro, so it should be marked with the <code class="incode">#<a href="swag.runtime.html#Swag_Macro">Swag.Macro</a></code> attribute. <code class="incode">opVisit</code> is also a generic function which takes a constant generic parameter of type <code class="incode">bool</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">impl</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
    </span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
    </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(ptr: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">opVisit</span><span class="SyntaxCode">(self, stmt: code)
    {
        ...
        </span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> idx: </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">
        {
            ...
            #macro
            {
                ...
                </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> @alias0: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxKeyword">undefined</span><span class="SyntaxCode">
                ...
                {
                </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">: @alias0 = #up self.x   </span><span class="SyntaxComment">// Same for function parameter 'self'</span><span class="SyntaxCode">
                </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">: @alias0 = #up self.y
                </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">: @alias0 = #up self.z
                }

                </span><span class="SyntaxComment">// @alias1 will be the index</span><span class="SyntaxCode">
                </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> @alias1 = </span><span class="SyntaxIntrinsic">@index</span><span class="SyntaxCode">
...
<p>
So now that the <code class="incode">opVisit</code> has been defined, we can <code class="incode">visit</code> it.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> myStruct = </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">{}
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
<p>
You can have variants of <code class="incode">opVisit</code> by specifying an <b>additional name</b>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">impl</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
    </span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
    </span><span class="SyntaxKeyword">mtd</span><span class="SyntaxCode">(ptr: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">opVisitReverse</span><span class="SyntaxCode">(stmt: code)   </span><span class="SyntaxComment">// We add 'Reverse' in the name</span><span class="SyntaxCode">
    {
        ...
        </span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> idx: </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">
        {
            #macro
            {
                ...
                {
                </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">: @alias0 = #up self.z
                </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">: @alias0 = #up self.y
                </span><span class="SyntaxLogic">case</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">: @alias0 = #up self.x
                }
...
<h3 id="067_008_offset">Offset</h3><p>
You can force the layout of a field with the <code class="incode">Swag.Offset</code> attribute.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
    x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.y == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.idx[</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">] == v.z)</code>
</p>

<h3 id="068_009_packing">Packing</h3><p>
You can also control the struct layout with two attributes: <code class="incode">#<a href="swag.runtime.html#Swag_Pack">Swag.Pack</a></code> and <code class="incode">#<a href="swag.runtime.html#Swag_Align">Swag.Align</a></code>.</p>
<p>
The default struct packing is the same as in C: each field is aligned to the size of the type. This is the equivalent of <code class="incode">#<a href="swag.runtime.html#Swag_Pack(0)">Swag.Pack(0)</a></code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
...
#assert </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">)     == </span><span class="SyntaxNumber">16</span><span class="SyntaxCode"></code>
</p>
<p>
You can <i>reduce</i> the packing of the fields with <code class="incode">#<a href="swag.runtime.html#Swag_Pack">Swag.Pack</a></code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Pack(1)]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct1</span><span class="SyntaxCode">
{
...
#assert </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyStruct3</span><span class="SyntaxCode">)     == </span><span class="SyntaxNumber">12</span><span class="SyntaxCode"></code>
</p>
<p>
The total struct size is always a multiple of the biggest alignement of the fields.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct1</span><span class="SyntaxCode">
{
...
#assert </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyStruct1</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">8</span><span class="SyntaxCode"></code>
</p>
<p>
You can force the struct alignement with <code class="incode">#<a href="swag.runtime.html#Swag_Align">Swag.Align</a></code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct1</span><span class="SyntaxCode">
{
...
#assert </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyStruct2</span><span class="SyntaxCode">)     == </span><span class="SyntaxNumber">8</span><span class="SyntaxCode"></code>
</p>
<p>
...
<h2 id="075_interface">Interface</h2><p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point2</span><span class="SyntaxCode">
{
    x, y: </span><span class="SyntaxType">f32</span><span class="SyntaxCode">
}
...
<p>
Here we declare an interface, with two functions <code class="incode">set</code> and <code class="incode">reset</code>.</p>
<p class="code">
...
<p>
You can implement an interface for any given struct with <code class="incode">impl</code> and <code class="incode">for</code>.For example here, we implement interface <code class="incode">IReset</code> for struct <code class="incode">Point2</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">impl</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">IReset</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">for</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point2</span><span class="SyntaxCode">
{
...
<p>
And we implement interface <code class="incode">IReset</code> also for struct <code class="incode">Point3</code>.</p>
<p class="code">
...
<p>
We can then use these interfaces on either <code class="incode">Vector2</code> or <code class="incode">Vector3</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> pt2: </span><span class="SyntaxConstant">Point2</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(pt3.x == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> pt3.y == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
...
pt3.</span><span class="SyntaxConstant">IReset</span><span class="SyntaxCode">.</span><span class="SyntaxFunction">reset</span><span class="SyntaxCode">()</code>
</p>
<p>
...
itf = </span><span class="SyntaxKeyword">cast</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">IReset</span><span class="SyntaxCode">) pt3
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@dataof</span><span class="SyntaxCode">(itf) == &pt3)</code>
</p>

<h2 id="100_function">Function</h2>
<h3 id="101_001_declaration">Declaration</h3><p>
A function declaration usually starts with the <code class="incode">func</code> keyword followed by the function name.</p>
<p class="code">
...
<p>
If the function needs to return a value, you must add <code class="incode">-&gt;</code> followed by the type.</p>
<p class="code">
...
<p>
The return type can be deduced in case of a simple expression, by using <code class="incode">=&gt;</code> instead of <code class="incode">-&gt;</code>.Here the return type will be deduced to be <code class="incode">s32</code>.</p>
<p class="code">
...
<p>
Parameters are specified after the function name, between parenthesis.Here we declare two parameters <code class="incode">x</code> and <code class="incode">y</code> of type <code class="incode">s32</code>, and one last parameter of type <code class="incode">f32</code>.</p>
<p class="code">
...
<p>
The type of the parameters can be deduced if you specify a default value.Here <code class="incode">x</code> and <code class="incode">y</code> have the type <code class="incode">f32</code> because <code class="incode">0.0</code> is a 32 bits floating point literal.</p>
<p class="code">
...
<p>
Functions can be nested inside other functions.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This are not closure but just functions in a sub scope.</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myFunction</span><span class="SyntaxCode">() -&gt; {x, y: </span><span class="SyntaxType">f32</span><span class="SyntaxCode">}
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(w == </span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">)</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">returns2</span><span class="SyntaxCode">() -&gt; {x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">}
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>

<h3 id="102_002_lambda">Lambda</h3><p>
A lambda is just a <b>pointer to a function</b>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myFunction0</span><span class="SyntaxCode">() {}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">ptr1</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>
<p>
A lambda can be null.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> lambda: </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">()-&gt;</span><span class="SyntaxType">bool</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(lambda == </span><span class="SyntaxKeyword">null</span><span class="SyntaxCode">)</code>
</p>
<p>
You can use a lambda as a function parameter type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">typealias</span><span class="SyntaxCode"> callback = </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(</span><span class="SyntaxType">s32</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">toDo</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">, &square) == </span><span class="SyntaxNumber">16</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cb = </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode"> =&gt; x * x
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">cb</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">64</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">toDo</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">, </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode"> { </span><span class="SyntaxLogic">return</span><span class="SyntaxCode"> x - x; }) == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">toDo</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">, </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(x) { </span><span class="SyntaxLogic">return</span><span class="SyntaxCode"> x - x; }) == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> fct: </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(</span><span class="SyntaxType">s32</span><span class="SyntaxCode">, </span><span class="SyntaxType">s32</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxType">bool</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">fct</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">120</span><span class="SyntaxCode">))</code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">125</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">127</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also capture by reference with <code class="incode">ref</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">125</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> fct: </span><span class="SyntaxKeyword">closure</span><span class="SyntaxCode">(</span><span class="SyntaxType">s32</span><span class="SyntaxCode">, </span><span class="SyntaxType">s32</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode">

fct = </span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(x, y) =&gt; x + y
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">fct</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
You can capture arrays, structs, slices etc... as long as it fits in the maximum storage of <code class="incode">n</code> bytes (and as long as the struct is a pod).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(result == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode"> + </span><span class="SyntaxNumber">2</span><span class="SyntaxCode"> + </span><span class="SyntaxNumber">3</span><span class="SyntaxCode"> + </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>
<p>
Captured variables are mutable, and part of the closure. So you can modify them.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">getInc</span><span class="SyntaxCode">()-&gt;</span><span class="SyntaxKeyword">closure</span><span class="SyntaxCode">()-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">fct</span><span class="SyntaxCode">() == </span><span class="SyntaxNumber">13</span><span class="SyntaxCode">)</code>
</p>

<h3 id="104_004_mixin">Mixin</h3><p>
A mixin is declared like a function, with the attribute <code class="incode">#<a href="swag.runtime.html#Swag_Mixin">Swag.Mixin</a></code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Mixin]</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
A mixin accepts parameters of type <code class="incode">code</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Mixin]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">doItTwice</span><span class="SyntaxCode">(what: code)
{
...
<p>
When the last parameter of a mixin is of type <code class="incode">code</code>, the caller can declare that code in a statement just after the call.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Mixin]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">doItTwice</span><span class="SyntaxCode">(value: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, what: code)
{
    #mixin what
    #mixin what
}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">12</span><span class="SyntaxCode">)</code>
</p>
<p>
You can use the special name <code class="incode">@alias</code> to create a named alias for an identifier.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Mixin]</span><span class="SyntaxCode">
...
{
    @alias0 += </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == b </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> b == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Mixin]</span><span class="SyntaxCode">
...
{
    </span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> @alias0 = value
}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias0 == </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">)</code>
</p>
<p>
You can declare special variables named <code class="incode">@mixin?</code>. Those variables will have a unique name each time the mixin is used. So the same mixin, even if it declares local variables, can be used multiple time in the same scope.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> total: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
{
    </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> @mixin0: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
    total += @mixin0
}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(total == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>

<h3 id="105_005_macro">Macro</h3><p>
A macro, like a mixin, is declared like a function, but with the attribute <code class="incode">Swag.Macro</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
But you can force an identifier to be found <b>outside</b> of the scope of the macro with <code class="incode">#up</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myMacro</span><span class="SyntaxCode">()
{
...
<p>
Like a mixin, macro accepts <code class="incode">code</code> parameters.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myMacro</span><span class="SyntaxCode">(what: code)
{
    #mixin what
}
...
<p>
You can use <code class="incode">#macro</code> inside a macro to force the code after to be in the same scope of the caller. That is, no <code class="incode">#up</code> is necessary to reference variables of the caller.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myMacro</span><span class="SyntaxCode">(what: code)
{
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">repeat</span><span class="SyntaxCode">(count: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, what: code)
{
    </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> a = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
When you need <code class="incode">break</code> in the user code to break outside of a multi loop.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">repeatSquare</span><span class="SyntaxCode">(count: </span><span class="SyntaxType">u32</span><span class="SyntaxCode">, what: code)
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(a == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)</code>
</p>
<p>
In a macro, you can use special variables named <code class="incode">@alias&lt;num&gt;</code>. Note that this is also valid for mixins.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Macro]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">call</span><span class="SyntaxCode">(v: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, stmt: code)
{
    </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> @alias0 = v
    </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> @alias1 = v * </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">
    #mixin stmt
}
...
{
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias0 == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias1 == </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">)
}
...
</span><span class="SyntaxFunction">call</span><span class="SyntaxCode">(|x| </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)
{
    ...
    </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(@alias1 == </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">)  </span><span class="SyntaxComment">// @alias1 is not renamed</span><span class="SyntaxCode">
}
...
<h3 id="105_006_variadic_parameters">Variadic parameters</h3><p>
A function can take a variable number of arguments with <code class="incode">...</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myFunction</span><span class="SyntaxCode">(value: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">, parameters: ...)
{
}

</span><span class="SyntaxFunction">myFunction</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">, </span><span class="SyntaxString">"true"</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">5.6</span><span class="SyntaxCode">)</code>
</p>
<p>
In that case, <code class="incode">parameters</code> is a slice of <code class="incode">any</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myFunction</span><span class="SyntaxCode">(parameters: ...)
{
...
</span><span class="SyntaxFunction">myFunction</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">30</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">40</span><span class="SyntaxCode">)</code>
</p>
<p>
Variadic parameters can be passed from function to function.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">A</span><span class="SyntaxCode">(params: ...)
{
...
</span><span class="SyntaxConstant">B</span><span class="SyntaxCode">(</span><span class="SyntaxString">"value"</span><span class="SyntaxCode">, </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">)</code>
</p>
<p>
You can spread the content of an array or a slice to variadic parameters with <code class="incode">@spread</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">sum</span><span class="SyntaxCode">(params: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">...)-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(res1 == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">+</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>

<h3 id="106_007_ufcs">Ufcs</h3><p>
<i>ufcs</i> stands for <i>uniform function call syntax</i>. It allows every functions to be called with a <code class="incode">param.func()</code> form when the first parameter of <code class="incode">func()</code> is of the same type as <code class="incode">param</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">(param: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">) =&gt; param
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">(b) == b.</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">())</code>
</p>
<p>
This means that in Swag, there are only <i>static</i> functions, but which can be called like <i>methods</i>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode"> { x, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; }
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(pt.x == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> pt.y == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)</code>
</p>

<h3 id="107_008_constexpr">Constexpr</h3><p>
A function marked with <code class="incode">Swag.ConstExpr</code> can be executed by the compiler if it can.</p>
<p class="code">
...
<p>
Here <code class="incode">G</code> will be baked to 3 by the compiler.</p>
<p class="code">
...
<p>
If a function is not <code class="incode">ConstExpr</code>, you can force the compile time call with <code class="incode">#run</code>.</p>
<p class="code">
...
<h3 id="108_009_function_overloading">Function overloading</h3><p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">over</span><span class="SyntaxCode">(x, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">) =&gt; x + y
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(res1 == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>

<h3 id="109_010_discard">Discard</h3><p>
By default, you must always use the returned value of a function, otherwise the compiler will generate an error.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">sum</span><span class="SyntaxCode">(x, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">) =&gt; x + y
...
</span><span class="SyntaxFunction">mul</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">4</span><span class="SyntaxCode">)</code>
</p>

<h3 id="110_011_retval">Retval</h3><p>
Inside a function, you can use the <code class="incode">retval</code> type which is an alias to the function return type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">()-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">() == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)</code>
</p>
<p>
But <code class="incode">retval</code> will also make a direct reference to the caller storage, to avoid an unnecessary copy (if possible). So this is mostly a hint for the compiler, and usefull when the function returns a complexe type like a struct, a tuple or an array.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode"> { x, y, z: </span><span class="SyntaxType">f64</span><span class="SyntaxCode">; }
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(b == </span><span class="SyntaxNumber">1.0</span><span class="SyntaxCode">)</code>
</p>
<p>
This is the preferred way (because optimal) to return a struct or an array.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">()-&gt;[</span><span class="SyntaxNumber">255</span><span class="SyntaxCode">] </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(arr[</span><span class="SyntaxNumber">254</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">254</span><span class="SyntaxCode">)</code>
</p>

<h3 id="111_012_foreign">Foreign</h3><p>
Swag can interop with external "modules" (dlls under windows), which contain exported C functions.</p>
<p>
Put a special attribute <code class="incode">Swag.Foreign</code> before the function prototype, and specify the module name where the function is located.</p>
<p>
The module name can be a swag compiled module, or an external system module (where the location depends on the OS).</p>
<p>
In the case below, the function is located in <code class="incode">kernel32.dll</code> (under windows)</p>
<p class="code">
...
<p>
<code class="incode">#foreignlib</code> is here to force a link to the given library (when generating executables).</p>
<p class="code">
...
<h2 id="120_intrinsics">Intrinsics</h2><p>
This is the list of all intrinsics.All intrinsics start with <code class="incode">@</code>, which is reserved for them.</p>
<p class="code">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(value: </span><span class="SyntaxType">bool</span><span class="SyntaxCode">);
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxIntrinsic">@spread</span><span class="SyntaxCode">()
</span><span class="SyntaxIntrinsic">@init</span><span class="SyntaxCode">()
</span><span class="SyntaxIntrinsic">@drop</span><span class="SyntaxCode">()
</span><span class="SyntaxIntrinsic">@postmove</span><span class="SyntaxCode">()
</span><span class="SyntaxIntrinsic">@postcopy</span><span class="SyntaxCode">()
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxIntrinsic">@alloc</span><span class="SyntaxCode">(size: </span><span class="SyntaxType">u64</span><span class="SyntaxCode">)-&gt;*</span><span class="SyntaxType">void</span><span class="SyntaxCode">;
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxIntrinsic">@atomadd</span><span class="SyntaxCode">(addr: *</span><span class="SyntaxType">s8</span><span class="SyntaxCode">, value: </span><span class="SyntaxType">s8</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxType">s8</span><span class="SyntaxCode">;
...
<h2 id="121_init">Init</h2><p>
<h3 id="@init">@init</h3></p>
<p>
<code class="incode">@init</code> can be used to reinitialize a variable/array to the default value.</p>
<p>
For a simple variable, the default value is 0.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@init</span><span class="SyntaxCode">(&x)
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
Work also for an array, as you can specify the number of elements you want to initialize.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = [</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also specify a <i>value</i> to initialize, instead of the default one.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">'</span><span class="SyntaxType">f32</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxNumber">3.14</span><span class="SyntaxCode">)</code>
</p>
<p>
Same for an array.</p>
<p class="code">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x[</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">555</span><span class="SyntaxCode">)</code>
</p>
<p>
When called on a struct, the struct will be restored to the values defined in it.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">{r = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, g = </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, b = </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(rgb.b == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(rgb.b == </span><span class="SyntaxNumber">7</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(rgb[</span><span class="SyntaxNumber">3</span><span class="SyntaxCode">].b == </span><span class="SyntaxNumber">7</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="@drop">@drop</h3></p>
<p>
For a struct, <code class="incode">@init</code> will <b>not</b> call <code class="incode">opDrop</code>, so this is mostly useful to initialize a plain old data.</p>
<p>
But there is also <code class="incode">@drop</code> intrinsic, which works the same, except that it will <code class="incode">drop</code> all the content by calling <code class="incode">opDrop</code> if it is defined.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">{r = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, g = </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">, b = </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">}
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">2.0</span><span class="SyntaxCode">'</span><span class="SyntaxType">f32</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">4.0</span><span class="SyntaxCode">)     </span><span class="SyntaxComment">// T is deduced to be f32</span><span class="SyntaxCode"></code>
</p>
<p>
You can also specify constants as generic parameters.</p>
<p>
<code class="incode">N</code> is a constant a type <code class="incode">s32</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">N</span><span class="SyntaxCode">: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">() = </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">N</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)
</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">'</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">()</code>
</p>
<p>
<code class="incode">const</code> can also be omitted, as an identifier followed by a type definition is considered to be a constant and not a type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">N</span><span class="SyntaxCode">: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">() = </span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">N</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">)
</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">'</span><span class="SyntaxNumber">10</span><span class="SyntaxCode">()</code>
</p>
<p>
...
</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">()</code>
</p>
<p>
You can ommit the type if you declare the constant with <code class="incode">const</code>. It will be deduced from the assignment expression.</p>
<p class="code">
...
<h3 id="132_002_validif">Validif</h3><p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Here we validate the function only if the generic type is `s32` or `s64`.</span><span class="SyntaxCode">
...
</span><span class="SyntaxComment">// var res1 = sum'f32(1, 2)</span><span class="SyntaxCode"></code>
</p>
<p>
You can use <code class="incode">#validif</code> to make a kind of a generic specialisation.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// s32 version</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">isNull</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">0.001</span><span class="SyntaxCode">'</span><span class="SyntaxType">f32</span><span class="SyntaxCode">))</code>
</p>
<p>
Instead of a single expression, <code class="incode">#validif</code> can be followed by a block that returns a <code class="incode">bool</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">sum</span><span class="SyntaxCode">(x: </span><span class="SyntaxConstant">T</span><span class="SyntaxCode">...)-&gt;</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">
    #validif
    {
...
<p>
By using <code class="incode">@compilererror</code>, you can then trigger your own errors at compile time if the type is incorrect.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">) </span><span class="SyntaxFunction">sum</span><span class="SyntaxCode">(x, y: </span><span class="SyntaxConstant">T</span><span class="SyntaxCode">)-&gt;</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">
    #validif
    {
        </span><span class="SyntaxLogic">if</span><span class="SyntaxCode"> </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">) == </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">or</span><span class="SyntaxCode"> </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">) == </span><span class="SyntaxType">s64</span><span class="SyntaxCode">
            </span><span class="SyntaxLogic">return</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">true</span><span class="SyntaxCode">
...
</span><span class="SyntaxComment">//var v: Point's32</span><span class="SyntaxCode"></code>
</p>
<p>
<h4 id="Multiple evaluations">Multiple evaluations</h4></p>
<p>
Instead of <code class="incode">#validif</code>, you can use <code class="incode">#validifx</code>. <code class="incode">#validifx</code> is evaluated for <b>each</b> call, so it can be used to check parameters, as long as they can be <b>evaluated at compile time</b>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">{
...
<h3 id="133_003_constraint">Constraint</h3><p>
Swag provides also a simple way of checking generic parameters, without the need of <code class="incode">#validif</code>.A type constraint can be added when declaring a generic type. If a function or a struct is instantiated with a type that does not conform to the constraint, then an error will be raised.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// The type constraint is a compile time function (with #[Swag.ConstExpr]) that should return a bool.</span><span class="SyntaxCode">
</span><span class="SyntaxAttribute">#[Swag.ConstExpr]</span><span class="SyntaxCode">
...
</span><span class="SyntaxComment">// let res1 = sum'f32(1, 2)</span><span class="SyntaxCode"></code>
</p>
<p>
The type constraint can be any compile time expression, as long as the resulting type is <code class="incode">bool</code>.So you could do something like this.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.ConstExpr]</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">isS32</span><span class="SyntaxCode">(t: </span><span class="SyntaxType">typeinfo</span><span class="SyntaxCode">)  =&gt; t == </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
</span><span class="SyntaxAttribute">#[Swag.ConstExpr]</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">(</span><span class="SyntaxKeyword">false</span><span class="SyntaxCode">) == </span><span class="SyntaxKeyword">false</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxComment">//var pt: Point's32</span><span class="SyntaxCode"></code>
</p>
...
</span><span class="SyntaxComment">// defer expression will be executed here</span><span class="SyntaxCode"></code>
</p>
<p>
<code class="incode">defer</code> can also be used with a block.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> v = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">defer</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxComment">// defer block will be executed here</span><span class="SyntaxCode"></code>
</p>
<p>
<code class="incode">defer</code> expressions are called when leaving the corresponding scope, even with <code class="incode">return</code>, <code class="incode">break</code>, <code class="incode">continue</code> etc., and even inside a <code class="incode">loop/while/for</code> etc.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">G</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
</span><span class="SyntaxLogic">loop</span><span class="SyntaxCode"> </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">G</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
<code class="incode">defer</code> are executed in reverse order of their declaration.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(!resource.</span><span class="SyntaxFunction">isResourceCreated</span><span class="SyntaxCode">())</code>
</p>

<h3 id="162_002_using">Using</h3><p>
<code class="incode">using</code> brings the scope of a namespace, a struct or an enum in the current one.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode"> { </span><span class="SyntaxConstant">R</span><span class="SyntaxCode">; </span><span class="SyntaxConstant">G</span><span class="SyntaxCode">; </span><span class="SyntaxConstant">B</span><span class="SyntaxCode">; }
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">G</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
<code class="incode">using</code> can also be used with a variable</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode"> { x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> }
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(pt.y == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>
<p>
You can declare a variable with <code class="incode">using</code> just before.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode"> { x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; }
...
<p>
<code class="incode">using</code> applied to a function parameter can be seen as the equivalent of the hidden <code class="incode">this</code> in C++.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode"> { x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; }
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(pt.y == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
<h4 id="For a field">For a field</h4></p>
<p>
<code class="incode">using</code> can also be used with a field inside a struct.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point2</span><span class="SyntaxCode">
{
    x, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(value.base.y == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>

<h3 id="163_003_with">With</h3><p>
You can use <code class="incode">with</code> to avoid repeating the same variable again and again. You can then access fields with a simple <code class="incode">.</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode"> { x, y: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">; }
...
<p>
<code class="incode">with</code> on a variable.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> pt: </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">with</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">NameSpace</span><span class="SyntaxCode">
{
...
<p>
Instead of an identifier name, <code class="incode">with</code> also accepts a variable declaration.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">with</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> pt = </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode">{</span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">}
{
    .x = </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
    .y = </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">
}

</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(pt.x == </span><span class="SyntaxNumber">10</span><span class="SyntaxCode"> </span><span class="SyntaxLogic">and</span><span class="SyntaxCode"> pt.y == </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">)</code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">with</span><span class="SyntaxCode"> </span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> pt: </span><span class="SyntaxConstant">Point</span><span class="SyntaxCode">
{
    .x = </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
    .y = </span><span class="SyntaxNumber">20</span><span class="SyntaxCode">
}
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">namespace</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">NameSpace</span><span class="SyntaxCode">
{
...
<h2 id="164_alias">Alias</h2><p>
<h3 id="Type alias">Type alias</h3></p>
<p>
</p>
<p>
<code class="incode">typealias</code> is used to make a shortcut to another type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">enum</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode"> { </span><span class="SyntaxConstant">R</span><span class="SyntaxCode">; </span><span class="SyntaxConstant">G</span><span class="SyntaxCode">; </span><span class="SyntaxConstant">B</span><span class="SyntaxCode">; }
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">RGB</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">R</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">)
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">Color</span><span class="SyntaxCode">.</span><span class="SyntaxConstant">G</span><span class="SyntaxCode"> == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)</code>
</p>
<p>
You can then use the new name in place of the original type. This does not create a new type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">typealias</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Float32</span><span class="SyntaxCode"> = </span><span class="SyntaxType">f32</span><span class="SyntaxCode">
...
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: </span><span class="SyntaxConstant">MyType</span><span class="SyntaxCode"> = </span><span class="SyntaxKeyword">cast</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">MyType</span><span class="SyntaxCode">) </span><span class="SyntaxNumber">0</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p>
You can alias a function name with <code class="incode">namealias</code></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">thisIsABigFunctionName</span><span class="SyntaxCode">(x: </span><span class="SyntaxType">s32</span><span class="SyntaxCode">) =&gt; x * x
</span><span class="SyntaxKeyword">namealias</span><span class="SyntaxCode"> myFunc = thisIsABigFunctionName
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">myFunc</span><span class="SyntaxCode">(</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">) == </span><span class="SyntaxNumber">16</span><span class="SyntaxCode">)</code>
</p>
<p>
You can also alias variables and namespaces</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> myLongVariableName: </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(myLongVariableName == </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">)</code>
</p>

<h2 id="170_error_management">Error management</h2><p>
...
<p>
A function that can return an error must be marked with <code class="incode">throw</code>. It can then raise an error with the <code class="incode">throw</code> keyword, passing an error message.</p>
<p>
</p>
<blockquote><p>
...
<p>
The caller will then have to deal with the error in some way. It can <code class="incode">catch</code> it, and test (or not) its value with the <code class="incode">@errmsg</code> intrinsic. The execution will continue at the call site.</p>
<p class="code">
...
<p>
The caller can stop the execution with <code class="incode">try</code>, and return to its own caller with the same error raised. The function must then also be marked with <code class="incode">throw</code>.</p>
<p>
Here, the caller of <code class="incode">myFunc1</code> will have to deal with the error at its turn.</p>
<p class="code">
...
<p>
The caller can also panic if an error is raised, with <code class="incode">assume</code>.</p>
<p>
</p>
<blockquote><p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@errmsg</span><span class="SyntaxCode"> == </span><span class="SyntaxString">"error"</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="defer">defer</h3></p>
<p>
<code class="incode">defer</code> can have parameters like <code class="incode">defer(err)</code> or <code class="incode">defer(noerr)</code> to control if it should be executed depending on the error status.</p>
<p class="code">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">g_Defer = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(g_Defer == </span><span class="SyntaxNumber">5</span><span class="SyntaxCode">)   </span><span class="SyntaxComment">// Will call only defer(noerr) and the normal defer</span><span class="SyntaxCode"></code>
</p>

<h2 id="175_safety">Safety</h2><p>
Swag comes with a bunch of safety checks which can be activated by module, function or even instruction with the <code class="incode">#<a href="swag.runtime.html#Swag_Safety">Swag.Safety</a></code> attribute.</p>
<p>
Safety checks can also be changed for a specific build configuration (<code class="incode">--cfg:&lt;config&gt;</code>) with <code class="incode">buildCfg.safetyGuards</code>.</p>
<p>
</p>
<blockquote><p>
Swag comes with four predefined configurations : <code class="incode">debug</code>, <code class="incode">fast-debug</code>, <code class="incode">fast-compile</code> and <code class="incode">release</code>. Safety checks are disabled in <code class="incode">fast-compile</code> and <code class="incode">release</code>.</p></blockquote>
<p>
</p>
<p>
...
<p>
Operators that can overflow are : <code class="incode">+ - * &lt;&lt; &gt;&gt;</code> and their equivalent <code class="incode">+= -= <i>= &lt;&lt;= &gt;&gt;=</code>.</i></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">255</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">
</span><span class="SyntaxComment">// x += 1      // This would overflow, and panic, because we lose informations</span><span class="SyntaxCode"></code>
</p>
<p>
But if you know what your are doing, you can use a special version of those operators, which will not panic. Add the <code class="incode">,over</code> modifier after the operation. This will disable safety checks.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">255</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">
...
<p>
You can also use <code class="incode">#<a href="swag.runtime.html#Swag_Overflow(true)">Swag.Overflow(true)</a></code> to authorize overflow on a more global scale.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Overflow(true)]</span><span class="SyntaxCode"></code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">255</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">
...
<p>
For 8 or 16 bits, you can promote an operation to 32 bits by using <code class="incode">,up</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">255</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode"> +,up </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(x) == </span><span class="SyntaxType">u32</span><span class="SyntaxCode">)</code>
</p>
<p>
Swag will also check that a cast does not lose information.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x1 = </span><span class="SyntaxNumber">255</span><span class="SyntaxCode">'</span><span class="SyntaxType">u8</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(y2 == </span><span class="SyntaxNumber">255</span><span class="SyntaxCode">)</code>
</p>
<p>
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxNumber">127</span><span class="SyntaxCode">)</code>
</p>
<p>
<h3 id="any">any</h3></p>
<p>
...
<p>
Swag will panic if a bad cast from <code class="incode">any</code> is performed.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x: </span><span class="SyntaxType">any</span><span class="SyntaxCode"> = </span><span class="SyntaxString">"1"</span><span class="SyntaxCode">
...
</span><span class="SyntaxComment">//@assert(z == 0)</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = [</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
...
</span><span class="SyntaxComment">//@assert(x[idx] == 1)     // '10' is out of range, will panic</span><span class="SyntaxCode"></code>
</p>
<p>
Safety when indexing a slice.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> x: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> [..] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: </span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> [..] </span><span class="SyntaxType">s32</span><span class="SyntaxCode"> = [</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">, </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">]
</span><span class="SyntaxComment">//var slice = x[1..4]              // '4' is out of range, will panic</span><span class="SyntaxCode">
</span><span class="SyntaxComment">//@assert(slice[0] == 1)</span><span class="SyntaxCode"></code>
</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxString">"string"</span><span class="SyntaxCode">
</span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> idx = </span><span class="SyntaxNumber">10</span><span class="SyntaxCode">
</span><span class="SyntaxComment">//var slice = x[0..idx]            // '10' is out of range, will panic</span><span class="SyntaxCode">
</span><span class="SyntaxComment">//@assert(slice[0] == `s`)</span><span class="SyntaxCode"></code>
</p>
<p>
<h3 id="math">math</h3></p>
<p>
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x = </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">'</span><span class="SyntaxType">f32</span><span class="SyntaxCode">
...
</span><span class="SyntaxComment">//@print(z)</span><span class="SyntaxCode"></code>
</p>
<p>
Swag will also check for invalid arguments on some math intrinsics.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// All of this will panic if the arguments are unsupported.</span><span class="SyntaxCode">
...
</span><span class="SyntaxComment">//@acos(2'f32)</span><span class="SyntaxCode"></code>
</p>
<p>
...
<p>
Swag will panic if a switch is marked with <code class="incode">#<a href="swag.runtime.html#Swag_Complete">Swag.Complete</a></code>, but the value is not covered by a <code class="incode">case</code>.</p>
<p>
...
<p>
Swag will panic if a boolean value is not <code class="incode">true</code> (1) or <code class="incode">false</code> (0).</p>
<p>
<h3 id="nan">nan</h3></p>
<p>
</p>
...
<p>
Swag will panic if a floating point <code class="incode">NaN</code> is used in an operation.</p>

<h2 id="180_compiler_declarations">Compiler declarations</h2>
<h3 id="181_001_compile_time_evaluation">Compile time evaluation</h3><p>
<code class="incode">#assert</code> is a static assert (at compile time).</p>
<p class="code">
...
<p>
<code class="incode">@defined(SYMBOL)</code> returns true, at compile time, if the given symbol exists in the current context.</p>
<p class="code">
...
<p>
A static <code class="incode">#if/#elif/#else</code>, with an expression that can be evaluated at compile time.</p>
<p class="code">
...
<p>
<code class="incode">#error</code> to raise a compile time error, and <code class="incode">#warning</code> to raise a compile time warning.</p>
<p class="code">
...
#if #run </span><span class="SyntaxFunction">isThisRelease</span><span class="SyntaxCode">() == </span><span class="SyntaxKeyword">false</span><span class="SyntaxCode">
{
    #error </span><span class="SyntaxString">"this should not be called !"</span><span class="SyntaxCode">
}</code>
</p>
<p>
A more complicated <code class="incode">#assert</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.ConstExpr]</span><span class="SyntaxCode">
...
<p>
<code class="incode">#test</code> is a special function than can be used in the <code class="incode">tests/</code> folder of the workspace.All <code class="incode">#test</code> will be executed only if swag is running in test mode.</p>
<p>
<h4 id="#main">#main</h4></p>
<p>
<code class="incode">#main</code> is the program entry point. It can only be defined <b>once</b> per module, and has meaning only for an executable.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxCompiler">#main</span><span class="SyntaxCode">
{
}</code>
...
<p>
<code class="incode">#init</code> will be called at runtime, during the module initialization.You can have as many <code class="incode">#init</code> as you want, but the execution order in the same module is undefined.</p>
<p class="code">
...
<p>
<code class="incode">#drop</code> will be called at runtime, when module is unloaded.You can have as many <code class="incode">#drop</code> as you want.The execution order in the same module is undefined, but is always the inverse order of <code class="incode">#init</code>.</p>
<p class="code">
...
<p>
<code class="incode">#premain</code> will be called after all the modules have done their <code class="incode">#init</code> code, but before the <code class="incode">#main</code> function is called.</p>
<p class="code">
...
<h3 id="183_003_run">Run</h3><p>
<code class="incode">#run</code> is a special function that will be called at <b>compile time</b>.It can be used to precompute some global values for example.</p>
<p class="code">
...
<p>
Initialize <code class="incode">G</code> with <code class="incode">[1,2,4,8,16]</code> at compile time.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">#run
{
...
<p>
<code class="incode">#test</code> are executed after <code class="incode">#run</code>, even at compile time (during testing).So we can test the values of <code class="incode">G</code> here.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">G</span><span class="SyntaxCode">[</span><span class="SyntaxNumber">0</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">G</span><span class="SyntaxCode">[</span><span class="SyntaxNumber">4</span><span class="SyntaxCode">] == </span><span class="SyntaxNumber">16</span><span class="SyntaxCode">)</code>
</p>
<p>
<code class="incode">#run</code> can also be used as an expression, to call for example a function not marked with <code class="incode">#<a href="swag.runtime.html#Swag_ConstExpr">Swag.ConstExpr</a></code>.</p>
<p class="code">
...
<p>
<code class="incode">#run</code> can also be used as an expression block.The return type is deduced from the <code class="incode">return</code> statement.</p>
<p class="code">
...
<h3 id="184_004_global">Global</h3><p>
A bunch of <code class="incode">#global</code> can start a source file.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Skip the content of the file, like this one (but must be a valid swag file)</span><span class="SyntaxCode">
#global skip
...
<h3 id="185_005_var">Var</h3><p>
A global variable can be tagged with <code class="incode">#<a href="swag.runtime.html#Swag_Tls">Swag.Tls</a></code> to store it in the thread local storage (one copy per thread).</p>
<p class="code">
...
<p>
A local variable can be tagged with <code class="incode">#<a href="swag.runtime.html#Swag_Global">Swag.Global</a></code> to make it global (aka <code class="incode">static</code> in C/C++).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">func</span><span class="SyntaxCode"> </span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">()-&gt;</span><span class="SyntaxType">s32</span><span class="SyntaxCode">
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxFunction">toto</span><span class="SyntaxCode">() == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
A global variable can also be marked as <code class="incode">#<a href="swag.runtime.html#Swag_Compiler">Swag.Compiler</a></code>. That kind of variable will not be exported to the runtime and can only be used in compile time code.</p>
<p class="code">
...
<h2 id="190_attributes">Attributes</h2><p>
Attributes are tags associated with functions, structures etc...</p>

<h3 id="191_001_user_attributes">User attributes</h3><p>
User attributes are declared like functions, but with the <code class="incode">attr</code> keyword before instead of <code class="incode">func</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">using</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">Swag</span><span class="SyntaxCode">
...
<p>
To use an attribute, the syntax is <code class="incode">#[attribute, attribute...]</code>. It should be placed <b>before</b> the thing you want to tag.</p>
<p class="code">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> type = </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(function2)                  </span><span class="SyntaxComment">// Get the type of the function</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@countof</span><span class="SyntaxCode">(type.attributes) == </span><span class="SyntaxNumber">1</span><span class="SyntaxCode">)     </span><span class="SyntaxComment">// Check that the function has one attribute associated with it</span><span class="SyntaxCode"></code>
</p>

<h3 id="192_002_predefined_attributes">Predefined attributes</h3><p>
This is the list of predefined attributes.All are located in the reserved <code class="incode">Swag</code> namespace.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">#global skip
...
<h2 id="200_type_reflection">Type reflection</h2><p>
In Swag, types are also values that can be inspected at compile time or at runtime. The two main intrinsics for this are <code class="incode">@typeof</code> and <code class="incode">@kindof</code>.</p>
<p>
You can get the type of an expression with <code class="incode">@typeof</code>, or just with the type itself (<b>types are also values</b>).</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> ptr1 = </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxType">s8</span><span class="SyntaxCode">)
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(ptr4 == </span><span class="SyntaxType">s64</span><span class="SyntaxCode">)</code>
</p>
<p>
The return result of <code class="incode">@typeof</code> is a const pointer to a <code class="incode">Swag.TypeInfo</code> kind of structure. This is an typealias for the <code class="incode">typeinfo</code> type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> ptr = </span><span class="SyntaxType">bool</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(ptr1.name == </span><span class="SyntaxString">"[2] s32"</span><span class="SyntaxCode">)</code>
</p>
<p>
The <code class="incode">TypeInfo</code> structure contains a different enum value for each type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">let</span><span class="SyntaxCode"> ptr = </span><span class="SyntaxType">f64</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(ptr.sizeof == </span><span class="SyntaxIntrinsic">@sizeof</span><span class="SyntaxCode">(</span><span class="SyntaxType">f64</span><span class="SyntaxCode">))</code>
</p>
<p>
...
<p>
<code class="incode">@decltype</code> can be used to transform a <code class="incode">typeinfo</code> to a real compiler type. This is the opposite of <code class="incode">@typeof</code> or <code class="incode">@kindof</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> x: </span><span class="SyntaxIntrinsic">@decltype</span><span class="SyntaxCode">(</span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(</span><span class="SyntaxType">s32</span><span class="SyntaxCode">))
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(x) == </span><span class="SyntaxType">s32</span><span class="SyntaxCode"></code>
</p>
<p>
<code class="incode">@decltype</code> can evaluate a constexpr expression that returns a <code class="incode">typeinfo</code> to determine the real type.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.ConstExpr]</span><span class="SyntaxCode">
...
x1 = </span><span class="SyntaxString">"0"</span><span class="SyntaxCode"></code>
</p>

<h2 id="210_code_inspection">Code inspection</h2><p>
<code class="incode">#message</code> is a special function that will be called by the compiler when something specific occurs during the build. The parameter of <code class="incode">#message</code> is a mask that tells the compiler when to call the function.</p>
<p>
With the <code class="incode">Swag.CompilerMsgMask.SemFunctions</code> flag, for example, <code class="incode">#message</code> will be called each time a function of the module <b>has been typed</b>. You can then use <code class="incode">getMessage()</code> in the <code class="incode">@compiler()</code> interface to retrieve some informations about the reason of the call.</p>
<p class="code">
...
<h2 id="220_meta_programmation">Meta programmation</h2><p>
...
<h3 id="221_001_ast">Ast</h3><p>
The most simple way to produce a string which contains the Swag code to compile is with an <code class="incode">#ast</code> block. An <code class="incode">#ast</code> block is executed at compile time and the string it returns will be compiled <b>inplace</b>.</p>
<p>
The <code class="incode">#ast</code> can be a simple expression with the string to compile.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode">#ast </span><span class="SyntaxString">"var x = 666"</span><span class="SyntaxCode">
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(x == </span><span class="SyntaxNumber">666</span><span class="SyntaxCode">)</code>
</p>
<p>
Or it can be a block, with an explicit <code class="incode">return</code></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">var</span><span class="SyntaxCode"> cpt = </span><span class="SyntaxNumber">2</span><span class="SyntaxCode">
#ast
{
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(cpt == </span><span class="SyntaxNumber">7</span><span class="SyntaxCode">)</code>
</p>
<p>
<h4 id="Struct and enums">Struct and enums</h4></p>
<p>
<code class="incode">#ast</code> can for example be used to generate the content of a <code class="incode">struct</code> or <code class="incode">enum</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
    #ast
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">struct</span><span class="SyntaxCode">(</span><span class="SyntaxConstant">T</span><span class="SyntaxCode">) </span><span class="SyntaxConstant">MyStruct</span><span class="SyntaxCode">
{
    #ast
    {
...
#assert </span><span class="SyntaxIntrinsic">@typeof</span><span class="SyntaxCode">(v1.z) == </span><span class="SyntaxType">string</span><span class="SyntaxCode"></code>
</p>
<p>
<code class="incode">#ast</code> needs to return a <i>string like</i> value, which can of course be dynamically constructed.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxAttribute">#[Swag.Compiler]</span><span class="SyntaxCode">
...
</span><span class="SyntaxIntrinsic">@assert</span><span class="SyntaxCode">(v.z == </span><span class="SyntaxNumber">3</span><span class="SyntaxCode">)</code>
</p>
<p>
<h4 id="For example">For example</h4></p>
<p>
This is a real life example of an <code class="incode">#ast</code> usage from the <code class="incode">Std.Core</code> module. Here we generate a structure which contains all the fields of an original other structure, but where the types are forced to be <code class="incode">bool</code>.</p>
<p class="code">
...
<p>
<code class="incode">#ast</code> can also be called at the global scope.</p>
<p class="code">
...
<p>
But be aware that you must use <code class="incode">#placeholder</code> in case you are generating global symbols that can be used by something else in the code. This will tell Swag that <i>this symbol</i> will exist at some point, so please wait for it to <i>exist</i> before complaining.</p>
<p class="code">
...
<p>
Here for example, thanks to the <code class="incode">#placeholder</code>, the <code class="incode">#assert</code> will wait for the symbol <code class="incode">myGeneratedConst</code> to be replaced with its real content.</p>
<p class="code">
...
<h3 id="222_002_compiler_interface">Compiler interface</h3><p>
The other method to compile generated code is to use the function <code class="incode">compileString()</code> in the <code class="incode">@compiler()</code> interface. Of course this should be called at compile time, and mostly during a <code class="incode">#message</code> call.</p>
<p>
Here is a real life example from the <code class="incode">Std.Ogl</code> module (opengl wrapper), which uses <code class="incode">#message</code> to track functions marked with a specific <b>user attribute</b> <code class="incode">Ogl.Extension</code>, and generates some code for each function that has been found.</p>
<p>
...
<p>
This <code class="incode">#message</code> will be called for each function of the <code class="incode">Ogl</code> module.</p>
<p class="code">
...
<p>
We will generate a <code class="incode">glInitExtensions</code> global function, so we register it as a place holder.</p>
<p class="code">
...
<h2 id="230_documentation">Documentation</h2><p>
...
<p>
The main module documentation should be placed at the top of the corresponding <code class="incode">module.swg</code> file. The rest is placed in various source files.</p>
<p>
The documentation comment needs to be placed just before a function, struct or enum.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// Everything between empty lines is considered to be a simple paragraph. Which</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This is the short description.</span><span class="SyntaxCode">
...
<p>
A paragraph that starts with <code class="incode">---</code> is a paragraph where every blanks and end of linesare respected.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// ---</span><span class="SyntaxCode">
...
<p>
You can create a list of bullet points with <code class="incode"><i></code>.</i></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// * This is a bullet point</span><span class="SyntaxCode">
...
<p>
You can create a quote with <code class="incode">&gt;</code></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This is the short description.</span><span class="SyntaxCode">
...
<p>
You can create a table with <code class="incode">|</code>.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// A table with 4 lines of 2 columns:</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// For example:</span><span class="SyntaxCode">
</span><span class="SyntaxComment">// ```</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxKeyword">const</span><span class="SyntaxCode"> </span><span class="SyntaxConstant">A</span><span class="SyntaxCode"> = </span><span class="SyntaxNumber">0</span><span class="SyntaxCode">     </span><span class="SyntaxComment">// This is a documentation comment</span><span class="SyntaxCode">
...
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// `this is code` (backtick) for 'inline' code.</span><span class="SyntaxCode">
...
<p>
You can create a reference to something in the current module with <code class="incode">[name]</code> or <code class="incode">[name1.name2 etc.]</code></p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This is a function with a 'value' parameter.</span><span class="SyntaxCode">
...
<p>
The attribute <code class="incode">#<a href="swag.runtime.html#Swag_NoDoc">Swag.NoDoc</a></code> can be used to avoid a given element to appear in the documentation.</p>
<p class="code">
<code style="white-space: break-spaces"></span><span class="SyntaxCode"></span><span class="SyntaxComment">// This function will be ignored when generating documentation.</span><span class="SyntaxCode">
