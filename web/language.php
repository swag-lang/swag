...
</span><span style="color:#569CD6">attr</span><span style="color:#FFFFFF"> </span><span style="color:#4EC9B0">CalleeReturn</span><span style="color:#FFFFFF">()
...
<div class="code"><code style="white-space: break-spaces"><span style="color:#FFFFFF">swag doc -w:myWorkspaceFolder</span></code></div><div></div>
<div>The documentation comment needs to be placed just before a function, struct or enum.</br>
</div>
<div class="code"><code style="white-space: break-spaces"><span style="color:#6A9955">// Everything between empty lines is considered to be a simple paragraph.</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// Which means that if you put several comments on several lines like</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// this, they all will be part of the same paragraph.</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">//</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// This is another paragraph because there's an empty line before.</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">//</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// ---</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// A paragraph that starts with '---' is a paragraph where every blanks and end of lines</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// are respected. Even...</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">//</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// ...empty lines are preserved.</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// You end that kind of paragraph with another '---' alone on its line.</span><span style="color:#FFFFFF">
</span><span style="color:#6A9955">// ---</span><span style="color:#FFFFFF">
</span><span style="color:#569CD6">func</span><span style="color:#FFFFFF"> </span><span style="color:#FF7411">test</span><span style="color:#FFFFFF">()
{

}</span></code></div><div>For constants or enum values, the document comment is the one declared at the end of the line.</br>
</div>
<div class="code"><code style="white-space: break-spaces"><span style="color:#569CD6">const</span><span style="color:#FFFFFF"> </span><span style="color:#4EC9B0">A</span><span style="color:#FFFFFF"> = </span><span style="color:#B5CEA8">0</span><span style="color:#FFFFFF"> </span><span style="color:#6A9955">// This is a documentation comment</span><span style="color:#FFFFFF">
</span><span style="color:#569CD6">enum</span><span style="color:#FFFFFF"> </span><span style="color:#4EC9B0">Color</span><span style="color:#FFFFFF">
{
    </span><span style="color:#4EC9B0">Red</span><span style="color:#FFFFFF"> </span><span style="color:#6A9955">// This is a documentation comment</span><span style="color:#FFFFFF">
}</span></code></div><div>Some other markdown markers are also supported.</br>
</div>
<div class="code"><code style="white-space: break-spaces"><span style="color:#FFFFFF"> </span><span style="color:#FF7411">#test</span><span style="color:#FFFFFF">
 {
    </span><span style="color:#6A9955">// `this is code` (backtick) for 'inline' code.</span><span style="color:#FFFFFF">
    </span><span style="color:#6A9955">// 'single_word'  (tick) for 'inline' code.</span><span style="color:#FFFFFF">
    </span><span style="color:#6A9955">// **bold**</span><span style="color:#FFFFFF">
    </span><span style="color:#569CD6">struct</span><span style="color:#FFFFFF"> </span><span style="color:#4EC9B0">RGB</span><span style="color:#FFFFFF">
    {
...
</span><span style="color:#6A9955">// This is a reference to [one]</span><span style="color:#FFFFFF">
