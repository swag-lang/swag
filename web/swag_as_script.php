...
<p>Instead of a workspace, Swag can also be used to build and run a simple script file, thanks to the fact that the compiler can run anything at compile time.No executable will be generated, the compiler will do all the job.To create a new script file with the special extension 'swgs':</p>
<p></p>
<pre><code><span style="color:#0">$ swag new -f:myScript
=> script file 'myScript.swgs' has been created
=> type 'swag script -f:myScript.swgs' to run that script</span></code></pre><p></p>
<p></p>
...
</span><span style="color:#3BC3A7">Hello</span><span style="color:#0"> world !</span></code></pre><p></p>
...
<p>You will find a bunch of small scripts in <code>swag/bin/examples/scripts</code>.To run one of them from the console, go to the folder and type for example <code>swag pendulum.swgs</code></p>
<p><h2 id="Dependencies">Dependencies</h2></p>
<p></p>
...
<p></p>
<p><h2 id="More than one script file">More than one script file</h2></p>
<p></p>
<p>If your script is divided in more than one single file, you can add <code>#load <filename></code> in the <code>#dependencies</code> block.</p>
<p></p>
<pre><code><span style="color:#FF6A00">#dependencies</span><span style="color:#0">
{
...
<p><h2 id="Debug">Debug</h2></p>
<p></p>
<p>The compiler comes with a <b>bytecode debugger</b> that can be used to trace and debug compile time execution.Add <code>@breakpoint()</code> in your code when you want the debugger to trigger.</p>
