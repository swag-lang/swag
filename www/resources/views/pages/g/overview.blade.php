...
<div class="right flex-1 lg:pl-2">
<div class="page">
<h1 class="leading-8 mt-10 lg:my-5">Swag language reference</h1>
<h2 id="000_introduction">Introduction</h2>
<p>This <code>swag-lang/swag/bin/reference/language</code> module provides a brief explanation of the language basic syntax and usage without the need of the <a href="{{ route('std') }}">Swag standard modules</a> (<code>Std</code>).<br/>
<br/>
...
swag test -w:c:/swag-lang/swag/bin/reference</span></code></pre><p>This will run all the test modules of the specified workspace (including this one). You can also omit the <code>--workspace</code> parameter (or <code>-w</code> in its short form) if you run Swag directly from the workspace folder.<br/>
<br/>
...
<p>Let's start with the most simple version of the "hello word" example. This is a version that does not require external dependencies like the <a href="{{ route('std') }}">Swag standard modules</a>.<br/>
<br/>
...
<p>Next, a version that this time uses the <code>Console.print</code> function in the <a href="std/std.core.html">Std.Core</a> module.<br/>
...
<p>A <code>#run</code> block is executed at <b>compile time</b>, and can make Swag behaves like a kind of a <b>scripting language</b>.<br/>
...
<p>A version that calls a <b>nested function</b> at compile time (only) to initialize the string constant to print.<br/>
</p>
...
<p>Now a stupid version that generates the code to do the print thanks to <b>meta programming</b>.<br/>
</p>
...
<p>And finally let's be more and more crazy.<br/>
</p>
<pre><code><span style="color:#3186CD">using</span><span style="color:#0"> </span><span style="color:#3BC3A7">Core</span><span style="color:#0">
...
<p>This whole piece of code is equivalent to...<br/>
</p>
<pre><code><span style="color:#FF6A00">#main</span><span style="color:#0">
{
...
<p>All source files in Swag have the <code>.swg</code> extension, except if you write a simple script with the <code>.swgs</code> extension.<br/>
...
<p>Let's start with the basics. Swag support classical single-line and multi-line comments.<br/>
</p>
...
</span><span style="color:#3186CD">const</span><span style="color:#0"> </span><span style="color:#3BC3A7">B</span><span style="color:#0"> = </span><span style="color:#6A9955">/* false */</span><span style="color:#0"> </span><span style="color:#3186CD">true</span></code></pre><p>Nested comments are supported.<br/>
</p>
...
<p>User identifiers (like variables, constants, function names...) must start with an underscore or an ascii letter. Those identifiers can then contain underscores, ascii letters and digit numbers.<br/>
</p>
...
</span><span style="color:#3186CD">const</span><span style="color:#0"> this_1_is_2_also__3_valid = </span><span style="color:#74A35B">0</span></code></pre><p>But your identifiers cannot start with two underscores. This is reserved by the compiler.<br/>
</p>
<pre><code><span style="color:#6A9955">// const __this_is_invalid = 0</span></code></pre><p>Note that some identifiers may start with <code>#</code>. This indicates a <b>compiler special keyword</b>.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#assert</span><span style="color:#0">
</span><span style="color:#FF6A00">#run</span><span style="color:#0">
</span><span style="color:#FF6A00">#main</span></code></pre><p><br/>
...
<p>This is the list of all keywords in the language.<br/>
<br/>
...
</span><span style="color:#ED9A11">cvarargs</span></code></pre><p><h3 id="Language keywords">Language keywords<br/>
</h3></p>
...
</span><span style="color:#3186CD">dref</span></code></pre><p><h3 id="Compiler keywords">Compiler keywords<br/>
</h3></p>
...
</span><span style="color:#FF6A00">#run</span></code></pre><p><h3 id="Intrinsics libc">Intrinsics libc<br/>
</h3></p>
...
</span><span style="color:#F2470C">@trunc</span></code></pre><p><h3 id="Other intrinsics">Other intrinsics<br/>
</h3></p>
...
</span><span style="color:#B4B44A">@typeof</span></code></pre><p><h3 id="Modifiers">Modifiers<br/>
</h3></p>
<pre><code><span style="color:#0">,over
,nodrop
,bit
,move
,moveraw</span></code></pre><p></p>

<h2 id="006_semicolon">Semicolon</h2>
<p>In Swag, there's no need to end a statement with <code>;</code> like in C/C++. Most of the time a <code>end of line</code> is enough.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(y == x)     </span><span style="color:#6A9955">// Verify that y is equal to x.</span></code></pre><p>The semicolons are not mandatory, but it's possible to use them if you want.<br/>
</p>
...
x, y += </span><span style="color:#74A35B">1</span><span style="color:#0">;</span></code></pre><p>Semicolons can be usefull if you want to do multiple things on the same line.<br/>
</p>
...
<p>The order of all <b>top level</b> declarations does not matter.<br/>
</p>
...
{
}</span></code></pre><p>Note that the order is not relevant in the same file, but it is also irrelevant across multiple files. You can for example call a function in one file and declare it in another one. Ordrer does not matter !<br/>
</p>
...
}</span></code></pre><p><h3 id="Type reflection">Type reflection<br/>
...
}</span></code></pre><p><h3 id="Postfix">Postfix<br/>
...
<p>In Swag, strings are encoded in UTF8.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>You cannot index a string to get a rune, except in ascii strings. This is because we didn't want the runtime to come with the cost of UTF8 encoding/decoding. But note that the <code>Std.Core</code> module will have all you need to manipulate UTF8 strings.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>Multiple adjacent strings are compiled as one.<br/>
</p>
...
</span><span style="color:#7F7F7F">#assert</span><span style="color:#0"> a == </span><span style="color:#BB6643">"this is a string"</span></code></pre><p>You can concatenate some values if the values are known at compile time. Use the <code>++</code> operator for that.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(d == </span><span style="color:#BB6643">"they are 4 apples in 4 baskets"</span><span style="color:#0">)</span></code></pre><p>A string can be <code>null</code> if not defined.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(a == </span><span style="color:#3186CD">null</span><span style="color:#0">)</span></code></pre><p><h3 id="Escape sequence">Escape sequence<br/>
...
}</span></code></pre><p><h3 id="Raw string">Raw string<br/>
...
}</span></code></pre><p><h3 id="Multiline string">Multiline string<br/>
...
}</span></code></pre><p><h3 id="Character">Character<br/>
...
}</span></code></pre><p><h3 id="@stringof and @nameof">@stringof and @nameof<br/>
...
<p>To declare a variable, use the <code>var</code> keyword, followed by <code>:</code> and then the type.<br/>
</p>
<pre><code><span style="color:#0">{
...
}</span></code></pre><p>If you don't assign a value, then the variable will be initialized with its default value (0). So a variable is <b>always</b> initialized.<br/>
</p>
...
</span><span style="color:#3186CD">var</span><span style="color:#0"> b: </span><span style="color:#ED9A11">string</span><span style="color:#0"> = </span><span style="color:#3186CD">undefined</span></code></pre><p>We have seen that the type is optional in the declaration if it can be deduced from the assignment.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>And in fact even <code>var</code> is optional if you use the short form with <code>:=</code>.<br/>
</p>
...
<p>If you use <code>const</code> instead of <code>var</code>, the value must be known by the compiler. There's no memory footprint if the type is a value or a string.<br/>
</p>
...
<p>These are the basic operators that can be used to manipulate values.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p><h3 id="Logical operators">Logical operators<br/>
...
a = (</span><span style="color:#74A35B">1</span><span style="color:#0"> > </span><span style="color:#74A35B">10</span><span style="color:#0">) </span><span style="color:#B040BE">or</span><span style="color:#0"> (</span><span style="color:#74A35B">10</span><span style="color:#0"> < </span><span style="color:#74A35B">1</span><span style="color:#0">)</span></code></pre><p><h3 id="Ternary operator">Ternary operator<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(y == </span><span style="color:#74A35B">666</span><span style="color:#0">)</span></code></pre><p><h3 id="Spaceshift operator">Spaceshift operator<br/>
...
}</span></code></pre><p><h3 id="Null-coalescing operator">Null-coalescing operator<br/>
...
}</span></code></pre><p><h3 id="Type promotion">Type promotion<br/>
...
<p>Sometimes it's necessary to change the type of a value.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>Use <code>cast,bit</code> to convert a native type to another without converting the value. Works only if the two types are of the same size.<br/>
</p>
...
</span><span style="color:#7F7F7F">#assert</span><span style="color:#0"> </span><span style="color:#3186CD">cast</span><span style="color:#0">,</span><span style="color:#FF6A00">bit</span><span style="color:#0">(</span><span style="color:#ED9A11">f32</span><span style="color:#0">) </span><span style="color:#74A35B">0</span><span style="color:#0">x</span><span style="color:#74A35B">3</span><span style="color:#0">f</span><span style="color:#74A35B">800000</span><span style="color:#0"> == </span><span style="color:#74A35B">1.0</span></code></pre><p>Swag can sometimes cast from one type to another for you. This is an <i>implicit</i> cast.<br/>
</p>
<p>
<br/>
...
<p>Remember that dynamic arrays are part of the <code>Std.Core</code> module. Here we are only talking about native static arrays.<br/>
</p>
<p>
<br/>
...
<p>A slice is a pointer on a buffer of datas, and a <code>u64</code> to count the number of elements. Unlike a static array, its value can be changed at runtime.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p><h3 id="The slicing operator">The slicing operator<br/>
</h3></p>
<p>
<br/>
...
<p><h3 id="Single value pointers">Single value pointers<br/>
</h3></p>
<p>
<br/>
...
}</span></code></pre><p><h3 id="Multiple values pointers">Multiple values pointers<br/>
...
<p>Swag has also <b>references</b>, which are pointers that behave like values.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(myRef == </span><span style="color:#74A35B">42</span><span style="color:#0">)</span></code></pre><p>When an affectation is done outside of an initialization, you will change the pointed value, and not the reference itself.<br/>
</p>
<pre><code><span style="color:#0">x := </span><span style="color:#74A35B">42</span><span style="color:#0">
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(x == </span><span style="color:#74A35B">66</span><span style="color:#0">)</span></code></pre><p>If you want to change the reference and not the pointed value, you can use <code>ref</code> in the affectation.<br/>
</p>
...
}</span></code></pre><p>This is usefull for structs for examples, as you can directly pass a literal to a function.<br/>
</p>
...
}</span></code></pre><p>Note that declaring a tuple type or a struct type is equivalent to a constant reference.<br/>
</p>
...
<p><code>any</code> is a specific type that can store every other types. <code>any</code> is <b>not a variant</b>. It's a dynamic typed reference to an existing value.<br/>
</p>
<pre><code><span style="color:#0">{
...
}</span></code></pre><p><h3 id="Tuple unpacking">Tuple unpacking<br/>
</h3></p>
<p>
<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(value & </span><span style="color:#3BC3A7">MyFlags</span><span style="color:#0">.</span><span style="color:#3BC3A7">C</span><span style="color:#0"> == </span><span style="color:#3BC3A7">MyFlags</span><span style="color:#0">.</span><span style="color:#3BC3A7">C</span><span style="color:#0">)</span></code></pre><p><h3 id="Enum of arrays">Enum of arrays<br/>
...
</span><span style="color:#7F7F7F">#assert</span><span style="color:#0"> </span><span style="color:#3BC3A7">Value</span><span style="color:#0">.</span><span style="color:#3BC3A7">B</span><span style="color:#0">[</span><span style="color:#74A35B">1</span><span style="color:#0">] == </span><span style="color:#74A35B">20</span></code></pre><p><h3 id="Enum of slices">Enum of slices<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(y[</span><span style="color:#74A35B">1</span><span style="color:#0">] == </span><span style="color:#74A35B">20</span><span style="color:#0">)</span></code></pre><p><h3 id="Enum type inference">Enum type inference<br/>
</h3></p>
<p>
<br/>
...
}</span></code></pre><p>By type reflection, you can loop/visit all values of an enum.<br/>
</p>
<pre><code><span style="color:#0">{
    </span><span style="color:#3186CD">enum</span><span style="color:#0"> </span><span style="color:#3BC3A7">RGB</span><span style="color:#0"> { </span><span style="color:#3BC3A7">R</span><span style="color:#0">; </span><span style="color:#3BC3A7">G</span><span style="color:#0">; </span><span style="color:#3BC3A7">B</span><span style="color:#0">; }
...
<p><code>impl</code> can be used to declare some stuff in the scope of an enum. The keyword <code>self</code> represents the enum value.<br/>
</p>
...
<p>You can create a global scope with a namespace. All symbols inside the namespace will be in the corresponding global scope.<br/>
</p>
...
}</span></code></pre><p>You can also specify more than one name. Here <code>C</code> will be a namespace inside <code>B</code> which is itself inside <code>A</code>.<br/>
</p>
...
<h2 id="050_if">If</h2>
<p>A basic test with <code>if</code>. Curlies are optional. The expression doesn't need to be enclosed with <code>()</code> unlike C/C++.<br/>
</p>
...
}</span></code></pre><p>You can also at the same time declare and test one variable in an <code>if</code> expression. <code>var</code> or <code>const</code> is mandatory in that case.<br/>
</p>
...
<p><code>loop</code> are used to iterate a given amount of time.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p><code>loop</code> can be used on every types that accept the <code>@countof</code> intrinsic. So you can loop on a slice, an array, a string... and we'll see later, even on a struct.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(cpt == </span><span style="color:#74A35B">10</span><span style="color:#0">+</span><span style="color:#74A35B">20</span><span style="color:#0">+</span><span style="color:#74A35B">30</span><span style="color:#0">+</span><span style="color:#74A35B">40</span><span style="color:#0">)</span></code></pre><p><b>Warning !</b><br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(cpt == </span><span style="color:#74A35B">3</span><span style="color:#0">)</span></code></pre><p><code>break</code> and <code>continue</code> can be used inside a loop.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>Loop can also be used to iterate on a range of signed values.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>A loop without an expression but with a block is infinite. This is equivalent to <code>while true {}</code>.<br/>
</p>
...
}</span></code></pre><p>A function can take an argument of type <code>struct</code>. No copy is done (this is equivalent to a const reference in C++).<br/>
</p>
...
<p>Like for an enum, <code>impl</code> is used to declare some stuff in the scope of a struct.<br/>
</p>
...
}</span></code></pre><p>If you declare your function with <code>mtd</code> (method) instead of <code>func</code>, then the first parameter is forced to be <code>using self</code>.<br/>
...
<p>A struct can have special operations in the <code>impl</code> block. This operations are predefined, and known by the compiler.This is the way to go to <b>overload operators</b> for example.<br/>
</p>
...
}</span></code></pre><p>Here the variable <code>v</code> will not be initialized prior to the affectation. This is more optimal, as there's only one initialization.<br/>
</p>
...
<p>Swag accepts copy and move semantics for structures. In this examples, we use a <code>Vector3</code> to illustrate, even if of course that kind of struct does not need a move semantic, as there's no heap involved.<br/>
</p>
...
a =,moveraw b
a =,nodrop,moveraw b</span></code></pre><p><code>moveref</code> can be used instead of <code>ref</code> in a function parameter to declare a move semantic intention.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(cpt == </span><span style="color:#74A35B">3</span><span style="color:#0">)</span></code></pre><p>You can have variants of <code>opVisit</code> by specifying an <b>additional name</b>.<br/>
</p>
<pre><code><span style="color:#3186CD">impl</span><span style="color:#0"> </span><span style="color:#3BC3A7">MyStruct</span><span style="color:#0">
{
    </span><span style="color:#7F7F7F">#[Swag.Macro]</span><span style="color:#0">
...
<p>An union is just a struct where all fields are located at offset 0.<br/>
</p>
<pre><code><span style="color:#0">{
...
{
    x, y, z: </span><span style="color:#ED9A11">f32</span><span style="color:#0">
}</span></code></pre><p>Here we declare an interface, with two functions <code>set</code> and <code>reset</code>.<br/>
</p>
...
}</span></code></pre><p>You can implement an interface for any given struct with <code>impl</code> and <code>for</code>.<br/>
...
}</span></code></pre><p>And we implement interface <code>IReset</code> also for struct <code>Point3</code>.<br/>
</p>
...
<p>A function declaration usually starts with the <code>func</code> keyword followed by the function name.<br/>
</p>
<pre><code><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#FF6A00">toto</span><span style="color:#0">()
{
}</span></code></pre><p>If the function needs to return a value, you must add <code>-></code> followed by the type.<br/>
</p>
...
}</span></code></pre><p>The return type can be deduced in case of a simple expression, by using <code>=></code> instead of <code>-></code>.<br/>
Here the return type will be deduced to be <code>s32</code>.<br/>
</p>
<pre><code><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#FF6A00">sum</span><span style="color:#0">(x, y: </span><span style="color:#ED9A11">s32</span><span style="color:#0">) => x + y</span></code></pre><p>A short version exists, in case of a function returning nothing.<br/>
</p>
<pre><code><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#FF6A00">print</span><span style="color:#0">(val: </span><span style="color:#ED9A11">string</span><span style="color:#0">) = </span><span style="color:#B4B44A">@print</span><span style="color:#0">(val)</span></code></pre><p>Parameters are specified after the function name, between parenthesis.<br/>
...
}</span></code></pre><p>Parameters can have default values.<br/>
</p>
...
}</span></code></pre><p>The type of the parameters can be deduced if you specify a default value.<br/>
...
}</span></code></pre><p>You can name parameters, and don't have to respect parameters order in that case.<br/>
</p>
...
}</span></code></pre><p><h4 id="Multiple return values">Multiple return values<br/>
</h4></p>
<p>
<br/>
...
<p>A lambda is just a <b>pointer to a function</b>.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#FF6A00">ptr1</span><span style="color:#0">(</span><span style="color:#74A35B">2</span><span style="color:#0">) == </span><span style="color:#74A35B">4</span><span style="color:#0">)</span></code></pre><p>A lambda can be null.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(lambda == </span><span style="color:#3186CD">null</span><span style="color:#0">)</span></code></pre><p>You can use a lambda as a function parameter type.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#FF6A00">toDo</span><span style="color:#0">(</span><span style="color:#74A35B">4</span><span style="color:#0">, &square) == </span><span style="color:#74A35B">16</span><span style="color:#0">)</span></code></pre><p><h4 id="Anonymous functions">Anonymous functions<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#FF6A00">fct</span><span style="color:#0">(</span><span style="color:#74A35B">20</span><span style="color:#0">, </span><span style="color:#74A35B">120</span><span style="color:#0">))</span></code></pre><p>Lambdas can have default parameters values.<br/>
</p>
<pre><code><span style="color:#0">{
...
<p>Swag supports a limited set of the <code>closure</code> concept.<br/>
<br/>
...
}</span></code></pre><p>You can spread the content of an array or a slice to variadic parameters with <code>@spread</code>.<br/>
</p>
<pre><code><span style="color:#0">{
...
<p><i>ufcs</i> stands for <i>uniform function call syntax</i>. It allows every functions to be called with a <code>param.func()</code> form when the first parameter of <code>func()</code> is of the same type as <code>param</code>.<br/>
</p>
<pre><code><span style="color:#0">{
...
<p>A function marked with <code>Swag.ConstExpr</code> can be executed by the compiler if it can.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[Swag.ConstExpr]</span><span style="color:#0">
</span><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#FF6A00">sum</span><span style="color:#0">(x, y: </span><span style="color:#ED9A11">f32</span><span style="color:#0">) => x + y</span></code></pre><p>Here <code>G</code> will be baked to 3 by the compiler.<br/>
</p>
...
</span><span style="color:#7F7F7F">#assert</span><span style="color:#0"> </span><span style="color:#3BC3A7">G</span><span style="color:#0"> == </span><span style="color:#74A35B">3</span></code></pre><p>If a function is not <code>ConstExpr</code>, you can force the compile time call with <code>#run</code>.<br/>
</p>
...
<p>Functions can have the same names as long as their parameters are different.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[Swag.ConstExpr]</span><span style="color:#0">
{
...
<p>By default, you must always use the returned value of a function, otherwise the compiler will generate an error.<br/>
</p>
...
</span><span style="color:#3186CD">discard</span><span style="color:#0"> </span><span style="color:#FF6A00">sum</span><span style="color:#0">(</span><span style="color:#74A35B">2</span><span style="color:#0">, </span><span style="color:#74A35B">3</span><span style="color:#0">)</span></code></pre><p>If a function authorizes the caller to not use its return value, because it's not that important, it can be marked with <code>Swag.Discardable</code>.<br/>
</p>
...
<p>Inside a function, you can use the <code>retval</code> type which is an alias to the function return type.<br/>
</p>
<pre><code><span style="color:#0">{
...
}</span></code></pre><p>But <code>retval</code> will also make a direct reference to the caller storage, to avoid an unnecessary copy (if possible). So this is mostly a hint for the compiler, and usefull when the function returns a complexe type like a struct, a tuple or an array.<br/>
</p>
<pre><code><span style="color:#0">{
...
<p>Swag can interop with external "modules" (dlls under windows), which contain exported C functions.<br/>
<br/>
...
<p>In the case below, the function is located in <code>kernel32.dll</code> (under windows)<br/>
</p>
...
}</span></code></pre><p>Note that in the case of a system module, you will have to declare somewhere the imported library too.<br/>
<br/>
...
<p>This is the list of all compiler intrinsics.<br/>
All intrinsics start with <code>@</code>, which is reserved for them.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#global</span><span style="color:#0"> skip</span></code></pre><p><h3 id="Base">Base<br/>
</h3></p>
...
</span><span style="color:#B4B44A">@compilerwarning</span><span style="color:#0">()</span></code></pre><p><h3 id="Buildin">Buildin<br/>
</h3></p>
...
</span><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#F2470C">@strlen</span><span style="color:#0">(value: </span><span style="color:#3186CD">const</span><span style="color:#0"> *</span><span style="color:#ED9A11">u8</span><span style="color:#0">)-></span><span style="color:#ED9A11">u64</span><span style="color:#0">;</span></code></pre><p><h3 id="Atomic operations">Atomic operations<br/>
</h3></p>
...
</span><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#F2470C">@atomcmpxchg</span><span style="color:#0">(addr: *</span><span style="color:#ED9A11">u64</span><span style="color:#0">, compareTo, exchangeWith: </span><span style="color:#ED9A11">u64</span><span style="color:#0">)-></span><span style="color:#ED9A11">u64</span><span style="color:#0">;</span></code></pre><p><h3 id="Math">Math<br/>
</h3></p>
...
}</span></code></pre><p>When called on a struct, the struct will be restored to the values defined in it.<br/>
</p>
...
}</span></code></pre><p>Generic types can be deduced from parameters, so <code>func'type()</code> is not always necessary.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#FF6A00">myFunc</span><span style="color:#0">(</span><span style="color:#74A35B">2.0</span><span style="color:#0">'</span><span style="color:#ED9A11">f32</span><span style="color:#0">) == </span><span style="color:#74A35B">4.0</span><span style="color:#0">)     </span><span style="color:#6A9955">// T is deduced to be f32</span></code></pre><p>You can also specify constants as generic parameters.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p>Like functions, a struct can also be generic.<br/>
</p>
<pre><code><span style="color:#0">{
...
<p><h4 id="One time evaluation">One time evaluation<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#FF6A00">isNull</span><span style="color:#0">(</span><span style="color:#74A35B">0.001</span><span style="color:#0">'</span><span style="color:#ED9A11">f32</span><span style="color:#0">))</span></code></pre><p>Instead of a single expression, <code>#validif</code> can be followed by a block that returns a <code>bool</code>.<br/>
</p>
...
}</span></code></pre><p>By using <code>@compilererror</code>, you can then trigger your own errors at compile time if the type is incorrect.<br/>
</p>
...
</span><span style="color:#6A9955">// x := sum'f32(1, 2)</span></code></pre><p><code>#validif</code> can also be used on a generic struct. Unlike functions, if the expression failed, then you will have an error right away because there's no overload in the case of structures.<br/>
</p>
...
</span><span style="color:#6A9955">//var v: Point's32</span></code></pre><p><h4 id="Multiple evaluations">Multiple evaluations<br/>
...
<p>Swag provides also a simple way of checking generic parameters, without the need of <code>#validif</code>.<br/>
...
</span><span style="color:#6A9955">// res1 := sum'f32(1, 2)</span></code></pre><p>The type constraint can be any compile time expression, as long as the resulting type is <code>bool</code>.<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#FF6A00">myFunc</span><span style="color:#0">(</span><span style="color:#3186CD">false</span><span style="color:#0">) == </span><span style="color:#3186CD">false</span><span style="color:#0">)</span></code></pre><p>Works also for structs.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[Swag.ConstExpr]</span><span style="color:#0">
...
<p><code>defer</code> is used to call an expression when the current scope is left. It's purely compile time, so it does not evaluate until the block is left.<br/>
</p>
<pre><code><span style="color:#0">{
...
}</span></code></pre><p><h4 id="For a function parameter">For a function parameter<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(pt.y == </span><span style="color:#74A35B">1</span><span style="color:#0">)</span></code></pre><p><h4 id="For a field">For a field<br/>
...
<p>You can use <code>with</code> to avoid repeating the same variable again and again. You can then access fields with a simple <code>.</code>.<br/>
</p>
...
<p>Swag contains a <b>very</b> simple error system used to deal with function returning errors.<br/>
...
}</span></code></pre><p>The caller can stop the execution with <code>try</code>, and return to its own caller with the same error raised. The function must then also be marked with <code>throw</code>.<br/>
<br/>
...
}</span></code></pre><p>Note that you can use a block instead of one single statement (this does not create a scope).<br/>
</p>
...
}</span></code></pre><p>When a function is marked with <code>throw</code>, the <code>try</code> for a function call is automatic if not specified. That means that most of the time it's not necessary to specify it.<br/>
</p>
...
</span><span style="color:#6A9955">// x += 1      // This would overflow, and panic, because we lose informations</span></code></pre><p>But if you know what your are doing, you can use a special version of those operators, which will not panic. Add the <code>,over</code> modifier after the operation. This will disable safety checks.<br/>
</p>
<pre><code><span style="color:#0">x := </span><span style="color:#74A35B">255</span><span style="color:#0">'</span><span style="color:#ED9A11">u8</span><span style="color:#0">
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(x == </span><span style="color:#74A35B">0</span><span style="color:#0">)</span></code></pre><p>For 8 or 16 bits, you can promote an operation to 32 bits by using ',up'.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(</span><span style="color:#B4B44A">@typeof</span><span style="color:#0">(x) == </span><span style="color:#ED9A11">u32</span><span style="color:#0">)</span></code></pre><p>Swag will also check that a cast does not lose information.<br/>
</p>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(y2 == </span><span style="color:#74A35B">255</span><span style="color:#0">)</span></code></pre><p>Rember that you can disable these safety checks with the corresponding attribute.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[Swag.Overflow(true)]</span></code></pre><pre><code><span style="color:#0">x := </span><span style="color:#74A35B">255</span><span style="color:#0">'</span><span style="color:#ED9A11">u8</span><span style="color:#0">
...
</span><span style="color:#6A9955">//@assert(x[idx] == 1)     // '10' is out of range, will panic</span></code></pre><p>Safety when indexing a slice.<br/>
</p>
...
</span><span style="color:#6A9955">//@assert(x[idx] == 1)      // '10' is out of range, will panic</span></code></pre><p>Safety when slicing a sized value.<br/>
</p>
<pre><code><span style="color:#3186CD">var</span><span style="color:#0"> x: </span><span style="color:#3186CD">const</span><span style="color:#0"> [..] </span><span style="color:#ED9A11">s32</span><span style="color:#0"> = [</span><span style="color:#74A35B">0</span><span style="color:#0">, </span><span style="color:#74A35B">1</span><span style="color:#0">, </span><span style="color:#74A35B">2</span><span style="color:#0">]
...
<p><code>#assert</code> is a static assert (at compile time).<br/>
</p>
<pre><code><span style="color:#7F7F7F">#assert</span><span style="color:#0"> </span><span style="color:#3186CD">true</span></code></pre><p><code>@defined(SYMBOL)</code> returns true, at compile time, if the given symbol exists in the current context.<br/>
</p>
...
</span><span style="color:#3186CD">var</span><span style="color:#0"> </span><span style="color:#3BC3A7">Global</span><span style="color:#0"> = </span><span style="color:#74A35B">0</span></code></pre><p>A static <code>#if/#elif/#else</code>, with an expression that can be evaluated at compile time.<br/>
</p>
...
{
}</span></code></pre><p><code>#error</code> to raise a compile time error, and <code>#warning</code> to raise a compile time warning.<br/>
</p>
...
}</span></code></pre><p>A more complicated <code>#assert</code>.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[Swag.ConstExpr]</span><span style="color:#0">
...
{
}</span></code></pre><p><h4 id="#premain">#premain<br/>
...
}</span></code></pre><p><code>#run</code> can also be used as an expression block.<br/>
...
<p>A bunch of <code>#global</code> can start a source file.<br/>
</p>
...
<p>Attributes are tags associated with functions, structures etc...<br/>
</p>

<h3 id="191__user_attributes">User attributes</h3>
<p>User attributes are declared like functions, but with the <code>attr</code> keyword before instead of <code>func</code>.<br/>
</p>
<pre><code><span style="color:#3186CD">using</span><span style="color:#0"> </span><span style="color:#3BC3A7">Swag</span><span style="color:#0">
</span><span style="color:#3186CD">attr</span><span style="color:#0"> </span><span style="color:#3BC3A7">AttributeA</span><span style="color:#0">()</span></code></pre><p>Like functions, attributes can have parameters.<br/>
</p>
...
{
}</span></code></pre><p>You can declare multiple usages.<br/>
</p>
...
{
}</span></code></pre><p>Finaly, attributes can be retrieved at runtime thanks to <b>type reflection</b>.<br/>
</p>
...
<p>This is the list of predefined attributes.<br/>
...
<p>In Swag, types are also values that can be inspected at compile time or at runtime. The two main intrinsics for this are <code>@typeof</code> and <code>@kindof</code>.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p><h3 id="@decltype">@decltype<br/>
</h3></p>
<p>
<br/>
...
<p><code>#message</code> is a special function that will be called by the compiler when something specific occurs during the build. The parameter of <code>#message</code> is a mask that tells the compiler when to call the function.<br/>
</p>
<p>With the <code>Swag.CompilerMsgMask.SemFunctions</code> flag, for example, <code>#message</code> will be called each time a function of the module <b>has been typed</b>. You can then use <code>getMessage()</code> in the <code>@compiler()</code> interface to retrieve some informations about the reason of the call.<br/>
</p>
...
</span><span style="color:#3186CD">func</span><span style="color:#0"> </span><span style="color:#3BC3A7">XXTestFunc3</span><span style="color:#0">() {}</span></code></pre><p>The compiler will call the following function after the semantic pass. So after <b>all the functions</b> of the module have been parsed.<br/>
</p>
...
}</span></code></pre><p>This will be called for every global variables of the module.<br/>
</p>
<pre><code><span style="color:#FF6A00">#message</span><span style="color:#0">(</span><span style="color:#3BC3A7">Swag</span><span style="color:#0">.</span><span style="color:#3BC3A7">CompilerMsgMask</span><span style="color:#0">.</span><span style="color:#3BC3A7">SemGlobals</span><span style="color:#0">)
{
    itf := </span><span style="color:#B4B44A">@compiler</span><span style="color:#0">()
    msg := itf.</span><span style="color:#FF6A00">getMessage</span><span style="color:#0">()
}</span></code></pre><p>This will be called for every global types of the module (structs, enums, interfaces...).<br/>
</p>
...
<p>In Swag you can construct some source code at compile time, which will then be compiled. The source code you provide in the form of a <b>string</b> must be a valid Swag program.<br/>
</p>

<h3 id="221__ast">Ast</h3>
<p>The most simple way to produce a string which contains the Swag code to compile is with an <code>#ast</code> block. An <code>#ast</code> block is executed at compile time and the string it returns will be compiled <b>inplace</b>.<br/>
</p>
<p>
<br/>
...
}</span></code></pre><p><h4 id="Struct and enums">Struct and enums<br/>
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(v.y == </span><span style="color:#74A35B">666</span><span style="color:#0">)</span></code></pre><p>It works with generics too, and can be mixed with static declarations.<br/>
</p>
...
</span><span style="color:#7F7F7F">#assert</span><span style="color:#0"> </span><span style="color:#B4B44A">@typeof</span><span style="color:#0">(v1.z) == </span><span style="color:#ED9A11">string</span></code></pre><p><code>#ast</code> needs to return a <i>string like</i> value, which can of course be dynamically constructed.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[Swag.Compiler]</span><span style="color:#0">
...
</span><span style="color:#B4B44A">@assert</span><span style="color:#0">(v.z == </span><span style="color:#74A35B">3</span><span style="color:#0">)</span></code></pre><p><h4 id="For example">For example<br/>
...
<p><h4 id="At global scope">At global scope<br/>
...
}</span></code></pre><p>But be aware that you must use <code>#placeholder</code> in case you are generating global symbols that can be used by something else in the code. This will tell Swag that <i>this symbol</i> will exist at some point, so please wait for it to <i>exist</i> before complaining.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#placeholder</span><span style="color:#0"> myGeneratedConst   </span><span style="color:#6A9955">// Symbol `myGeneratedConst` will be generated</span></code></pre><p>Here for example, thanks to the <code>#placeholder</code>, the <code>#assert</code> will wait for the symbol <code>myGeneratedConst</code> to be replaced with its real content.<br/>
</p>
...
<p>The other method to compile generated code is to use the function <code>compileString()</code> in the <code>@compiler()</code> interface. Of course this should be called at compile time, and mostly during a <code>#message</code> call.<br/>
<br/>
...
<p>First we declare a new specific attribute, which can then be associated with a function.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#[AttrUsage(AttributeUsage.Function)]</span><span style="color:#0">
...
}</span></code></pre><p>The following will be used to track the functions with that specific attribute.<br/>
</p>
...
</span><span style="color:#3186CD">var</span><span style="color:#0"> g_Functions: </span><span style="color:#3BC3A7">Array</span><span style="color:#0">'</span><span style="color:#3BC3A7">OneFunc</span></code></pre><p>This <code>#message</code> will be called for each function of the <code>Ogl</code> module.<br/>
</p>
...
}</span></code></pre><p>We will generate a <code>glInitExtensions</code> global function, so we register it as a place holder.<br/>
</p>
<pre><code><span style="color:#7F7F7F">#placeholder</span><span style="color:#0"> glInitExtensions</span></code></pre><p>This is called once all functions of the module have been typed, and this is the main code generation.<br/>
</p>
...
<p>The Swag compiler can generate documentation for all the modules of a given workspace.<br/>
</p>
