<header class="sticky top-0 z-50 bg-black">
    <div class="lg:m-auto w-full lg:w-[75rem] lg:flex justify-between items-center p-2" x-data="{ open_menu: false }">
        <div class="flex justify-between items-center">
            <a href="{{ route('home') }}"><img src="/imgs/swag-logo.jpg" alt="SWAG" class="w-24 lg:w-50" /></a>
            <div class="lg:hidden">
        ...
        <ul class="text-white text-md mt-3 lg:mt-0" :class="open_menu ? '' : 'hidden lg:flex'">
            <li class="lg:mr-5 mb-1 lg:mb-0 ml-2 lg:ml-0"><a href="{{ route('home') }}" class="<?=$_SERVER['REQUEST_URI'] == '/' ? 'border-b' : ''?> hover:border-b">Home</a></li>
