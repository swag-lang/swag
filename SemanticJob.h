...
struct SemanticJob : public Job
{
    ...
    static bool setupFuncDeclParams(SourceFile* sourceFile, TypeInfoFuncAttr* typeInfo, AstNode* funcAttr, AstNode* parameters, bool forGenerics);
    ...
    static bool resolveUserBinaryOp(SemanticContext* context, const char* name, const char* op, AstNode* left, AstNode* right);
