...
SWAG_ERROR(Nte0045, "instance of generic function `%s%s` ")
SWAG_ERROR(Nte0046, "%s `%s` is waiting for %s `%s` to be solved")
SWAG_ERROR(Nte0047, "resulting type is `%s%s`")
SWAG_ERROR(Nte0048, "function `%s%s`")
SWAG_ERROR(Nte0049, "struct `%s%s`")
...
SWAG_ERROR(Nte0055, "occured when trying to match the type of the other part of the conditional expression")
