...
void profiler()
{
    ...
    ranges::sort(bcs, [](const ByteCode* a, const ByteCode* b) { return b->profileCumTime < a->profileCumTime; });
    ...
    ranges::sort(linFFi, [](const FFIStat& a, const FFIStat& b) { return b.cum < a.cum; });
