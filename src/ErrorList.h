...
SWAG_ERROR(Err0107, "cannot reference a compile time function (function `%s` is marked with `Swag.Compiler`) from runtime %s")
...
SWAG_ERROR(Err0151, "missing at least one digit in the binary number")
...
SWAG_ERROR(Err0434, "missing at least one digit in the hexadecimal number")
...
SWAG_ERROR(Nte0068, "here is generic argument `%s` of %s")
