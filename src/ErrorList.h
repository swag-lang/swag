...
SWAG_ERROR(Err0785, "`@mkcallback` cannot be used with a function with more than `%d` parameters (`%d` provided)")
SWAG_ERROR(Err0786, "`@mkcallback` cannot be used with a function that returns type `%s` (only simple types are supported)")
