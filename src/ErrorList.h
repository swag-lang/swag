...
SWAG_ERROR(Err0107, "cannot reference a compile time function (function `%s` marked with `Swag.Compiler`) from runtime %s")
...
SWAG_ERROR(Err0699, "the dimension of the enum array type `%s` should be specified")
