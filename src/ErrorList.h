...
SWAG_ERROR(Err0468, "the index is out of range (the index is `%I64u` but the maximum value is `%I64u`)")
...
SWAG_ERROR(Nte0067, "expected `%s` because of function return type")
