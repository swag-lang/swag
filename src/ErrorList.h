...
SWAG_ERROR(Err0002, "the type `%s` cannot be used in a range expression")
...
SWAG_ERROR(Err0555, "a tuple type in generic parameters is not supported")
...
SWAG_ERROR(Err0735, "the type `cvarargs` can only be used for a function parameter")
SWAG_ERROR(Err0736, "the type `code` can only be used for a function parameter")
...
SWAG_ERROR(Err0769, "the `retval` type can only be used in a function body")
SWAG_ERROR(Err0770, nullptr)
SWAG_ERROR(Err0771, "the `retval` type cannot be used in a function that returns nothing")
...
SWAG_ERROR(Err0810, "the type cannot be evaluated in that context because it`s generic")
...
SWAG_ERROR(Err0909, "the type `%s` cannot be used in an union because it contains `opPostCopy` (or one of its members does)")
SWAG_ERROR(Err0910, "the type `%s` cannot be used in an union because it contains `opPostMove` (or one of its members does)")
SWAG_ERROR(Err0911, "the type `%s` cannot be used in an union because it contains `opDrop` (or one of its members does)")
