...
SWAG_ERROR(Err0078, "a function name starting with `op` and followed by a letter in upper case (like `%s`) is reserved for struct special functions")
...
SWAG_ERROR(Nte0066, "here is the argument `%s` of %s")
SWAG_ERROR(Nte0067, "expected `%s` because of the function return type")
SWAG_ERROR(Nte0068, "here is the generic argument `%s` of %s")
