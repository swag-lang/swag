SWAG_ERROR(Nte0053, " (do you mean `%s` ?)")
SWAG_ERROR(Nte0054, " (do you mean `%s` or `%s` ?)")
SWAG_ERROR(Nte0055, " (do you mean `%s`, `%s` or `%s` ?)")
...
SWAG_ERROR(Err0505, "%s overflow, the maximum size is 0x%I64x bytes")
SWAG_ERROR(Err0749, "%s returns a type `%s`, but the body is missing a `return`")
...
SWAG_ERROR(Err0665, "`%s` can only be used in a global scope")
...
SWAG_ERROR(Err0489, "`@init` first parameter should be a pointer (`%s` provided)")
SWAG_ERROR(Err0490, "`@init` second parameter should be an integer (`%s` provided)")
...
SWAG_ERROR(Err0635, "`fallthrough` cannot be used in the last `case` of a `switch`")
...
SWAG_ERROR(Err0668, "`using` cannot be used on a constant")
...
SWAG_ERROR(Err0364, "a `#mixin` replacement block can only be used inside a breakable statement (`loop`, `visit`, `for` ...)")
SWAG_ERROR(Err0384, "a `#placeholder` can only be declared in a top level scope")
...
SWAG_ERROR(Err0617, "a `Swag.Complete` attribute cannot be used on a switch with type `%s`")
SWAG_ERROR(Err0595, "a `Swag.Pack` value should be 0 or a power of two (`%d` provided)")
SWAG_ERROR(Err0136, "a back ticked identifier can only be used inside a `Swag.Macro` function or an `#inline` block")
...
SWAG_ERROR(Err0413, "a function name starting with `@` is reserved for intrinsics")
...
SWAG_ERROR(Err0419, "a semantic cycle has been detected during resolution of %s `%s`")
...
SWAG_ERROR(Err0067, "a special function (`%s`) should be defined in a `impl` scope")
SWAG_ERROR(Err0625, "a special visit name is only valid for struct (type is `%s`)")
...
SWAG_ERROR(Err0574, "affectation to the tuple is not possible because the right expression is not compatible")
...
SWAG_ERROR(Err0301, "an affectation is not allowed from an array")
SWAG_ERROR(Err0027, "an alias can only be used with a type or an identifier")
SWAG_ERROR(Err0485, "an array access type should be integer, but is `%s`")
SWAG_ERROR(Err0190, "an attribute declaration (`attr`), unlike function, cannot be marked with `throw`")
SWAG_ERROR(Err0726, "an attribute declaration (`attr`), unlike function, should not have a return value starting with `->`")
...
SWAG_ERROR(Err0308, "cannot deduce a type from `null`")
SWAG_ERROR(Err0709, "cannot deduce the flag value of `%s` because the previous value is not power of two")
SWAG_ERROR(Err0352, "cannot deduce the generic parameters when calling special %s")
...
SWAG_ERROR(Err0108, "cannot reference the `Swag.Test` function `%s` from `%s`")
SWAG_ERROR(Err0107, "cannot reference the compile time function `%s` (marked with `Swag.Compiler`) from runtime %s")
SWAG_ERROR(Err0206, "cannot reference the variable `%s` because it`s in another stack frame")
...
SWAG_ERROR(Err0004, "cannot select the function `%s` because `%s` has failed")
...
SWAG_ERROR(Err0469, "cannot take the address of constant")
SWAG_ERROR(Err0462, "cannot take the address of function parameter of type '%s'")
...
SWAG_ERROR(Err0291, "cannot unpack the type `%s` (expected a struct)")
...
SWAG_ERROR(Err0772, "expected a return expression of type `%s` after `return`")
...
SWAG_ERROR(Nte0060, "if this is a tuple literal and not a type declaration, use `@{` instead of `{`")
SWAG_ERROR(Nte0059, "if this is an array literal and not a type declaration, use `@[` instead of `[`")
...
SWAG_ERROR(Err0654, "missing `self` as a first parameter for the interface function `%s`")
SWAG_ERROR(Err0867, "missing a `case` expression before `:`")
SWAG_ERROR(Err0868, "missing a `case` expression before `break`")
SWAG_ERROR(Err0412, "missing a generic name or a type")
SWAG_ERROR(Err0339, "missing a pointer declaration `*` after `const`")
SWAG_ERROR(Err0623, "missing a variable type or an assignment (`:` or `=`)")
SWAG_ERROR(Err0872, "missing another `visit` variable name after `,` and before `:`")
SWAG_ERROR(Err0151, "missing at least one digit in the number")
SWAG_ERROR(Err0879, "missing the `#global if` expression")
SWAG_ERROR(Err0878, "missing the `#if` expression")
SWAG_ERROR(Err0269, "missing the `#main` function (executable entry point)")
SWAG_ERROR(Err0863, "missing the `if` boolean expression before `{`")
...
SWAG_ERROR(Err0864, "missing the `while` boolean expression before `{`")
SWAG_ERROR(Err0020, "missing the function call `()` to %s")
SWAG_ERROR(Err0119, "missing the function call parameters")
SWAG_ERROR(Err0414, "missing the function name instead of `%s`")
SWAG_ERROR(Err0409, "missing the function parameter type or assignment (`:` or `=`)")
SWAG_ERROR(Err0883, "missing the function parameters before `{`")
SWAG_ERROR(Err0049, "missing the generic parameters for %s")
SWAG_ERROR(Err0411, "missing the generic parameters")
SWAG_ERROR(Err0303, "missing the initialization expression to deduce the size of the array")
SWAG_ERROR(Err0390, "missing the namespace name before `;`")
SWAG_ERROR(Err0389, "missing the namespace name before `{`")
SWAG_ERROR(Err0068, "missing the parameters of special function `%s`")
SWAG_ERROR(Err0677, "missing the parameters of the interface member `%s` (`self` is expected as a first parameter)")
SWAG_ERROR(Err0064, "missing the return type of the special function `%s` (`%s` expected)")
SWAG_ERROR(Err0063, "missing the return type of the special function `%s`")
...
SWAG_ERROR(Err0028, "the `Swag.Strict` attribute can only be used on a type alias")
...
SWAG_ERROR(Err0567, "the affect operation is not allowed because left expression is not a variable")
SWAG_ERROR(Err0565, "the affect operation is not allowed because the left expression is not an l-value")
SWAG_ERROR(Err0564, "the affect operation is not allowed because the left expression is immutable (`const`)")
SWAG_ERROR(Err0566, "the affect operation is not allowed")
...
SWAG_ERROR(Err0022, "the array dimension should be of type integer, but is `%s`")
...
SWAG_ERROR(Err0586, "the attribute `%s` cannot be used in that context")
SWAG_ERROR(Err0600, "the attribute `%s` does not have the `Swag.AttributeUsage.File` usage, so it cannot be used with `#global`")
SWAG_ERROR(Err0591, "the attribute `%s` is assigned twice to `%s` (`Swag.AttrMulti` is not present in the declaration of `%s`)")
SWAG_ERROR(Err0297, "the attribute `Swag.Discardable` can only be used on a lambda variable (provided type is `%s`)")
SWAG_ERROR(Err0602, "the attribute parameter cannot be evaluated at compile time")
SWAG_ERROR(Err0786, "the callback return type `%s` not supported")
...
SWAG_ERROR(Err0120, "the field name `%s` cannot be found in the tuple")
SWAG_ERROR(Err0242, "the filename cannot be evaluated at compile time")
SWAG_ERROR(Err0752, "the function `%s` cannot have generic parameters because it is flagged with the `Swag.NoGeneric` attribute")
...
SWAG_ERROR(Err0751, "the function `%s` has the `Swag.NoGeneric` attribute but seems to be generic")
...
SWAG_ERROR(Err0893, "the identifier `%s` has not been solved")
SWAG_ERROR(Err0272, "the identifier `%s` starts with `__`, and this is reserved by the language")
SWAG_ERROR(Err0881, "the identifier is preceeded with `.`, but no parent scope can be found")
...
SWAG_ERROR(Err0468, "the index is out of range (index is `%I64u` but the maximum index is `%I64u`)")
...
SWAG_ERROR(Err0006, "the parameter `%d` should be named because some parameters before are named")
SWAG_ERROR(Err0738, "the parameter `%d` should have a default value because some parameters before have a default value")
SWAG_ERROR(Err0892, "the placeholder identifier `%s` has not been solved")
...
SWAG_ERROR(Err0078, "the special function `%s` (starting with `op` followed by a letter in upper case) is unknown")
...
SWAG_ERROR(Err0674, "the struct member name `%s` starts with `item`, and this is reserved by the language")
...
SWAG_ERROR(Err0346, "the symbol `%s` is already defined in parent scope")
SWAG_ERROR(Nte0043, "the symbol `%s` was not found in `%s`")
SWAG_ERROR(Nte0013, "the symbol has been found thanks to a `using`")
SWAG_ERROR(Err0477, "the upper bound `%I64u` of the slicing arguments is out of range")
SWAG_ERROR(Err0086, "the variable `%s` has only been used to find function `%s`; use the scope `%s` instead")
SWAG_ERROR(Err0894, "the variable `%s` is used before being declared")
...
SWAG_ERROR(Err0062, "too few arguments for the special function `%s` (at least `%d` expected, only `%d` provided)")
...
SWAG_ERROR(Err0450, "too many generic parameters for the special function `%s`")
...
SWAG_ERROR(Err0555, "tuple types in generic parameters is not supported")
...
SWAG_ERROR(Err0054, "unexpected generic parameter `%d` for %s (type expected, value provided)")
SWAG_ERROR(Err0057, "unexpected generic parameter `%d` for %s (value expected, type provided)")
...
SWAG_ERROR(Err0304, "unexpected initialization expression for the array (expected an array literal or `?`)")
...
SWAG_ERROR(Err0061, "unexpected number of arguments for special function `%s` (`%d` expected, `%d` provided)")
...
SWAG_ERROR(Err0066, "unexpected parameter `%d` for special function `%s` (`%s` expected, `%s` provided)")
SWAG_ERROR(Err0077, "unexpected parameter `2` for special function `%s` (cannot be of type `%s`)")
SWAG_ERROR(Err0408, "unexpected parameter name `%s`")
SWAG_ERROR(Err0373, "unexpected pass name `%s`")
SWAG_ERROR(Err0065, "unexpected return type for special function `%s` (`%s` expected, `%s` provided)")
...
SWAG_ERROR(Err0697, "unexpected type `%s` for enum flags (should be unsigned integer)")
SWAG_ERROR(Err0698, "unexpected type `%s` for enum index (should be integer)")
...
SWAG_ERROR(Err0070, "unexpected type of generic parameter `%d` for %s (`%s` expected, `%s` provided)")
SWAG_ERROR(Err0053, "unexpected type of parameter `%d` for %s (`%s` expected, `%s` provided)")
SWAG_ERROR(Err0050, "unexpected type of parameter `%d` for %s (`%s` is expected for field `%s`, `%s` provided)")
SWAG_ERROR(Err0047, "unexpected type of parameter `%d` for %s, generic type `%s` is assigned to `%s` (`%s` provided)")
...
SWAG_ERROR(Err0478, "the special function '%s' can have generic parameters")
