...
SWAG_ERROR(Err0201, "the `%s` is referencing itself, which make it recursive")
...
SWAG_ERROR(Err0893, "the %s `%s` has not been solved")
...
SWAG_ERROR(Nte0064, "here is where the field where the recursion occurs")