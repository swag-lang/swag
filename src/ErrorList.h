...
SWAG_ERROR(Nte0058, "occurred during conversion of type `%s` to `%s` with `%s`")
...
SWAG_ERROR(Err0532, "a literal with a suffix ('%s') can only be used in a struct conversion")
