...
SWAG_ERROR(Err0047, "mismatched type for %s of %s, generic type `%s` is assigned to `%s` (`%s` provided)")
...
SWAG_ERROR(Err0050, "mismatched type for %s of %s (`%s` is expected for field `%s`, `%s` provided)")
SWAG_ERROR(Err0051, "cannot add `%s` to the `PATH` environment variable")
SWAG_ERROR(Err0052, "unexpected return value in a %s")
SWAG_ERROR(Err0053, "mismatched type for %s of %s (`%s` expected, `%s` provided)")
...
SWAG_ERROR(Nte0065, "because of %s `%s`")
SWAG_ERROR(Nte0066, "here is argument `%s` of %s")