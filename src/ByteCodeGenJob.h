...
struct ByteCodeGenJob : public Job
{
    ...
    static bool emitInit(ByteCodeGenContext* context, TypeInfo* pointedType, RegisterList& rExpr, uint64_t numToInit, AstNode* count, AstNode* parameters);
    ...
    static void        emitSafetyCastAny(ByteCodeGenContext* context, AstNode* exprNode, TypeInfo* toType, bool isExplicit);
    ...
    static uint32_t reserveRegisterRC(ByteCodeGenContext* context, const SymbolOverload* overload = nullptr);
