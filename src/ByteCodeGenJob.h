...
struct ByteCodeGenJob : public Job
{
    ...
    static bool emitCopyArrayOfStructs(ByteCodeGenContext* context, TypeInfoArray* typeArray, TypeInfoStruct* typeStruct, RegisterList& r1, RegisterList& fromReg, AstNode* from);
