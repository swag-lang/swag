...
const uint64_t TYPEINFO_ENUM_HAS_USING           = 0x00040000'00000000;
const uint64_t TYPEINFO_GHOST_TUPLE              = 0x00080000'00000000;
const uint64_t TYPEINFO_GENERATED_OPEQUALS       = 0x00100000'00000000;

const uint8_t TYPEINFOPARAM_DEFINED_VALUE    = 0x00000001;
const uint8_t TYPEINFOPARAM_HAS_USING        = 0x00000002;
const uint8_t TYPEINFOPARAM_AUTO_NAME        = 0x00000004;
const uint8_t TYPEINFOPARAM_GENERIC_TYPE     = 0x00000008;
const uint8_t TYPEINFOPARAM_GENERIC_CONSTANT = 0x00000010;
const uint8_t TYPEINFOPARAM_FROM_GENERIC     = 0x00000020;
