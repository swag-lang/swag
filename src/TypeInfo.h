...
const uint64_t TYPEINFO_SHARED                   = 0x00000004'00000000;
...
const uint64_t TYPEINFO_POINTER_ACCEPT_MOVE_REF  = 0x00040000'00000000;
...
{
    int            numRegisters();
    bool           isSame(TypeInfoParam* to, uint32_t castFlags);
    TypeInfoParam* clone();
...
struct TypeInfoEnum : public TypeInfo
{
    ...
    bool      isSame(TypeInfo* to, uint32_t castFlags) override;
    TypeInfo* clone() override;
