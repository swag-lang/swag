...
const TypeInfoFlags TYPEINFO_SELF                     = 0x00000000'00000001;
const TypeInfoFlags TYPEINFO_UNTYPED_BIN_HEX          = 0x00000000'00000002;
const TypeInfoFlags TYPEINFO_INTEGER                  = 0x00000000'00000004;
const TypeInfoFlags TYPEINFO_FLOAT                    = 0x00000000'00000008;
const TypeInfoFlags TYPEINFO_UNSIGNED                 = 0x00000000'00000010;
const TypeInfoFlags TYPEINFO_CONST                    = 0x00000000'00000020;
const TypeInfoFlags TYPEINFO_AUTO_NAME                = 0x00000000'00000040;
const TypeInfoFlags TYPEINFO_VARIADIC                 = 0x00000000'00000080;
const TypeInfoFlags TYPEINFO_STRUCT_HAS_INIT_VALUES   = 0x00000000'00000100;
const TypeInfoFlags TYPEINFO_STRUCT_ALL_UNINITIALIZED = 0x00000000'00000200;
const TypeInfoFlags TYPEINFO_STRUCT_NO_POST_COPY      = 0x00000000'00000400;
const TypeInfoFlags TYPEINFO_STRUCT_NO_POST_MOVE      = 0x00000000'00000800;
const TypeInfoFlags TYPEINFO_STRUCT_NO_DROP           = 0x00000000'00001000;
const TypeInfoFlags TYPEINFO_GENERIC                  = 0x00000000'00002000;
const TypeInfoFlags TYPEINFO_POINTER_MOVE_REF         = 0x00000000'00004000;
const TypeInfoFlags TYPEINFO_UNTYPED_INTEGER          = 0x00000000'00008000;
const TypeInfoFlags TYPEINFO_UNTYPED_FLOAT            = 0x00000000'00010000;
const TypeInfoFlags TYPEINFO_DEFINED_VALUE            = 0x00000000'00020000;
const TypeInfoFlags TYPEINFO_AUTO_CAST                = 0x00000000'00040000;
const TypeInfoFlags TYPEINFO_TYPED_VARIADIC           = 0x00000000'00080000;
const TypeInfoFlags TYPEINFO_STRUCT_TYPEINFO          = 0x00000000'00100000;
const TypeInfoFlags TYPEINFO_STRUCT_IS_TUPLE          = 0x00000000'00200000;
const TypeInfoFlags TYPEINFO_ENUM_FLAGS               = 0x00000000'00400000;
const TypeInfoFlags TYPEINFO_SPREAD                   = 0x00000000'00800000;
const TypeInfoFlags TYPEINFO_UNDEFINED                = 0x00000000'01000000;
const TypeInfoFlags TYPEINFO_ENUM_INDEX               = 0x00000000'02000000;
const TypeInfoFlags TYPEINFO_STRICT                   = 0x00000000'04000000;
const TypeInfoFlags TYPEINFO_CONST_ALIAS              = 0x00000000'08000000;
const TypeInfoFlags TYPEINFO_HAS_USING                = 0x00000000'10000000;
const TypeInfoFlags TYPEINFO_FUNC_IS_ATTR             = 0x00000000'20000000;
const TypeInfoFlags TYPEINFO_FROM_GENERIC             = 0x00000000'40000000;
const TypeInfoFlags TYPEINFO_STRUCT_NO_COPY           = 0x00000000'80000000;
const TypeInfoFlags TYPEINFO_CAN_THROW                = 0x00000001'00000000;
const TypeInfoFlags TYPEINFO_GENERIC_COUNT            = 0x00000002'00000000;
const TypeInfoFlags TYPEINFO_POINTER_ACCEPT_MOVE_REF  = 0x00000004'00000000;
const TypeInfoFlags TYPEINFO_C_STRING                 = 0x00000008'00000000;
const TypeInfoFlags TYPEINFO_C_VARIADIC               = 0x00000010'00000000;
const TypeInfoFlags TYPEINFO_GENERATED_TUPLE          = 0x00000020'00000000;
const TypeInfoFlags TYPEINFO_CLOSURE                  = 0x00000040'00000000;
const TypeInfoFlags TYPEINFO_INCOMPLETE               = 0x00000080'00000000;
const TypeInfoFlags TYPEINFO_STRUCT_IS_ITABLE         = 0x00000100'00000000;
const TypeInfoFlags TYPEINFO_CAN_PROMOTE_816          = 0x00000200'00000000;
const TypeInfoFlags TYPEINFO_POINTER_ARITHMETIC       = 0x00000400'00000000;
const TypeInfoFlags TYPEINFO_LIST_ARRAY_ARRAY         = 0x00000800'00000000;
const TypeInfoFlags TYPEINFO_POINTER_REF              = 0x00001000'00000000;
const TypeInfoFlags TYPEINFO_POINTER_AUTO_REF         = 0x00002000'00000000;
const TypeInfoFlags TYPEINFO_STRUCT_NO_INIT           = 0x00004000'00000000;
const TypeInfoFlags TYPEINFO_SPEC_OP_GENERATED        = 0x00008000'00000000;
const TypeInfoFlags TYPEINFO_STRUCT_EMPTY             = 0x00010000'00000000;
const TypeInfoFlags TYPEINFO_CHARACTER                = 0x00020000'00000000;
const TypeInfoFlags TYPEINFO_ENUM_HAS_USING           = 0x00040000'00000000;
const TypeInfoFlags TYPEINFO_GHOST_TUPLE              = 0x00080000'00000000;
const TypeInfoFlags TYPEINFO_GENERATED_OP_EQUALS      = 0x00100000'00000000;
...
struct TypeInfoNative final : TypeInfo
{
    ...
    TypeInfoNative(NativeTypeKind type, const char* ptrName, int sof, TypeInfoFlags fl)
    {
        ...
        nativeType = type;
        name.setView(ptrName, static_cast<int>(strlen(ptrName)));
        sizeOf       = sof;
        flags        = fl;
        valueInteger = 0;
    }
