...
bool ByteCodeOptimizer::optimizePassCheckStack(ByteCodeOptContext* context)
{
...
{
#if 0
    if (context->bc->name != "__compiler4169.toto")
        return true;
    context->bc->print();
#endif
    ...
    SWAG_CHECK(optimizePassCheckStack(context));
