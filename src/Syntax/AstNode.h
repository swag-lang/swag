...
constexpr CollectedScopeFlags COLLECTED_SCOPE_CONTEXT_CALL = 0x00000010;
...
struct AstIdentifier : AstNode
{
    ...
    static constexpr SpecFlags SPEC_FLAG_TOP_LEVEL           = 0x0040;
...
struct AstFuncDecl : AstNode
{
    ...
    static constexpr SpecFlags SPEC_FLAG_IMPL                 = 0x2000;
    static constexpr SpecFlags SPEC_FLAG_DEFAULT_IMPL         = 0x4000;
...
{
    static constexpr SpecFlags SPEC_FLAG_COMPILER_LITERAL = 0x0001;

    AstNode* clone(CloneContext& context);

    Register    literalValue;
    LiteralType literalType;
    TokenId     compilerTokenId;
};
