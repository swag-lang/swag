...
TypeInfo* Generic::doTypeSubstitution(MapUtf8<TypeInfo*>& replaceTypes, TypeInfo* typeInfo)
{
    if (!typeInfo)
        return nullptr;
...
Job* Generic::end(SemanticContext* context, Job* job, SymbolName* symbol, AstNode* newNode, bool waitSymbol, MapUtf8<TypeInfo*>& replaceTypes)
{
