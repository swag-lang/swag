...
void CommandLineParser::setup(CommandLine* cmdLine)
{
    ...
    addArg("bu cl sc", "--cfg-optim-bc", nullptr, CommandLineType::EnumString, &cmdLine->buildCfgOptimBC, "O0|O1|O2|O3|default", "bytecode optimization level");
    addArg("bu cl sc", "--cfg-optim-backend", nullptr, CommandLineType::EnumString, &cmdLine->buildCfgOptim, "O0|O1|O2|O3|Os|Oz|default", "optimize output for speed and/or size");
    ...
    addArg("bu sc ru te", "--profile-children", nullptr, CommandLineType::Int, &cmdLine->profileChildsLevel, nullptr, "[stats] display a given amount of sub-functions level");
#endif
