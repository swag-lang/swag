...
#ifdef SWAG_HAS_RACE_CONDITION_SEGMENT
#define SWAG_RACE_CONDITION_WRITE_SEGMENT(__x)    SWAG_RACE_CONDITION_ON_WRITE(__x)
#define SWAG_RACE_CONDITION_READ_SEGMENT(__x)     SWAG_RACE_CONDITION_ON_READ(__x)
#define SWAG_RACE_CONDITION_INSTANCE_SEGMENT(__x) SWAG_RACE_CONDITION_ON_INSTANCE(__x)
#else
#define SWAG_RACE_CONDITION_WRITE_SEGMENT(__x)    SWAG_RACE_CONDITION_OFF_WRITE(__x)
#define SWAG_RACE_CONDITION_READ_SEGMENT(__x)     SWAG_RACE_CONDITION_OFF_READ(__x)
#define SWAG_RACE_CONDITION_INSTANCE_SEGMENT(__x) SWAG_RACE_CONDITION_OFF_INSTANCE(__x)
#endif
