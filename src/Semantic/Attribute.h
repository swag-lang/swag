...
constexpr AttributeFlagsV ATTRIBUTE_MATCH_VALIDIF_FUNC  = 0x0000000000001000;
...
constexpr AttributeFlagsV ATTRIBUTE_MATCH_VALIDIF_OFF   = 0x0000000100000000;
...
constexpr AttributeFlagsV ATTRIBUTE_MATCH_VALIDIFX_FUNC = 0x0000800000000000;
...
constexpr AttributeFlagsV ATTRIBUTE_OVERLOAD            = 0x0020000000000000;
...
constexpr AttributeFlagsV ATTRIBUTE_MATCH_MASK    = ATTRIBUTE_MATCH_VALIDIF_OFF | ATTRIBUTE_MATCH_SELF_OFF;
