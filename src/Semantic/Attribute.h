...
constexpr AttributeFlagsV ATTRIBUTE_MATCH_ME_OFF        = 0x0000000200000000;
...
constexpr AttributeFlagsV ATTRIBUTE_PRINT_BC_GEN        = 0x0004000000000000;
...
constexpr AttributeFlagsV ATTRIBUTE_PLACEHOLDER         = 0x0080000000000000;
constexpr AttributeFlagsV ATTRIBUTE_PRINT_ASM           = 0x0100000000000000;
constexpr AttributeFlagsV ATTRIBUTE_FIELD_PRIVATE       = 0x0200000000000000;
...
constexpr AttributeFlagsV ATTRIBUTE_ACCESS_MASK   = ATTRIBUTE_PUBLIC | ATTRIBUTE_INTERNAL | ATTRIBUTE_PRIVATE | ATTRIBUTE_FIELD_PRIVATE;
constexpr AttributeFlagsV ATTRIBUTE_MATCH_MASK    = ATTRIBUTE_MATCH_WHERE_OFF | ATTRIBUTE_MATCH_ME_OFF;
