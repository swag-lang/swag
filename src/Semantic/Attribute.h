...
constexpr AttributeFlagsV ATTRIBUTE_FIELD_INTERNAL      = 0x0200000000000000;
...
constexpr AttributeFlagsV ATTRIBUTE_ACCESS_MASK   = ATTRIBUTE_PUBLIC | ATTRIBUTE_INTERNAL | ATTRIBUTE_PRIVATE | ATTRIBUTE_FIELD_INTERNAL;
