...
struct TypeManager
{
    ...
    static bool safetyComputedValue(SemanticContext* context, const TypeInfo* toType, const TypeInfo* fromType, AstNode* fromNode, CastFlags castFlags);
    static void getCastErrorMsg(Utf8& msg, Utf8& note, Vector<Utf8>& remarks, TypeInfo* toType, TypeInfo* fromType, CastFlags castFlags, CastErrorType castError, Vector<const Diagnostic*>& notes);
