        ...
        {
            {
                ...
                PushErrCxtStep ec(context, declParam, ErrCxtStepKind::Note, [declParam] { return form("this is the corresponding parameter [[%s]]", declParam->token.cstr()); });
...
bool Semantic::setSymbolMatchFunc(SemanticContext* context, const OneMatch& oneMatch, AstIdentifier* identifier, const SymbolOverload* overload)
{
    ...
    SWAG_CHECK(mustInline(context, identifier, overload, canInline));
    YIELD();
