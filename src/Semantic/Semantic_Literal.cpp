    ...
    switch (literalType)
    {
        ...
        case LiteralType::TypeCharacterEscape:
        {
            ...
            else
            {
                switch (typeSuffix->nativeType)
                {
                    ...
                    default:
                        return formErr(Err0150, typeSuffix->getDisplayNameC());
                }
            }
        ...
        case LiteralType::TypeUntypedFloat:
            switch (typeSuffix->nativeType)
            {
                ...
                case NativeTypeKind::F64:
                    ...
                    break;
                default:
                    return formErr(Err0192, typeSuffix->getDisplayNameC());
            }
            break;
        ...
        case LiteralType::TypeUntypedInt:
            switch (typeSuffix->nativeType)
            {
                ...
                default:
                    return formErr(Err0190, computedValue.reg.u64);
            }
...
bool Semantic::resolveLiteral(SemanticContext* context)
{
    ...
    SWAG_VERIFY(suffixType->isNative(), context->report({suffix, formErr(Err0193, suffixType->getDisplayNameC())}));
    ...
    switch (suffixType->nativeType)
    {
        ...
        case NativeTypeKind::F64:
            break;
        default:
            return context->report({suffix, formErr(Err0193, suffix->typeInfo->getDisplayNameC())});
    }
