...
constexpr OverloadFlags OVERLOAD_VAR_HAS_ASSIGN   = 0x00000020;
constexpr OverloadFlags OVERLOAD_VAR_INLINE       = 0x00000040;
constexpr OverloadFlags OVERLOAD_VAR_IS_LET       = 0x00000080;
constexpr OverloadFlags OVERLOAD_VAR_LOCAL        = 0x00000100;
constexpr OverloadFlags OVERLOAD_VAR_STRUCT       = 0x00000200;
constexpr OverloadFlags OVERLOAD_VAR_TLS          = 0x00000400;
constexpr OverloadFlags OVERLOAD_CONSTANT         = 0x00000800;
constexpr OverloadFlags OVERLOAD_CONST_VALUE      = 0x00001000;
constexpr OverloadFlags OVERLOAD_CONST_ASSIGN     = 0x00002000;
constexpr OverloadFlags OVERLOAD_EMITTED          = 0x00004000;
constexpr OverloadFlags OVERLOAD_FROM_ALIAS       = 0x00008000;
constexpr OverloadFlags OVERLOAD_GENERIC          = 0x00010000;
constexpr OverloadFlags OVERLOAD_HAS_AFFECT       = 0x00020000;
constexpr OverloadFlags OVERLOAD_HAS_MAKE_POINTER = 0x00040000;
constexpr OverloadFlags OVERLOAD_IMPL_IN_STRUCT   = 0x00080000;
constexpr OverloadFlags OVERLOAD_INCOMPLETE       = 0x00100000;
constexpr OverloadFlags OVERLOAD_REG_HINT         = 0x00200000;
constexpr OverloadFlags OVERLOAD_REG_INLINE       = 0x00400000;
constexpr OverloadFlags OVERLOAD_REG_PERSISTENT   = 0x00800000;
constexpr OverloadFlags OVERLOAD_NOT_INITIALIZED  = 0x01000000;
constexpr OverloadFlags OVERLOAD_RETVAL           = 0x02000000;
constexpr OverloadFlags OVERLOAD_STRUCT_AFFECT    = 0x04000000;
constexpr OverloadFlags OVERLOAD_TUPLE_UNPACK     = 0x08000000;
constexpr OverloadFlags OVERLOAD_UNDEFINED        = 0x10000000;
constexpr OverloadFlags OVERLOAD_USED             = 0x20000000;
