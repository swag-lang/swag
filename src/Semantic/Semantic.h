...
namespace Semantic
{
    ...
    bool           findFuncCallInContext(SemanticContext* context, const AstNode* node, VectorNative<SymbolOverload*>& result, AstFuncCallParam** callParam);
    ...
    bool           copyStructSegSeg(SemanticContext* context, DataSegment* dstSegment, uint32_t dstOffset, DataSegment* srcSegment, uint32_t srcOffset, TypeInfo* typeInfo);
    ...
    void           inheritAttributesFrom(AstNode* child, const AttributeFlags& attributeFlags, const SafetyWhatFlags* safetyOn, const SafetyWhatFlags* safetyOff);
    ...
    AstNode* prepareParamsForCall(AstNode* allParams, AstNode& tempParams, bool considerInverseSwap = false, uint32_t numCallParams = UINT32_MAX);
    ...
    bool resolveCompilerInject(SemanticContext* context);
    ...
    bool resolveCompilerNameOf(SemanticContext* context);
    bool resolveCompilerStringOf(SemanticContext* context);
    bool resolveCompilerTag(SemanticContext* context);
    bool resolveCompilerDeclType(SemanticContext* context);
    bool resolveCompilerRunes(SemanticContext* context);
    bool resolveCompilerIsConstExpr(const SemanticContext* context);
    bool resolveCompilerSizeOf(SemanticContext* context);
    bool resolveCompilerAlignOf(SemanticContext* context);
    bool resolveCompilerOffsetOf(SemanticContext* context);
    bool resolveCompilerScopeName(SemanticContext* context);
    ...
    bool resolveCompilerTypeOf(SemanticContext* context);
