...
void LanguageSpec::setupKeywords()
{
    ...
    keywords.add("@nameof", {TokenId::IntrinsicNameOf, LiteralType::TT_MAX});
    ...
    keywords.add("@cvaend", {TokenId::IntrinsicCVaEnd, LiteralType::TT_MAX});
    keywords.add("@cvaarg", {TokenId::IntrinsicCVaArg, LiteralType::TT_MAX});
