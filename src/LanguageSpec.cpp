...
void LanguageSpec::setup()
{
    ...
    keywords["#placeholder"]    = TokenId::CompilerPlaceHolder;
    ...
    keywords["protected"]   = TokenId::KwdProtected;
    ...
    keywords["bitcast"]     = TokenId::KwdBitCast;
    ...
    keywords["@reloc"]       = TokenId::IntrinsicReloc;
    ...
    keywords["@panic"]       = TokenId::IntrinsicPanic;
    keywords["@errormsg"]    = TokenId::IntrinsicErrorMsg;
