...
void initErrors()
{
    ...
    SWAG_ERROR(Err0530, "missing return value                              $ expected all control paths of %s to return a value");
    SWAG_ERROR(Err0531, "missing return value                              $ expected the %s to have a [[return]] in its body because it returns type [[%s]]");
    ...
    SWAG_ERROR(Err0546, "not enough arguments                              $ expected the %s to have arguments");
    ...
    SWAG_ERROR(Err0560, "out of range callback parameters                  $ can't make a callback of a function with more than [[%d]] parameters (got [[%d]])");
