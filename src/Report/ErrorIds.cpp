...
void initErrors()
{
    ...
    SWAG_ERROR(Err0390, "misplaced match variable                          $ cannot declare a match variable in a [[switch]] expression of type [[%s]]                                                                $ the only supported [[switch]] type is [[interface]]");
