...
void initErrors()
{
    ...
    SWAG_ERROR(Err0033, "type [[%s]] cannot be converted to a compile-time constant                                             $ ");
    ...
    SWAG_ERROR(Err0443, "assignment or [[:]] missing for type, found $$TKN$$                                                      $ ");
    ...
    SWAG_ERROR(Err0446, "line break or [[;]] missing after %s, found $$TKN$$                                                      $ hint: add a line break or separate with [[;]]");
    ...
    SWAG_ERROR(Err0466, "assignment or [[:]] missing for type, found $$TKN$$                                                      $ ");
