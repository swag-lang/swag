...
void initErrors()
{
    ...
    SWAG_ERROR(Err0149, "cannot take address                                                                                    $ note: [[let]] variable has no address $ hint: use [[var]] for a mutable variable");
    ...
    SWAG_ERROR(Err0235, "invalid $$TKN$$ inside [[#inject]] replacement block                                                   $ note: [[#inject]] only accepts [[break]] or [[continue]] as valid keywords");
    SWAG_ERROR(Err0236, "invalid Unicode code point [[0x%x]]                                                                    $ ");
    SWAG_ERROR(Err0237, "invalid [[#[Swag.Align]]] value                                                                        $ note: not a power of two; found [[%d]]");
    SWAG_ERROR(Err0238, "invalid [[#[Swag.CalleeReturn]]] on %s                                                                 $ ");
    SWAG_ERROR(Err0239, "invalid [[#[Swag.CalleeReturn]]] on [[%s]]                                                             $ note: requires [[#[Swag.Macro]]] or [[#[Swag.Mixin]]] attribute");
    SWAG_ERROR(Err0240, "invalid [[#[Swag.Complete]]] on [[%s]]                                                                 $ note: only valid on [[opAffect]] or [[opAffectLiteral]]");
    SWAG_ERROR(Err0241, "invalid [[#[Swag.Complete]]] without [[switch]] expression                                             $ ");
    SWAG_ERROR(Err0242, "invalid [[#[Swag.Discardable]]] on [[%s]]                                                              $ note: only valid on lambda variables");
    SWAG_ERROR(Err0243, "invalid [[#[Swag.Foreign]]] module name                                                                $ note: [[.]] not allowed $ note: module names cannot contain file extensions");
    SWAG_ERROR(Err0244, "invalid [[#[Swag.Implicit]]] on [[%s]]                                                                 $ note: only valid on [[opAffect]], [[opAffectLiteral]], or [[opCast]]");
    SWAG_ERROR(Err0245, "invalid [[#[Swag.Implicit]]] on generic %s                                                             $ ");
    SWAG_ERROR(Err0246, "invalid [[#[Swag.Inline]]] on %s                                                                       $ ");
    SWAG_ERROR(Err0247, "invalid [[#[Swag.Macro]]] on %s                                                                        $ ");
    SWAG_ERROR(Err0248, "invalid [[#[Swag.Mixin]]] on %s                                                                        $ ");
    SWAG_ERROR(Err0249, "invalid [[#[Swag.NotGeneric]]] on %s                                                                   $ ");
    SWAG_ERROR(Err0250, "invalid [[#[Swag.Offset]]] on interface members                                                        $ ");
    SWAG_ERROR(Err0251, "invalid [[#[Swag.Pack]]] value                                                                         $ note: found [[%d]] (not 0 or power of two)");
    SWAG_ERROR(Err0252, "invalid [[#alias]] context                                                                             $ note: allowed only in [[#[Swag.Macro]]] or [[#[Swag.Mixin]]]");
    SWAG_ERROR(Err0253, "invalid [[#alias]] sequence in [[%s]]                                                                  $ note: [[#alias%u]] is missing in the sequence");
    SWAG_ERROR(Err0254, "invalid [[#alias]] variable name [[%s]]                                                                $ hint: use [[#alias0]], [[#alias1]], and so on");
    SWAG_ERROR(Err0255, "invalid [[#ast]] expression return type                                                                $ note: expected [[string]], found [[%s]]");
    SWAG_ERROR(Err0256, "invalid [[#code]] type usage                                                                           $ note: [[#code]] is only valid in a [[#[Swag.Macro]]] or [[#[Swag.Mixin]]] function");
    SWAG_ERROR(Err0257, "invalid [[#dependencies]] directive placement                                                          $ note: must be at file level");
    SWAG_ERROR(Err0258, "invalid [[#elif]]                                                                                      $ note: without preceding [[#if]]");
    SWAG_ERROR(Err0259, "invalid [[#else]]                                                                                      $ note: without preceding [[#if]] or [[#elif]]");
    SWAG_ERROR(Err0260, "invalid [[#gettag]] last argument                                                                      $ note: must be constant, got [[%s]]");
    SWAG_ERROR(Err0261, "invalid [[#global]] instruction [[%s]]                                                                 $ ");
    SWAG_ERROR(Err0262, "invalid [[#global]] placement                                                                          $ note: must appear at top of file");
    SWAG_ERROR(Err0263, "invalid [[#import]] location format                                                                    $ hint: use [[location=\"mode@accesspath\"]], where mode is [[swag]] or [[disk]]");
    SWAG_ERROR(Err0264, "invalid [[#import]] version format                                                                     $ ");
    SWAG_ERROR(Err0265, "invalid [[#include]] argument type [[%s]]                                                              $ note: [[#include]] requires a [[string]] argument");
    SWAG_ERROR(Err0266, "invalid [[#include]] filename                                                                          $ note: not a compile-time constant");
    SWAG_ERROR(Err0267, "invalid [[#inject]] argument type [[%s]]                                                               $ note: [[#inject]] requires a [[code]] argument");
    SWAG_ERROR(Err0268, "invalid [[#message]] argument type [[%s]]                                                              $ note: [[#message]] requires a [[Swag.CompilerMsgMask]] argument");
    SWAG_ERROR(Err0269, "invalid [[#runes]] argument type [[%s]]                                                                $ note: [[#runes]] requires a [[string]] argument");
    SWAG_ERROR(Err0270, "invalid [[#scope]] name                                                                                $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0271, "invalid [[#sizeof]]                                                                                    $ note: applied to generic expression");
    SWAG_ERROR(Err0272, "invalid [[#uniq]] context                                                                              $ note: allowed only in [[#[Swag.Mixin]]]");
    SWAG_ERROR(Err0273, "invalid [[#uniq]] variable name [[%s]]                                                                 $ hint: use [[#uniq0]], [[#uniq1]], and so on");
    SWAG_ERROR(Err0274, "invalid [[#up]] argument                                                                               $ note: expected an integer literal, found $$TKN$$");
    SWAG_ERROR(Err0275, "invalid [[#up]] count                                                                                  $ note: must be an untyped integer, got [[%s]]");
    SWAG_ERROR(Err0276, "invalid [[%s]] argument type [[%s]]                                                                    $ note: [[%s]] requires a [[%s]] argument");
    SWAG_ERROR(Err0277, "invalid [[%s]] assignment                                                                              $ note: expects [[%s]], found [[%s]]");
    SWAG_ERROR(Err0278, "invalid [[%s]] compiler instruction                                                                    $ ");
    SWAG_ERROR(Err0279, "invalid [[%s]] count type [[%s]]                                                                       $ note: [[%s]] count must be an integer");
    SWAG_ERROR(Err0280, "invalid [[%s]] declaration                                                                             $ note: [[%s]] cannot be declared outside a corresponding [[impl]] block");
    SWAG_ERROR(Err0281, "invalid [[%s]] first argument                                                                          $ note: [[%s]] requires a mutable pointer, found [[%s]]");
    SWAG_ERROR(Err0282, "invalid [[%s]] first argument                                                                          $ note: [[%s]] requires a mutable type, found [[%s]]");
    SWAG_ERROR(Err0283, "invalid [[%s]] first argument                                                                          $ note: [[%s]] requires a mutable variable, found [[%s]]");
    SWAG_ERROR(Err0284, "invalid [[%s]] first argument type [[%s]]                                                              $ note: [[%s]] requires a block pointer as its first argument");
    SWAG_ERROR(Err0285, "invalid [[%s]] first argument type [[%s]]                                                              $ note: [[%s]] requires a block pointer when the element count exceeds one");
    SWAG_ERROR(Err0286, "invalid [[%s]] first argument type [[%s]]                                                              $ note: [[%s]] requires a pointer as its first argument");
    SWAG_ERROR(Err0287, "invalid [[%s]] in this context                                                                         $ ");
    SWAG_ERROR(Err0288, "invalid [[%s]] inside [[#global]] block                                                                $ note: this requires [[Swag.AttributeUsage.File]]");
    SWAG_ERROR(Err0289, "invalid [[%s]] nested inside [[%s]]                                                                    $ hint: use only one [[try]], [[catch]], or [[assume]] block");
    SWAG_ERROR(Err0290, "invalid [[%s]] on %s                                                                                   $ ");
    SWAG_ERROR(Err0291, "invalid [[%s]] return type [[%s]]                                                                      $ note: [[%s]] requires a [[%s]] return type");
    SWAG_ERROR(Err0292, "invalid [['=']] in expression                                                                          $ hint: use [['==']] for comparison");
    SWAG_ERROR(Err0293, "invalid [['==']]                                                                                       $ hint: use [['=']] for assignment");
    SWAG_ERROR(Err0294, "invalid [[@countof]] argument type [[%s]]                                                              $ ");
    SWAG_ERROR(Err0295, "invalid [[@countof]] argument type [[%s]]                                                              $ note: [[@countof]] requires an integer argument");
    SWAG_ERROR(Err0296, "invalid [[@countof]] value                                                                             $ note: non-positive [[%lld]]");
    SWAG_ERROR(Err0297, "invalid [[@countof]] value                                                                             $ note: non-positive [[%d]]");
    SWAG_ERROR(Err0298, "invalid [[@cvastart]] argument type [[%s]]                                                             $ note: [[@cvastart]] requires a [[%s]] argument");
    SWAG_ERROR(Err0299, "invalid [[@dataof]] argument type [[%s]]                                                               $ ");
    SWAG_ERROR(Err0300, "invalid [[@kindof]] target type [[%s]]                                                                 $ note: [[@kindof]] is only allowed on [[any]] or interface types");
    SWAG_ERROR(Err0301, "invalid [[@mkany]] second argument type [[%s]]                                                         $ note: [[@mkany]] requires a [[typeinfo]] as its second argument");
    SWAG_ERROR(Err0302, "invalid [[@mkcallback]] argument type [[%s]]                                                           $ note: [[@mkcallback]] requires a function pointer argument");
    SWAG_ERROR(Err0303, "invalid [[@mkinterface]] first argument type [[%s]]                                                    $ note: [[@mkinterface]] requires a pointer or a struct as its first argument");
    SWAG_ERROR(Err0304, "invalid [[@mkinterface]] second argument type [[%s]]                                                   $ note: [[@mkinterface]] requires a [[typeinfo]] as its second argument");
    SWAG_ERROR(Err0305, "invalid [[@mkinterface]] third argument type [[%s]]                                                    $ note: [[@mkinterface]] requires an interface name as its third argument");
    SWAG_ERROR(Err0306, "invalid [[@mkstring]] first argument type [[%s]]                                                       $ note: [[@mkstring]] requires type [[*u8]] as its first argument");
    SWAG_ERROR(Err0307, "invalid [[@postcopy]] on [[%s]]                                                                        $ note: disallowed by [[#[Swag.NoCopy]]]");
    
    SWAG_ERROR(Err0308, "invalid [[AttributeUsage.Gen]]                                                                         $ note: [[AttributeUsage.Gen]] requires [[AttributeUsage.Struct]] or [[AttributeUsage.Enum]]");
    SWAG_ERROR(Err0309, "invalid [[case]] expression                                                                            $ note: not a compile-time constant $ note: a [[switch]] statement marked with the [[#[Swag.Complete]]] attribute requires constant case values");
    SWAG_ERROR(Err0310, "invalid [[case]] match variable                                                                        $ note: a match variable is only valid for an [[interface]] or an [[any]] $ note: switch expression has type [[%s]]");
    SWAG_ERROR(Err0311, "invalid [[case]] range without a [[switch]] expression                                                 $ note: a [[case]] range requires a [[switch]] expression to compare against");
    SWAG_ERROR(Err0312, "invalid [[const]] placement                                                                            $ note: only allowed after [[mtd]], not [[func]]");
    SWAG_ERROR(Err0313, "invalid [[default]]                                                                                    $ note: [[default]] is invalid for a [[switch]] marked as [[#[Swag.Complete]]]");
    SWAG_ERROR(Err0314, "invalid [[discard]] argument                                                                           $ note: found $$TKN$$");
    SWAG_ERROR(Err0315, "invalid [[discard]] on function returning nothing                                                      $ ");
    SWAG_ERROR(Err0316, "invalid [[do]] before [[{]]                                                                            $ hint: use [[do]] or [[{]], not both");
    SWAG_ERROR(Err0317, "invalid [[elif]]                                                                                       $ note: without preceding [[if]]");
    SWAG_ERROR(Err0318, "invalid [[else]]                                                                                       $ note: without preceding [[if]] or [[#elif]]");
    SWAG_ERROR(Err0319, "invalid [[fallthrough]] in last [[case]]                                                               $ hint: remove it");
    SWAG_ERROR(Err0320, "invalid [[foreach]] specialization                                                                     $ note: [[foreach]] specialization is only valid for [[struct]] visit, found [[%s]]");
    SWAG_ERROR(Err0321, "invalid [[impl]] block generation                                                                      $ note: only allowed in [[#message]] with [[Swag.CompilerMsgMask.AttributeGen]]");
    SWAG_ERROR(Err0322, "invalid [[impl]] block name                                                                            $ note: an [[impl]] block must reference a concrete type, not an alias $ hint: use the original type name instead of the alias");
    SWAG_ERROR(Err0323, "invalid [[impl]] on function outside [[impl for]] block                                                $ ");
    SWAG_ERROR(Err0324, "invalid [[impl]] syntax                                                                                $ note: targets [[%s]], but [[%s]] is [[%s]]");
    SWAG_ERROR(Err0325, "invalid [[impl]] target                                                                                $ note: [[%s]] is [[%s]], not an interface");
    SWAG_ERROR(Err0326, "invalid [[impl]] target                                                                                $ note: [[%s]] is [[%s]], not struct or enum");
    SWAG_ERROR(Err0327, "invalid [[location]] value [[\"%s\"]]                                                                  $ hint: use [[\"swag\"]] or [[\"disk\"]]");
    SWAG_ERROR(Err0328, "invalid [[me]] default value                                                                           $ ");
    SWAG_ERROR(Err0329, "invalid [[moveref]] on compile-time value                                                              $ note: only allowed on pointers or references");
    SWAG_ERROR(Err0330, "invalid [[moveref]] on immutable expression                                                            $ ");
    SWAG_ERROR(Err0331, "invalid [[moveref]] on unsupported type [[%s]]                                                         $ ");
    SWAG_ERROR(Err0332, "invalid [[moveref]] placement                                                                          $ note: must precede function arguments");
    SWAG_ERROR(Err0333, "invalid [[opDrop]] for [[%s]]                                                                          $ note: disallowed by [[#[Swag.ConstExpr]]]");
    SWAG_ERROR(Err0334, "invalid [[opPostCopy]] for [[%s]]                                                                      $ note: disallowed by [[#[Swag.NoCopy]]]");
    SWAG_ERROR(Err0335, "invalid [[opSlice]] return type [[%s]]                                                                 $ note: only [[string]] or [[slice]] return types are supported");
    SWAG_ERROR(Err0336, "invalid [[opVisit]] specialization name [[%s]]                                                         $ note: [[opVisit]] specializations must start with an uppercase letter");
    SWAG_ERROR(Err0337, "invalid [[opVisit]] variant [[%s]]                                                                     $ hint: must use a valid identifier name");
    SWAG_ERROR(Err0338, "invalid [[orelse]] argument type [[%s]]                                                                $ note: [[orelse]] requires a nullable type");
    SWAG_ERROR(Err0339, "invalid [[ref]]                                                                                        $ note: applied to non-pointer or non-reference type [[%s]]");
    SWAG_ERROR(Err0340, "invalid [[return]] after [[=>]]                                                                        $ hint: remove it");
    SWAG_ERROR(Err0341, "invalid [[throw]] in attribute definition                                                              $ note: attributes are not functions; remove it");
    SWAG_ERROR(Err0342, "invalid [[throw]] type [[%s]]                                                                          $ note: only structs or [[@err]] expressions can be thrown");
    SWAG_ERROR(Err0343, "invalid [[throw]]                                                                                      $ note: requires struct or [[@err]] expression");
    SWAG_ERROR(Err0344, "invalid [[using]] at [[%s]] scope                                                                      $ ");
    SWAG_ERROR(Err0345, "invalid [[using]] on interface functions                                                               $ ");
    SWAG_ERROR(Err0346, "invalid [[using]] target type [[%s]]                                                                   $ ");
    SWAG_ERROR(Err0347, "invalid [[using]] target type [[%s]]                                                                   $ note: only valid on a namespace, struct, or enum");
    SWAG_ERROR(Err0348, "invalid [[using]] target type [[%s]]                                                                   $ note: only valid on a pointer to a struct");
    SWAG_ERROR(Err0349, "invalid [[using]]                                                                                      $ note: applied to multiple variables of type [[%s]]");
    SWAG_ERROR(Err0350, "invalid [[var]] in struct declarations                                                                 $ hint: declare as [[fieldName: Type]] instead");
    SWAG_ERROR(Err0351, "invalid [[verify]] on [[%s]]                                                                           $ note: unsupported for [[opDrop]], [[opPostCopy]], and [[opPostMove]]");
    SWAG_ERROR(Err0352, "invalid [[verify]] on structs                                                                          $ hint: use [[where]] instead");
    SWAG_ERROR(Err0353, "invalid [[visit]] specialization name                                                                  $ note: $$TKN$$");
    SWAG_ERROR(Err0354, "invalid [[where]] condition type [[%s]]                                                                $ note: [[where]] requires a boolean expression");
    SWAG_ERROR(Err0355, "invalid [[where]] on [[%s]]                                                                            $ note: unsupported for [[opDrop]], [[opPostCopy]], and [[opPostMove]]");
    SWAG_ERROR(Err0356, "invalid [[where]] without [[switch]] expression                                                        $ ");
    SWAG_ERROR(Err0357, "invalid [[while]] condition                                                                            $ note: always evaluates to [[true]] $ hint: use [[for { ... }]] for an intentional infinite loop");
    SWAG_ERROR(Err0358, "invalid [[with]] expression                                                                            $ ");
    SWAG_ERROR(Err0359, "invalid [[{]] after [[try]], [[assume]], or [[catch]]                                                  $ ");
    SWAG_ERROR(Err0360, "invalid access                                                                                         $ note: compile-time %s [[%s]] accessed from runtime %s");
    SWAG_ERROR(Err0361, "invalid access                                                                                         $ note: compile-time %s accessed from runtime %s");
    SWAG_ERROR(Err0362, "invalid alias name                                                                                     $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0363, "invalid alias name on %s                                                                               $ ");
    SWAG_ERROR(Err0364, "invalid alias target                                                                                   $ note: expected an identifier or a type, found $$TKN$$");
    SWAG_ERROR(Err0365, "invalid argument [[%s]]                                                                                $ note: not a compile-time constant");
    SWAG_ERROR(Err0366, "invalid argument for [[%s]]                                                                            $ note: expects literal but received type [[%s]]");
    SWAG_ERROR(Err0367, "invalid argument name before [[:]]                                                                     $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0368, "invalid array dimension type [[%s]]                                                                    $ note: array dimension must be an integer");
    SWAG_ERROR(Err0369, "invalid array dimension                                                                                $ note: not a compile-time constant");
    SWAG_ERROR(Err0370, "invalid array index type [[%s]]                                                                        $ note: array index must be an integer");
    SWAG_ERROR(Err0371, "invalid assignment of function pointer to constant                                                     $ ");
    SWAG_ERROR(Err0372, "invalid assignment target                                                                              $ note: left expression is not assignable");
    SWAG_ERROR(Err0373, "invalid attribute [[%s]]                                                                               $ note: is %s");
    SWAG_ERROR(Err0374, "invalid attribute in this location                                                                     $ ");
    SWAG_ERROR(Err0375, "invalid attribute name                                                                                 $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0376, "invalid attribute parameter type [[%s]]                                                                $ ");
    SWAG_ERROR(Err0377, "invalid attribute parameter: not a compile-time constant                                               $ ");
    SWAG_ERROR(Err0378, "invalid attribute placement                                                                            $ note: must appear before [[%s]] $ hint: move the attribute before [[%s]]");
    SWAG_ERROR(Err0379, "invalid binary digit $$TKN$$                                                                           $ note: binary literals may only contain [[0]] or [[1]]");
    SWAG_ERROR(Err0380, "invalid binary literal: exceeds 64-bit range                                                           $ ");
    SWAG_ERROR(Err0381, "invalid bit-cast source type [[%s]]                                                                    $ note: only integer, rune, float, or pointer types are allowed");
    SWAG_ERROR(Err0382, "invalid bit-cast target type [[%s]]                                                                    $ note: only integer, rune, or float types are allowed");
    SWAG_ERROR(Err0383, "invalid bitwise inversion [['~']] for type [[%s]]                                                      $ ");
    SWAG_ERROR(Err0384, "invalid bracket closure                                                                                $ note: [[[]]] without matching [[[]");
    SWAG_ERROR(Err0385, "invalid call target [[%s]]                                                                             $ note: is [[%s]], not callable");
    SWAG_ERROR(Err0386, "invalid call to [[%s]] with type [[%s]]                                                                $ note: [[%s]] requires type [[%s]] as its first argument");
    SWAG_ERROR(Err0387, "invalid call                                                                                           $ note: [[%s]] invoked with [[{}]] instead of [[()]]");
    SWAG_ERROR(Err0388, "invalid callable variable [[%s]]                                                                       $ note: is %s");
    SWAG_ERROR(Err0389, "invalid capture of [[%s]]                                                                              $ note: is %s $ note: capturing %s is not allowed");
    SWAG_ERROR(Err0390, "invalid capture                                                                                        $ note: [[%s]] is not plain old data $ note: structs with [[opDrop]], [[opPostCopy]], or [[opPostMove]] cannot be captured");
    SWAG_ERROR(Err0391, "invalid character [['%s']]                                                                             $ ");
    SWAG_ERROR(Err0392, "invalid character literal                                                                              $ note: [['%s']] appears as string, not single character");
    SWAG_ERROR(Err0393, "invalid character                                                                                      $ note: [[0x%x]] exceeds [[u16]] range");
    SWAG_ERROR(Err0394, "invalid character                                                                                      $ note: [[0x%x]] exceeds [[u8]] range");
    SWAG_ERROR(Err0395, "invalid closure outside a function scope                                                               $ note: closure definitions are allowed only within functions");
    SWAG_ERROR(Err0396, "invalid combination                                                                                    $ note: [[%s]] conflicts with [[%s]]");
    SWAG_ERROR(Err0397, "invalid comparison for interface type                                                                  $ note: interfaces can only be compared with [[null]], another interface, or [[typeinfo]], found [[%s]]");
    SWAG_ERROR(Err0398, "invalid comparison for slice type                                                                      $ note: slices can only be compared with [[null]], found [[%s]]");
    SWAG_ERROR(Err0399, "invalid comparison for type [[any]]                                                                    $ note: [[any]] can only be compared with [[null]] or [[typeinfo]], found [[%s]]");
    SWAG_ERROR(Err0400, "invalid compiler pass [[%s]]                                                                           $ ");
    SWAG_ERROR(Err0401, "invalid consecutive identifiers                                                                        $ ");
    SWAG_ERROR(Err0402, "invalid const version of [[%s]]                                                                        $ ");
    SWAG_ERROR(Err0403, "invalid constraint                                                                                     $ note: %s [[%s]] violates [[%s]]");
    SWAG_ERROR(Err0404, "invalid context: [[compileString]] not accessible at this compiler stage                               $ note: meta-programming is not allowed at this compiler stage");
    SWAG_ERROR(Err0405, "invalid declaration: cannot begin with a type                                                          $ note: variable declarations must start with [[var]], [[let]], or [[const]]");
    SWAG_ERROR(Err0406, "invalid direct call to [[opDrop]]                                                                      $ hint: use [[@drop]] instead");
    SWAG_ERROR(Err0407, "invalid direct call to [[opPostCopy]]                                                                  $ hint: use [[@postcopy]] instead");
    SWAG_ERROR(Err0408, "invalid direct call to [[opPostMove]]                                                                  $ hint: use [[@postmove]] instead");
    
    SWAG_ERROR(Err0409, "invalid division                                                                                       $ note: division by [[-1]] causes overflow");
    SWAG_ERROR(Err0410, "invalid division                                                                                       $ note: division by zero");
    SWAG_ERROR(Err0411, "invalid element type [[void]] for static array                                                         $ ");
    SWAG_ERROR(Err0412, "invalid empty statement [[;]]                                                                          $ hint: use [[{}]] instead to create an empty block");
    SWAG_ERROR(Err0413, "invalid enum base type [[cstring]]                                                                     $ hint: use [[string]] instead");
    SWAG_ERROR(Err0414, "invalid enum name                                                                                      $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0415, "invalid enum value                                                                                     $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0416, "invalid enum value [[%s]] for type [[%s]]                                                              $ ");
    SWAG_ERROR(Err0417, "invalid enum value                                                                                     $ note: [[%s]] has the same underlying value as [[%s]]");
    SWAG_ERROR(Err0418, "invalid error propagation                                                                              $ note: escapes from [[defer]] or [[defer<err>]] block");
    SWAG_ERROR(Err0419, "invalid escape code [['%c']]                                                                           $ ");
    SWAG_ERROR(Err0420, "invalid expression                                                                                     $ note: [[%s]] is statement-only");
    SWAG_ERROR(Err0421, "invalid expression                                                                                     $ note: not a compile-time constant");
    SWAG_ERROR(Err0422, "invalid expression                                                                                     $ note: replaced by type");
    SWAG_ERROR(Err0423, "invalid field name [[%s]]                                                                              $ note: reserved by the language $ note: names beginning with [[item]] are reserved");
    SWAG_ERROR(Err0424, "invalid file encoding                                                                                  $ note: supported encodings are [[ASCII]], [[UTF-8]], or [[UTF-8-BOM]]");
    SWAG_ERROR(Err0425, "invalid first argument of [[%s]]                                                                       $ note: expected %s [[%s]] as the first argument");
    SWAG_ERROR(Err0426, "invalid first argument to [[%s]]                                                                       $ note: requires [[variable]] when the second [[@init]] argument is omitted");
    SWAG_ERROR(Err0427, "invalid first parameter [[%s]]; expected [[me]]                                                        $ hint: use [[mtd]] instead of [[func]] for interface methods");
    SWAG_ERROR(Err0428, "invalid first parameter type for [[%s]]                                                                $ note: expected [[%s]], got [[%s]]");
    SWAG_ERROR(Err0429, "invalid function declaration placement                                                                 $ note: a function cannot be declared directly inside a [[struct]] $ hint: move the declaration inside an [[impl]] block instead");
    SWAG_ERROR(Err0430, "invalid function name [[%s]]                                                                           $ note: reserved by the compiler");
    SWAG_ERROR(Err0431, "invalid function return type [[%s]]                                                                    $ ");
    SWAG_ERROR(Err0432, "invalid generic argument                                                                               $ note: %s ([[%s]]) $ hint: generic arguments must be literals or types");
    SWAG_ERROR(Err0433, "invalid generic arguments                                                                              $ note: %s [[%s]] is not generic and cannot be specialized");
    SWAG_ERROR(Err0434, "invalid generic type                                                                                   $ note: type starting with [[:]] not allowed");
    SWAG_ERROR(Err0435, "invalid hexadecimal digit $$TKN$$                                                                      $ note: hexadecimal digits must be [[0-9]], [[A-F]], or [[a-f]]");
    SWAG_ERROR(Err0436, "invalid hexadecimal literal: exceeds 64-bit range                                                      $ ");
    SWAG_ERROR(Err0437, "invalid identifier [[%s]] at file level                                                                $ note: only mixin function calls are allowed at the top level");
    SWAG_ERROR(Err0438, "invalid identifier [[%s]]                                                                              $ note: uses reserved [[__]] prefix $ note: the [[__]] prefix is reserved for compiler use");
    SWAG_ERROR(Err0439, "invalid identifier [[_]]                                                                               $ note: reserved by the compiler");
    SWAG_ERROR(Err0440, "invalid index operation on [[%s]]                                                                      $ note: pointer arithmetic disallowed on [[%s]]");
    SWAG_ERROR(Err0441, "invalid initialization count for type [[%s]]                                                           $ note: expected [[1]] value, found [[%d]]");
    SWAG_ERROR(Err0442, "invalid initialization                                                                                 $ note: not a compile-time constant");
    SWAG_ERROR(Err0443, "invalid initialization                                                                                 $ note: not a compile-time constant $ hint: add the [[#[Swag.ConstExpr]]] attribute to [[opAffect]] to allow this");
    SWAG_ERROR(Err0444, "invalid input                                                                                          $ note: expected [[%s]], found [[%s]]");
    SWAG_ERROR(Err0445, "invalid instruction modifier [[%s]] for [[%s]]                                                         $ ");
    SWAG_ERROR(Err0446, "invalid intrinsic [[%s]]                                                                               $ ");
    SWAG_ERROR(Err0447, "invalid lambda parameters default values                                                               $ note: the parameters of a lambda cannot have default values");
    SWAG_ERROR(Err0448, "invalid literal suffix [[%s]]                                                                          $ ");
    SWAG_ERROR(Err0449, "invalid literal suffix [[%s]] for float literals                                                       $ note: only [[f32]] and [[f64]] suffixes are allowed");
    SWAG_ERROR(Err0450, "invalid literal suffix [[%s]] for this literal                                                         $ note: suffixes are only valid for struct conversions");
    SWAG_ERROR(Err0451, "invalid literal suffix for [[%s]]                                                                      $ note: [[%s]] $ note: suffix must correspond to a valid type");
    SWAG_ERROR(Err0452, "invalid logical operator                                                                               $ note: expected [[%s]] but found [[%s]]");
    SWAG_ERROR(Err0453, "invalid match variable                                                                                 $ note: used with multiple [[case]] values $ hint: each [[case]] must have exactly one value");
    SWAG_ERROR(Err0454, "invalid match variable                                                                                 $ note: used without [[switch]] expression");
    SWAG_ERROR(Err0455, "invalid member in interface                                                                            $ note: [[%s]]; requires [[func]] or [[mtd]] $ hint: declare interface functions with [[func]] or [[mtd]]");
    SWAG_ERROR(Err0456, "invalid message [[%s]]                                                                                 $ note: not a compile-time constant");
    SWAG_ERROR(Err0457, "invalid move reference                                                                                 $ note: a move reference [[&&]] is only valid for function parameters");
    SWAG_ERROR(Err0458, "invalid namespace name [[%s]]                                                                          $ note: reserved");
    SWAG_ERROR(Err0459, "invalid negation                                                                                       $ note: [[%lld]] exceeds [[s64]]; [[%llu]] too large");
    SWAG_ERROR(Err0460, "invalid negation                                                                                       $ note: [[%d]] exceeds [[%s]] range; [[%u]] too large");
    SWAG_ERROR(Err0461, "invalid number of [[foreach]] alias names                                                              $ note: [[foreach]] allows a maximum of [[2]] alias names, got [[%u]]  $ note: valid forms are [[foreach value in expr]] or [[foreach value, index in expr]]");
    SWAG_ERROR(Err0462, "invalid number prefix [[0]]$$TKN$$                                                                     $ note: valid numeric prefixes are [[0x]] for hexadecimal or [[0b]] for binary");
    SWAG_ERROR(Err0463, "invalid numeric literal syntax                                                                         $ note: a [['_']] cannot end the number");
    SWAG_ERROR(Err0464, "invalid numeric literal syntax                                                                         $ note: consecutive [['__']] are not permitted in numeric literals $ hint: remove extra underscores or use a single [[_]] for digit grouping");
    SWAG_ERROR(Err0465, "invalid numeric literal syntax                                                                         $ note: the exponent part cannot start with [['_']]");
    SWAG_ERROR(Err0466, "invalid numeric literal syntax                                                                         $ note: the fractional part cannot start with [['_']]");
    SWAG_ERROR(Err0467, "invalid numeric literal                                                                                $ note: exceeds 64-bit range");
    SWAG_ERROR(Err0468, "invalid operation [['%s']] on [[null]] value                                                           $ ");
    SWAG_ERROR(Err0469, "invalid operation [['%s']]                                                                             $ note: left enum [[%s]] not marked [[#[Swag.EnumFlags]]] $ hint: add the [[#[Swag.EnumFlags]]] attribute to the left enum");
    SWAG_ERROR(Err0470, "invalid operation [['%s']]                                                                             $ note: right enum [[%s]] not marked [[#[Swag.EnumFlags]]] $ hint: add the [[#[Swag.EnumFlags]]] attribute to the right enum");
    SWAG_ERROR(Err0471, "invalid operation on [[%s]]                                                                            $ note: not a compile-time constant $ hint: add the [[#[Swag.ConstExpr]]] attribute to the struct to allow this");
    SWAG_ERROR(Err0472, "invalid operator [['%s']] for [[%s]] in [[%s]]                                                         $ ");
    SWAG_ERROR(Err0473, "invalid operator [['%s']] for left operand type [[%s]]                                                 $ ");
    SWAG_ERROR(Err0474, "invalid operator [['%s']] for right operand type [[%s]]                                                $ ");
    SWAG_ERROR(Err0475, "invalid operator [['%s']] for tuple types                                                              $ ");
    SWAG_ERROR(Err0476, "invalid operator [['%s']] for type [[%s]]                                                              $ ");
    SWAG_ERROR(Err0477, "invalid parameter [[%s]] of type [[%s]]                                                                $ note: not a compile-time constant");
    SWAG_ERROR(Err0478, "invalid parameter for [[%s]]                                                                           $ note: requires [[bool]], got [[%s]]");
    SWAG_ERROR(Err0479, "invalid parameter for [[%s]]                                                                           $ note: requires [[string]], got [[%s]]");
    SWAG_ERROR(Err0480, "invalid parameter name                                                                                 $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0481, "invalid pointer arithmetic                                                                             $ ");
    SWAG_ERROR(Err0482, "invalid pointer arithmetic on [[void*]]                                                                $ note: [[void]] has no size");
    SWAG_ERROR(Err0483, "invalid pointer arithmetic                                                                             $ note: requires integer, got [[%s]]");
    SWAG_ERROR(Err0484, "invalid pointer slicing: type not supported                                                            $ ");
    SWAG_ERROR(Err0485, "invalid range expression                                                                               $ note: the lower bound [[%llu]] exceeds the upper bound [[%llu]]");
    SWAG_ERROR(Err0486, "invalid range expression                                                                               $ note: the upper bound of an [[until]] range must be greater than zero");
    SWAG_ERROR(Err0487, "invalid range type [[%s]]                                                                              $ note: only integer, rune, or float types can form ranges");
    SWAG_ERROR(Err0488, "invalid range                                                                                          $ note: lower bound [[%lld]] exceeds upper bound [[%lld]] $ hint: use [[#reverse]] for descending ranges");
    SWAG_ERROR(Err0489, "invalid range                                                                                          $ note: mixes signed and unsigned bounds $ note: both range bounds must use the same sign");
    SWAG_ERROR(Err0490, "invalid reference                                                                                      $ note: %s [[%s]] resides in a different stack frame");
    SWAG_ERROR(Err0491, "invalid return type                                                                                    $ hint: missing [[->]] before $$TKN$$");
    SWAG_ERROR(Err0492, "invalid return type                                                                                    $ note: expected [[->]] but found $$TKN$$");
    SWAG_ERROR(Err0493, "invalid return type [[%s]]                                                                             $ note: function has no declared return type");
    SWAG_ERROR(Err0494, "invalid return type [[%s]] for function [[%s]]                                                         $ note: function has no declared return type");
    SWAG_ERROR(Err0495, "invalid return type [[->]] in attribute definition                                                     $ note: attributes are not functions; remove the return type");
    SWAG_ERROR(Err0496, "invalid return type [[void]]                                                                           $ note: a value is required $ hint: remove the return type if the function returns nothing");
    SWAG_ERROR(Err0497, "invalid return type                                                                                    $ note: already inferred as [[%s]]");
    SWAG_ERROR(Err0498, "invalid scope before intrinsic                                                                         $ note: intrinsics are defined in the top-level scope");
    SWAG_ERROR(Err0499, "invalid scope name                                                                                     $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0500, "invalid semantic dependency cycle during %s [[%s]] evaluation                                          $ ");
    SWAG_ERROR(Err0501, "invalid shift operator [['%s']] for type [[%s]]                                                        $ note: operator [[%s]] requires an integer operand");
    SWAG_ERROR(Err0502, "invalid shorthand to [[%s]]                                                                            $ note: cannot find a corresponding [[enum]], [[with]], or [[mtd]] context");
    SWAG_ERROR(Err0503, "invalid signature in [[%s.%s]]                                                                         $ ");
    SWAG_ERROR(Err0504, "invalid slice bound type [[%s]]                                                                        $ note: slice bounds must be of integer type");
    SWAG_ERROR(Err0505, "invalid slicing: type [[%s]] does not support slicing                                                  $ ");
    SWAG_ERROR(Err0506, "invalid specialization                                                                                 $ note: type required but value provided");
    SWAG_ERROR(Err0507, "invalid specialization                                                                                 $ note: value required but type provided");
    SWAG_ERROR(Err0508, "invalid statement                                                                                      $ note: $$TKN$$ cannot appear at the start of an instruction");
    SWAG_ERROR(Err0509, "invalid statement inside [[switch]]                                                                    $ note: a [[switch]] body may only contain a [[case]] or a [[default]] section, found $$TKN$$");
    
    SWAG_ERROR(Err0510, "invalid struct initialization                                                                          $ note: both type syntax and assignment");
    SWAG_ERROR(Err0511, "invalid struct initialization                                                                          $ note: used [[()]] instead of [[{}]] $ hint: use [[{}]] for struct initialization; [[()]] is for function calls");
    SWAG_ERROR(Err0512, "invalid switch expression type [[%s]]                                                                  $ ");
    SWAG_ERROR(Err0513, "invalid symbol [['%s']] after %s                                                                       $ ");
    SWAG_ERROR(Err0514, "invalid symbol [['%s']] detected                                                                       $ ");
    SWAG_ERROR(Err0515, "invalid syntax after parameter declaration                                                             $ note: expected an assignment or [[:]], found $$TKN$$");
    SWAG_ERROR(Err0516, "invalid syntax after variable declaration                                                              $ note: expected an assignment or [[:]], found $$TKN$$");
    SWAG_ERROR(Err0517, "invalid syntax                                                                                         $ note: unexpected $$TKN$$, expected [[%s]]");
    SWAG_ERROR(Err0518, "invalid token $$TKN$$ after array dimensions                                                           $ ");
    SWAG_ERROR(Err0519, "invalid top-level [[using]]                                                                            $ note: a top-level [[using]] must not appear after other declarations");
    SWAG_ERROR(Err0520, "invalid top-level call [[%s]]                                                                          $ note: not marked [[#[Swag.Mixin]]] $ hint: only mixin calls are allowed at the top level");
    SWAG_ERROR(Err0521, "invalid top-level instruction                                                                          $ note: token $$TKN$$");
    SWAG_ERROR(Err0522, "invalid tuple type as generic parameter                                                                $ ");
    SWAG_ERROR(Err0523, "invalid tuple unpacking in %s scope                                                                    $ ");
    SWAG_ERROR(Err0524, "invalid type [[%s]] for [[@cvaarg]]                                                                    $ ");
    SWAG_ERROR(Err0525, "invalid type [[%s]]                                                                                    $ note: is %s");
    SWAG_ERROR(Err0526, "invalid type declaration after [[me]]                                                                  $ note: [[me]] is implicitly typed");
    SWAG_ERROR(Err0527, "invalid type declaration after unnamed parameter                                                       $ note: unnamed parameters ([['?']]) cannot have an explicit type $ hint: give the parameter a name or remove the type annotation");
    SWAG_ERROR(Err0528, "invalid type declaration                                                                               $ note: token $$TKN$$");
    SWAG_ERROR(Err0529, "invalid type expression after [[#type]]                                                                $ note: expected a type, found $$TKN$$");
    SWAG_ERROR(Err0530, "invalid type suffix %s                                                                                 $ note: type suffixes are allowed only on [[integer]], [[float]], or [[character]] literals");
    SWAG_ERROR(Err0531, "invalid unpacking: type [[%s]] does not support unpacking                                              $ note: only struct or tuple types can be unpacked");
    SWAG_ERROR(Err0532, "invalid unused expression                                                                              $ ");
    SWAG_ERROR(Err0533, "invalid use of [[#callerfunction]] outside a parameter list                                            $ note: this can only be used as a default function parameter value");
    SWAG_ERROR(Err0534, "invalid use of [[#callerlocation]] outside a parameter list                                            $ note: this can only be used as a default function parameter value");
    SWAG_ERROR(Err0535, "invalid use of [[#dependencies]]                                                                       $ note: can only be used in [[module.swg]] or in a [[.swgs]] file");
    SWAG_ERROR(Err0536, "invalid use of [[#global testerror]] outside test files ([[./tests]] folder)                           $ ");
    SWAG_ERROR(Err0537, "invalid use of [[#global testwarning]] outside test files ([[./tests]] folder)                         $ ");
    SWAG_ERROR(Err0538, "invalid use of [[#global using]]                                                                       $ note: can only be used in [[module.swg]] or in a [[.swgs]] file");
    SWAG_ERROR(Err0539, "invalid use of [[#import]]                                                                             $ note: can only be used in [[module.swg]] or in a [[.swgs]] file");
    SWAG_ERROR(Err0540, "invalid use of [[#import]] outside a [[#dependencies]] block                                           $ ");
    SWAG_ERROR(Err0541, "invalid use of [[#inject]] outside loop blocks                                                         $ ");
    SWAG_ERROR(Err0542, "invalid use of [[#load]]                                                                               $ note: can only be used in [[module.swg]] or in a [[.swgs]] file");
    SWAG_ERROR(Err0543, "invalid use of [[#load]] outside a [[#dependencies]] block                                             $ ");
    SWAG_ERROR(Err0544, "invalid use of [[#macro]] outside [[#[Swag.Macro]]] functions                                          $ ");
    SWAG_ERROR(Err0545, "invalid use of [[#test]] outside test modules ([[./tests]] folder)                                     $ ");
    SWAG_ERROR(Err0546, "invalid use of [[#up]] outside [[#[Swag.Macro]]] functions                                             $ ");
    SWAG_ERROR(Err0547, "invalid use of [[%s]]                                                                                  $ note: function [[%s]] is not marked with [[throw]]");
    SWAG_ERROR(Err0548, "invalid use of [[%s]] in struct special function [[%s]]                                                $ ");
    SWAG_ERROR(Err0549, "invalid use of [[%s]] on %s [[%s]]                                                                     $ ");
    SWAG_ERROR(Err0550, "invalid use of [[%s]] outside global scope                                                             $ ");
    SWAG_ERROR(Err0551, "invalid use of [[%s]] with arguments                                                                   $ hint: [[%s]] is a value, not a function call, remove the parentheses");
    SWAG_ERROR(Err0552, "invalid use of [[@cvastart]] in function without [[cvarargs]] parameter                                $ ");
    SWAG_ERROR(Err0553, "invalid use of [[@index]] outside loop blocks                                                          $ ");
    SWAG_ERROR(Err0554, "invalid use of [[alias]] on struct members                                                             $ ");
    SWAG_ERROR(Err0555, "invalid use of [[break]] outside loop blocks                                                           $ ");
    SWAG_ERROR(Err0556, "invalid use of [[continue]] outside loop blocks                                                        $ ");
    SWAG_ERROR(Err0557, "invalid use of [[fallthrough]] outside [[case]] blocks                                                 $ ");
    SWAG_ERROR(Err0558, "invalid use of [[fallthrough]] outside [[switch]] statement                                            $ ");
    SWAG_ERROR(Err0559, "invalid use of [[for]] in [[enum]] implementation                                                      $ ");
    SWAG_ERROR(Err0560, "invalid use of [[me]] outside enum or struct [[impl]] blocks                                           $ ");
    SWAG_ERROR(Err0561, "invalid use of [[mtd]] outside struct [[impl]] blocks                                                  $ hint: use [[func]] instead");
    SWAG_ERROR(Err0562, "invalid use of [[mtd]] outside struct [[impl]] blocks                                                  $ hint: use [[func]] instead");
    SWAG_ERROR(Err0563, "invalid use of [[retval]] for return type                                                              $ ");
    SWAG_ERROR(Err0564, "invalid use of [[retval]] in function without return value                                             $ ");
    SWAG_ERROR(Err0565, "invalid use of [[retval]] outside function body                                                        $ ");
    SWAG_ERROR(Err0566, "invalid use of [[try]] outside a function, macro, or mixin                                             $ note: [[try]] can only appear inside executable code blocks");
    SWAG_ERROR(Err0567, "invalid use of [[with]] on enum variable [[%s]]                                                        $ note: [[with]] applies to enum types, not enum variables");
    SWAG_ERROR(Err0568, "invalid use of [[with]] on type [[%s]]                                                                 $ note: [[with]] applies only to namespaces, enums, structs, or struct pointers");
    SWAG_ERROR(Err0569, "invalid value: [[%llu]] does not fit in [[%s]]                                                         $ ");
    SWAG_ERROR(Err0570, "invalid variable alias name                                                                            $ note: expected an identifier, found $$TKN$$");
    SWAG_ERROR(Err0571, "invalid variable aliasing for [[%s]]                                                                   $ note: variable aliasing is only allowed for macros or mixins");
    SWAG_ERROR(Err0572, "invalid variable name ($$TKN$$)                                                                        $ note: tuple unpacking requires valid identifiers or [[?]] $ hint: replace with a variable name or [[?]] if the value should be ignored");
    SWAG_ERROR(Err0573, "invalid variable name [[%s]]: starts with [[#]]                                                        $ hint: only [[#uniq]] and [[#alias]] are allowed");
    SWAG_ERROR(Err0574, "invalid variable type [[void]]                                                                         $ ");
    SWAG_ERROR(Err0575, "invalid variadic argument position                                                                     $ note: a variadic argument must be the last one");
    SWAG_ERROR(Err0576, "invalid variadic parameter default value                                                               $ note: variadic parameters cannot have a default value");
    SWAG_ERROR(Err0577, "invalid variadic parameter position                                                                    $ note: a variadic parameter must be the last one");
    SWAG_ERROR(Err0578, "invalid visibility specifier [[%s]]                                                                    $ note: conflicts with [[#global export]] $ hint: remove [[public]] since [[#global export]] already makes all declarations public");
