...
void initErrors()
{
    ...
    SWAG_ERROR(Err0390, "misplaced match variable                          $ cannot declare a match variable in a [[switch]] expression of type [[%s]]                                                                $ the only supported type are [[interface]] and [[any]]");
    ...
    SWAG_ERROR(Err0754, "partial import version                            $ expected a [[#import]] major version because the revision was set to [[%d]]                                                              $ ");
    SWAG_ERROR(Err0755, "partial import version                            $ expected a [[#import]] revision because the build number was set to [[%d]]                                                               $ ");
