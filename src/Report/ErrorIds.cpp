...
void initErrors()
{
    ...
    SWAG_ERROR(Err0687, "unknown value safety                              $ cannot recognize [[\"%s\"]] as a valid safety value                                                                                      $ the acceptable values are [[\"boundcheck|overflow|math|switch|unreachable|dyncast|bool|nan|null\"]]");
