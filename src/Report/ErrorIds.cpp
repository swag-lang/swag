...
void initErrors()
{
    ...
    SWAG_ERROR(Err0593, "too many initializers                             $ unexpected number of parameters for the type [[%s]]");
    ...
    SWAG_ERROR(Err0615, "type mismatch argument                            $ expected the type [[string]] as an argument of [[%s]], got type [[%s]] instead");
