...
void initErrors()
{
    ...
    SWAG_ERROR(Err0004, "%s already defined                                $ %s [[%s]] conflicts with an existing definition %s                         $ ");
    ...
    SWAG_ERROR(Err0037, "invalid constant case                             $ [[case]] expression is not a compile-time constant                       $ [[switch]] marked [[#[Swag.Complete]]] requires constant case values");
    ...
    SWAG_ERROR(Err0043, "invalid constant initialization                   $ initialization is not a compile-time constant                            $ mark [[opAffect]] with [[#[Swag.ConstExpr]]] to enable this");
    SWAG_ERROR(Err0044, "invalid constant operation                        $ operation on [[%s]] is not a compile-time constant                       $ mark struct [[#[Swag.ConstExpr]]] to enable this");
    ...
    SWAG_ERROR(Err0063, "empty [[switch]]                                  $ [[switch]] statement has no body                                           $ add cases or remove it");
    SWAG_ERROR(Err0064, "empty array literal                               $ array literal contains no elements                                         $ ");
    SWAG_ERROR(Err0065, "empty attribute                                   $ attribute has no specified value                                           $ add attribute name");
    ...
    SWAG_ERROR(Err0070, "empty statement                                   $ [[;]] alone forms an invalid empty statement                               $ use [[{}]] instead");
    ...
    SWAG_ERROR(Err0087, "direct [[opDrop]] call                            $ direct call to [[opDrop]] is invalid                                       $ use [[@drop]] instead");
    SWAG_ERROR(Err0088, "direct [[opPostCopy]] call                        $ direct call to [[opPostCopy]] is invalid                                   $ use [[@postcopy]] instead");
    SWAG_ERROR(Err0089, "direct [[opPostMove]] call                        $ direct call to [[opPostMove]] is invalid                                   $ use [[@postmove]] instead");
    ...
    SWAG_ERROR(Err0095, "incomplete [[case]] list                          $ missing expression after [[,]] before $$TKN$$                              $ add case expression or remove trailing [[,]]");
    SWAG_ERROR(Err0096, "unterminated alias list                           $ missing [[,]] or [['|']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0097, "incomplete alias list                             $ missing alias name after [[,]] before $$TKN$$                              $ add alias name or remove trailing [[,]]");
    SWAG_ERROR(Err0098, "unterminated arguments list                       $ missing [[,]] or [[')']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0099, "incomplete arguments list                         $ missing argument after [[,]] before $$TKN$$                                $ add argument or remove trailing [[,]]");
    SWAG_ERROR(Err0100, "unterminated array dimensions                     $ missing [[,]] or [[']']] before $$TKN$$                                    $ add dimension or close with [[']']]");
    SWAG_ERROR(Err0101, "incomplete array dimensions                       $ missing dimension after [[,]] before $$TKN$$                               $ add dimension or remove trailing [[,]]");
    SWAG_ERROR(Err0102, "unterminated attribute arguments                  $ missing [[,]] or [[')']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0103, "incomplete attribute arguments                    $ missing argument after [[,]] before $$TKN$$                                $ add argument or remove trailing [[,]]");
    SWAG_ERROR(Err0104, "unterminated attribute list                       $ missing [[,]] or [[']']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0105, "incomplete attribute list                         $ missing attribute after [[,]] before $$TKN$$                               $ add attribute or remove trailing [[,]]");
    SWAG_ERROR(Err0106, "unterminated generic arguments                    $ missing [[,]] or [[')']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0107, "incomplete generic arguments                      $ missing argument after [[,]] before $$TKN$$                                $ add generic argument or remove trailing [[,]]");
    SWAG_ERROR(Err0108, "unterminated index list                           $ missing [[,]] or [[')']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0109, "incomplete index list                             $ missing index after [[,]] before $$TKN$$                                   $ add index or remove trailing [[,]]");
    ...
    SWAG_ERROR(Err0113, "incomplete parameters list                        $ missing parameter after [[,]] before $$TKN$$                               $ add parameter or remove trailing [[,]]");
    SWAG_ERROR(Err0114, "unterminated tuple unpacking                      $ missing [[,]] or [[')']] before $$TKN$$                                    $ ");
    SWAG_ERROR(Err0115, "incomplete tuple unpacking                        $ missing variable name after [[,]] before $$TKN$$                           $ add variable or remove trailing [[,]]");
    SWAG_ERROR(Err0116, "incomplete variables list                         $ missing variable name after [[,]] before $$TKN$$                           $ add variable or remove trailing [[,]]");
    SWAG_ERROR(Err0117, "infinite [[while]] loop                           $ [[while]] condition always evaluates to [[true]]                           $ use [[for { ... }]] for intentional infinite loop");
    SWAG_ERROR(Err0118, "invalid [[#alias]] name                           $ [[%s]] is not a valid [[#alias]] variable name                             $ use [[#alias0]], [[#alias1]], etc.");
    SWAG_ERROR(Err0119, "invalid [[#alignof]] usage                        $ [[#alignof]] applied to generic expression                                 $ ");
    SWAG_ERROR(Err0120, "invalid [[#inject]] keyword                       $ invalid token for [[#inject]] replacement, found $$TKN$$                   $ [[#inject]] only accepts [[break]] and [[continue]]");
    SWAG_ERROR(Err0121, "invalid [[#uniq]] name                            $ [[%s]] is not a valid [[#uniq]] variable name                              $ use [[#uniq0]], [[#uniq1]], etc.");
    ...
    SWAG_ERROR(Err0126, "invalid [[@cvaarg]] type                          $ variadic argument type [[%s]] not supported                                $ promoted to [[%s]] at call site");
    SWAG_ERROR(Err0127, "invalid [[code]] append                           $ next block statement cannot serve as [[code]] argument                     $ %s [[%s]] expects following statement as [[code]] argument, not allowed in [[%s]]");
    ...
    SWAG_ERROR(Err0140, "invalid [[opVisit]] name                          $ [[%s]] is not a valid [[opVisit]] variant                                  $ must be a valid identifier");
    ...
    SWAG_ERROR(Err0157, "invalid argument                                  $ [[%s]] requires [[variable]] as first argument                             $ needed if [[@init]] second argument omitted");
    ...
    SWAG_ERROR(Err0164, "invalid bit-cast                                  $ invalid bit-cast source type [[%s]]                                        $ requires integer, rune, float, or pointer");
    SWAG_ERROR(Err0165, "invalid bit-cast                                  $ cannot bit-cast from [[%s]] to larger [[%s]]                               $ ");
    SWAG_ERROR(Err0166, "invalid bit-cast                                  $ invalid bit-cast target type [[%s]]                                        $ requires integer, rune, or float");
    SWAG_ERROR(Err0168, "invalid capture                                   $ [[%s]] is %s; capture not allowed                                          $ capturing %s is disallowed");
    SWAG_ERROR(Err0169, "invalid capture                                   $ [[%s]] is not plain old data                                               $ structs with [[opDrop]], [[opPostCopy]], or [[opPostMove]] cannot be captured");
    ...
    SWAG_ERROR(Err0172, "invalid compound name                             $ multiple identifiers found, expected single %s                             $ remove [['.']] separator");
    SWAG_ERROR(Err0173, "invalid const move reference                      $ [[const]] conflicts with move reference [[&&]]                             $ remove [[const]] or use [[&]]");
    ...
    SWAG_ERROR(Err0190, "invalid function declaration                      $ [[%s]] found in interface, requires [[func]] or [[mtd]]                    $ use [[func]] or [[mtd]] for interface functions");
    ...
    SWAG_ERROR(Err0194, "invalid generic argument                          $ %s ([[%s]]) not valid as generic argument                                  $ must be literal or type");
    ...
    SWAG_ERROR(Err0203, "invalid interface function signature              $ first parameter [[%s]] invalid; expected [[me]]                            $ use [[mtd]] instead of [[func]]");
    SWAG_ERROR(Err0204, "invalid interface function signature              $ interface function [[%s]] missing [[me]] as first parameter                $ use [[mtd]] instead of [[func]]");
    SWAG_ERROR(Err0205, "invalid lambda call                               $ [[%s]] is %s, not callable variable                                        $ ");
    SWAG_ERROR(Err0206, "invalid literal suffix                            $ [[%s]] is [[%s]], invalid literal suffix                                   $ must match a type");
    SWAG_ERROR(Err0207, "invalid literal suffix                            $ [[%s]] invalid for float literals                                          $ only [[f32]] and [[f64]] allowed");
    ...
    SWAG_ERROR(Err0212, "invalid module name                               $ [[.]] not permitted in [[#[Swag.Foreign]]] module name                     $ module name cannot contain extension");
    ...
    SWAG_ERROR(Err0226, "invalid pointer arithmetic                        $ pointer arithmetic on [[void*]] disallowed                                 $ [[void]] has no size");
    ...
    SWAG_ERROR(Err0230, "invalid range type                                $ type [[%s]] cannot define a range                                          $ only integer, rune, or float types are valid");
    SWAG_ERROR(Err0231, "invalid reference                                 $ [[ref]] applied to non-pointer or non-reference type [[%s]]                $ ");
    SWAG_ERROR(Err0232, "invalid return type                               $ [[void]] used as return type where a value is required                     $ remove return type if function returns nothing");
    SWAG_ERROR(Err0233, "invalid return type                               $ [[opSlice]] returns unsupported type [[%s]]                                $ only [[string]] or [[slice]] are valid");
    ...
    SWAG_ERROR(Err0237, "invalid struct initialization                     $ [[()]] used instead of [[{}]] for struct initialization                    $ [[()]] is for function calls");
    ...
    SWAG_ERROR(Err0242, "invalid suffix type                               $ suffix [[%s]] cannot apply to this literal                                 $ only valid for struct conversions");
    ...
    SWAG_ERROR(Err0245, "invalid [[throw]] expression                      $ [[throw]] used with unsupported type [[%s]]                                $ requires struct or [[@err]]");
    ...
    SWAG_ERROR(Err0248, "invalid tuple comparison                          $ tuple compared with incompatible type [[%s]]                               $ tuples only compare with tuples");
    ...
    SWAG_ERROR(Err0251, "invalid tuple unpacking                           $ type [[%s]] does not support unpacking                                     $ only struct or tuple types can be unpacked");
    SWAG_ERROR(Err0252, "invalid type                                      $ generic type cannot be evaluated                                           $ ");
    SWAG_ERROR(Err0253, "invalid type assignment                           $ [[%s]] second parameter type [[%s]] incompatible                           $ use [[opAssign]] for copying");
    ...
    SWAG_ERROR(Err0275, "invalid variable declaration                      $ [[if]] cannot declare multiple variables                                   $ [[if]] requires a single variable declaration");
    SWAG_ERROR(Err0276, "invalid variable declaration                      $ [[using]] cannot declare multiple variables                                $ [[using]] requires a single variable declaration");
    SWAG_ERROR(Err0277, "invalid variable declaration                      $ [[with]] cannot declare multiple variables                                 $ [[with]] requires a single variable declaration");
    SWAG_ERROR(Err0278, "invalid dereference                               $ [[void*]] cannot be dereferenced                                           $ [[void]] has no size");
    ...
    SWAG_ERROR(Err0316, "invalid block syntax                              $ [[':]] before [[{]] not allowed                                            $ use [[':']] or [[{]], not both");
    SWAG_ERROR(Err0317, "misplaced [[@cvastart]] usage                     $ [[@cvastart]] only valid in functions with [[cvarargs]] parameter          $ ");
    SWAG_ERROR(Err0318, "invalid [[@kindof]] usage                         $ [[@kindof]] applied to invalid type [[%s]]                                 $ only allowed on [[any]] or interface types");
    SWAG_ERROR(Err0319, "invalid type declaration                          $ missing type after [[code]], got $$TKN$$                                   $ [[code]] requires type or [[void]]");
    ...
    SWAG_ERROR(Err0327, "invalid [[fallthrough]] usage                     $ [[fallthrough]] not valid in last [[case]]                                $ remove it");
    ...
    SWAG_ERROR(Err0332, "invalid [[as]] usage                              $ match variable used with multiple [[case]] values                         $ [[case]] requires exactly one value");
    SWAG_ERROR(Err0333, "invalid [[as]] usage                              $ match variable used without [[switch]] expression                         $ ");
    SWAG_ERROR(Err0334, "invalid [[moveref]] usage                         $ [[moveref]] applied to compile-time value                                 $ only allowed on pointers or references");
    ...
    SWAG_ERROR(Err0338, "misplaced [[mtd]] usage                           $ [[mtd]] only valid inside struct [[impl]] blocks                          $ use [[func]] instead");
    SWAG_ERROR(Err0339, "invalid [[mtd]] declaration                       $ [[mtd]] cannot declare lambda type                                        $ use [[func]] instead");
    SWAG_ERROR(Err0340, "misplaced [[mtd]] usage                           $ [[mtd]] only valid inside struct [[impl]] blocks                          $ use [[func]] instead");
    SWAG_ERROR(Err0341, "redundant [[return]] statement                    $ [[return]] after [[=>]] is implicit                                       $ remove it");
    ...
    SWAG_ERROR(Err0347, "invalid [[using]] usage                           $ [[using]] applied to unsupported type [[%s]]                              $ only valid on pointer to struct");
    ...
    SWAG_ERROR(Err0350, "invalid [[using]] usage                           $ [[using]] applied to unsupported type [[%s]]                              $ only valid on namespace, struct, or enum");
    SWAG_ERROR(Err0351, "invalid [[using]] usage                           $ [[using]] not valid on interface functions                                $ ");
    SWAG_ERROR(Err0352, "invalid [[var]] usage                             $ [[var]] not allowed in struct declarations                                $ use [[fieldName: Type]]");
    SWAG_ERROR(Err0354, "invalid [[verify]] usage                          $ [[verify]] not valid on [[%s]]                                            $ unsupported for [[opDrop]], [[opPostCopy]], [[opPostMove]]");
    SWAG_ERROR(Err0355, "invalid [[verify]] usage                          $ [[verify]] only valid on functions, not structs                           $ use [[where]] instead");
    SWAG_ERROR(Err0356, "invalid [[where]] usage                           $ [[where]] used without [[switch]] expression                              $ ");
    SWAG_ERROR(Err0357, "invalid [[where]] usage                           $ [[where]] not valid on [[%s]]                                             $ unsupported for [[opDrop]], [[opPostCopy]], [[opPostMove]]");
    ...
    SWAG_ERROR(Err0363, "misplaced attribute                               $ attribute placed after [[%s]]                                             $ move attribute before [[%s]]");
    SWAG_ERROR(Err0364, "invalid attribute                                 $ [[#[Swag.CalleeReturn]]] not valid on %s                                  $ ");
    SWAG_ERROR(Err0365, "invalid attribute                                 $ [[#[Swag.CalleeReturn]]] only valid on macro or mixin [[%s]]              $ requires [[#[Swag.Macro]]] or [[#[Swag.Mixin]]]");
    ...
    SWAG_ERROR(Err0377, "invalid attribute usage                           $ [[%s]] not allowed inside [[#global]] block                                $ requires [[Swag.AttributeUsage.File]]");
    ...
    SWAG_ERROR(Err0383, "invalid closure                                   $ closure used outside function scope $ closures allowed only within functions          $ ");
    ...
    SWAG_ERROR(Err0394, "invalid error catching                            $ [[%s]] nested inside [[%s]]                                                      $ use only one [[try]], [[catch]], or [[assume]]");
    SWAG_ERROR(Err0395, "invalid error catching                            $ [[%s]] used outside function, macro, or mixin                                     $ ");
    SWAG_ERROR(Err0396, "invalid error catching                            $ [[%s]] requires [[throw]] on [[%s]]                                              $ function missing [[throw]] attribute");
    SWAG_ERROR(Err0397, "invalid function declaration                      $ function declared directly in struct                                             $ use [[impl]] block instead");
    ...
    SWAG_ERROR(Err0406, "misplaced special function                        $ [[%s]] outside corresponding [[impl]] block                                      $ [[impl for]] only allowed for interface implementation");
    ...
    SWAG_ERROR(Err0415, "missing [[#foreignlib]] argument                  $ library name missing after [[#foreignlib]], got $$TKN$$                         $ use [[#foreignlib \"path/to/library\"]]");
    ...
    SWAG_ERROR(Err0427, "missing [[in]]                                    $ [[in]] missing after [[for]] variable [[%s]]                                    $ use [[for variable in count]]");
    SWAG_ERROR(Err0429, "missing [[case]] expression                       $ [[case]] expression missing, got [[%s]]                                         $ ");
    SWAG_ERROR(Err0430, "missing capture variable                          $ capture variable missing between [[,]] and [['|']]                              $ add variable or remove trailing comma");
    SWAG_ERROR(Err0431, "missing [[foreach]] expression                    $ element expression missing before [[%s]]                                        $ ");
    SWAG_ERROR(Err0432, "missing [[foreach]] variable                      $ [[foreach]] variable missing between [[,]] and [[:]]                            $ first is [[value]], second is [[index]]");
    ...
    SWAG_ERROR(Err0442, "unhandled error                                   $ [[%s]] lacks error handling                                                     $ use [[try]], [[catch]], or [[assume]]");
    ...
    SWAG_ERROR(Err0445, "missing dereference index                         $ array [[%s]] of type [[%s]] missing index                                      $ add index in brackets");
    SWAG_ERROR(Err0446, "missing end of line                               $ line break or [[;]] missing after %s, got $$TKN$$                               $ add line break or separate with [[;]]");
    ...
    SWAG_ERROR(Err0449, "missing function parameters                       $ parameters [[()]] missing before [[{]]                                         $ add [[()]] after [[%s]] if none");
    ...
    SWAG_ERROR(Err0453, "missing generic parameters                        $ no generic parameters between [[()]]                                           $ remove [[()]] if not generic");
    ...
    SWAG_ERROR(Err0461, "missing lambda parameter type                     $ parameter type missing after [[:]] or assignment                                $ cannot mix inferred and explicit types");
    ...
    SWAG_ERROR(Err0476, "missing slice upper bound                         $ upper bound missing after [[until]]                                           $ use [[to]] for slicing to end");
    ...
    SWAG_ERROR(Err0482, "non-contiguous [[#alias]]                         $ non-contiguous [[#alias]] in [[%s]]                                            $ [[#alias%u]] missing");
    ...
    SWAG_ERROR(Err0494, "[[#alias]] number out of range                    $ [[#alias]] number [[%u]] exceeds valid range                                  $ valid range is [0, 31]");
    SWAG_ERROR(Err0495, "[[#uniq]] number out of range                     $ [[#uniq]] number [[%u]] exceeds valid range                                   $ valid range is [0, 31]");
    SWAG_ERROR(Err0496, "[[#up]] count out of range                        $ [[#up]] count [[%u]] exceeds valid range                                     $ valid range is [1, 255]");
    ...
    SWAG_ERROR(Err0508, "redundant access specifier                        $ duplicate visibility specifier [[%s]] conflicts with [[#global export]]       $ remove [[public]]: [[#global export]] already makes all declarations public");
    SWAG_ERROR(Err0509, "redundant nullable                                $ parameter already nullable due to [[null]] default                           $ remove [[#null]]");
    SWAG_ERROR(Err0510, "reserved field name                               $ field name [[%s]] is reserved                                                $ names beginning with [[item]] are reserved");
    SWAG_ERROR(Err0511, "reserved function name                            $ function name [[%s]] is reserved                                             $ ");
    SWAG_ERROR(Err0512, "reserved identifier                               $ identifier [[_]] is reserved by compiler                                     $ single [[_]] reserved for internal use");
    SWAG_ERROR(Err0513, "reserved identifier                               $ identifier [[%s]] uses reserved [[__]] prefix                                $ [[__]] prefix reserved for compiler use");
    ...
    SWAG_ERROR(Err0516, "unused expression                                 $ expression result discarded                                                  $ remove unused expression");
    ...
    SWAG_ERROR(Err0521, "initializer overflow                              $ excessive initializers: expected [[%d]] for [[%s]], found [[%d]]              $ remove extra initializer values");
    ...
    SWAG_ERROR(Err0529, "invalid interface cast                            $ interface cannot cast to struct                                               $ interface can only cast to struct pointer");
    ...
    SWAG_ERROR(Err0532, "incompatible range types                          $ range mixes signed and unsigned bounds                                       $ lower and upper bounds must have same sign");
    ...
    SWAG_ERROR(Err0539, "invalid [[@mkany]] pointer type                   $ pointer type [[%s]] incompatible with second argument [[%s]]                 $ first argument requires pointer to [[%s]], or second argument type [[%s]]");
    ...
    SWAG_ERROR(Err0543, "invalid [[with]] usage                            $ [[with]] applied to enum variable [[%s]] instead of enum type                 $ [[with]] applies to enum types, not variables");
    SWAG_ERROR(Err0544, "invalid [[with]] type                             $ [[with]] applied to type [[%s]] not allowed                                   $ requires namespace, enum, struct, or struct pointer");
    ...
    SWAG_ERROR(Err0584, "invalid [[#[Swag.EnumFlags]]] enum base type      $ type [[%s]] not valid for [[#[Swag.EnumFlags]]] enum                          $ requires unsigned integer");
    SWAG_ERROR(Err0585, "invalid [[#[Swag.EnumIndex]]] enum base type      $ type [[%s]] not valid for [[#[Swag.EnumIndex]]] enum                          $ requires integer");
    SWAG_ERROR(Err0586, "invalid [[#[Swag.NoDuplicate]]] enum base type    $ type [[%s]] not valid for [[#[Swag.NoDuplicate]]] enum                        $ ");
    SWAG_ERROR(Err0587, "invalid enum base type                            $ [[cstring]] not valid as enum base type                                      $ use [[string]] instead");
    SWAG_ERROR(Err0588, "enum type mismatch                                $ expected enum type [[%s]], found [[%s]]                                      $ ");
    SWAG_ERROR(Err0589, "constness violation in enum array                 $ enum array type [[%s]] must be [[const]]                                     $ use [[const %s]]");
    SWAG_ERROR(Err0590, "constness violation in enum slice                 $ enum slice type [[%s]] must be [[const]]                                     $ use [[const %s]]");
    ...
    SWAG_ERROR(Err0609, "unclosed string literal                       $ missing closing [['\"']] before line end                                   $ use [[\"\"\"string\"\"\"]] for multi-line strings");
    ...
    SWAG_ERROR(Err0614, "invalid [[foreach]] specialization            $ [[foreach]] specialization invalid for [[%s]]                              $ only valid for struct visits");
    ...
    SWAG_ERROR(Err0617, "invalid assignment                            $ [['=']] not allowed in expression                                          $ use [['==']] for comparison");
    ...
    SWAG_ERROR(Err0625, "invalid binary digit                          $ invalid binary digit $$TKN$$                                              $ binary literals use [[0]] or [[1]]");
    SWAG_ERROR(Err0626, "invalid character                             $ invalid character [['%s']]                                                $ ");
    SWAG_ERROR(Err0627, "invalid comparison                            $ [['==']] not allowed here                                                 $ use [['=']] for assignment");
    SWAG_ERROR(Err0628, "invalid compiler instruction scope            $ compiler instruction cannot have a scope                                   $ compiler instructions belong to no scope");
    ...
    SWAG_ERROR(Err0635, "duplicate function definition                 $ duplicate function [[%s]]                                                 $ mark all with [[#[Swag.Overload]]] for overloading");
    ...
    SWAG_ERROR(Err0643, "invalid hexadecimal digit                     $ invalid hexadecimal digit $$TKN$$                                         $ hexadecimal uses [[0-9]], [[A-F]], [[a-f]]");
    SWAG_ERROR(Err0644, "consecutive identifiers                       $ consecutive identifiers not allowed                                        $ ");
    SWAG_ERROR(Err0645, "invalid identifier                            $ identifier [[%s]] invalid at file level                                   $ only mixin function calls allowed at top level");
    SWAG_ERROR(Err0646, "invalid intrinsic scope                       $ intrinsic cannot have a scope                                              $ intrinsics belong to no scope");
    SWAG_ERROR(Err0647, "invalid instruction modifier                  $ modifier [[%s]] invalid for [[%s]]                                         $ ");
    SWAG_ERROR(Err0648, "invalid lambda parameter name                 $ parameter name not allowed in lambda type declaration                      $ remove it");
    SWAG_ERROR(Err0649, "too many [[foreach]] aliases                  $ [[foreach]] allows maximum [[2]] alias names, got [[%u]]                   $ ");
    SWAG_ERROR(Err0650, "invalid number prefix                         $ invalid number prefix 0$$TKN$$                                            $ use [[0x]] (hex) or [[0b]] (binary)");
    SWAG_ERROR(Err0651, "invalid parameter name                        $ invalid parameter name, got $$TKN$$                                       $ ");
    SWAG_ERROR(Err0652, "invalid compiler parameters                   $ compiler %s cannot have parameters                                         $ use [[{]]");
    ...
    SWAG_ERROR(Err0662, "invalid type alias                            $ type alias not allowed as [[impl]] block name                              $ use direct type");
    SWAG_ERROR(Err0663, "invalid type declaration                      $ type declaration not allowed after [[me]]                                  $ [[me]] is implicitly typed");
    ...
    SWAG_ERROR(Err0667, "misplaced [[mtd]]                             $ [[mtd]] lambda missing capture parameters                                 $ use [[func]] or declare captures between [[|...|]]");
    SWAG_ERROR(Err0669, "unvisitable [[foreach]] type                  $ type [[%s]] cannot be visited                                             $ no [[opVisit]] found");
    ...
    SWAG_ERROR(Err0673, "unknown compiler instruction                  $ [[%s]] not recognized as compiler instruction                             $ compiler instructions start with [['#']]");
    ...
    SWAG_ERROR(Err0404, "invalid dot notation                          $ statement starting with [[.]] only allowed in [[with]] or [[mtd]]         $ use [[me.field]] or wrap in [[with]]");
    ...
    SWAG_ERROR(Err0695, "invalid value export                          $ [[\"%s\"]] not valid [[#[Swag.ExportType]]]                              $ use [[\"methods\"]] or [[\"nozero\"]]");
    SWAG_ERROR(Err0696, "invalid match value                              $ [[\"%s\"]] is not a valid [[#[Swag.Match]]] value                             $ use [[\"where\"]] or [[\"me\"]]");
    SWAG_ERROR(Err0697, "invalid optimization value                       $ [[\"%s\"]] is not a valid [[#[Swag.Optim]]] value                             $ use [[\"bytecode\"]] or [[\"backend\"]]");
    SWAG_ERROR(Err0698, "invalid safety setting                           $ [[\"%s\"]] is not a recognized safety option                                  $ use [[\"boundcheck|overflow|math|switch|unreachable|dyncast|bool|nan|null\"]]");
    ...
    SWAG_ERROR(Err0710, "unused alias                                     $ no matching variable found for alias [[%s]]                                 $ remove it");
    SWAG_ERROR(Err0711, "ignored return value                             $ function [[%s]] return value cannot be ignored                              $ use [[discard]] to ignore");
    SWAG_ERROR(Err0712, "ignored return value                             $ intrinsic [[%s]] return value cannot be ignored                             $ ");
    SWAG_ERROR(Err0713, "ignored return value                             $ lambda [[%s]] return value cannot be ignored                                $ use [[discard]] to ignore");
    ...
    SWAG_ERROR(Err0739, "invalid [[#import]] location format              $ [[#import]] location format is invalid                                     $ use [[location=\"mode@accesspath\"]] where mode is [[swag]] or [[disk]]");
    ...
    SWAG_ERROR(Err0748, "invalid variable name                            $ variable name [[%s]] starts with [[#]], not allowed                        $ only [[#uniq]] and [[#alias]] permitted");
    ...
    SWAG_ERROR(Err0767, "invalid enum operation                            $ operation [['%s']] invalid: left enum [[%s]] not marked [[#[Swag.EnumFlags]]]  $ ");
    SWAG_ERROR(Err0768, "invalid enum operation                            $ operation [['%s']] invalid: right enum [[%s]] not marked [[#[Swag.EnumFlags]]] $ ");
    ...
    SWAG_ERROR(Err0774, "invalid [[location]] value                        $ [[\"%s\"]] is not a valid [[location]] value                               $ use [[\"swag\"]] or [[\"disk\"]]");
    ...
    SWAG_ERROR(Err0786, "invalid intrinsic usage                           $ [[%s]] used incorrectly with arguments                                     $ [[%s]] is a value, not a function call; remove [['(']]");
    ...
    SWAG_ERROR(Err0785, "missing [[#import]] location                      $ second [[#import]] argument missing or invalid, got $$TKN$$                $ use [[location:\"location\"]]");
    SWAG_ERROR(Err0773, "missing [[#import]] version                       $ third [[#import]] argument missing or invalid, got $$TKN$$                 $ use [[version:\"version\"]]");
