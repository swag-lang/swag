...
void initErrors()
{
    ...
    SWAG_ERROR(Err0415, "library name missing after [[#foreignlib]], found $$TKN$$                                                $ hint: add [[#foreignlib \"path/to/library\"]]");
    SWAG_ERROR(Err0416, "error string missing after [[#global testerror]], found $$TKN$$                                          $ ");
    SWAG_ERROR(Err0417, "warning string missing after [[#global testwarning]], found $$TKN$$                                      $ ");
    SWAG_ERROR(Err0418, "boolean expression missing after [[#if]], found $$TKN$$                                                  $ ");
    ...
    SWAG_ERROR(Err0425, "[[(]] missing to start [[%s]] arguments, found $$TKN$$                                                   $ ");
    SWAG_ERROR(Err0426, "[[(]] missing to start parameters, found $$TKN$$                                                         $ ");
    ...
    SWAG_ERROR(Err0433, "boolean expression missing after [[if]], found $$TKN$$                                                 $ ");
    ...
    SWAG_ERROR(Err0462, "missing name of %s                                                                                     $ note: previous arguments are named, so this one must be as well");
