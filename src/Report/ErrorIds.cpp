...
void initErrors()
{
    ...
    SWAG_ERROR(Err0280, "invalid number format float                       $ expected at least one digit in the scientific notation exponent");
    ...
    SWAG_ERROR(Err0283, "invalid number format hexadecimal                 $ unexpected hexadecimal digit $$TKN$$ $ hexadecimal literals can only contain digits [[0-9]], [[A-F]], and [[a-f]]");
    ...
    SWAG_ERROR(Err0289, "invalid parameter                                 $ expected a type [[Swag.CompilerMsgMask]] as the [[#message]] argument, got type [[%s]] instead");
