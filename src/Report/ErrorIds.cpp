...
void initErrors()
{
    ...
    SWAG_ERROR(Err0587, "invalid [[cstring]] as enum base type                                                                  $ hint: use [[string]] instead");
    ...
    SWAG_ERROR(Err0662, "invalid type alias as [[impl]] block name                                                              $ note: an [[impl]] block must reference a concrete type, not an alias $ hint: use the original type name instead of the alias");
    ...
    SWAG_ERROR(Err0532, "range mixes signed and unsigned bounds                                                                 $ note: both range bounds must use the same sign");
