...
void initErrors()
{
    ...
    SWAG_ERROR(Err0617, "type mismatch argument                            $ can't use the type [[%s]] as the [[@countof]] argument $ it needs to be an integer");
    ...
    SWAG_ERROR(Err0620, "type mismatch argument                            $ can't use the type [[%s]] as the [[@mkany]] second argument $ it needs to be a [[typeinfo]]");
    SWAG_ERROR(Err0621, "type mismatch argument                            $ can't use the type [[%s]] as the [[@mkcallback]] first argument $ it needs to be a pointer to function");
    SWAG_ERROR(Err0622, "type mismatch argument                            $ can't use the type [[%s]] as the [[@mkinterface]] first argument $ it needs to be a pointer or a struct");
    SWAG_ERROR(Err0623, "type mismatch argument                            $ can't use the type [[%s]] as the [[@mkinterface]] second argument $ it needs to be a [[typeinfo]]");
    SWAG_ERROR(Err0624, "type mismatch argument                            $ can't use the type [[%s]] as the [[@mkinterface]] third argument $ it needs to be an interface name");
    SWAG_ERROR(Err0625, "type mismatch argument                            $ can't use the type [[%s]] as the [[@mkstring]] first argument $ it needs to be a pointer to [[u8]]");
    SWAG_ERROR(Err0626, "type mismatch argument                            $ can't use the type [[%s]] as the [[@runes]] argument $ it needs to be a type [[string]]");
    SWAG_ERROR(Err0627, "type mismatch argument const                      $ can't use the type [[%s]] as the [[%s]] first argument $ it needs to be a mutable pointer");
    SWAG_ERROR(Err0628, "type mismatch argument const                      $ can't use the type [[%s]] as the [[%s]] first argument $ it needs to be a mutable variable");
