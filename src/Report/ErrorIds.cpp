...
void initErrors()
{
    ...
    SWAG_ERROR(Err0017, "cannot assign [[%s]] to [[%s]] $ note: type mismatch");
    ...
    SWAG_ERROR(Err0028, "cannot cast interface to struct $ note: interfaces can only be cast to struct pointers");
    SWAG_ERROR(Err0030, "cannot cast left side [[%s]] to [[interface]]");
    SWAG_ERROR(Err0031, "cannot cast right side [[%s]] to [[struct]]");
    SWAG_ERROR(Err0026, "cannot cast type value to compile-time type ([[%s]])");
    SWAG_ERROR(Err0032, "cannot cast value pointer [[%s]] to block pointer [[%s]]");
    SWAG_ERROR(Err0027, "cannot cast value to a type");
    SWAG_ERROR(Err0033, "cannot combine [[#[Swag.Compiler]]] with [[#[Swag.Tls]]]");
    SWAG_ERROR(Err0034, "cannot combine [[#[Swag.Inline]]] with [[#[Swag.NoInline]]]");
    SWAG_ERROR(Err0035, "cannot combine [[#[Swag.Macro]]] with [[#[Swag.Inline]]]");
    SWAG_ERROR(Err0036, "cannot combine [[#[Swag.Macro]]] with [[#[Swag.Mixin]]]");
    SWAG_ERROR(Err0037, "cannot combine [[#[Swag.Macro]]] with [[#[Swag.NoInline]]]");
    SWAG_ERROR(Err0038, "cannot combine [[#[Swag.Mixin]]] with [[#[Swag.Inline]]]");
    SWAG_ERROR(Err0039, "cannot combine [[#[Swag.Mixin]]] with [[#[Swag.NoInline]]]");
    SWAG_ERROR(Err0040, "cannot combine [[%s]] with [[%s]]");
    ...
    SWAG_ERROR(Err0044, "cannot convert closure type to lambda type");
    SWAG_ERROR(Err0045, "cannot convert function return slice into compile-time value $ note: function return type is [[%s]]");
    ...
    SWAG_ERROR(Err0049, "cannot convert type [[%s]] to compile-time constant");
    ...
    SWAG_ERROR(Err0056, "cannot declare generic parameters for function [[%s]] $ note: function has [[#[Swag.NotGeneric]]]");
    ...
    SWAG_ERROR(Err0058, "cannot declare multiple variables in [[if]] $ note: [[if]] allows only one variable declaration");
    SWAG_ERROR(Err0059, "cannot declare multiple variables in [[using]] $ note: [[using]] allows only one variable declaration");
    SWAG_ERROR(Err0060, "cannot declare multiple variables in [[with]] $ note: [[with]] allows only one variable declaration");
    SWAG_ERROR(Err0061, "cannot declare type [[%s]] as nullable");
    SWAG_ERROR(Err0062, "cannot deduce flag [[%s]] from previous value $ note: previous value ([[%llu]]) is not a power of two $ note: [[#[Swag.EnumFlags]]] requires power-of-two values (1, 2, 4, 8, ...)");
    SWAG_ERROR(Err0063, "cannot define body for function marked [[#[Swag.Foreign]]] $ note: [[#[Swag.Foreign]]] indicates the function is externally defined");
    ...
    SWAG_ERROR(Err0068, "cannot dereference tuple as pointer");
    ...
    SWAG_ERROR(Err0097, "cannot find variable for alias [[%s]] $ hint: remove the alias");
    ...
    SWAG_ERROR(Err0112, "cannot infer variable type from [[null]] expression");
    SWAG_ERROR(Err0115, "cannot initialize [[%s]] with special literal $ note: [[%s]] does not implement [[opAffectLiteral]]");
    SWAG_ERROR(Err0117, "cannot initialize constant array type [[%s]] with single value $ note: only variables can be initialized this way");
    SWAG_ERROR(Err0118, "cannot initialize struct member with function pointer");
    SWAG_ERROR(Err0116, "cannot initialize value with [[void]] expression");
    SWAG_ERROR(Err0119, "cannot inline [[%s]] $ note: expansion exceeds configuration limit $ note: [[--limit-inline:%d]]");
    ...
    SWAG_ERROR(Err0124, "cannot make callback of function [[%s]] $ note: function [[%s]] has too many parameters, maximum is [[%d]], found [[%d]]");
    ...
    SWAG_ERROR(Err0016, "cannot move immutable expression of type [[%s]]");
    ...
    SWAG_ERROR(Err0163, "cannot use [[%s]] as enum base type $ note: enum has [[#[Swag.EnumFlags]]]; only unsigned integer types allowed");
    SWAG_ERROR(Err0164, "cannot use [[%s]] as enum base type $ note: enum has [[#[Swag.EnumIndex]]]; only integer types allowed");
    SWAG_ERROR(Err0165, "cannot use [[%s]] as enum base type $ note: enum has [[#[Swag.NoDuplicate]]]; only basic types allowed");
    ...
    SWAG_ERROR(Err0013, "cannot use static member [[%s]] of [[%s]] as instance field");
    ...
    SWAG_ERROR(Err0176, "cannot visit variadic type by pointer");
    ...
    SWAG_ERROR(Err0185, "duplicate [[#global export]] directives in same file");
    SWAG_ERROR(Err0186, "duplicate [[#import]] location definition");
    SWAG_ERROR(Err0187, "duplicate [[#import]] version definition");
    SWAG_ERROR(Err0188, "duplicate [[#main]] function in module");
    SWAG_ERROR(Err0197, "duplicate [[%s]] application $ note: [[Swag.AttrMulti]] not specified");
    ...
    SWAG_ERROR(Err0195, "duplicate [[default]] clauses in [[switch]]");
    ...
    SWAG_ERROR(Err0198, "duplicate function [[%s]] definition $ hint: mark overloads with [[#[Swag.Overload]]]");
