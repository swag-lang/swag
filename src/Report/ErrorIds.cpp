...
void initErrors()
{
    ...
    SWAG_ERROR(Err0029, "assertion failed                                                                                       $ note: [[#assert]] expression evaluated to false");
    ...
    SWAG_ERROR(Err0027, "cannot allocate stack                                                                                  $ note: size exceeds [[%s]] limit set by [[--stack-size]]");
    SWAG_ERROR(Err0509, "cannot apply [[#null]] modifier                                                                        $ note: parameter already nullable due to [[null]] default value $ hint: remove the [[#null]] modifier");
    ...
    SWAG_ERROR(Err0162, "cannot assign                                                                                          $ note: call produces no value");
    SWAG_ERROR(Err0093, "cannot assign                                                                                          $ note: left expression is immutable");
    SWAG_ERROR(Err0165, "cannot bit-cast from [[%s]] to larger [[%s]]                                                           $ ");
    SWAG_ERROR(Err0028, "cannot capture                                                                                         $ note: size [[%u]] bytes exceeds limit [[%u]] bytes");
    SWAG_ERROR(Err0530, "cannot cast [[%s]] to [[%s]]                                                                           $ ");
    SWAG_ERROR(Err0202, "cannot cast [[%s]] to [[%s]]                                                                           $ note: implementation not found");
    ...
    SWAG_ERROR(Err0239, "cannot convert [[%s]] to [[%s]] by index                                                               $ note: missing [[opIndexAffect]]");
    ...
    SWAG_ERROR(Err0031, "cannot convert function return value into constant array                                               $ note: [[opCount]] returned [[0]] $ note: function return type is [[%s]]");
    SWAG_ERROR(Err0032, "cannot convert function return value into constant array                                               $ note: [[opSlice]] returned empty slice $ note: function return type is [[%s]]");
    SWAG_ERROR(Err0743, "cannot convert literal [[%llu]]                                                                        $ ");
    SWAG_ERROR(Err0033, "cannot convert type [[%s]] to a compile-time constant                                                  $ ");
    SWAG_ERROR(Err0090, "cannot copy [[%s]]                                                                                     $ note: marked [[#[Swag.NoCopy]]]");
    ...
    SWAG_ERROR(Err0763, "cannot emit data segment [[%s]]                                                                        $ note: size exceeds [[0x%llx]] bytes");
    ...
    SWAG_ERROR(Err0780, "cannot infer generic type                                                                              $ note: embedded tuples too complex");
    ...
    SWAG_ERROR(Err0501, "cannot inline [[%s]]                                                                                   $ note: expansion exceeds the configuration limit $ note: [[--limit-inline:%d]]");
    SWAG_ERROR(Err0080, "cannot instantiate generic struct with partial type alias ([[%s]])                                     $ ");
    SWAG_ERROR(Err0296, "cannot make %s [[%s]] public                                                                           $ note: %s [[%s]] has [[%s]] access");
    SWAG_ERROR(Err0297, "cannot make [[%s]] internal                                                                            $ note: struct declared [[public]]");
    SWAG_ERROR(Err0298, "cannot make [[%s]] public                                                                              $ note: struct declared [[internal]]");
    ...
    SWAG_ERROR(Err0091, "cannot modify [[%s]]                                                                                   $ note: immutable");
    SWAG_ERROR(Err0092, "cannot modify global [[%s]]                                                                            $ note: zero-initialized and immutable at compile-time");
    ...
    SWAG_ERROR(Err0762, "cannot process %s                                                                                      $ note: size exceeds [[0x%llx]] bytes");
    SWAG_ERROR(Err0733, "cannot read source file [[%s]]                                                                         $ ");
    SWAG_ERROR(Err0761, "cannot recurse further                                                                                 $ note: call level limit [[--limit-recurse-bc:%d]] exceeded");
    ...
    SWAG_ERROR(Err0144, "cannot take address of [[%s]]                                                                          $ note: returns no value");
    SWAG_ERROR(Err0145, "cannot take address                                                                                    $ note: %s has no address $ note: only variables have addresses");
    SWAG_ERROR(Err0152, "cannot take address                                                                                    $ note: [[let]] variable has no address $ hint: use [[var]] for a mutable variable");
    SWAG_ERROR(Err0147, "cannot take address                                                                                    $ note: constant type [[%s]] has no address $ note: this constant type has no storage");
    SWAG_ERROR(Err0149, "cannot take address                                                                                    $ note: function returning [[%s]] has no address");
    SWAG_ERROR(Err0153, "cannot take address                                                                                    $ note: inline function has no address");
    SWAG_ERROR(Err0150, "cannot take address                                                                                    $ note: macro has no address");
    SWAG_ERROR(Err0151, "cannot take address                                                                                    $ note: mixin has no address");
    SWAG_ERROR(Err0148, "cannot take address                                                                                    $ note: parameter type [[%s]] has no address $ note: this parameter type has no storage");
    SWAG_ERROR(Err0154, "cannot take address                                                                                    $ note: right-hand expression has no address");
    SWAG_ERROR(Err0146, "cannot take address                                                                                    $ note: string literal character has no address $ note: string literals have no storage");
    SWAG_ERROR(Err0250, "cannot unpack tuple                                                                                    $ note: contains no elements");
    SWAG_ERROR(Err0701, "cannot unpack%s[[%u]] variables                                                                        $ note: because right tuple has%s[[%u]] fields");
    ...
    SWAG_ERROR(Err0709, "cannot use [[%s]] in a union                                                                           $ note: contains [[%s]]");
    ...
    SWAG_ERROR(Err0353, "failed to patch icon in [[%s]]                                                                         $ note: %s");
    ...
    SWAG_ERROR(Err0220, "incompatible attributes                                                                                $ note: [[#[Swag.Opaque]]] with [[#global export]]");
    SWAG_ERROR(Err0171, "incompatible character literal with type [[%s]]                                                        $ ");
    SWAG_ERROR(Err0248, "incompatible comparison                                                                                $ note: tuple with [[%s]] $ note: tuples can only be compared with other tuples");
    ...
    SWAG_ERROR(Err0193, "incompatible generic [[%s]]                                                                            $ note: deduced as [[%s]], expected [[%s]]");
    SWAG_ERROR(Err0253, "incompatible second parameter type for [[%s]]                                                          $ note: expected [[%s]] $ hint: implement or use [[opAssign]] for value copying");
    ...
    SWAG_ERROR(Err0475, "inconsistent control paths                                                                             $ note: not all return a value in %s");
    ...
    SWAG_ERROR(Err0500, "index out of range                                                                                     $ note: index [[%llu]] exceeds the maximum value of [[%llu]]");
    ...
    SWAG_ERROR(Err0155, "invalid [[#[Swag.Align]]] value                                                                        $ note: not a power of two; found [[%d]]");
    ...
    SWAG_ERROR(Err0212, "invalid [[#[Swag.Foreign]]] module name                                                                $ note: [[.]] not allowed $ note: module names cannot contain file extensions");
    ...
    SWAG_ERROR(Err0223, "invalid [[#[Swag.Pack]]] value                                                                         $ note: found [[%d]] (not 0 or power of two)");
    SWAG_ERROR(Err0267, "invalid [[#alias]] context                                                                             $ note: allowed only in [[#[Swag.Macro]]] or [[#[Swag.Mixin]]]");
    ...
    SWAG_ERROR(Err0279, "invalid [[#elif]]                                                                                      $ note: without preceding [[#if]]");
    SWAG_ERROR(Err0280, "invalid [[#else]]                                                                                      $ note: without preceding [[#if]] or [[#elif]]");
    SWAG_ERROR(Err0158, "invalid [[#gettag]] last argument                                                                      $ note: must be constant, got [[%s]]");
    ...
    SWAG_ERROR(Err0034, "invalid [[#include]] filename                                                                          $ note: not a compile-time constant");
    ...
    SWAG_ERROR(Err0122, "invalid [[#sizeof]]                                                                                    $ note: applied to generic expression");
    SWAG_ERROR(Err0268, "invalid [[#uniq]] context                                                                              $ note: allowed only in [[#[Swag.Mixin]]]");
    ...
    SWAG_ERROR(Err0124, "invalid [[#up]] count                                                                                  $ note: must be an untyped integer, got [[%s]]");
    ...
    SWAG_ERROR(Err0159, "invalid [[@countof]] value                                                                             $ note: non-positive [[%lld]]");
    SWAG_ERROR(Err0160, "invalid [[@countof]] value                                                                             $ note: non-positive [[%d]]");
    ...
    SWAG_ERROR(Err0083, "invalid [[@postcopy]] on [[%s]]                                                                        $ note: disallowed by [[#[Swag.NoCopy]]]");
    ...
    SWAG_ERROR(Err0037, "invalid [[case]] expression                                                                            $ note: not a compile-time constant $ note: a [[switch]] statement marked with the [[#[Swag.Complete]]] attribute requires constant case values");
    ...
    SWAG_ERROR(Err0283, "invalid [[elif]]                                                                                       $ note: without preceding [[if]]");
    SWAG_ERROR(Err0284, "invalid [[else]]                                                                                       $ note: without preceding [[if]] or [[#elif]]");
    ...
    SWAG_ERROR(Err0295, "invalid [[impl]] syntax                                                                                $ note: targets [[%s]], but [[%s]] is [[%s]]");
    SWAG_ERROR(Err0139, "invalid [[impl]] target                                                                                $ note: [[%s]] is [[%s]], not an interface");
    SWAG_ERROR(Err0138, "invalid [[impl]] target                                                                                $ note: [[%s]] is [[%s]], not struct or enum");
    ...
    SWAG_ERROR(Err0337, "invalid [[moveref]] placement                                                                          $ note: must precede function arguments");
    SWAG_ERROR(Err0084, "invalid [[opDrop]] for [[%s]]                                                                          $ note: disallowed by [[#[Swag.ConstExpr]]]");
    SWAG_ERROR(Err0085, "invalid [[opPostCopy]] for [[%s]]                                                                      $ note: disallowed by [[#[Swag.NoCopy]]]");
    ...
    SWAG_ERROR(Err0231, "invalid [[ref]]                                                                                        $ note: applied to non-pointer or non-reference type [[%s]]");
    ...
    SWAG_ERROR(Err0246, "invalid [[throw]]                                                                                      $ note: requires struct or [[@err]] expression");
    ...
    SWAG_ERROR(Err0019, "invalid [[using]]                                                                                      $ note: applied to multiple variables of type [[%s]]");
    ...
    SWAG_ERROR(Err0134, "invalid [[visit]] specialization name                                                                  $ note: $$TKN$$");
    ...
    SWAG_ERROR(Err0117, "invalid [[while]] condition                                                                            $ note: always evaluates to [[true]] $ hint: use [[for { ... }]] for an intentional infinite loop");
    SWAG_ERROR(Err0616, "invalid [[with]] expression                                                                            $ ");
    SWAG_ERROR(Err0381, "invalid [[{]] after [[try]], [[assume]], or [[catch]]                                                  $ ");
    SWAG_ERROR(Err0142, "invalid access                                                                                         $ note: compile-time %s [[%s]] accessed from runtime %s");
    SWAG_ERROR(Err0143, "invalid access                                                                                         $ note: compile-time %s accessed from runtime %s");
    ...
    SWAG_ERROR(Err0035, "invalid argument [[%s]]                                                                                $ note: not a compile-time constant");
    SWAG_ERROR(Err0195, "invalid argument for [[%s]]                                                                            $ note: expects literal but received type [[%s]]");
    ...
    SWAG_ERROR(Err0038, "invalid array dimension                                                                                $ note: not a compile-time constant");
    ...
    SWAG_ERROR(Err0737, "invalid assignment target                                                                              $ note: left expression is not assignable");
    SWAG_ERROR(Err0163, "invalid attribute [[%s]]                                                                               $ note: is %s");
    ...
    SWAG_ERROR(Err0363, "invalid attribute placement                                                                            $ note: must appear before [[%s]] $ hint: move the attribute before [[%s]]");
    ...
    SWAG_ERROR(Err0282, "invalid bracket closure                                                                                $ note: [[[]]] without matching [[[]");
    SWAG_ERROR(Err0189, "invalid call target [[%s]]                                                                             $ note: is [[%s]], not callable");
    SWAG_ERROR(Err0537, "invalid call to [[%s]] with type [[%s]]                                                                $ note: [[%s]] requires type [[%s]] as its first argument");
    SWAG_ERROR(Err0187, "invalid call                                                                                           $ note: [[%s]] invoked with [[{}]] instead of [[()]]");
    SWAG_ERROR(Err0205, "invalid callable variable [[%s]]                                                                       $ note: is %s");
    SWAG_ERROR(Err0168, "invalid capture of [[%s]]                                                                              $ note: is %s $ note: capturing %s is not allowed");
    SWAG_ERROR(Err0169, "invalid capture                                                                                        $ note: [[%s]] is not plain old data $ note: structs with [[opDrop]], [[opPostCopy]], or [[opPostMove]] cannot be captured");
    SWAG_ERROR(Err0626, "invalid character [['%s']]                                                                             $ ");
    SWAG_ERROR(Err0170, "invalid character literal                                                                              $ note: [['%s']] appears as string, not single character");
    SWAG_ERROR(Err0287, "invalid character                                                                                      $ note: [[0x%x]] exceeds [[u16]] range");
    SWAG_ERROR(Err0288, "invalid character                                                                                      $ note: [[0x%x]] exceeds [[u8]] range");
    SWAG_ERROR(Err0383, "invalid closure outside a function scope                                                               $ note: closure definitions are allowed only within functions");
    SWAG_ERROR(Err0312, "invalid combination                                                                                    $ note: [[%s]] conflicts with [[%s]]");
    ...
    SWAG_ERROR(Err0078, "invalid constraint                                                                                     $ note: %s [[%s]] violates [[%s]]");
    ...
    SWAG_ERROR(Err0054, "invalid division                                                                                       $ note: division by [[-1]] causes overflow");
    SWAG_ERROR(Err0053, "invalid division                                                                                       $ note: division by zero");
    ...
    SWAG_ERROR(Err0010, "invalid enum value                                                                                     $ note: [[%s]] has the same underlying value as [[%s]]");
    SWAG_ERROR(Err0071, "invalid error propagation                                                                              $ note: escapes from [[defer]] or [[defer<err>]] block");
    SWAG_ERROR(Err0676, "invalid escape code [['%c']]                                                                           $ ");
    SWAG_ERROR(Err0183, "invalid expression                                                                                     $ note: [[%s]] is statement-only");
    SWAG_ERROR(Err0040, "invalid expression                                                                                     $ note: not a compile-time constant");
    SWAG_ERROR(Err0185, "invalid expression                                                                                     $ note: replaced by type");
    SWAG_ERROR(Err0510, "invalid field name [[%s]]                                                                              $ note: reserved by the language $ note: names beginning with [[item]] are reserved");
    ...
    SWAG_ERROR(Err0157, "invalid first argument to [[%s]]                                                                       $ note: requires [[variable]] when the second [[@init]] argument is omitted");
    SWAG_ERROR(Err0203, "invalid first parameter [[%s]]; expected [[me]]                                                        $ hint: use [[mtd]] instead of [[func]] for interface methods");
    SWAG_ERROR(Err0262, "invalid first parameter type for [[%s]]                                                                $ note: expected [[%s]], got [[%s]]");
    ...
    SWAG_ERROR(Err0511, "invalid function name [[%s]]                                                                           $ note: reserved by the compiler");
    SWAG_ERROR(Err0745, "invalid function return type [[%s]]                                                                    $ ");
    SWAG_ERROR(Err0194, "invalid generic argument                                                                               $ note: %s ([[%s]]) $ hint: generic arguments must be literals or types");
    SWAG_ERROR(Err0400, "invalid generic arguments                                                                              $ note: %s [[%s]] is not generic and cannot be specialized");
    SWAG_ERROR(Err0197, "invalid generic type                                                                                   $ note: type starting with [[:]] not allowed");
    ...
    SWAG_ERROR(Err0513, "invalid identifier [[%s]]                                                                              $ note: uses reserved [[__]] prefix $ note: the [[__]] prefix is reserved for compiler use");
    SWAG_ERROR(Err0512, "invalid identifier [[_]]                                                                               $ note: reserved by the compiler");
    SWAG_ERROR(Err0224, "invalid index operation on [[%s]]                                                                      $ note: pointer arithmetic disallowed on [[%s]]");
    SWAG_ERROR(Err0524, "invalid initialization count for type [[%s]]                                                           $ note: expected [[1]] value, found [[%d]]");
    SWAG_ERROR(Err0042, "invalid initialization                                                                                 $ note: not a compile-time constant");
    SWAG_ERROR(Err0043, "invalid initialization                                                                                 $ note: not a compile-time constant $ hint: add the [[#[Swag.ConstExpr]]] attribute to [[opAffect]] to allow this");
    SWAG_ERROR(Err0592, "invalid input                                                                                          $ note: expected [[%s]], found [[%s]]");
    ...
    SWAG_ERROR(Err0206, "invalid literal suffix for [[%s]]                                                                      $ note: [[%s]] $ note: suffix must correspond to a valid type");
    SWAG_ERROR(Err0210, "invalid logical operator                                                                               $ note: expected [[%s]] but found [[%s]]");
    SWAG_ERROR(Err0332, "invalid match variable                                                                                 $ note: used with multiple [[case]] values $ hint: each [[case]] must have exactly one value");
    SWAG_ERROR(Err0333, "invalid match variable                                                                                 $ note: used without [[switch]] expression");
    SWAG_ERROR(Err0190, "invalid member in interface                                                                            $ note: [[%s]]; requires [[func]] or [[mtd]] $ hint: declare interface functions with [[func]] or [[mtd]]");
    SWAG_ERROR(Err0036, "invalid message [[%s]]                                                                                 $ note: not a compile-time constant");
    SWAG_ERROR(Err0402, "invalid move reference                                                                                 $ note: a move reference [[&&]] is only valid for function parameters");
    SWAG_ERROR(Err0514, "invalid namespace name [[%s]]                                                                          $ note: reserved");
    SWAG_ERROR(Err0293, "invalid negation                                                                                       $ note: [[%lld]] exceeds [[s64]]; [[%llu]] too large");
    SWAG_ERROR(Err0294, "invalid negation                                                                                       $ note: [[%d]] exceeds [[%s]] range; [[%u]] too large");
    ...
    SWAG_ERROR(Err0292, "invalid numeric literal                                                                                $ note: exceeds 64-bit range");
    SWAG_ERROR(Err0222, "invalid operation [['%s']] on [[null]] value                                                           $ ");
    SWAG_ERROR(Err0767, "invalid operation [['%s']]                                                                             $ note: left enum [[%s]] not marked [[#[Swag.EnumFlags]]] $ hint: add the [[#[Swag.EnumFlags]]] attribute to the left enum");
    SWAG_ERROR(Err0768, "invalid operation [['%s']]                                                                             $ note: right enum [[%s]] not marked [[#[Swag.EnumFlags]]] $ hint: add the [[#[Swag.EnumFlags]]] attribute to the right enum");
    SWAG_ERROR(Err0044, "invalid operation on [[%s]]                                                                            $ note: not a compile-time constant $ hint: add the [[#[Swag.ConstExpr]]] attribute to the struct to allow this");
    ...
    SWAG_ERROR(Err0041, "invalid parameter [[%s]] of type [[%s]]                                                                $ note: not a compile-time constant");
    SWAG_ERROR(Err0258, "invalid parameter for [[%s]]                                                                           $ note: requires [[bool]], got [[%s]]");
    SWAG_ERROR(Err0259, "invalid parameter for [[%s]]                                                                           $ note: requires [[string]], got [[%s]]");
    ...
    SWAG_ERROR(Err0227, "invalid pointer arithmetic                                                                             $ note: requires integer, got [[%s]]");
    SWAG_ERROR(Err0228, "invalid pointer slicing: type not supported                                                            $ ");
    SWAG_ERROR(Err0503, "invalid range expression                                                                               $ note: the lower bound [[%llu]] exceeds the upper bound [[%llu]]");
    ...
    SWAG_ERROR(Err0229, "invalid range                                                                                          $ note: lower bound [[%lld]] exceeds upper bound [[%lld]] $ hint: use [[#reverse]] for descending ranges");
    SWAG_ERROR(Err0532, "invalid range                                                                                          $ note: mixes signed and unsigned bounds $ note: both range bounds must use the same sign");
    SWAG_ERROR(Err0072, "invalid reference                                                                                      $ note: %s [[%s]] resides in a different stack frame");
    ...
    SWAG_ERROR(Err0232, "invalid return type [[void]]                                                                           $ note: a value is required $ hint: remove the return type if the function returns nothing");
    SWAG_ERROR(Err0473, "invalid return type                                                                                    $ note: already inferred as [[%s]]");
    ...
    SWAG_ERROR(Err0398, "invalid specialization                                                                                 $ note: type required but value provided");
    SWAG_ERROR(Err0399, "invalid specialization                                                                                 $ note: value required but type provided");
    ...
    SWAG_ERROR(Err0056, "invalid struct initialization                                                                          $ note: both type syntax and assignment");
    SWAG_ERROR(Err0237, "invalid struct initialization                                                                          $ note: used [[()]] instead of [[{}]] $ hint: use [[{}]] for struct initialization; [[()]] is for function calls");
    ...
    SWAG_ERROR(Err0073, "invalid syntax                                                                                         $ note: unexpected $$TKN$$, expected [[%s]]");
    ...
    SWAG_ERROR(Err0310, "invalid top-level call [[%s]]                                                                          $ note: not marked [[#[Swag.Mixin]]] $ hint: only mixin calls are allowed at the top level");
    SWAG_ERROR(Err0247, "invalid top-level instruction                                                                          $ note: token $$TKN$$");
    ...
    SWAG_ERROR(Err0263, "invalid type [[%s]]                                                                                    $ note: is %s");
    ...
    SWAG_ERROR(Err0264, "invalid type declaration                                                                               $ note: token $$TKN$$");
    ...
    SWAG_ERROR(Err0289, "invalid value: [[%llu]] does not fit in [[%s]]                                                         $ ");
    ...
    SWAG_ERROR(Err0508, "invalid visibility specifier [[%s]]                                                                    $ note: conflicts with [[#global export]] $ hint: remove [[public]] since [[#global export]] already makes all declarations public");
    ...
    SWAG_ERROR(Err0106, "missing [[,]] or [[')']] before $$TNK$$                                                                $ ");
    ...
    SWAG_ERROR(Err0759, "missing required error                                                                                 $ note: none detected");
    SWAG_ERROR(Err0760, "missing required warning                                                                               $ note: none detected");
    ...
    SWAG_ERROR(Err0172, "too many identifiers                                                                                   $ note: expected single %s $ hint: remove the [['.']] separator");
    ...
    SWAG_ERROR(Err0286, "unmatched comment terminator [['*/']] after %s                                                         $ note: missing matching [['/*']]");
