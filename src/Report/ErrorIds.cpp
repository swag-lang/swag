...
void initErrors()
{
    ...
    SWAG_ERROR(Err0109, "generic type mismatch                             $ expected type [[%s]] for the generic %s, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0134, "invalid [[#import]] location                      $ expected a [[#import]] location path, got [[%]] instead");
    SWAG_ERROR(Err0135, "invalid [[#import]] location                      $ expected a [[#import]] version as a string, got [[%]] instead");
    ...
    SWAG_ERROR(Err0186, "invalid argument                                  $ [[#include]] requires an argument of type [[string]], got [[%s]] instead");
    SWAG_ERROR(Err0187, "invalid argument                                  $ [[#mixin]] requires an argument of type [[code]], got [[%s]] instead");
    SWAG_ERROR(Err0188, "invalid argument                                  $ [[%s]] requires an argument of type [[bool]], got [[%s]] instead");
    ...
    SWAG_ERROR(Err0190, "invalid argument                                  $ the [[%s]] count must be an integer, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0193, "invalid argument                                  $ the intrinsic [[%s]] requires a block pointer as a first argument, got [[%s]] instead");
    SWAG_ERROR(Err0194, "invalid argument                                  $ the intrinsic [[%s]] requires a pointer as a first argument, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0196, "invalid argument                                  $ the intrinsic [[%s]] requires an argument of type [[string]], got [[%s]] instead");
    ...
    SWAG_ERROR(Err0200, "invalid argument                                  $ the intrinsic [[@mkcallback]] requires a pointer to function as a first argument, got [[%s]] instead");
    SWAG_ERROR(Err0201, "invalid argument                                  $ the intrinsic [[@mkinterface]] requires a pointer or a struct as a first argument, got [[%s]] instead");
    SWAG_ERROR(Err0202, "invalid argument                                  $ the intrinsic [[@mkinterface]] requires a type as a second argument, got [[%s]] instead");
    SWAG_ERROR(Err0203, "invalid argument                                  $ the intrinsic [[@mkinterface]] requires an interface name as a third argument, got [[%s]] instead");
    SWAG_ERROR(Err0204, "invalid argument                                  $ the intrinsic [[@mkstring]] requires a pointer to [[u8]] as a first argument, got [[%s]] instead");
    SWAG_ERROR(Err0205, "invalid argument                                  $ the intrinsic [[@runes]] requires an argument of type [[string]], got [[%s]] instead");
    SWAG_ERROR(Err0206, "invalid array dimension                           $ the array dimension is 0");
    SWAG_ERROR(Err0207, "invalid array dimension                           $ the array dimension must be an integer, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0262, "invalid enum type                                 $ an enum marked with [[#[Swag.EnumFlags]]] should have an unsigned integer type, got [[%s]] instead");
    SWAG_ERROR(Err0263, "invalid enum type                                 $ an enum marked with [[#[Swag.EnumIndex]]] should have an integer type, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0311, "invalid interface function                        $ the first parameter should be [[self]], got [[%s]] instead $ consider declaring the interface function with [[mtd]] instead of [[func]]");
    ...
    SWAG_ERROR(Err0348, "invalid parameter                                 $ the [[#message]] block needs a parameter of type [[Swag.CompilerMsgMask]], got [[%s]]");
    ...
    SWAG_ERROR(Err0353, "invalid pointer arithmetic                        $ pointer arithmetic requires an integer, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0357, "invalid reference                                 $ [[ref]] requires a pointer or a reference as an expression, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0362, "invalid return type                               $ the function [[opSlice]] must return a string or a slice, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0382, "invalid type                                      $ the operator [[<<]] requires an integer, got [[%s]] instead");
    SWAG_ERROR(Err0383, "invalid type                                      $ the operator [[>>]] requires an integer, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0385, "invalid type                                      $ the special function [[%s]] expects a [[bool]] as a generic parameter, got [[%s]] instead");
    SWAG_ERROR(Err0386, "invalid type                                      $ the special function [[%s]] expects a [[string]] as a generic parameter, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0401, "invalid variable name                             $ expected a variable name, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0421, "mismatch enum types                               $ expected an enum of type [[%s]], got [[%s]] instead");
    ...
    SWAG_ERROR(Err0478, "misplaced attribute                               $ the [[#[Swag.Discardable]]] attribute can only be applied to lambda variables, got [[%s]]");
    ...
    SWAG_ERROR(Err0614, "return type mismatch                              $ an [[#ast]] block must return a string, got [[%s]] instead");
    SWAG_ERROR(Err0615, "return type mismatch                              $ the return type has already been deduced to be [[%s]], and here it's [[%s]]");
    SWAG_ERROR(Err0616, "return type mismatch                              $ the return type has already been deduced to be nothing, and here it's [[%s]]");
    ...
    SWAG_ERROR(Err0636, "type mismatch                                     $ casting from [[%s]] to [[%s]] is not allowed");
    SWAG_ERROR(Err0637, "type mismatch                                     $ casting from [[%s]] to a pointer type is not allowed");
    SWAG_ERROR(Err0638, "type mismatch                                     $ casting from a type value ([[typeinfo]]) to a compile type ([[%s]]) is not allowed");
    SWAG_ERROR(Err0639, "type mismatch                                     $ casting from a value pointer [[%s]] to a block pointer [[%s]] is not allowed");
    SWAG_ERROR(Err0640, "type mismatch                                     $ casting from closure to lambda is not allowed");
    SWAG_ERROR(Err0641, "type mismatch                                     $ expected [[%s]] for field [[%s]], got [[%s]] instead");
    SWAG_ERROR(Err0642, "type mismatch                                     $ expected return type [[%s]] for special function [[%s]], got [[%s]] instead");
    SWAG_ERROR(Err0643, "type mismatch                                     $ expected type [[%s]] for the UFCS argument, got [[%s]] instead");
    SWAG_ERROR(Err0644, "type mismatch                                     $ expected type [[%s]], got [[%s]] instead");
    SWAG_ERROR(Err0645, "type mismatch                                     $ expected type [[*Swag.CVaList]], got [[%s]] instead");
    ...
    SWAG_ERROR(Err0647, "type mismatch                                     $ the [[%s]] assignment requires an expression of type [[%s]], got [[%s]] instead");
    ...
    SWAG_ERROR(Err0731, "unsupported index type                            $ the array access index must be an integer, got [[%s]] instead");
