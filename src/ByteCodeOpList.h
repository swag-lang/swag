...
BYTECODE_OP(AffectOpAndEqS8, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] &= _rbs8_", 0)
BYTECODE_OP(AffectOpAndEqS16, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] &= _rbs16_", 0)
BYTECODE_OP(AffectOpAndEqS32, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] &= _rbs32_", 0)
BYTECODE_OP(AffectOpAndEqS64, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] &= _rbs64_", 0)

BYTECODE_OP(AffectOpOrEqS8, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] |= _rbs8_", 0)
BYTECODE_OP(AffectOpOrEqS16, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] |= _rbs16_", 0)
BYTECODE_OP(AffectOpOrEqS32, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] |= _rbs32_", 0)
BYTECODE_OP(AffectOpOrEqS64, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] |= _rbs64_", 0)

BYTECODE_OP(AffectOpXorEqU8, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] ^= _rbs8_", 0)
BYTECODE_OP(AffectOpXorEqU16, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] ^= _rbs16_", 0)
BYTECODE_OP(AffectOpXorEqU32, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] ^= _rbs32_", 0)
BYTECODE_OP(AffectOpXorEqU64, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "[_ra_] ^= _rbs64_", 0)
