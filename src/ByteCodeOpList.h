...
BYTECODE_OP(IntrinsicStrCmp, OPFLAG_READ_A | OPFLAG_READ_B | OPFLAG_READ_C | OPFLAG_READ_D | OPFLAG_WRITE_D, "_rd_ = @strcmp(_ra_, _rb_, _rc_, _rd_)", 5)
...
BYTECODE_OP(IntrinsicMemCpy, OPFLAG_READ_A | OPFLAG_READ_B | OPFLAG_READ_C, "@memcpy(_ra_, _rb_, _rc_)", 0)
...
BYTECODE_OP(Add32byVB32, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_VAL32_B | OPFLAG_IMM_C, "", 0)
BYTECODE_OP(Add64byVB64, OPFLAG_READ_A | OPFLAG_WRITE_A | OPFLAG_READ_VAL64_B | OPFLAG_IMM_C, "", 0)
...
BYTECODE_OP(CopyRCtoRT, OPFLAG_READ_A, "&result = _ra_", 0)
BYTECODE_OP(CopyRRtoRC, OPFLAG_WRITE_A, "_ra_ = &result", 0)
...
BYTECODE_OP(CopySPVaargs, OPFLAG_WRITE_A | OPFLAG_READ_VAL32_B | OPFLAG_READ_VAL32_C | OPFLAG_READ_VAL64_D, "_ra_ = &sp - _rcu32_", 0)

BYTECODE_OP(GetFromStackParam64SI, OPFLAG_WRITE_A | OPFLAG_READ_VAL32_B | OPFLAG_READ_VAL32_C, "", 0)
BYTECODE_OP(IntrinsicIsConstExprSI, OPFLAG_WRITE_A | OPFLAG_READ_VAL32_B, "", 0)
...
BYTECODE_OP(MakeStackPointerParam, OPFLAG_WRITE_A | OPFLAG_READ_VAL32_B | OPFLAG_READ_VAL32_C, "_ra_ = param + _rcu32_", 0)
...
BYTECODE_OP(CastBool8, OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "_ra_ = cast(bool, 0) _rb_", 0)
BYTECODE_OP(CastBool16, OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "_ra_ = cast(bool, 0) _rb_", 0)
BYTECODE_OP(CastBool32, OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "_ra_ = cast(bool, 0) _rb_", 0)
BYTECODE_OP(CastBool64, OPFLAG_WRITE_A | OPFLAG_READ_B | OPFLAG_IMM_B, "_ra_ = cast(bool, 0) _rb_", 0)

BYTECODE_OP(CastS8S16, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s16, 0) _ra_", 0)

BYTECODE_OP(CastS8S32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s32, 0) _ra_", 0)
BYTECODE_OP(CastS16S32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s32, 0) _ra_", 0)
BYTECODE_OP(CastF32S32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s32, 0) _ra_", 0)

BYTECODE_OP(CastS8S64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s64, 0) _ra_", 0)
BYTECODE_OP(CastS16S64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s64, 0) _ra_", 0)
BYTECODE_OP(CastS32S64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s64, 0) _ra_", 0)
BYTECODE_OP(CastF64S64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(s64, 0) _ra_", 0)

BYTECODE_OP(CastS8F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastS16F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastS32F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastS64F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastU8F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastU16F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastU32F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastU64F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)
BYTECODE_OP(CastF64F32, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f32, 0) _ra_", 0)

BYTECODE_OP(CastS8F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastS16F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastS32F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastS64F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastU8F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastU16F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastU32F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastU64F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
BYTECODE_OP(CastF32F64, OPFLAG_READ_A | OPFLAG_WRITE_A, "_ra_ = cast(f64, 0) _ra_", 0)
