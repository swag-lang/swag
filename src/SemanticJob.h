...
struct SemanticJob : public Job
{
    ...
    static bool     reserveAndStoreToSegment(JobContext* context, DataSegment* segment, uint32_t& storageOffset, ComputedValue* value, TypeInfo* typeInfo, AstNode* assignment);
    static bool     storeToSegment(SemanticContext* context, DataSegment* segment, uint32_t storageOffset, ComputedValue* value, TypeInfo* typeInfo, AstNode* assignment);
