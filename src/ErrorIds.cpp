...
const char* Msg0559 = "'move' cannot be applied to a constant expression (type is '%s')";
...
const char* Msg0306 = "'slice' type should be declared as immutable with 'const', because right expression is const";
...
const char* Msg0600 = "attribute '%s' does not have the 'Swag.AttributeUsage.File' usage, so it cannot be used with '#global'";
...
const char* Msg0476 = "bad slicing arguments, lower bound '%I64u' is greater than upper bound '%I64u'";
const char* Msg0477 = "bad slicing arguments, upper bound '%I64u' is out of range";
...
const char* Msg0029 = "cannot alias a struct member";
...
const char* Msg0091 = "cannot reference compile time %s '%s' (marked with 'Swag.Compiler') from runtime %s";
const char* Msg0107 = "cannot reference compile time function '%s' (marked with 'Swag.Compiler') from runtime function '%s'";
...
const char* Msg0291 = "cannot unpack type '%s' (expected a struct)";
...
const char* Msg0624 = "cannot visit a tuple type";
...
const char* Msg0012 = "expected an expression, found a type";
...
const char* Msg0772 = "expected return expression of type '%s' after 'return'";
...
const char* Msg0124 = "invalid lambda call, '%s' is not a variable (it's %s)";
...
const char* Msg0040 = "partial type alias '%s' for generic struct instantiation is not supported";
...
const char* Msg0474 = "slicing operator cannot be applied on an array with multiple dimensions (type is '%s')";
...
const char* Msg0696 = "struct '%s' already defined";
...
const char* Msg0645 = "variable initialized twice, first with type arguments, and then with an assignment";
