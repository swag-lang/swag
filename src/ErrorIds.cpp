...
void initErrors()
{
    ...
    SWAG_ERROR(Err0380, "the `#import` location is defined twice");
    SWAG_ERROR(Err0382, "the `#import` version is defined twice");
    ...
    SWAG_ERROR(Err0376, "unexpected `#global` instruction `%s`");
