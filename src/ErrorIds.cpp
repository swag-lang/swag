...
void initErrors()
{
    ...
    SWAG_ERROR(Fat0011, "[fatal] workspace folder expected '--workspace'");
    ...
    SWAG_ERROR(Tkn0003, "binary digit expected, got '%s'");
    ...
    SWAG_ERROR(Tkn0004, "hexadecimal digit expected, got '%s'");
    ...
    SWAG_ERROR(Syn0082, "'#global if' expression expected");
    ...
    SWAG_ERROR(Syn0083, "'#if' expression expected");
    ...
    SWAG_ERROR(Syn0211, "'#up' scopes count as literal expected, found '%s'");
    ...
    SWAG_ERROR(Syn0084, "'if' boolean expression before '{' expected");
    SWAG_ERROR(Syn0104, "'impl' block generation allowed only in '#message' with 'Swag.CompilerMsgMask.AttributeGen'");
    SWAG_ERROR(Syn0085, "'loop' evaluation expression before '{' expected");
    ...
    SWAG_ERROR(Syn0086, "'visit' evaluation expression before '{' expected");
    SWAG_ERROR(Syn0087, "'while' boolean expression before '{' expected");
    ...
    SWAG_ERROR(Syn0071, "alias name expected, found '%s'");
    SWAG_ERROR(Syn0195, "ambiguous lambda type parameter declaration");
    SWAG_ERROR(Syn0200, "ambiguous syntax");
    SWAG_ERROR(Syn0212, "another 'visit' variable name expected before ':'");
    ...
    SWAG_ERROR(Syn0074, "enum name expected, found '%s'");
    SWAG_ERROR(Syn0075, "enum value identifier expected, found '%s'");
    SWAG_ERROR(Syn0048, "expected '%s' %s, got '%s'");
    SWAG_ERROR(Syn0049, "expected '(' for closure parameters");
    SWAG_ERROR(Syn0050, "expected ',' or ']', got '%s'");
    ...
    SWAG_ERROR(Syn0184, "expected constant name, got '%s'");
    ...
    SWAG_ERROR(Syn0090, "function parameter type or assignment (':' or '=') expected");
    SWAG_ERROR(Syn0091, "function parameters before '{' expected");
    SWAG_ERROR(Syn0092, "generic parameters expected");
    SWAG_ERROR(Syn0162, "generic parameters found, none expected");
    SWAG_ERROR(Syn0161, "generic parameters not expected for variable '%s'");
    SWAG_ERROR(Syn0036, "global 'using' must be at file start");
    SWAG_ERROR(Syn0122, "identifier '%s' starts with '__', language-reserved");
    SWAG_ERROR(Syn0077, "identifier expected");
    SWAG_ERROR(Syn0218, "identifier expected, found %s '%s'");
    SWAG_ERROR(Syn0078, "identifier expected, found '%s'");
    ...
    SWAG_ERROR(Syn0216, "invalid parameters for variable '%s'");
    SWAG_ERROR(Syn0167, "invalid pass name '%s'");
    SWAG_ERROR(Syn0172, "invalid symbol '%s' in type declaration");
    SWAG_ERROR(Syn0199, "invalid token '%s' in lambda type; ',' or ')' expected");
    SWAG_ERROR(Syn0175, "invalid token '%s' in tuple type; ',' or '}' expected");
    SWAG_ERROR(Syn0108, "label name invalid; add ';' or use valid identifier");
    SWAG_ERROR(Syn0107, "label name should be a valid identifier");
    SWAG_ERROR(Syn0191, "lambda parameter name not expected");
    SWAG_ERROR(Syn0170, "lambda parameter type not expected");
    SWAG_ERROR(Syn0165, "lambda return type not expected");
    SWAG_ERROR(Syn0059, "left expression required");
    SWAG_ERROR(Syn0109, "location '%s' is invalid");
    SWAG_ERROR(Syn0203, "match string expected after ',', found '%'");
    ...
    SWAG_ERROR(Syn0093, "namespace name before ';' expected");
    SWAG_ERROR(Syn0094, "namespace name before '{' expected");
    ...
    SWAG_ERROR(Syn0114, "slice upper bound expects integer, got '%s'");
    ...
    SWAG_ERROR(Syn0054, "to start %s body, expected '{', got ';'");
    ...
    SWAG_ERROR(Syn0177, "tuple unpacking not expected in %s");
    SWAG_ERROR(Syn0189, "type declaration after unnamed parameters detected");
    SWAG_ERROR(Syn0066, "type declaration expected, found '%s'");
    ...
    SWAG_ERROR(Err0498, "'%s' count must be integer, got '%s'");
    SWAG_ERROR(Err0495, "'%s' first parameter must be pointer, got '%s'");
    ...
    SWAG_ERROR(Err0249, "'%s' parameter must be string, got '%s'");
    SWAG_ERROR(Err0201, "'%s' references itself, causing recursion");
    SWAG_ERROR(Err0496, "'%s' second parameter must be pointer, got '%s'");
    SWAG_ERROR(Err0497, "'%s' second parameter should point to '%s', points to '%s'");
    SWAG_ERROR(Err0137, "'%s' shouldn't be in struct special function ('%s')");
    SWAG_ERROR(Err0858, "'%s' shouldn't have line break %s");
    SWAG_ERROR(Err0772, "'%s' type expression expected after 'return'");
    ...
    SWAG_ERROR(Err0801, "'@countof' requires integer, got '%s'");
    ...
    SWAG_ERROR(Err0283, "'@gettag' expects default value, got type");
    SWAG_ERROR(Err0245, "'@gettag' expects name, got type");
    SWAG_ERROR(Err0630, "'@index' limited to breakable loops");
    SWAG_ERROR(Err0489, "'@init' first parameter must be pointer, got '%s'");
    SWAG_ERROR(Err0301, "'@mixin' number range: [0, 9] (given: '%u')");
    SWAG_ERROR(Err0790, "'@mkany' can't use 'null' as first parameter");
    SWAG_ERROR(Err0792, "'@mkany' expects 'typeinfo' or type for second parameter, got '%s'");
    SWAG_ERROR(Err0789, "'@mkany' requires pointer as first parameter");
    SWAG_ERROR(Err0785, "'@mkcallback' function limit exceeded: max '%d' parameters, got '%d'");
    ...
    SWAG_ERROR(Err0084, "'@runes' requires string, got '%s'");
    ...
    SWAG_ERROR(Err0517, "'ref' requires pointer/reference, got type '%s'");
    ...
    SWAG_ERROR(Err0236, "'string' type expected for '%s' message; received '%s'");
    ...
    SWAG_ERROR(Err0020, "arguments '()' expected when calling %s");
    ...
    SWAG_ERROR(Err0582, "attribute expected; '%s' is %s");
    ...
    SWAG_ERROR(Err0702, "enum type expected; got '%s'");
    ...
    SWAG_ERROR(Err0141, "expected '\"' or intrinsic name; got '%c'");
    ...
    SWAG_ERROR(Err0012, "expression expected; type found");
    ...
    SWAG_ERROR(Err0240, "expression type mismatch: expected 'code', got '%s'");
    ...
    SWAG_ERROR(Err0723, "field '%s' type mismatch; expected '%s', got '%s'");
    SWAG_ERROR(Err0050, "field '%s' type mismatch; expected '%s', got '%s'");
    ...
    SWAG_ERROR(Err0049, "generic parameters for %s expected");
    ...
    SWAG_ERROR(Err0848, "initialization of '%s' expected; enum '%s' lacks zero value");
    ...
    SWAG_ERROR(Err0061, "insufficient arguments for function '%s' (expected '%d', got '%d')");
    ...
    SWAG_ERROR(Err0646, "interface expected; '%s' is %s");
    ...
    SWAG_ERROR(Err0621, "invalid 'moveref' for type '%s' (pointer/reference expected)");
    ...
    SWAG_ERROR(Err0655, "invalid first parameter type (expected 'self', got '%s')");
    SWAG_ERROR(Err0317, "invalid floating point suffix, got type '%s'");
    ...
    SWAG_ERROR(Err0679, "invalid interface member type (expected 'self', got '%s')");
    ...
    SWAG_ERROR(Err0707, "one test error expected; none raised");
    SWAG_ERROR(Err0580, "one test warning expected; none raised");
    ...
    SWAG_ERROR(Err0068, "parameters for special function '%s' expected");
    ...
    SWAG_ERROR(Err0063, "return type for special function '%s' expected");
    SWAG_ERROR(Err0064, "return type for special function '%s' expected; got '%s'");
    SWAG_ERROR(Err0774, "return type mismatch (expected void, got '%s') for %s");
    ...
    SWAG_ERROR(Err0450, "single generic parameter expected for function '%s'; '%d' provided");
    ...
    SWAG_ERROR(Err0367, "slice lower bound type mismatch; expected integer, got '%s'");
    ...
    SWAG_ERROR(Err0074, "special function '%s' expects 'bool', got '%s'");
    SWAG_ERROR(Err0072, "special function '%s' expects 'string', got '%s'");
    SWAG_ERROR(Err0069, "special function '%s' expects type '%s', got '%s'");
    SWAG_ERROR(Err0065, "special function '%s' return type mismatch (expected '%s', got '%s')");
    ...
    SWAG_ERROR(Err0648, "struct expected; got '%s' as %s");
    SWAG_ERROR(Err0290, "struct expected; symbol '%s' is %s");
    ...
    SWAG_ERROR(Err0662, "struct or enum expected; got '%s' as %s");
    ...
    SWAG_ERROR(Err0053, "type mismatch; expected '%s', got '%s'");
    ...
    SWAG_ERROR(Err0233, "unexpected expression type in '%s' (expected 'bool', got '%s')");
    ...
    SWAG_ERROR(Err0687, "value below 256 expected");
    ...
    SWAG_ERROR(Hlp0034, "'#validif' and '#validifx' are not valid with 'opDrop', 'opPostCopy', or 'opPostMove'");
    SWAG_ERROR(Hlp0010, "'@alias' is only valid within a 'Swag.Macro' or 'Swag.Mixin' function");
    SWAG_ERROR(Hlp0020, "'@mixin' is permitted exclusively inside a 'Swag.Mixin' function");
    SWAG_ERROR(Hlp0012, "'Swag.Optim' should have either 'bytecode' or 'backend' as its value");
    SWAG_ERROR(Hlp0045, "'closure' should be accompanied by capture parameters enclosed in '|...|'");
    SWAG_ERROR(Hlp0039, "'with' should be paired with a single variable");
    SWAG_ERROR(Hlp0038, "a 'break' should be added");
    SWAG_ERROR(Hlp0021, "a generic argument must be a literal or a type");
    SWAG_ERROR(Hlp0024, "a standard function in an 'impl' block shouldn't overshadow a function from the matching interface");
    SWAG_ERROR(Hlp0015, "a struct special function should be defined within the corresponding 'impl' scope");
    SWAG_ERROR(Hlp0001, "attribute declarations shouldn't be tagged with 'throw'");
    SWAG_ERROR(Hlp0000, "attribute declarations shouldn't have return values prefixed with '->'");
    SWAG_ERROR(Hlp0032, "both parts of an 'orelse' should be of identical type");
    SWAG_ERROR(Hlp0017, "closures can only be defined within functions");
    SWAG_ERROR(Hlp0025, "consider 'typealias' to create an alias for %s");
    SWAG_ERROR(Hlp0042, "consider using 'func' instead of 'mtd'");
    SWAG_ERROR(Hlp0002, "could 'self' be missing?");
    SWAG_ERROR(Hlp0054, "did you forget 'var' or 'const' when declaring a global variable or constant?");
    SWAG_ERROR(Hlp0028, "do you need a 'using' before 'self'?");
    SWAG_ERROR(Hlp0053, "employ '{}' for an intentional empty statement");
    SWAG_ERROR(Hlp0052, "for a new block's start, consider placing '{' on a new line");
    SWAG_ERROR(Hlp0030, "for an infinite loop, use 'loop { ... }'");
    SWAG_ERROR(Hlp0004, "for lambda declaration, use 'func(' or 'closure('");
    SWAG_ERROR(Hlp0006, "for multi-dimensional array access, use [x, y], not [x][y]");
    SWAG_ERROR(Hlp0051, "for the start of a struct initialization block, consider eliminating spaces between '%s' and '{'");
    SWAG_ERROR(Hlp0036, "force the evaluation using '#run'");
    SWAG_ERROR(Hlp0008, "function names beginning with '@' are reserved for intrinsics");
    SWAG_ERROR(Hlp0014, "function names that start with 'op' followed by an uppercase letter are reserved for struct special functions");
    SWAG_ERROR(Hlp0016, "function parameters are immutable and can't be modified");
    SWAG_ERROR(Hlp0018, "if lambda parameter types are inferred, the return type will also be inferred");
    SWAG_ERROR(Hlp0019, "in lambda parameters, inferred and specified types shouldn't be combined");
    SWAG_ERROR(Hlp0027, "internal structs shouldn't export their special functions");
    SWAG_ERROR(Hlp0007, "methods are reserved for structs and interfaces");
    SWAG_ERROR(Hlp0050, "only variables can be initialized in this manner");
    SWAG_ERROR(Hlp0037, "please include a 'break' or a 'fallthrough'");
    SWAG_ERROR(Hlp0046, "pointer arithmetic is only valid for pointers declared with '^', not '*'");
    SWAG_ERROR(Hlp0026, "public structs should export all their special functions");
    SWAG_ERROR(Hlp0009, "struct member names that begin with 'item' are reserved by the language");
    SWAG_ERROR(Hlp0013, "the acceptable values for 'Swag.ExportType' are 'methods' and 'nozero'");
    SWAG_ERROR(Hlp0011, "the allowed safety values are 'boundcheck|overflow|math|switch|unreachable|any|bool|nan|sanity|null'");
    SWAG_ERROR(Hlp0048, "the correct values for 'Swag.Match' are 'validif|self'");
    SWAG_ERROR(Hlp0031, "the interface member can also be declared with 'mtd' instead of 'func'");
    SWAG_ERROR(Hlp0023, "the valid modes are 'defer(err)' and 'defer(noerr)'");
    SWAG_ERROR(Hlp0044, "this appears to be a potentially invalid UFCS call");
    SWAG_ERROR(Hlp0043, "this is ambiguous; consider removing one 'using'");
    SWAG_ERROR(Hlp0035, "this is reserved for function calls");
    SWAG_ERROR(Hlp0041, "this parameter type doesn't have related memory storage");
    SWAG_ERROR(Hlp0022, "this specific constant doesn't have associated memory storage");
    SWAG_ERROR(Hlp0005, "to dereference variable '%s' as in C, employ 'dref %s'");
    SWAG_ERROR(Hlp0047, "to slice to the end, use '..'");
    SWAG_ERROR(Hlp0040, "use '++' for compile-time string append operations");
    SWAG_ERROR(Hlp0033, "use '?' to unpack and ignore a variable");
    SWAG_ERROR(Hlp0029, "use 'mtd' instead of 'func' to implicitly declare 'using self' as the initial parameter");
    SWAG_ERROR(Hlp0003, "you can assign a lambda to a closure type, but not vice versa");
    SWAG_ERROR(Hlp0049, "you might want to get the address of '%s' using '&'");
    ...
    SWAG_ERROR(Hnt0102, "'self' has already been typed. Please remove the redundant type");
    ...
    SWAG_ERROR(Hnt0114, "a return type is missing");
    ...
    SWAG_ERROR(Hnt0047, "hidden call to '%s' detected");
    SWAG_ERROR(Hnt0119, "identified an enum value");
    SWAG_ERROR(Hnt0059, "identified as the first usage");
    SWAG_ERROR(Hnt0005, "if intended, initialize with 'undefined'");
    SWAG_ERROR(Hnt0124, "if intended, please add 'impl' before this");
    SWAG_ERROR(Hnt0092, "if intentional, rename this to '_%s'");
    SWAG_ERROR(Hnt0023, "if you don't need the return value, prefix this call with 'discard'");
    ...
    SWAG_ERROR(Hnt0105, "operation not allowed on type '%s'");
    SWAG_ERROR(Hnt0110, "operation not allowed because 'void' doesn't have a size");
    ...
    SWAG_ERROR(Hnt0021, "should be a pointer type");
    SWAG_ERROR(Hnt0058, "should be an integer type");
    SWAG_ERROR(Hnt0004, "should be designated as 'const %s'");
    SWAG_ERROR(Hnt0020, "should be designated as 'impl %s'");
    SWAG_ERROR(Hnt0019, "should be designated as 'impl enum %s'");
    SWAG_ERROR(Hnt0056, "should be succeeded by generic arguments");
    SWAG_ERROR(Hnt0052, "should cast to a sized integer like 's32', 's64', etc.");
    SWAG_ERROR(Hnt0051, "should cast to either 'f32' or 'f64'");
    SWAG_ERROR(Hnt0116, "should cast to the base 'any' type");
    SWAG_ERROR(Hnt0108, "should point to '%s'");
    SWAG_ERROR(Hnt0094, "should this be removed?")
    SWAG_ERROR(Hnt0060, "the 'dref' operation isn't possible here");
    SWAG_ERROR(Hnt0123, "the array has %d elements of type '%s', which doesn't match a slice of type '%s'");
    SWAG_ERROR(Hnt0000, "the divisor expression evaluates to zero");
    ...
    SWAG_ERROR(Hnt0032, "the type is '%s' (consider an explicit 'cast(%s)' if needed)");
    SWAG_ERROR(Hnt0011, "the type is identified as '%s'");
    SWAG_ERROR(Hnt0098, "the upper bound is expected");
    SWAG_ERROR(Hnt0083, "there's a missing '%s' of type '%s'");
    SWAG_ERROR(Hnt0049, "there's an implied first parameter 'self'");
    SWAG_ERROR(Hnt0070, "this %s has the 'Swag.Compiler' attribute");
    SWAG_ERROR(Hnt0084, "this %s is of type '%s'");
    SWAG_ERROR(Hnt0127, "this %s is set to '%s' access");
    ...
    SWAG_ERROR(Hnt0090, "this expression evaluates to '%f'");
    SWAG_ERROR(Hnt0091, "this expression evaluates to '%lld'");
    SWAG_ERROR(Hnt0033, "this expression results in 0");
    SWAG_ERROR(Hnt0057, "this function can't be instantiated");
    SWAG_ERROR(Hnt0078, "this function doesn't support aliased names");
    SWAG_ERROR(Hnt0073, "this function doesn't support UFCS of type '%s'");
    SWAG_ERROR(Hnt0065, "this function is tagged with the 'Swag.Test' attribute");
    SWAG_ERROR(Hnt0064, "this function is tagged with the 'Swag.Compiler' attribute");
    ...
    SWAG_ERROR(Hnt0036, "this is a pointer and can't be accessed");
    SWAG_ERROR(Hnt0027, "this is a type but a literal was expected");
    SWAG_ERROR(Hnt0054, "this is a type, not a value");
    SWAG_ERROR(Hnt0038, "this isn't a constant");
    SWAG_ERROR(Hnt0076, "this needs to be in lowercase");
    SWAG_ERROR(Hnt0089, "this parameter should also have a default value");
    SWAG_ERROR(Hnt0003, "this references a static struct member of '%s'");
    SWAG_ERROR(Hnt0075, "this should be a namespace, function, or variable instead of a type");
    SWAG_ERROR(Hnt0125, "this slice appears to be null or empty");
    SWAG_ERROR(Hnt0126, "this string seems to be null or empty");
    SWAG_ERROR(Hnt0068, "this tuple has '%d' field(s)");
    SWAG_ERROR(Hnt0069, "this tuple seems to be empty");
    ...
    SWAG_ERROR(Nte0000, "refer to its declaration");
    SWAG_ERROR(Nte0026, "refer to the %s");
    SWAG_ERROR(Nte0028, "refer to the declaration");
    SWAG_ERROR(Nte0007, "refer to the item '%s'");
    SWAG_ERROR(Nte0036, "refer to the other definition");
    ...
    SWAG_ERROR(Nte0021, "see another reference");
    SWAG_ERROR(Nte0031, "see the deprecated definition");
    SWAG_ERROR(Nte0023, "see the immutable value reference");
    SWAG_ERROR(Nte0035, "see the other '#import'");
    SWAG_ERROR(Nte0063, "see the other return statement");
    SWAG_ERROR(Nte0014, "see the other value reference");
    SWAG_ERROR(Nte0037, "see the preceding definition");
