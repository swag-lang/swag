...
void initErrors()
{
    ...
    SWAG_ERROR(Err0510, "i/o error                                         $ can't fetch file '%s' for module dependency '%s'");
    ...
    SWAG_ERROR(Err0702, "invalid enum type                                 $ the type '%s' can't be used as an enum type");
    ...
    SWAG_ERROR(Err0308, "invalid variable type                             $ can't deduce the type of the variable because the expression is 'null'");
    ...
    SWAG_ERROR(Err0243, "type mismatch                                     $ '@include' requires an argument of type 'string', got '%s' instead");
