...
void initErrors()
{
    ...
    SWAG_ERROR(Err0260, "invalid dereference                               $ derefencing type [[%s]] is not valid");
    ...
    SWAG_ERROR(Err0282, "invalid expression                                $ expected an expression after operator [[%s]], found [[%s]] instead $ consider adding [[(]] after [[%s]] to start an expression");
    ...
    SWAG_ERROR(Err0293, "invalid function declaration                      $ expected [[func]] or [[mtd]] to declare an interface function, found [[%s]] instead $ to declare a function within an interface, use [[func]] or [[mtd]]");
    ...
    SWAG_ERROR(Err0323, "invalid logical operator                          $ expected [[%s]] for the ogical test, found [[%s]] instead");
    ...
    SWAG_ERROR(Err0352, "invalid operator modifier                         $ [[%s]] is not recognized as a valid intruction modifier");
    SWAG_ERROR(Err0353, "invalid optim argument                            $ invalid argument [[%s]] for the attribute [[#[Swag.Optim]]] $ the acceptable values for [[#[Swag.Optim]]] are [[bytecode]] and [[backend]]");
    ...
    SWAG_ERROR(Err0508, "misplaced special function                        $ the struct special function [[%s]] should de declared within the corresponding [[impl]] block $ an [[impl for]] block can only be used to implement interfaces");
    SWAG_ERROR(Err0509, "misplaced special function                        $ the struct special function [[%s]] should de declared within the corresponding [[impl]] block");
    ...
    SWAG_ERROR(Err0517, "missing [[#foreignlib]] string argument           $ expected the library name after [[#foreignlib]], found [[%s]] instead $ use [[#foreignlib \"path/to/library\"]] to specify the library to import");
    ...
    SWAG_ERROR(Err0550, "missing end of line                               $ expected a line break or a [[;]] to close the %s, found [[%s]] instead $ consider adding a line break or separating the previous statement with a [[;]]");
    ...
    SWAG_ERROR(Err0674, "unexpected affectation                            $ unexpected usage of the assignement operator [[=]] inside an expression");
    ...
    SWAG_ERROR(Err0718, "unknown identifier                                $ the identifier [[%s]] is preceeded with [[.]] but no corresponding [[enum]] or [[with]] can be deduced");
    ...
    SWAG_ERROR(Err0735, "unsupported OS                                    $ the OS [[%s]] is not supported by the SCBE backend");
