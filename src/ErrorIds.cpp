...
void initErrors()
{
    ...
    SWAG_ERROR(Nte0134, "'#validif' and '#validifx' are not valid with 'opDrop', 'opPostCopy', or 'opPostMove'");
    ...
    SWAG_ERROR(Nte0123, "the valid modes are 'defer(err)' and 'defer(noerr)'");
    ...
    SWAG_ERROR(Nte0147, "to slice to the end, use '..'");
