...
const char* Msg0749 = "%s missing return value";
...
const char* Msg0750 = "'#compiler' function should have 'Swag.CompilerMsgMask' as a parameter";
const char* Msg0268 = "'#dependencies' can only be declared at the file level";
const char* Msg0232 = "'#dependencies' can only be used in the module configuration file";
const char* Msg0256 = "'#function' can only be called inside a function";
...
const char* Msg0376 = "'#global' unexpected token '%s'";
...
const char* Msg0377 = "'#import' can only be used in the module configuration file";
...
const char* Msg0739 = "'#main' directive already defined";
const char* Msg0366 = "'#mixin' empty replacement block";
const char* Msg0365 = "'#mixin' invalid replacement '%s'";
const char* Msg0364 = "'#mixin' replacement block can only be used inside a breakable statement";
...
const char* Msg0275 = "'@alias' variable name should be followed by a number";
...
const char* Msg0630 = "'@index' can only be used inside a breakable loop";
...
const char* Msg0869 = "'case' statement is empty";
const char* Msg0848 = "'catch' can only be used inside a function";
const char* Msg0637 = "'continue' can only be used inside a breakable loop";
...
const char* Msg0407 = "a method can only be declared inside a struct 'impl' block";
...
const char* Msg0564 = "affect operation not allowed, left expression is const";
...
const char* Msg0310 = "an enum variable should be initialized";
...
const char* Msg0483 = "cannot dereference type '%s'";
const char* Msg0094 = "cannot discard a function call that returns nothing";
const char* Msg0111 = "cannot discard a function call that returns nothing";
...
const char* Msg0673 = "cannot find structure member '%s' to compute variable relocation";
...
const char* Msg0291 = "cannot unpack type '%s' which is not a struct";
...
const char* Msg0898 = "expected a left expression for variable declaration";
...
const char* Msg0763 = "function '%s' cannot be marked with 'Swag.Inline' attribute";
const char* Msg0761 = "function '%s' cannot be marked with 'Swag.Macro' attribute";
const char* Msg0762 = "function '%s' cannot be marked with 'Swag.Mixin' attribute";
...
const char* Msg0756 = "function '%s' cannot have the 'Swag.Implicit' attribute because it's generic";
const char* Msg0754 = "function '%s' cannot have the 'Swag.Implicit' attribute, this is reserved for 'opAffect' and 'opCast'";
const char* Msg0755 = "function '%s' cannot have the 'Swag.NoReturn' attribute without 'Swag.Macro' or 'Swag.Mixin'";
const char* Msg0078 = "function '%s' does not match a special function/operator overload";
...
const char* Msg0757 = "function '%s' is marked with 'Swag.Macro' and 'Swag.Inline' attributes at the same time";
const char* Msg0758 = "function '%s' is marked with 'Swag.Macro' and 'Swag.Mixin' attributes at the same time";
const char* Msg0759 = "function '%s' is marked with 'Swag.Mixin' and 'Swag.Inline' attributes at the same time";
const char* Msg0760 = "function '%s' is marked with 'Swag.Mixin' and 'Swag.Macro' attributes at the same time";
const char* Msg0088 = "function '%s' is not declared with the 'Swag.Mixin' attribute, and this is mandatory for a function call at global scope";
...
const char* Msg0126 = "here is '%s'";
const char* Msg0158 = "here is a previous declaration";
const char* Msg0587 = "here is attribute '%s'";
const char* Msg0589 = "here is the %s";
const char* Msg0398 = "here is the declaration of '%s'";
const char* Msg0551 = "here is the declaration";
const char* Msg0018 = "here is the definition of '%s'";
const char* Msg0553 = "here is the definition of the tuple";
const char* Msg0084 = "here is the deprecated definition";
const char* Msg0592 = "here is the faulty attribute";
const char* Msg0106 = "here is the function";
const char* Msg0619 = "here is the missing value";
const char* Msg0517 = "here is the other '#import'";
const char* Msg0884 = "here is the other definition";
const char* Msg0287 = "here is the previous definition";
const char* Msg0253 = "here is the related command line option: '%s'";
const char* Msg0095 = "here is the variable declaration";
...
const char* Msg0881 = "identifier is preceeded with '.', but no scope can be found in context";
const char* Msg0201 = "if this is a tuple literal and not a type definition, use '@{' instead of '{'";
const char* Msg0198 = "if this is an array literal and not a type definition, use '@[' instead of '['";
...
const char* Msg0906 = "initialization value cannot be evaluated atcompile time because 'opAffect' is not 'Swag.ConstExpr'";
...
const char* Msg0276 = "invalid '@alias' variable name '%s', '%s' is not a valid number";
...
const char* Msg0099 = "invalid aliased identifiers because function '%s' is not a macro or a mixin";
...
const char* Msg0130 = "invalid generic parameters, identifier '%s' is %s and not a function or a structure";
const char* Msg0440 = "invalid generic parameters, should be naked";
const char* Msg0463 = "invalid hexadecimal digit '%s'";
const char* Msg0304 = "invalid initialization expression for an array";
...
const char* Msg0123 = "invalid lambda call, cannot reference structure member '%s'";
...
const char* Msg0455 = "invalid token '%s' in variable declaration, ':' or '=' are expected here";
...
const char* Msg0237 = "message expression cannot be evaluated at compile time";
const char* Msg0236 = "message expression is not a string";
...
const char* Msg0409 = "missing function parameter type or assignment";
...
const char* Msg0341 = "missing pointer '*' or reference '&' marker after 'const'";
...
const char* Msg0113 = "none of the %d overloads could match";
...
const char* Msg0006 = "parameter '%d' should be named";
const char* Msg0738 = "parameter '%d' should have a default value";
...
const char* Msg0416 = "special function '%s' should have a body";
...
const char* Msg0478 = "type '%s' is immutable and cannot be changed";
...
const char* Msg0307 = "type of expression is 'void'";
...
const char* Msg0271 = "variable name or '?' expected in tuple unpacking";
...
const char* Msg0858 = nullptr;
const char* Msg0561 = nullptr;
const char* Msg0826 = nullptr;
const char* Msg0315 = nullptr;
const char* Msg0622 = nullptr;
const char* Msg0825 = nullptr;
const char* Msg0190 = nullptr;
const char* Msg0560 = nullptr;
const char* Msg0823 = nullptr;
const char* Msg0623 = nullptr;
...
const char* Note021 = nullptr;
const char* Note022 = nullptr;
const char* Note023 = nullptr;
const char* Note024 = nullptr;
const char* Note025 = nullptr;
