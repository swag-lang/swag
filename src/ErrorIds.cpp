...
void initErrors()
{
    ...
    SWAG_ERROR(Wrn0010, "unchanged local variable $ the variable [[%s]] is declared to its default value, and is never modified after that $ are you sure this variable is necessary?");
    ...
    SWAG_ERROR(Err0281, "compile-time evaluation required                  $ the operation on struct [[%s]] can't be done compile-time $ in order to make that kind of compile-time evaluation, the struct should be [[#[Swag.ConstExpr]]]");
    SWAG_ERROR(Err0321, "compile-time evaluation required                  $ the operation on the tuple can't be done compile-time $ in order to make that kind of compile-time evaluation, the tuple should be [[#[Swag.ConstExpr]]]");
    ...
    SWAG_ERROR(Err0206, "escaping stack frame                              $ you can't reference the %s [[%s]] because it's in a different stack frame");
    ...
    SWAG_ERROR(Err0027, "failed semantic                                   $ can't resolve this");
    SWAG_ERROR(Err0118, "failed type constraint                            $ the type constraint has failed for type [[%s]]");
    SWAG_ERROR(Err0510, "fetch error                                       $ can't fetch file [[%s]] for module dependency [[%s]]");
    SWAG_ERROR(Err0603, "file delete error                                 $ failed to delete file [[%s]]");
    SWAG_ERROR(Err0314, "file format error                                 $ the file format must be ASCII, UTF-8, or UTF-8-BOM");
    ...
    SWAG_ERROR(Err0604, "folder error                                      $ failed to create directory [[%s]]");
    SWAG_ERROR(Err0493, "forbidden [[@postcopy]]                           $ the intrinsic [[@postcopy]] can't be called on type [[%s]] because of [[#[Swag.NoCopy]]]");
    ...
    SWAG_ERROR(Err0564, "forbidden assign                                  $ can't assign because the left expression is immutable");
    SWAG_ERROR(Err0571, "forbidden assign                                  $ can't assign from [[%s]] with type %s");
    SWAG_ERROR(Err0740, "forbidden assign                                  $ can't assign to [[%s]] because it's immutable");
    SWAG_ERROR(Err0572, "forbidden assign                                  $ can't assign to [[%s]] with type %s");
    ...
    SWAG_ERROR(Err2026, "incomplete character literal                      $ expected a closing backtick [[`]] before the end of the line");
    ...
    SWAG_ERROR(Err0160, "invalid assign                                    $ a function pointer can't be assigned to a constant");
    SWAG_ERROR(Err1190, "invalid assign                                    $ assignments are not allowed for unnamed parameters ([[?]])");
    SWAG_ERROR(Err0565, "invalid assign                                    $ can't assign because the left expression isn't a value");
    ...
    SWAG_ERROR(Err0001, "invalid comparison                                $ the comparison operation [[%s]] does not accept the type [[%s]]");
    ...
    SWAG_ERROR(Err0513, "invalid dependency                                $ can't resolve the module dependency [[%s]] because the [[location]] is empty");
    ...
    SWAG_ERROR(Err1159, "invalid empty attribute                           $ an attribute should contain at least one value $ you should specify the attribute name");
    ...
    SWAG_ERROR(Err0697, "invalid enum type                                 $ an enum marked with [[#[Swag.EnumFlags]]] should have an unsigned integer type, got [[%s]] instead");
    SWAG_ERROR(Err0698, "invalid enum type                                 $ an enum marked with [[#[Swag.EnumIndex]]] should have an integer type, got [[%s]] instead");
    ...
    SWAG_ERROR(Err0599, "invalid export argument                           $ invalid argument [[%s]] for the attribute [[#[Swag.ExportType]]] $ the acceptable values for [[#[Swag.ExportType]]] are [[methods]] and [[nozero]]");
    ...
    SWAG_ERROR(Err0054, "invalid generic argument                          $ unexpected generic %s (a type is expected but a value is provided) $ this is a literal but a type was expected");
    SWAG_ERROR(Err0057, "invalid generic argument                          $ unexpected generic %s (a value is expected but a type is provided) $ this is a type but a literal was expected");
    ...
    SWAG_ERROR(Err0515, "invalid location argument                         $ invalid [[location]] mode [[%s]] $ the acceptable values are [[swag]] and [[disk]]");
    SWAG_ERROR(Err1105, "invalid logical operator                          $ expected [[%s]] for the ogical test, found [[%s]] instead");
    SWAG_ERROR(Err0693, "invalid match argument                            $ invalid argument [[%s]] for the attribute [[#[Swag.Match]]] $ the acceptable values for [[#[Swag.Match]]] are [[validif]] and [[self]]");
    ...
    SWAG_ERROR(Err0827, "invalid negation                                  $ can't negate an unsigned type [[%s]]");
    SWAG_ERROR(Err0828, "invalid negation                                  $ can't negate type [[%s]]");
    ...
    SWAG_ERROR(Err0143, "invalid operation                                 $ the operation [[%s]] does not accept the type [[%s]] as the left argument");
    SWAG_ERROR(Err0183, "invalid operation                                 $ the operation [[%s]] does not accept the type [[%s]] as the right argument");
    ...
    SWAG_ERROR(Err0017, "invalid type declaration                          $ expected a type but [[%s]] is %s");
    ...
    SWAG_ERROR(Err0308, "invalid variable type                             $ failed to deduce the type of the variable because the expression is [[null]]");
    ...
    SWAG_ERROR(Err0676, "misplaced [[#do]]                                 $ unnecessary usage of [[#do]] before a block start [[{]] $ consider removing it");
    ...
    SWAG_ERROR(Err1006, "misplaced [[#global]]                             $ [[#global]] should be placed at the very top of the file");
    ...
    SWAG_ERROR(Err0744, "misplaced [[#test]]                               $ #test]] functions can only be declared in test modules (in the [[./tests]] folder)");
    ...
    SWAG_ERROR(Err1061, "misplaced [[const]] qualifier                     $ the [[const]] qualifier is not allowed for [[func]], only for [[mtd]]");
    SWAG_ERROR(Err0637, "misplaced [[continue]]                            $ [[continue]] is only valid within a breakable block such as [[loop]], [[visit]], [[for]], etc.");
    SWAG_ERROR(Err0776, "misplaced [[do]]                                  $ unnecessary usage of [[do]] before a block start [[{]] $ consider removing it");
    ...
    SWAG_ERROR(Err0695, "misplaced [[using]]                               $ [[using]] can't be associated with type [[%s]] $ expected a namespace, a struct, an enum or a variable");
    ...
    SWAG_ERROR(Err0530, "missing [[do]]                                    $ missing either [[do]] or [[{]] before [[%s]]");
    ...
    SWAG_ERROR(Err0187, "missing dereference index                         $ an index is missing to dereference the array [[%s]] of type [[%s]] $ consider adding the index between brackets");
    SWAG_ERROR(Err0180, "missing dereference index                         $ an index is missing to dereference the slice [[%s]] of type [[%s]] $ consider adding the index between brackets");
    ...
    SWAG_ERROR(Err0006, "missing named argument                            $ the %s should be named because some arguments before are named");
    ...
    SWAG_ERROR(Err0544, "not enough generic parameters                     $ not enough generic parameters for special function [[%s]]");
    ...
    SWAG_ERROR(Err0061, "not enough parameters                             $ not enough parameters for special function [[%s]] (expected [[%d]], got [[%d]])");
    ...
    SWAG_ERROR(Err2008, "out of range number                               $ this literal number exceeds 64 bits and is out of allowable range");
    ...
    SWAG_ERROR(Err1122, "reserved identifier                               $ the identifier [[%s]] starts with [[__]] $ identifiers starting with [[__]] are typically reserved for compiler-internal or system use");
    SWAG_ERROR(Err1118, "reserved namespace name                           $ the namespace [[%s]] is reserved by the compiler");
    SWAG_ERROR(Err0674, "reserved struct member name                       $ the struct member name [[%s]] is reserved by the compiler $ struct member names beginning with [[item]] are reserved by the language");
    ...
    SWAG_ERROR(Err0185, "type mismatch                                     $ a closure can't be assigned to a lambda type");
    ...
    SWAG_ERROR(Err0065, "type mismatch                                     $ expected return type [[%s]] for special function [[%s]], got [[%s]] instead");
    ...
    SWAG_ERROR(Err0359, "unexpected type                                   $ can't start a declaration with a type");
    ...
    SWAG_ERROR(Err0129, "unknown intrinsic                                 $ the intrinsic [[%s]] can't be found");
    SWAG_ERROR(Err0631, "unknown label                                     $ the scope label [[%s]] can't be found");
    SWAG_ERROR(Err1107, "unknown method                                    $ the method [[%s]] can't be found in [[%s]]");
    SWAG_ERROR(Err0008, "unknown parameter                                 $ the named parameter [[%s]] can't be found");
    ...
    SWAG_ERROR(Err0165, "unknown type                                      $ the type [[%s]] can't be found");
    ...
    SWAG_ERROR(Err0148, "unsupported array type                            $ can't declare a static array of type [[void]]");
    ...
    SWAG_ERROR(Nte0140, "consider using [[++]] to append literal strings at compile-time");
    ...
    SWAG_ERROR(Nte1110, "to declare a variable, the syntax is [[var name: type]] or [[var name = expression]]");
    ...
    SWAG_ERROR(Nte1106, nullptr);
    SWAG_ERROR(Nte1102, nullptr);
    SWAG_ERROR(Nte1012, nullptr);
    SWAG_ERROR(Nte1051, nullptr);
    SWAG_ERROR(Nte1000, nullptr);
    SWAG_ERROR(Nte1062, nullptr);
    SWAG_ERROR(Nte1128, nullptr);
    SWAG_ERROR(Nte1083, nullptr);
    SWAG_ERROR(Nte1090, nullptr);
    SWAG_ERROR(Nte1091, nullptr);
    SWAG_ERROR(Nte1029, nullptr);
    SWAG_ERROR(Nte1038, nullptr);
    SWAG_ERROR(Nte1053, nullptr);
    SWAG_ERROR(Nte1067, nullptr);
