...
void initErrors()
{
    ...
    SWAG_ERROR(CEr0001, "failed to load the module `%s` while resolving the foreign function `%s`: %s");
    SWAG_ERROR(CEr0002, "fatal error: cache directory `%s` does not exist");
    SWAG_ERROR(CEr0003, "fatal error: cannot create cache directory `%s`");
    SWAG_ERROR(CEr0004, "fatal error: cannot create directory `%s`");
    SWAG_ERROR(CEr0005, "fatal error: cannot create file `%s`");
    SWAG_ERROR(CEr0006, "fatal error: cannot create public directory `%s`");
    SWAG_ERROR(CEr0007, "fatal error: cannot create script file `%s`");
    SWAG_ERROR(CEr0008, "fatal error: cannot create target directory `%s`");
    SWAG_ERROR(CEr0009, "fatal error: cannot delete directory `%s`");
    SWAG_ERROR(CEr0010, "fatal error: cannot delete file `%s`");
    SWAG_ERROR(CEr0011, "fatal error: expected workspace folder `--workspace`");
    SWAG_ERROR(CEr0012, "fatal error: invalid module `%s`, configuration file `%s` is missing");
    ...
    SWAG_ERROR(CEr0018, "fatal error: module `%s` already exists in the `/modules` folder");
    SWAG_ERROR(CEr0019, "fatal error: not enough memory !");
    SWAG_ERROR(CEr0020, "fatal error: script file `%s` does not exist");
    SWAG_ERROR(CEr0021, "fatal error: some problems have been found in compiler bootstrap !!!");
    SWAG_ERROR(CEr0022, "fatal error: some problems have been found in compiler runtime !!!");
    ...
    SWAG_ERROR(CEr0025, "fatal error: workspace folder `%s` already exists");
    SWAG_ERROR(CEr0026, "fatal error: workspace folder `%s` does not exist");

    /////////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////////

    SWAG_ERROR(SEr0001, "[safety] `<<` shift operand value on type `%s` is greater than `%d`");
    SWAG_ERROR(SEr0002, "[safety] `>>` shift operand value on type `%s` is greater than `%d`");
    SWAG_ERROR(SEr0003, "[safety] `@abs` integer overflow on type `%s`");
    SWAG_ERROR(SEr0004, "[safety] bad slicing, lower bound is greater than upper bound");
    SWAG_ERROR(SEr0005, "[safety] bad slicing, upper bound is out of range");
    SWAG_ERROR(SEr0006, "[safety] cast from a negative value of type `%s` to unsigned type `%s`");
    SWAG_ERROR(SEr0007, "[safety] division by zero");
    SWAG_ERROR(SEr0008, "[safety] index out of range");
    SWAG_ERROR(SEr0009, "[safety] integer overflow during `*=` operation on type `%s`");
    SWAG_ERROR(SEr0010, "[safety] integer overflow during `*` operation on type `%s`");
    SWAG_ERROR(SEr0011, "[safety] integer overflow during `+=` operation on type `%s`");
    SWAG_ERROR(SEr0012, "[safety] integer overflow during `+` operation on type `%s`");
    SWAG_ERROR(SEr0013, "[safety] integer overflow during `-=` operation on type `%s`");
    SWAG_ERROR(SEr0014, "[safety] integer overflow during `-` operation on type `%s`");
    SWAG_ERROR(SEr0015, "[safety] integer overflow during `<<` operation on type `%s`");
    SWAG_ERROR(SEr0016, "[safety] integer overflow during `>>` operation on type `%s`");
    SWAG_ERROR(SEr0017, "[safety] integer overflow when taking the negative value of type `%s`");
    SWAG_ERROR(SEr0018, "[safety] truncated bits when casting expression from `%s` to `%s`");
    SWAG_ERROR(SEr0019, "[safety] unexpected switch value (switch is marked with `Swag.Complete`)");
    ...
    SWAG_ERROR(Tkn0005, "expected an identifier, found symbol `%s`");
    SWAG_ERROR(Tkn0006, "expected another `visit` variable name after `,` and before `:`");
    SWAG_ERROR(Tkn0007, "expected at least one digit in the hexadecimal number");
    SWAG_ERROR(Tkn0008, "the literal number is too big (it cannot fit in 64 bits)");
    SWAG_ERROR(Tkn0009, "too many digits in the literal number");
    SWAG_ERROR(Tkn0010, "unexpected `catch` inside `%s` expression");
    SWAG_ERROR(Tkn0011, "unexpected `throw` in attribute declaration");
    SWAG_ERROR(Tkn0012, "unexpected block after `discard try/assume/catch`");
    SWAG_ERROR(Tkn0013, "unexpected call parameters for the variable `%s`");
    SWAG_ERROR(Tkn0014, "unexpected comma, expecting `)` or another function argument");
    SWAG_ERROR(Tkn0015, "unexpected comma, expecting `)` or another function parameter");
    SWAG_ERROR(Tkn0016, "unexpected compare operator `=`");
