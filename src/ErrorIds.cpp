...
void initErrors()
{
    ...
    SWAG_ERROR(Wrn0010, "unchanged local variable  $ the variable 'a' is declared to its default value, and is never modified after that $ are you sure this variable is necessary?");
