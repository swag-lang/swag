...
void CommandLineParser::setup(CommandLine* cmdLine)
{
    ...
    addArg("bu cl sc", "--cfg", nullptr, CommandLineType::String, &cmdLine->buildCfg, nullptr, "set the build configuration (debug|fast-debug|release are predefined)");
    addArg("bu cl sc", "--cfg-debug", nullptr, CommandLineType::EnumString, &cmdLine->buildCfgDebug, "true|false|default", "force the build configuration to have (or not) debug informations");
    addArg("bu cl sc", "--cfg-safety", nullptr, CommandLineType::EnumString, &cmdLine->buildCfgSafety, "true|false|default", "force the build configuration to have (or not) safety guards");
    ...
    addArg("bu cl sc", "--cfg-optim-speed", nullptr, CommandLineType::EnumString, &cmdLine->buildCfgOptimSpeed, "true|false|default", "force the build configuration to be optimized (or not) for speed");
