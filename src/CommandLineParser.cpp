...
void CommandLineParser::setup(CommandLine* cmdLine)
{
    ...
    addArg("bu cl sc",       "--cfg-optim-bc",         nullptr,    CommandLineType::EnumString,    &cmdLine->buildCfgOptimBC, "true|false|default", "optimize the generated bytecode");
    addArg("bu cl sc",       "--cfg-remove-dup",       nullptr,    CommandLineType::EnumString,    &cmdLine->buildCfgRemoveDupBC, "true|false|default", "remove duplicated functions (if --cfg-optim-bc is true)");
