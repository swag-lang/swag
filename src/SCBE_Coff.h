...
struct SCBE_Coff
{
    ...
    static bool emitXData(const BuildParameters& buildParameters, SCBE_X64& pp);
    ...
    static bool emitRelocationTable(SCBE_CPU& pp, CPURelocationTable& cofftable, uint32_t* sectionFlags, uint16_t* count);
