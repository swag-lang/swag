...
static const uint64_t ATTRIBUTE_SAFETY_SWITCH_ON      = 0x0001000000000000;
...
static const uint64_t ATTRIBUTE_SAFETY_CASTANY_OFF    = 0x0080000000000000;
static const uint64_t ATTRIBUTE_SAFETY_SWITCH_OFF     = 0x0100000000000000;

static const uint64_t ATTRIBUTE_SAFETY_MASK_ON  = ATTRIBUTE_SAFETY_BOUNDCHECK_ON | ATTRIBUTE_SAFETY_OVERFLOW_ON | ATTRIBUTE_SAFETY_MATH_ON | ATTRIBUTE_SAFETY_CASTANY_ON | ATTRIBUTE_SAFETY_SWITCH_ON;
static const uint64_t ATTRIBUTE_SAFETY_MASK_OFF = ATTRIBUTE_SAFETY_BOUNDCHECK_OFF | ATTRIBUTE_SAFETY_OVERFLOW_OFF | ATTRIBUTE_SAFETY_MATH_OFF | ATTRIBUTE_SAFETY_CASTANY_OFF | ATTRIBUTE_SAFETY_SWITCH_OFF;
