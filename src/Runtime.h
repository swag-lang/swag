...
static const uint64_t ATTRIBUTE_SAFETY_CASTANY_ON     = 0x0000800000000000;
static const uint64_t ATTRIBUTE_SAFETY_NULLPTR_OFF    = 0x0001000000000000;
static const uint64_t ATTRIBUTE_SAFETY_BOUNDCHECK_OFF = 0x0002000000000000;
static const uint64_t ATTRIBUTE_SAFETY_OVERFLOW_OFF   = 0x0004000000000000;
static const uint64_t ATTRIBUTE_SAFETY_MATH_OFF       = 0x0008000000000000;
static const uint64_t ATTRIBUTE_SAFETY_CASTANY_OFF    = 0x0010000000000000;
static const uint64_t ATTRIBUTE_SAFETY_MASK_ON        = ATTRIBUTE_SAFETY_BOUNDCHECK_ON | ATTRIBUTE_SAFETY_OVERFLOW_ON | ATTRIBUTE_SAFETY_MATH_ON | ATTRIBUTE_SAFETY_CASTANY_ON;
static const uint64_t ATTRIBUTE_SAFETY_MASK_OFF       = ATTRIBUTE_SAFETY_BOUNDCHECK_OFF | ATTRIBUTE_SAFETY_OVERFLOW_OFF | ATTRIBUTE_SAFETY_MATH_OFF | ATTRIBUTE_SAFETY_CASTANY_OFF;
