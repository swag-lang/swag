...
static const uint64_t ATTRIBUTE_SAFETY_MASK_ON  = ATTRIBUTE_SAFETY_BOUNDCHECK_ON | ATTRIBUTE_SAFETY_OVERFLOW_ON | ATTRIBUTE_SAFETY_MATH_ON | ATTRIBUTE_SAFETY_CAST_ON | ATTRIBUTE_SAFETY_SWITCH_ON;
static const uint64_t ATTRIBUTE_SAFETY_MASK_OFF = ATTRIBUTE_SAFETY_BOUNDCHECK_OFF | ATTRIBUTE_SAFETY_OVERFLOW_OFF | ATTRIBUTE_SAFETY_MATH_OFF | ATTRIBUTE_SAFETY_CAST_OFF | ATTRIBUTE_SAFETY_SWITCH_OFF;
