...
SWAG_FORCE_INLINE bool ByteCodeRun::executeInstruction(ByteCodeRunContext* context, ByteCodeInstruction* ip)
{
    ...
    case ByteCodeOp::BinOpPlusS32:
    {
        auto val1 = IMMA_S32(ip);
        auto val2 = IMMB_S32(ip);
        if (addWillOverflow(ip->node, val1, val2))
    ...
    case ByteCodeOp::BinOpMinusS32:
    {
        auto val1 = IMMA_S32(ip);
        auto val2 = IMMB_S32(ip);
        if (subWillOverflow(ip->node, val1, val2))
    ...
    case ByteCodeOp::BinOpMulS32:
    {
        auto val1 = IMMA_S32(ip);
        auto val2 = IMMB_S32(ip);
        if (mulWillOverflow(ip->node, val1, val2))
    ...
    case ByteCodeOp::BinOpShiftLeftU64:
    {
        ...
        r1.u64 = IMMA_U64(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeLeftShift(registersRC + ip->c.u32, r1, r2, 64, false, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    ...
    case ByteCodeOp::BinOpShiftRightS8:
    {
        ...
        r1.s8  = IMMA_S8(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 8, true, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    case ByteCodeOp::BinOpShiftRightS16:
    {
        ...
        r1.s16 = IMMA_S16(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 16, true, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    case ByteCodeOp::BinOpShiftRightS32:
    {
        ...
        r1.s32 = IMMA_S32(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 32, true, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    case ByteCodeOp::BinOpShiftRightS64:
    {
        ...
        r1.s64 = IMMA_S64(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 64, true, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    ...
    case ByteCodeOp::BinOpShiftRightU8:
    {
        ...
        r1.u8  = IMMA_U8(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 8, false, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    case ByteCodeOp::BinOpShiftRightU16:
    {
        ...
        r1.u16 = IMMA_U16(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 16, false, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    case ByteCodeOp::BinOpShiftRightU32:
    {
        ...
        r1.u32 = IMMA_U32(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 32, false, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    case ByteCodeOp::BinOpShiftRightU64:
    {
        ...
        r1.u64 = IMMA_U64(ip);
        r2.u32 = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(registersRC + ip->c.u32, r1, r2, 64, false, ip->flags & BCI_SHIFT_SMALL);
        break;
    }
    ...
    case ByteCodeOp::AffectOpPlusEqS8:
        if (addWillOverflow(ip->node, *(int8_t*) registersRC[ip->a.u32].pointer, IMMB_S8(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqS16:
        if (addWillOverflow(ip->node, *(int16_t*) registersRC[ip->a.u32].pointer, IMMB_S16(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqS32:
        if (addWillOverflow(ip->node, *(int32_t*) registersRC[ip->a.u32].pointer, IMMB_S32(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqS64:
        if (addWillOverflow(ip->node, *(int64_t*) registersRC[ip->a.u32].pointer, IMMB_S64(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqU8:
        if (addWillOverflow(ip->node, *(uint8_t*) registersRC[ip->a.u32].pointer, (uint8_t) IMMB_S8(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqU16:
        if (addWillOverflow(ip->node, *(uint16_t*) registersRC[ip->a.u32].pointer, (uint16_t) IMMB_S16(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqU32:
        if (addWillOverflow(ip->node, *(uint32_t*) registersRC[ip->a.u32].pointer, (uint32_t) IMMB_S32(ip)))
    ...
    case ByteCodeOp::AffectOpPlusEqU64:
        if (addWillOverflow(ip->node, *(uint64_t*) registersRC[ip->a.u32].pointer, (uint64_t) IMMB_S64(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqS8:
        if (subWillOverflow(ip->node, *(int8_t*) registersRC[ip->a.u32].pointer, IMMB_S8(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqS16:
        if (subWillOverflow(ip->node, *(int16_t*) registersRC[ip->a.u32].pointer, IMMB_S16(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqS32:
        if (subWillOverflow(ip->node, *(int32_t*) registersRC[ip->a.u32].pointer, IMMB_S32(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqS64:
        if (subWillOverflow(ip->node, *(int64_t*) registersRC[ip->a.u32].pointer, IMMB_S64(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqU8:
        if (subWillOverflow(ip->node, *(uint8_t*) registersRC[ip->a.u32].pointer, (uint8_t) IMMB_S8(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqU16:
        if (subWillOverflow(ip->node, *(uint16_t*) registersRC[ip->a.u32].pointer, (uint16_t) IMMB_S16(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqU32:
        if (subWillOverflow(ip->node, *(uint32_t*) registersRC[ip->a.u32].pointer, (uint32_t) IMMB_S32(ip)))
    ...
    case ByteCodeOp::AffectOpMinusEqU64:
        if (subWillOverflow(ip->node, *(uint64_t*) registersRC[ip->a.u32].pointer, (uint64_t) IMMB_S64(ip)))
            callInternalPanic(context, ip, ByteCodeGenJob::safetyMsg(SafetyMsg::Minus, g_TypeMgr->typeInfoU64));
        *(uint64_t*) registersRC[ip->a.u32].pointer -= IMMB_S64(ip);
        break;
    ...
    case ByteCodeOp::AffectOpMulEqS8:
        if (mulWillOverflow(ip->node, *(int8_t*) registersRC[ip->a.u32].pointer, IMMB_S8(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqS16:
        if (mulWillOverflow(ip->node, *(int16_t*) registersRC[ip->a.u32].pointer, IMMB_S16(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqS32:
        if (mulWillOverflow(ip->node, *(int32_t*) registersRC[ip->a.u32].pointer, IMMB_S32(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqS64:
        if (mulWillOverflow(ip->node, *(int64_t*) registersRC[ip->a.u32].pointer, IMMB_S64(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqU8:
        if (mulWillOverflow(ip->node, *(uint8_t*) registersRC[ip->a.u32].pointer, (uint8_t) IMMB_S8(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqU16:
        if (mulWillOverflow(ip->node, *(uint16_t*) registersRC[ip->a.u32].pointer, (uint16_t) IMMB_S16(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqU32:
        if (mulWillOverflow(ip->node, *(uint32_t*) registersRC[ip->a.u32].pointer, (uint32_t) IMMB_S32(ip)))
    ...
    case ByteCodeOp::AffectOpMulEqU64:
        if (mulWillOverflow(ip->node, *(uint64_t*) registersRC[ip->a.u32].pointer, (uint64_t) IMMB_S64(ip)))
    ...
    case ByteCodeOp::AffectOpShiftLeftEqU8:
    {
        ...
        rr.u8        = *(uint8_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeLeftShift(&rr, rr, r1, 8, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint8_t*) ptr = rr.u8;
        break;
    }
    ...
    case ByteCodeOp::AffectOpShiftLeftEqU16:
    {
        ...
        rr.u16       = *(uint16_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeLeftShift(&rr, rr, r1, 16, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint16_t*) ptr = rr.u16;
        break;
    }
    ...
    case ByteCodeOp::AffectOpShiftLeftEqU32:
    {
        ...
        rr.u32       = *(uint32_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeLeftShift(&rr, rr, r1, 32, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint32_t*) ptr = rr.u32;
        break;
    }
    ...
    case ByteCodeOp::AffectOpShiftLeftEqU64:
    {
        ...
        rr.u64       = *(uint64_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeLeftShift(&rr, rr, r1, 64, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint64_t*) ptr = rr.u64;
        break;
    }
    ...
    case ByteCodeOp::AffectOpShiftRightEqS8:
    {
        ...
        rr.u8        = *(uint8_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 8, true, ip->flags & BCI_SHIFT_SMALL);
        *(uint8_t*) ptr = rr.u8;
        break;
    }
    case ByteCodeOp::AffectOpShiftRightEqS16:
    {
        ...
        rr.u16       = *(uint16_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 16, true, ip->flags & BCI_SHIFT_SMALL);
        *(uint16_t*) ptr = rr.u16;
        break;
    }
    case ByteCodeOp::AffectOpShiftRightEqS32:
    {
        ...
        rr.u32       = *(uint32_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 32, true, ip->flags & BCI_SHIFT_SMALL);
        *(uint32_t*) ptr = rr.u32;
        break;
    }
    case ByteCodeOp::AffectOpShiftRightEqS64:
    {
        ...
        rr.u64       = *(uint64_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 64, true, ip->flags & BCI_SHIFT_SMALL);
        *(uint64_t*) ptr = rr.u64;
        break;
    }
    ...
    case ByteCodeOp::AffectOpShiftRightEqU8:
    {
        ...
        rr.u8        = *(uint8_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 8, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint8_t*) ptr = rr.u8;
        break;
    }
    case ByteCodeOp::AffectOpShiftRightEqU16:
    {
        ...
        rr.u16       = *(uint16_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 16, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint16_t*) ptr = rr.u16;
        break;
    }
    case ByteCodeOp::AffectOpShiftRightEqU32:
    {
        ...
        rr.u32       = *(uint32_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 32, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint32_t*) ptr = rr.u32;
        break;
    }
    case ByteCodeOp::AffectOpShiftRightEqU64:
    {
        ...
        rr.u64       = *(uint64_t*) ptr;
        r1.u32       = IMMB_U32(ip);
        ByteCodeRun::executeRightShift(&rr, rr, r1, 64, false, ip->flags & BCI_SHIFT_SMALL);
        *(uint64_t*) ptr = rr.u64;
        break;
    }
