...
struct BackendX64 : public Backend
{
    ...
    void     emitShiftLeft(X64PerThread& pp, Concat& concat, ByteCodeInstruction* ip, uint8_t numBits);
    ...
    void         dbgEmitConstant(X64PerThread& pp, Concat& concat, AstNode* node);
