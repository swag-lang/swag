...
bool SemanticJob::resolveImplForType(SemanticContext* context)
{
    ...
    SWAG_CHECK(typeTable.makeConcreteTypeInfo(context, typeStruct, back->computedValue->storageSegment, &back->computedValue->storageOffset, MAKE_CONCRETE_SHOULD_WAIT | MAKE_CONCRETE_SIMPLE));
