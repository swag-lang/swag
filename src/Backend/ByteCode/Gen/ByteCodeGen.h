...
namespace ByteCodeGen
{
    ...
    bool emitSwitchCaseRange(ByteCodeGenContext* context, AstSwitchCase* caseNode, AstRange* rangeNode, RegisterList& result);
    ...
    bool emitSwitchCaseInterface(const ByteCodeGenContext* context, const AstNode* expr, const AstSwitchCase* caseNode, RegisterList& r0);
