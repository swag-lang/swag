...
struct ByteCodeDebugger
{
    ...
    static void appendTypedValue(ByteCodeRunContext* context, Utf8& result, Utf8& resultLight, EvaluateResult& res, uint32_t level, uint32_t indent);
    static void appendTypedValueProtected(ByteCodeRunContext* context, Utf8& result, Utf8& resultForExpression, EvaluateResult& res, uint32_t level, uint32_t indent);
