...
struct ByteCodeRun
{
    ...
    static void  executeLeftShift(Register* regDest, const Register& regLeft, const Register& regRight, uint32_t opBits, bool isSigned);
    static void  executeRightShift(Register* regDest, const Register& regLeft, const Register& regRight, uint32_t opBits, bool isSigned);
