...
BYTECODE_OP(IntrinsicCVaStart, OPF_READ_A | OPF_NOT_PURE, "@cvastart(_ra_)")
BYTECODE_OP(IntrinsicCVaEnd, OPF_READ_A | OPF_NOT_PURE, "@cvaend(_ra_)")
BYTECODE_OP(IntrinsicCVaArg, OPF_READ_A | OPF_WRITE_B | OPF_READ_VAL64_C | OPF_NOT_PURE, "_rb_ = @cvaarg(_ra_)")
