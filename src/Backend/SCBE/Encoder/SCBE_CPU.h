...
struct SCBE_CPU : BackendEncoder
{
    ...
    virtual void      emitCallParameters(const TypeInfoFuncAttr* typeFuncBc, const VectorNative<CPUPushParam>& params, uint32_t offset, void* retCopyAddr = nullptr)                                     = 0;
    virtual void      emitCallParameters(const TypeInfoFuncAttr* typeFuncBc, const VectorNative<CPUPushParam>& paramsRegisters, const VectorNative<TypeInfo*>& paramsTypes, void* retCopyAddr = nullptr) = 0;
    virtual void      emitStoreCallResult(CPUReg memReg, uint32_t memOffset, const TypeInfoFuncAttr* typeFuncBc)                                                                                         = 0;
    virtual void      emitJumpTable(CPUReg table, CPUReg offset)                                                                                                                                         = 0;
    virtual uint8_t*  emitJumpNear(CPUCondJump jumpType)                                                                                                                                                 = 0;
    virtual uint32_t* emitJumpLong(CPUCondJump jumpType)                                                                                                                                                 = 0;
    virtual void      emitJump(CPUCondJump jumpType, int32_t instructionCount, int32_t jumpOffset)                                                                                                       = 0;
    ...
    virtual void      emitCast(CPUReg regDst, CPUReg regSrc, OpBits numBitsDst, OpBits numBitsSrc, bool isSigned)                                                                                        = 0;
