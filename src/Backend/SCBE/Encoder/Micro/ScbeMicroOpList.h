...
SCBE_MICRO_OP(CallIndirect,                MOF_REG_A | MOF_READ_MEM,                                    MOF_ZERO)
                                                                                                        
SCBE_MICRO_OP(JumpTable,                   MOF_ZERO,                                                    MOF_ZERO)
SCBE_MICRO_OP(JumpCC,                      MOF_JUMP_TYPE | MOF_OPBITS_A,                                MOF_ZERO)
SCBE_MICRO_OP(JumpM,                       MOF_REG_A | MOF_READ_MEM,                                    MOF_ZERO)
...
SCBE_MICRO_OP(LoadR,                       MOF_REG_A | MOF_OPBITS_A | MOF_WRITE_REG,                    MOF_REG_A | MOF_OPBITS_A)
...
SCBE_MICRO_OP(LoadRM,                      MOF_REG_A | MOF_OPBITS_A | MOF_WRITE_REG,                    MOF_REG_B | MOF_VALUE_A | MOF_READ_MEM)
                                                                                                        
SCBE_MICRO_OP(LoadSignedExtendRM,          MOF_REG_A | MOF_OPBITS_A | MOF_WRITE_REG,                    MOF_REG_B | MOF_READ_REG | MOF_VALUE_A | MOF_OPBITS_B)
SCBE_MICRO_OP(LoadSignedExtendRR,          MOF_REG_A | MOF_OPBITS_A | MOF_WRITE_REG,                    MOF_REG_B | MOF_READ_REG | MOF_OPBITS_B)
SCBE_MICRO_OP(LoadZeroExtendRM,            MOF_REG_A | MOF_OPBITS_A | MOF_WRITE_REG,                    MOF_REG_B | MOF_READ_REG | MOF_VALUE_A | MOF_OPBITS_B)
SCBE_MICRO_OP(LoadZeroExtendRR,            MOF_REG_A | MOF_OPBITS_A | MOF_WRITE_REG,                    MOF_REG_B | MOF_READ_REG | MOF_OPBITS_B)
                                                                                                        
SCBE_MICRO_OP(LoadAddressM,                MOF_REG_A | MOF_WRITE_REG,                                   MOF_REG_B | MOF_READ_REG | MOF_VALUE_A)
SCBE_MICRO_OP(LoadAddressAddMul,           MOF_REG_A | MOF_WRITE_REG,                                   MOF_REG_B | MOF_REG_C | MOF_VALUE_A | MOF_OPBITS_A | MOF_READ_REG)
                                                                                                        
SCBE_MICRO_OP(StoreMR,                     MOF_REG_A | MOF_WRITE_MEM | MOF_VALUE_A,                     MOF_REG_B | MOF_READ_REG | MOF_OPBITS_A)
SCBE_MICRO_OP(StoreMI,                     MOF_REG_A | MOF_WRITE_MEM | MOF_VALUE_A,                     MOF_VALUE_B | MOF_OPBITS_A)
...
SCBE_MICRO_OP(CmpMR,                       MOF_REG_A | MOF_READ_MEM | MOF_VALUE_A,                      MOF_REG_B | MOF_READ_REG | MOF_OPBITS_A)
SCBE_MICRO_OP(CmpMI,                       MOF_REG_A | MOF_READ_MEM | MOF_VALUE_A,                      MOF_VALUE_B | MOF_OPBITS_A)
...
SCBE_MICRO_OP(ClearM,                      MOF_REG_A | MOF_WRITE_MEM | MOF_VALUE_A | MOF_VALUE_B,       MOF_ZERO)
SCBE_MICRO_OP(Copy,                        MOF_REG_A | MOF_WRITE_MEM,                                   MOF_REG_B | MOF_READ_MEM | MOF_VALUE_A)

SCBE_MICRO_OP(OpUnaryM,                    MOF_CPU_OP | MOF_REG_A | MOF_WRITE_MEM | MOF_VALUE_A,        MOF_ZERO)
...
SCBE_MICRO_OP(OpBinaryMR,                  MOF_CPU_OP | MOF_REG_A | MOF_WRITE_MEM | MOF_VALUE_A,        MOF_REG_B | MOF_READ_REG | MOF_OPBITS_A)
SCBE_MICRO_OP(OpBinaryRI,                  MOF_CPU_OP | MOF_REG_A | MOF_WRITE_REG | MOF_OPBITS_A,       MOF_VALUE_A | MOF_OPBITS_A)
SCBE_MICRO_OP(OpBinaryMI,                  MOF_CPU_OP | MOF_REG_A | MOF_WRITE_MEM | MOF_VALUE_A,        MOF_VALUE_B | MOF_OPBITS_A)
SCBE_MICRO_OP(OpBinaryRM,                  MOF_CPU_OP | MOF_REG_A | MOF_WRITE_REG | MOF_OPBITS_A,       MOF_REG_B | MOF_READ_MEM | MOF_VALUE_A)
