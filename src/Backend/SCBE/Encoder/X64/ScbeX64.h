...
struct ScbeX64 final : ScbeCpu
{
    ...
    CpuJump encodeJump(CpuCondJump jumpType, OpBits opBits, CpuEmitFlags emitFlags) override;
    ...
    void    encodeCopy(CpuReg memRegDst, CpuReg memRegSrc, uint32_t count, CpuEmitFlags emitFlags) override;
