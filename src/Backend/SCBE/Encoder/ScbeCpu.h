...
struct ScbeCpu : BackendEncoder
{
    ...
    virtual void    emitCallReg(CpuReg reg)                                                                                                             = 0;
    ...
    virtual void    emitJumpReg(CpuReg reg)                                                                                                             = 0;
    virtual void    emitLoadRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits opBits)                                                        = 0;
    virtual void    emitLoadRegImm(CpuReg reg, uint64_t value, OpBits opBits)                                                                           = 0;
    virtual void    emitLoadRegReg(CpuReg regDst, CpuReg regSrc, OpBits opBits)                                                                         = 0;
    virtual void    emitLoadRegImm64(CpuReg reg, uint64_t value)                                                                                        = 0;
    virtual void    emitLoadSignedExtendRegReg(CpuReg regDst, CpuReg regSrc, OpBits numBitsDst, OpBits numBitsSrc)                                      = 0;
    virtual void    emitLoadSignedExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits numBitsDst, OpBits numBitsSrc)                     = 0;
    virtual void    emitLoadZeroExtendRegReg(CpuReg regDst, CpuReg regSrc, OpBits numBitsDst, OpBits numBitsSrc)                                        = 0;
    virtual void    emitLoadZeroExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits numBitsDst, OpBits numBitsSrc)                       = 0;
    virtual void    emitLoadAddressAddMul(CpuReg regDst, CpuReg regSrc1, CpuReg regSrc2, uint64_t mulValue, OpBits opBits)                              = 0;
    virtual void    emitLoadAddressMem(CpuReg reg, CpuReg memReg, uint64_t memOffset)                                                                   = 0;
    virtual void    emitLoadMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, OpBits opBits)                                                        = 0;
    virtual void    emitLoadMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, OpBits opBits)                                                    = 0;
    virtual void    emitCmpRegReg(CpuReg reg0, CpuReg reg1, OpBits opBits)                                                                              = 0;
    virtual void    emitCmpMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, OpBits opBits)                                                         = 0;
    virtual void    emitCmpMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, OpBits opBits)                                                     = 0;
    virtual void    emitCmpRegImm(CpuReg reg, uint64_t value, OpBits opBits)                                                                            = 0;
    virtual void    emitSetCond(CpuReg reg, CpuCondFlag setType)                                                                                        = 0;
    virtual void    emitClearReg(CpuReg reg, OpBits opBits)                                                                                             = 0;
    virtual void    emitClearMem(CpuReg memReg, uint64_t memOffset, uint32_t count)                                                                     = 0;
    virtual void    emitCopy(CpuReg regDst, CpuReg regSrc, uint32_t count)                                                                              = 0;
    virtual void    emitOpUnaryMem(CpuReg memReg, uint64_t memOffset, CpuOp op, OpBits opBits)                                                          = 0;
    virtual void    emitOpUnaryReg(CpuReg reg, CpuOp op, OpBits opBits)                                                                                 = 0;
    virtual void    emitOpBinaryRegReg(CpuReg regDst, CpuReg regSrc, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)                      = 0;
    virtual void    emitOpBinaryRegMem(CpuReg regDst, CpuReg memReg, uint64_t memOffset, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)  = 0;
    virtual void    emitOpBinaryMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)     = 0;
    virtual void    emitOpBinaryRegImm(CpuReg reg, uint64_t value, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)                        = 0;
    virtual void    emitOpBinaryMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero) = 0;
    virtual void    emitOpMulAdd(CpuReg regDst, CpuReg regMul, CpuReg regAdd, OpBits opBits)                                                            = 0;
