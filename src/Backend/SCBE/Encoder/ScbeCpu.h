...
struct ScbeCpu : BackendEncoder
{
    ...
    CpuJump emitJump(CpuCondJump jumpType, OpBits opBits);
    ...
    virtual void    encodeSymbolRelocationRef(const Utf8& name, CpuEmitFlags emitFlags)                                                                       = 0;
    virtual void    encodeSymbolRelocationAddress(CpuReg reg, uint32_t symbolIndex, uint32_t offset, CpuEmitFlags emitFlags)                                  = 0;
    virtual void    encodeSymbolRelocationValue(CpuReg reg, uint32_t symbolIndex, uint32_t offset, CpuEmitFlags emitFlags)                                    = 0;
    virtual void    encodeSymbolGlobalString(CpuReg reg, const Utf8& str, CpuEmitFlags emitFlags)                                                             = 0;
    virtual void    encodePush(CpuReg reg, CpuEmitFlags emitFlags)                                                                                            = 0;
    virtual void    encodePop(CpuReg reg, CpuEmitFlags emitFlags)                                                                                             = 0;
    virtual void    encodeNop(CpuEmitFlags emitFlags)                                                                                                         = 0;
    virtual void    encodeRet(CpuEmitFlags emitFlags)                                                                                                         = 0;
    virtual void    encodeCallLocal(const Utf8& symbolName, CpuEmitFlags emitFlags)                                                                           = 0;
    virtual void    encodeCallExtern(const Utf8& symbolName, CpuEmitFlags emitFlags)                                                                          = 0;
    virtual void    encodeCallReg(CpuReg reg, CpuEmitFlags emitFlags)                                                                                         = 0;
    virtual void    encodeJumpTable(CpuReg table, CpuReg offset, int32_t currentIp, uint32_t offsetTable, uint32_t numEntries, CpuEmitFlags emitFlags)        = 0;
    virtual CpuJump encodeJump(CpuCondJump jumpType, OpBits opBits, CpuEmitFlags emitFlags)                                                                   = 0;
    virtual void    encodePatchJump(const CpuJump& jump, CpuEmitFlags emitFlags)                                                                              = 0;
    virtual void    encodePatchJump(const CpuJump& jump, uint64_t offsetDestination, CpuEmitFlags emitFlags)                                                  = 0;
    virtual void    encodeJumpReg(CpuReg reg, CpuEmitFlags emitFlags)                                                                                         = 0;
    virtual void    encodeLoadRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits opBits, CpuEmitFlags emitFlags)                                    = 0;
    virtual void    encodeLoadRegImm(CpuReg reg, uint64_t value, OpBits opBits, CpuEmitFlags emitFlags)                                                       = 0;
    virtual void    encodeLoadRegReg(CpuReg regDst, CpuReg regSrc, OpBits opBits, CpuEmitFlags emitFlags)                                                     = 0;
    virtual void    encodeLoadRegImm64(CpuReg reg, uint64_t value, CpuEmitFlags emitFlags)                                                                    = 0;
    virtual void    encodeLoadSignedExtendRegReg(CpuReg regDst, CpuReg regSrc, OpBits numBitsDst, OpBits numBitsSrc, CpuEmitFlags emitFlags)                  = 0;
    virtual void    encodeLoadSignedExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits numBitsDst, OpBits numBitsSrc, CpuEmitFlags emitFlags) = 0;
    virtual void    encodeLoadZeroExtendRegReg(CpuReg regDst, CpuReg regSrc, OpBits numBitsDst, OpBits numBitsSrc, CpuEmitFlags emitFlags)                    = 0;
    virtual void    encodeLoadZeroExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits numBitsDst, OpBits numBitsSrc, CpuEmitFlags emitFlags)   = 0;
    virtual void    encodeLoadAddressAddMul(CpuReg regDst, CpuReg regSrc1, CpuReg regSrc2, uint64_t mulValue, OpBits opBits, CpuEmitFlags emitFlags)          = 0;
    virtual void    encodeLoadAddressMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, CpuEmitFlags emitFlags)                                               = 0;
    virtual void    encodeLoadMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, OpBits opBits, CpuEmitFlags emitFlags)                                    = 0;
    virtual void    encodeLoadMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, OpBits opBits, CpuEmitFlags emitFlags)                                = 0;
    virtual void    encodeCmpRegReg(CpuReg reg0, CpuReg reg1, OpBits opBits, CpuEmitFlags emitFlags)                                                          = 0;
    virtual void    encodeCmpMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, OpBits opBits, CpuEmitFlags emitFlags)                                     = 0;
    virtual void    encodeCmpMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, OpBits opBits, CpuEmitFlags emitFlags)                                 = 0;
    virtual void    encodeCmpRegImm(CpuReg reg, uint64_t value, OpBits opBits, CpuEmitFlags emitFlags)                                                        = 0;
    virtual void    encodeSetCond(CpuReg reg, CpuCondFlag setType, CpuEmitFlags emitFlags)                                                                    = 0;
    virtual void    encodeClearReg(CpuReg reg, OpBits opBits, CpuEmitFlags emitFlags)                                                                         = 0;
    virtual void    encodeClearMem(CpuReg memReg, uint64_t memOffset, uint32_t count, CpuEmitFlags emitFlags)                                                 = 0;
    virtual void    encodeCopy(CpuReg regDst, CpuReg regSrc, uint32_t count, CpuEmitFlags emitFlags)                                                          = 0;
    virtual void    encodeOpUnaryMem(CpuReg memReg, uint64_t memOffset, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                                      = 0;
    virtual void    encodeOpUnaryReg(CpuReg reg, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                                                             = 0;
    virtual void    encodeOpBinaryRegReg(CpuReg regDst, CpuReg regSrc, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                                       = 0;
    virtual void    encodeOpBinaryRegMem(CpuReg regDst, CpuReg memReg, uint64_t memOffset, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                   = 0;
    virtual void    encodeOpBinaryMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                      = 0;
    virtual void    encodeOpBinaryRegImm(CpuReg reg, uint64_t value, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                                         = 0;
    virtual void    encodeOpBinaryMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags)                  = 0;
    virtual void    encodeOpMulAdd(CpuReg regDst, CpuReg regMul, CpuReg regAdd, OpBits opBits, CpuEmitFlags emitFlags)                                        = 0;
