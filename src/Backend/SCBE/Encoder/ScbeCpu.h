...
struct ScbeCpu : BackendEncoder
{
    ...
    virtual void    encodeSymbolRelocationValue(CpuReg reg, uint32_t symbolIndex, uint32_t offset)                                                        = 0;
    virtual void    encodeSymbolGlobalString(CpuReg reg, const Utf8& str)                                                                                 = 0;
    virtual void    encodePush(CpuReg reg)                                                                                                                = 0;
    virtual void    encodePop(CpuReg reg)                                                                                                                 = 0;
    virtual void    encodeNop()                                                                                                                           = 0;
    virtual void    encodeRet()                                                                                                                           = 0;
    virtual void    encodeCallLocal(const Utf8& symbolName)                                                                                               = 0;
    virtual void    encodeCallExtern(const Utf8& symbolName)                                                                                              = 0;
    virtual void    encodeCallReg(CpuReg reg)                                                                                                             = 0;
    virtual void    encodeJumpTable(CpuReg table, CpuReg offset, int32_t currentIp, uint32_t offsetTable, uint32_t numEntries)                            = 0;
    virtual CpuJump encodeJump(CpuCondJump jumpType, OpBits opBits)                                                                                       = 0;
    virtual void    encodePatchJump(const CpuJump& jump)                                                                                                  = 0;
    virtual void    encodePatchJump(const CpuJump& jump, uint64_t offsetDestination)                                                                      = 0;
    virtual void    encodeJumpReg(CpuReg reg)                                                                                                             = 0;
    virtual void    encodeLoadRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits opBits)                                                        = 0;
    virtual void    encodeLoadRegImm(CpuReg reg, uint64_t value, OpBits opBits)                                                                           = 0;
    virtual void    encodeLoadRegReg(CpuReg regDst, CpuReg regSrc, OpBits opBits)                                                                         = 0;
    virtual void    encodeLoadRegImm64(CpuReg reg, uint64_t value)                                                                                        = 0;
    virtual void    encodeLoadSignedExtendRegReg(CpuReg regDst, CpuReg regSrc, OpBits numBitsDst, OpBits numBitsSrc)                                      = 0;
    virtual void    encodeLoadSignedExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits numBitsDst, OpBits numBitsSrc)                     = 0;
    virtual void    encodeLoadZeroExtendRegReg(CpuReg regDst, CpuReg regSrc, OpBits numBitsDst, OpBits numBitsSrc)                                        = 0;
    virtual void    encodeLoadZeroExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, OpBits numBitsDst, OpBits numBitsSrc)                       = 0;
    virtual void    encodeLoadAddressAddMul(CpuReg regDst, CpuReg regSrc1, CpuReg regSrc2, uint64_t mulValue, OpBits opBits)                              = 0;
    virtual void    encodeLoadAddressMem(CpuReg reg, CpuReg memReg, uint64_t memOffset)                                                                   = 0;
    virtual void    encodeLoadMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, OpBits opBits)                                                        = 0;
    virtual void    encodeLoadMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, OpBits opBits)                                                    = 0;
    virtual void    encodeCmpRegReg(CpuReg reg0, CpuReg reg1, OpBits opBits)                                                                              = 0;
    virtual void    encodeCmpMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, OpBits opBits)                                                         = 0;
    virtual void    encodeCmpMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, OpBits opBits)                                                     = 0;
    virtual void    encodeCmpRegImm(CpuReg reg, uint64_t value, OpBits opBits)                                                                            = 0;
    virtual void    encodeSetCond(CpuReg reg, CpuCondFlag setType)                                                                                        = 0;
    virtual void    encodeClearReg(CpuReg reg, OpBits opBits)                                                                                             = 0;
    virtual void    encodeClearMem(CpuReg memReg, uint64_t memOffset, uint32_t count)                                                                     = 0;
    virtual void    encodeCopy(CpuReg regDst, CpuReg regSrc, uint32_t count)                                                                              = 0;
    virtual void    encodeOpUnaryMem(CpuReg memReg, uint64_t memOffset, CpuOp op, OpBits opBits)                                                          = 0;
    virtual void    encodeOpUnaryReg(CpuReg reg, CpuOp op, OpBits opBits)                                                                                 = 0;
    virtual void    encodeOpBinaryRegReg(CpuReg regDst, CpuReg regSrc, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)                      = 0;
    virtual void    encodeOpBinaryRegMem(CpuReg regDst, CpuReg memReg, uint64_t memOffset, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)  = 0;
    virtual void    encodeOpBinaryMemReg(CpuReg memReg, uint64_t memOffset, CpuReg reg, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)     = 0;
    virtual void    encodeOpBinaryRegImm(CpuReg reg, uint64_t value, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero)                        = 0;
    virtual void    encodeOpBinaryMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, CpuOp op, OpBits opBits, CpuEmitFlags emitFlags = EMITF_Zero) = 0;
    virtual void    encodeOpMulAdd(CpuReg regDst, CpuReg regMul, CpuReg regAdd, OpBits opBits)                                                            = 0;
