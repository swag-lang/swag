...
SCBEDebugTypeIndex SCBE_Debug::getTypeSlice(SCBE_CPU& pp, const TypeInfo* typeInfo, TypeInfo* pointedType, SCBEDebugTypeIndex* value)
{
...
void SCBE_Debug::getStructFields(SCBE_CPU& pp, SCBEDebugTypeRecord* tr, TypeInfoStruct* typeStruct, uint32_t baseOffset)
{
...
SCBEDebugTypeIndex SCBE_Debug::getOrCreateType(SCBE_CPU& pp, TypeInfo* typeInfo, bool forceUnRef)
{
...
SCBEDebugTypeIndex SCBE_Debug::getSimpleType(const TypeInfo* typeInfo)
{
...
SCBEDebugTypeIndex SCBE_Debug::getOrCreatePointerToType(SCBE_CPU& pp, TypeInfo* typeInfo, bool asRef)
{
...
SCBEDebugTypeIndex SCBE_Debug::getOrCreatePointerPointerToType(SCBE_CPU& pp, TypeInfo* typeInfo)
{
    // Pointer to something complex
    const auto tr             = addTypeRecord(pp);
    tr->kind                  = LF_POINTER;
...
SCBEDebugTypeRecord* SCBE_Debug::addTypeRecord(SCBE_CPU& pp)
{
...
Utf8 SCBE_Debug::getScopedName(const AstNode* node)
{
