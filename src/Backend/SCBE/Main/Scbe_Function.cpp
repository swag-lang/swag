    ...
    for (uint32_t i = 0; i < bc->numInstructions; i++, ip++)
    {
        ...
        switch (ip->op)
        {
            ...
            case ByteCodeOp::CastBool64:
                ...
                pp.emitSetCondReg(cc->computeRegI0, CpuCond::NE);
            ...
            case ByteCodeOp::CastF32S32:
                ...
                pp.emitOpBinaryRegReg(cc->computeRegI0, cc->computeRegF0, CpuOp::CVTF2I, OpBits::B32);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B32);
                break;
            case ByteCodeOp::CastF64S64:
                pp.emitLoadRegMem(cc->computeRegF0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B64);
                pp.emitOpBinaryRegReg(cc->computeRegI0, cc->computeRegF0, CpuOp::CVTF2I, OpBits::B64, EMIT_B64);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B64);
                break;
            ...
            case ByteCodeOp::CastF64F32:
                pp.emitLoadRegMem(cc->computeRegF0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B64);
                pp.emitOpBinaryRegReg(cc->computeRegF0, cc->computeRegF0, CpuOp::CVTF2F, OpBits::B64);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegF0, OpBits::B32);
                break;
            ...
            case ByteCodeOp::CastS64F64:
                pp.emitLoadRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B64);
                pp.emitOpBinaryRegReg(cc->computeRegF0, cc->computeRegI0, CpuOp::CVTI2F, OpBits::B64, EMIT_B64);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegF0, OpBits::B64);
                break;
            case ByteCodeOp::CastU8F64:
                pp.emitLoadZeroExtendRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B64, OpBits::B8);
                pp.emitOpBinaryRegReg(cc->computeRegF0, cc->computeRegI0, CpuOp::CVTI2F, OpBits::B64);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegF0, OpBits::B64);
                break;
            case ByteCodeOp::CastU16F64:
                pp.emitLoadZeroExtendRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B64, OpBits::B16);
                pp.emitOpBinaryRegReg(cc->computeRegF0, cc->computeRegI0, CpuOp::CVTI2F, OpBits::B64);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegF0, OpBits::B64);
                break;
            ...
            case ByteCodeOp::CastU64F64:
                pp.emitLoadRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B64);
                pp.emitOpBinaryRegReg(cc->computeRegF0, cc->computeRegI0, CpuOp::CVTU2F64, OpBits::B64);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegF0, OpBits::B64);
                break;

            case ByteCodeOp::CastF32F64:
                pp.emitLoadRegMem(cc->computeRegF0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), OpBits::B32);
                pp.emitOpBinaryRegReg(cc->computeRegF0, cc->computeRegF0, CpuOp::CVTF2F, OpBits::B32);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegF0, OpBits::B64);
                break;
            ...
            case ByteCodeOp::ZeroToTrue:
                ...
                pp.emitSetCondReg(cc->computeRegI0, CpuCond::E);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::LowerEqZeroToTrue:
                pp.emitCmpMemImm(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), 0, OpBits::B32);
                pp.emitSetCondReg(cc->computeRegI0, CpuCond::LE);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B8);
                break;
            case ByteCodeOp::GreaterZeroToTrue:
                pp.emitCmpMemImm(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), 0, OpBits::B32);
                pp.emitSetCondReg(cc->computeRegI0, CpuCond::G);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpGreaterS64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::G);
            ...
            case ByteCodeOp::CompareOpGreaterF64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::A);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpGreaterEqS64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::GE);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpGreaterEqF64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::AE);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpLowerS64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::L);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpLowerF64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::B);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpLowerEqS64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::LE);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpLowerEqF64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::BE);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOp3Way64:
                emitCompareOp(pp, cc->computeRegI1, CpuCond::G);
                pp.emitLoadZeroExtendRegReg(cc->computeRegI1, cc->computeRegI1, OpBits::B32, OpBits::B8);
                pp.emitLoadRegImm(cc->computeRegI0, 0xFFFFFFFF, OpBits::B32);
                pp.emitLoadCondRegReg(cc->computeRegI0, cc->computeRegI1, CpuCond::GE, OpBits::B32);
            ...
            case ByteCodeOp::CompareOp3WayF64:
                ...
                pp.emitSetCondReg(cc->computeRegI1, CpuCond::A);
                pp.emitLoadZeroExtendRegReg(cc->computeRegI1, cc->computeRegI1, OpBits::B32, OpBits::B8);
                pp.emitCmpRegReg(cc->computeRegF1, cc->computeRegF0, opBits);
                pp.emitLoadRegImm(cc->computeRegI0, 0xFFFFFFFF, OpBits::B32);
                pp.emitLoadCondRegReg(cc->computeRegI0, cc->computeRegI1, CpuCond::BE, OpBits::B32);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B32);
                break;
            ...
            case ByteCodeOp::CompareOpEqual64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::E);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            case ByteCodeOp::CompareOpEqualF32:
            case ByteCodeOp::CompareOpEqualF64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::EP);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::CompareOpNotEqual64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::NE);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            case ByteCodeOp::CompareOpNotEqualF32:
            case ByteCodeOp::CompareOpNotEqualF64:
                emitCompareOp(pp, cc->computeRegI0, CpuCond::NEP);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B8);
                break;
            ...
            case ByteCodeOp::JumpIfStackNotEqual8:
                emitJumpCmpAddr(pp, CpuCondJump::JNZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B8);
                break;

            case ByteCodeOp::JumpIfStackEqual16:
                emitJumpCmpAddr(pp, CpuCondJump::JZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B16);
                break;
            case ByteCodeOp::JumpIfStackNotEqual16:
                emitJumpCmpAddr(pp, CpuCondJump::JNZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B16);
                break;

            case ByteCodeOp::JumpIfStackEqual32:
                emitJumpCmpAddr(pp, CpuCondJump::JZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B32);
                break;
            case ByteCodeOp::JumpIfStackNotEqual32:
                emitJumpCmpAddr(pp, CpuCondJump::JNZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B32);
                break;

            case ByteCodeOp::JumpIfStackEqual64:
                emitJumpCmpAddr(pp, CpuCondJump::JZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B64);
                break;
            case ByteCodeOp::JumpIfStackNotEqual64:
                emitJumpCmpAddr(pp, CpuCondJump::JNZ, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, OpBits::B64);
                break;
            ...
            case ByteCodeOp::GetFromStack64:
                opBits = ScbeCpu::getOpBits(ip->op);
                pp.emitLoadZeroExtendRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->b.u32, OpBits::B64, opBits);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B64);
                break;
            case ByteCodeOp::GetIncFromStack64:
                pp.emitLoadRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->b.u32, OpBits::B64);
                if (ip->c.u64)
            ...
            case ByteCodeOp::GetFromStack64x2:
                ...
                pp.emitLoadZeroExtendRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->b.u32, OpBits::B64, opBits);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, OpBits::B64);
                pp.emitLoadZeroExtendRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->d.u32, OpBits::B64, opBits);
                pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->c.u32), cc->computeRegI0, OpBits::B64);
                break;
            ...
            case ByteCodeOp::CopyStack64:
                opBits = ScbeCpu::getOpBits(ip->op);
                pp.emitLoadRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->b.u32, opBits);
            ...
            case ByteCodeOp::SetZeroStack64:
                opBits = ScbeCpu::getOpBits(ip->op);
                pp.emitLoadMemImm(CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, 0, opBits);
                break;
            case ByteCodeOp::SetZeroStackX:
                if (ip->b.u32 <= buildParameters.buildCfg->backendSCBE.unrollMemLimit &&
                    buildParameters.buildCfg->backendOptimize > BuildCfgBackendOptim::O1)
                {
                    emitClearMem(pp, CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, ip->b.u32);
                }
                else
                {
                    pp.pushParams.clear();
                    pp.pushParams.push_back({.type = CpuPushParamType::LoadAddress, .baseReg = CpuReg::Rsp, .value = pp.cpuFct->getStackOffsetBC() + ip->a.u32});
                    pp.pushParams.push_back({.type = CpuPushParamType::Constant, .value = 0});
            ...
            case ByteCodeOp::SetAtStackPointer64:
                opBits = ScbeCpu::getOpBits(ip->op);
                if (ip->hasFlag(BCI_IMM_B))
                    pp.emitLoadMemImm(CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, ip->b.u64, opBits);
                else
                {
                    pp.emitLoadRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->b.u32), opBits);
                    pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->a.u32, cc->computeRegI0, opBits);
            ...
            case ByteCodeOp::SetAtStackPointer64x2:
                ...
                if (ip->hasFlag(BCI_IMM_D))
                    pp.emitLoadMemImm(CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->c.u32, ip->d.u64, opBits);
                else
                {
                    pp.emitLoadRegMem(cc->computeRegI0, CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->d.u32), opBits);
                    pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetBC() + ip->c.u32, cc->computeRegI0, opBits);
                }
                break;
            ...
            case ByteCodeOp::IntrinsicAtomicCmpXchgS64:
                ...
                pp.emitOpTernaryRegRegReg(cc->computeRegI0, cc->computeRegI1, cc->computeRegI2, CpuOp::CMPXCHG, opBits, EMIT_Lock);
            ...
            case ByteCodeOp::IntrinsicS64x2:
            {
                ...
                switch (static_cast<TokenId>(ip->d.u32))
                {
                    case TokenId::IntrinsicMin:
                        ...
                        pp.emitLoadCondRegReg(cc->computeRegI0, cc->computeRegI1, CpuCond::L, opBits);
                        pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, opBits);
                        break;
            ...
            case ByteCodeOp::IntrinsicU64x2:
            {
                ...
                switch (static_cast<TokenId>(ip->d.u32))
                {
                    case TokenId::IntrinsicMin:
                        ...
                        emitIMMC(pp, cc->computeRegI1, opBits);
                        pp.emitCmpRegReg(cc->computeRegI1, cc->computeRegI0, opBits);
                        pp.emitLoadCondRegReg(cc->computeRegI0, cc->computeRegI1, CpuCond::B, opBits);
                        pp.emitLoadMemReg(CpuReg::Rsp, pp.cpuFct->getStackOffsetReg(ip->a.u32), cc->computeRegI0, opBits);
                        break;
                    case TokenId::IntrinsicMax:
                        emitIMMB(pp, cc->computeRegI0, opBits);
            ...
            case ByteCodeOp::InternalPushErr:
                pp.emitCallLocal(g_LangSpec->name_priv_pusherr, CallConv::get(CallConvKind::Swag));
                break;
            case ByteCodeOp::InternalPopErr:
                pp.emitCallLocal(g_LangSpec->name_priv_poperr, CallConv::get(CallConvKind::Swag));
                break;
            case ByteCodeOp::InternalCatchErr:
                pp.emitCallLocal(g_LangSpec->name_priv_catcherr, CallConv::get(CallConvKind::Swag));
                break;
