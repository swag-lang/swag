...
struct SCBE final : Backend
{
    ...
    static void emitLoadZeroExtendParam(SCBE_CPU& pp, CPUReg reg, uint32_t paramIdx, OpBits numBitsDst, OpBits numBitsSrc);
    static void emitLoadAddressParam(SCBE_CPU& pp, CPUReg reg, uint32_t paramIdx);
