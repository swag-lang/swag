...
struct SCBE final : Backend
{
    ...
    static void emitJumpCmpAddr(SCBE_X64& pp, const ByteCodeInstruction* ip, int32_t instructionCount, CPUJumpType op, uint32_t memOffset, CPUReg memReg, CPUBits numBits);
