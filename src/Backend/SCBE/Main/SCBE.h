...
struct SCBE final : Backend
{
    ...
    static void emitBinOp(SCBE_X64& pp, const ByteCodeInstruction* ip, CPUOp op, CPUBits numBits);
    static void emitBinOpAtReg(SCBE_X64& pp, const ByteCodeInstruction* ip, CPUOp op, CPUBits numBits);
    static void emitBinOpDivAtReg(SCBE_X64& pp, const ByteCodeInstruction* ip, CPUOp op, CPUBits numBits);
    ...
    static void emitJumpCmpAddr(SCBE_X64& pp, const ByteCodeInstruction* ip, int32_t instructionCount, CPUJumpType op, uint32_t memOffset, CPURegister memReg, CPUBits numBits);
    ...
    static void emitBinOpEq(SCBE_X64& pp, const ByteCodeInstruction* ip, uint32_t offset, CPUOp op, CPUBits numBits);
    static void emitBinOpEqS(SCBE_X64& pp, const ByteCodeInstruction* ip, uint32_t offset, CPUOp op, CPUBits numBits);
    static void emitBinOpEqSS(SCBE_X64& pp, const ByteCodeInstruction* ip, uint32_t offset, CPUOp op, CPUBits numBits);
    static void emitBinOpEqLock(SCBE_X64& pp, const ByteCodeInstruction* ip, CPUOp op, CPUBits numBits);
    static void emitIMMA(SCBE_X64& pp, const ByteCodeInstruction* ip, CPURegister reg, CPUBits numBits);
    static void emitIMMB(SCBE_X64& pp, const ByteCodeInstruction* ip, CPURegister reg, CPUBits numBits);
    static void emitIMMC(SCBE_X64& pp, const ByteCodeInstruction* ip, CPURegister reg, CPUBits numBits);
    static void emitIMMD(SCBE_X64& pp, const ByteCodeInstruction* ip, CPURegister reg, CPUBits numBits);
    static void emitIMMB(SCBE_X64& pp, const ByteCodeInstruction* ip, CPURegister reg, CPUSignedType srcType, CPUSignedType dstType);
    static void emitIMMC(SCBE_X64& pp, const ByteCodeInstruction* ip, CPURegister reg, CPUSignedType srcType, CPUSignedType dstType);
