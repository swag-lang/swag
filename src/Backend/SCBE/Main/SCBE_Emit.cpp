...
void SCBE::emitShiftRightArithmetic(SCBE_X64& pp, const ByteCodeInstruction* ip)
{
    ...
    {
        if (ip->hasFlag(BCI_IMM_B))
            pp.emitLoad(CPUReg::RCX, min(ip->b.u8, SCBE_CPU::countBits(numBits) - 1), CPUBits::B8);
        else
        {
            pp.emitLoad(CPUReg::RCX, CPUReg::RDI, REG_OFFSET(ip->b.u32), CPUBits::B32);
            pp.emitLoad(CPUReg::RAX, SCBE_CPU::countBits(numBits) - 1, CPUBits::B32);
            pp.emitCmp(CPUReg::RCX, SCBE_CPU::countBits(numBits) - 1, CPUBits::B32);
...
{
    const auto numBits = SCBE_CPU::getCPUBits(ip->op);
    if (ip->hasFlag(BCI_IMM_B) && ip->b.u32 >= SCBE_CPU::countBits(numBits))
    {
...
void SCBE::emitShiftEqLogical(SCBE_X64& pp, const ByteCodeInstruction* ip, CPUOp op)
{
    ...
    {
        pp.emitLoad(CPUReg::RCX, CPUReg::RDI, REG_OFFSET(ip->b.u32), CPUBits::B32);
        pp.emitCmp(CPUReg::RCX, SCBE_CPU::countBits(numBits), CPUBits::B32);
    ...
    if (op == CPUOp::DIV || op == CPUOp::MOD || op == CPUOp::IDIV || op == CPUOp::IMOD)
    {
        if (numBits == CPUBits::B8)
        {
            if (ip->hasFlag(BCI_IMM_A))
                ...
                pp.emitLoad(CPUReg::RAX, CPUReg::RDI, REG_OFFSET(ip->a.u32), CPUBits::B32, CPUBits::B8, true);
            else
...
{
    const auto numBits = SCBE_CPU::getCPUBits(ip->op);
    if ((op == CPUOp::IDIV || op == CPUOp::IMOD) &&  ip->hasFlag(BCI_IMM_B))
    {
        pp.emitLoad(CPUReg::RAX, CPUReg::RDI, REG_OFFSET(ip->a.u32), CPUBits::B64);
    ...
    else if (op == CPUOp::IDIV || op == CPUOp::IMOD)
    {
        ...
        pp.emitOp(CPUReg::RCX, offset, CPUReg::RAX, op, numBits);  */      
        pp.emitLoad(CPUReg::RCX, CPUReg::RDI, REG_OFFSET(ip->a.u32), CPUBits::B64);

        if (numBits == CPUBits::B8)
            pp.emitLoad(CPUReg::RAX, CPUReg::RCX, offset, CPUBits::B32, CPUBits::B8, true);
        else
        {
    ...
    else if (op == CPUOp::DIV || op == CPUOp::MOD)
    {
        ...
        if (numBits == CPUBits::B8)
            pp.emitLoad(CPUReg::RAX, CPUReg::RCX, offset, CPUBits::B32, CPUBits::B8, false);
        else
        {
            pp.emitLoad(CPUReg::RAX, CPUReg::RCX, offset, numBits);
            pp.emitClear(CPUReg::RDX, numBits);
...
void SCBE::emitBinOpEqS(SCBE_X64& pp, const ByteCodeInstruction* ip, uint32_t offsetStack, CPUOp op)
{
    ...
    {
        if (numBits == CPUBits::B8)
            pp.emitLoad(CPUReg::RAX, CPUReg::RDI, offsetStack + ip->a.u32, CPUBits::B32, CPUBits::B8, true);
        else
        {
    ...
    {
        if (numBits == CPUBits::B8)
            pp.emitLoad(CPUReg::RAX, CPUReg::RDI, offsetStack + ip->a.u32, CPUBits::B32, CPUBits::B8, false);
        else
        {
            pp.emitLoad(CPUReg::RAX, CPUReg::RDI, offsetStack + ip->a.u32, numBits);
            pp.emitClear(CPUReg::RDX, numBits);
    ...
    else if (op == CPUOp::FDIV || op == CPUOp::IMUL || op == CPUOp::MUL)
    {
        const auto r0 = SCBE_CPU::isInt(numBits) ? CPUReg::RAX : CPUReg::XMM0;
        const auto r1 = SCBE_CPU::isInt(numBits) ? CPUReg::RCX : CPUReg::XMM1;
