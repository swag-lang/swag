    ...
    for (uint32_t i = 0; i < bc->numInstructions; i++, ip++)
    {
        ...
        switch (ip->op)
        {
            ...
            case ByteCodeOp::SetZeroStack8:
            {
                ...
                builder.CreateStore(pp.cstAi8, r0);
                break;
            }
            ...
            {
                auto r0 = GEP8(allocStack, ip->a.u32);
                builder.CreateMemSet(r0, pp.cstAi8, ip->b.u32, {});
                break;
            }
            ...
            case ByteCodeOp::SetZeroAtPointer8:
            {
                ...
                builder.CreateStore(pp.cstAi8, v0);
                break;
            }
            case ByteCodeOp::SetZeroAtPointer16:
            {
                ...
                builder.CreateStore(pp.cstAi16, v0);
                break;
            }
            ...
            case ByteCodeOp::SetZeroAtPointer64:
            {
                ...
                builder.CreateStore(pp.cstAi64, v0);
                break;
            }
            case ByteCodeOp::SetZeroAtPointerX:
            {
                ...
                builder.CreateMemSet(v0, pp.cstAi8, ip->b.u64, llvm::Align{});
                break;
            }
            case ByteCodeOp::SetZeroAtPointerXRB:
            {
                ...
                builder.CreateMemSet(r0, pp.cstAi8, v2, {});
                break;
            }
            ...
            case ByteCodeOp::ClearRR64:
            {
                ...
                auto       v0      = GEP8_PTR_IX(r0, ip->c.u32, numBits);
                builder.CreateStore(builder.getIntN(0, numBits), v0);
                break;
            }
            ...
            case ByteCodeOp::GetIncFromStack64DeRef64:
            {
                ...
                auto v1      = GEP8_PTR_IX(v0, ip->c.u64, numBits);
                auto v2      = builder.CreateLoad(IX_TY(numBits), v1);
            ...
            case ByteCodeOp::MemCpy64:
            {
                ...
                auto r1      = builder.CreateLoad(PTR_IX_TY(numBits), GEP64(allocR, ip->b.u32));
                builder.CreateStore(builder.CreateLoad(IX_TY(numBits), r1), r0);
                break;
            }
            ...
            case ByteCodeOp::CopyRBtoRA64:
            {
                ...
                auto v1      = builder.CreateIntCast(builder.CreateLoad(IX_TY(numBits), r1), I64_TY(), false);
                builder.CreateStore(v1, r0);
                break;
            }
            ...
            case ByteCodeOp::DecrementRA32:
            {
                ...
                const auto v0 = builder.CreateSub(builder.CreateLoad(I32_TY(), r0), pp.cstBi32);
                builder.CreateStore(v0, r0);
                break;
            }
            ...
            {
                const auto r0 = GEP64(allocR, ip->a.u32);
                const auto v0 = builder.CreateAdd(builder.CreateLoad(I64_TY(), r0), pp.cstBi64);
                builder.CreateStore(v0, r0);
                break;
            }
            ...
            {
                const auto r0 = GEP64(allocR, ip->a.u32);
                const auto v0 = builder.CreateSub(builder.CreateLoad(I64_TY(), r0), pp.cstBi64);
                builder.CreateStore(v0, r0);
                break;
            }
            ...
            case ByteCodeOp::CompareOp3Way8:
            {
                ...
                auto         v1 = builder.CreateIntCast(builder.CreateICmpSGT(v0, pp.cstAi8), I32_TY(), false);
                auto         v2 = builder.CreateIntCast(builder.CreateICmpSLT(v0, pp.cstAi8), I32_TY(), false);
