...
#define Msg0223 "missing '#main' function to execute"
...
#define Note012 "note: use '-w:<path>' or '--workspace:<path>' to specifiy a valid workspace folder, or launch swag from a valid workspace folder"
