...
#define Msg0345 "fatal error: cannot delete directory '%s' (%s)"
...
#define Msg0251 "'#tagval' parameter should be a string, but is '%s'"
...
#define Msg0582 "'%s' is not a valid attribute, it is %s"
...
#define Msg0386 "global 'using' should be defined at the top of the file"
