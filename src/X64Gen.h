...
struct X64Gen
{
    ...
    uint32_t storageReg      = 0;
    uint32_t storageMemReg   = 0;
    ...
    void emit_Load16_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
    void emit_Load32_Immediate(uint32_t val, uint8_t reg);
    void emit_Load32_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
    ...
    void emit_Store16_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
    void emit_Store32_Immediate(uint32_t offset, uint32_t val, uint8_t reg);
    void emit_Store32_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
    void emit_Store64_Immediate(uint32_t offset, uint64_t val, uint8_t reg);
    void emit_Store64_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
    void emit_Store8_Immediate(uint32_t offset, uint8_t val, uint8_t reg);
    void emit_Store8_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
    void emit_StoreF32_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg = RDI);
