...
struct X64Gen
{
    ...
    void emit_SetNE();
    void emit_SetNEP();
    void emit_Store16_Immediate(uint32_t offset, uint16_t val, CPURegister reg);
    void emit_Store16_Indirect(uint32_t stackOffset, CPURegister reg, CPURegister memReg = RDI);
    void emit_Store32_Immediate(uint32_t offset, uint32_t val, CPURegister reg);
    void emit_Store32_Indirect(uint32_t stackOffset, CPURegister reg, CPURegister memReg = RDI);
    void emit_Store64_Immediate(uint32_t offset, uint64_t val, CPURegister reg);
    void emit_Store64_Indirect(uint32_t stackOffset, CPURegister reg, CPURegister memReg = RDI);
    void emit_Store8_Immediate(uint32_t offset, uint8_t val, CPURegister reg);
