...
struct X64Gen
{
    ...
    void emit_Load16_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Load32_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Load64_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Load8_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_LoadF32_Reg(uint32_t stackOffset, uint8_t reg);
    void emit_LoadF64_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg);
    void emit_LoadF64_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Store16_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Store32_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Store64_Reg(uint32_t stackOffset, uint8_t reg);
    ...
    void emit_Store8_Reg(uint32_t stackOffset, uint8_t reg);
    void emit_StoreF32_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg);
    void emit_StoreF32_Reg(uint32_t stackOffset, uint8_t reg);
    void emit_StoreF64_Indirect(uint32_t stackOffset, uint8_t reg, uint8_t memReg);
    void emit_StoreF64_Reg(uint32_t stackOffset, uint8_t reg);
