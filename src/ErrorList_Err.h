...
SWAG_ERROR(Err0111, "occurred during public export of `%s`")
SWAG_ERROR(Err0112, "occurred during generic expansion of `%s`")
...
SWAG_ERROR(Err0118, "occurred during inline expansion of `%s`")
...
SWAG_ERROR(Err0128, "occurred during the `#selectif` validation of the function call to `%s`")
SWAG_ERROR(Err0129, "occurred during the `#checkif` validation of the function call to `%s`")
...
SWAG_ERROR(Err0329, "end of file reached, expected `%s` %s")
...
SWAG_ERROR(Err0458, "unexpected lambda return type")
...
SWAG_ERROR(Err0723, "end of file reached, expected `%s` %s")
...
SWAG_ERROR(Err0862, "unexpected empty expression")
