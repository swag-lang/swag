...
SWAG_ERROR(Err0049, "expected the generic parameters of the %s")
...
SWAG_ERROR(Err0119, "expected the function call parameters")
...
SWAG_ERROR(Err0677, "expected the parameters of the interface member `%s` (`self` is expected as a first parameter)")
