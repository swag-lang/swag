...
SWAG_ERROR(Err0488, "%s (type is `%s`) cannot be dereferenced like a pointer")
...
SWAG_ERROR(Err0517, "unexpected `ref` because the expression type is not a reference (type is `%s`)")
