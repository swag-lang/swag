...
SWAG_ERROR(Err0808, "cannot instantiate generic %s `%s` with an untyped integer, you need to cast to a real type")
SWAG_ERROR(Err0809, "cannot instantiate generic %s `%s` with an untyped float, you need to cast to `f32` or `f64`")
...
SWAG_ERROR(Err0881, "the identifier `%s` is preceeded with `.` but no corresponding enum can be deduced")
