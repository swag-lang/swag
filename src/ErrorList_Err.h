...
SWAG_ERROR(Err0137, "`%s` should not be used inside a struct special function")
...
SWAG_ERROR(Err0246, "an identifier marked with `#scopefct` should not be used in a scope")
...
SWAG_ERROR(Err0617, "a `Swag.Complete` attribute should not be used on a switch with type `%s`")
...
SWAG_ERROR(Err0703, "`with` should not be used on type `%s` (expected a namespace, an enum or a variable)")
