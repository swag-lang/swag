...
SWAG_ERROR(Err0778, "the comparison operation `%s` does not accept %s as the right argument")
...
SWAG_ERROR(Err0809, "the comparison operation `%s` does not accept %s as the left argument")
