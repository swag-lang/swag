...
SWAG_ERROR(Err0135, "a backtick should only be used inside an inline or a macro block")
SWAG_ERROR(Err0136, "a backtick on an identifier should only be used inside a `Swag.Macro` function or an `#inline` block")
...
SWAG_ERROR(Err0247, "an identifier marked with `#scopefct` should only be used inside a function")
...
SWAG_ERROR(Err0256, "`#function` should only be used inside a function")
...
SWAG_ERROR(Err0296, "invalid variable name `%s` because `@alias` should only be used inside a macro or a mixin function")
...
SWAG_ERROR(Err0442, "`@cvastart` intrinsic should only be used in a function with a last argument of type `cvarargs`")
...
SWAG_ERROR(Err0535, "`%s` should only be used before a function call that can raise errors (function marked with `throw`)")
