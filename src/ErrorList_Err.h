...
SWAG_ERROR(Err0107, "unexpected reference to a compile time function (function `%s` is marked with `Swag.Compiler`) from runtime %s")
SWAG_ERROR(Err0108, "unexpected reference to a test function (function `%s` is marked with `Swag.Test`) from runtime `%s`")
...
SWAG_ERROR(Err0526, "expected the array type declaration, found `%s`")
SWAG_ERROR(Err0527, "expected the slice type declaration, found `%s`")
