...
SWAG_ERROR(Err0294, "the `@mixin` special variable name should be followed by a number")
...
SWAG_ERROR(Err0394, "the literal number `%I64u` is not in the range of `u8`")
...
SWAG_ERROR(Err0398, "the literal number `%I64u` is not in the range of `u16`")
...
SWAG_ERROR(Err0404, "the literal number `%I64u` is not in the range of `u32`")
...
SWAG_ERROR(Err0432, "the literal number `%I64u` is not in the range of `rune`")
...
SWAG_ERROR(Err0464, "the literal number is too big (it cannot fit in 64 bits)")
...
SWAG_ERROR(Err0480, "expected a tuple field name before `:`, found `%s`")
