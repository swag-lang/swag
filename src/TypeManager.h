...
const CastFlags CASTFLAG_DEFAULT            = 0x0000000000000000;
const CastFlags CASTFLAG_INTERFACE          = 0x0000000000000001;
const CastFlags CASTFLAG_EXPLICIT           = 0x0000000000000002;
const CastFlags CASTFLAG_CONCRETE_ENUM      = 0x0000000000000004;
const CastFlags CASTFLAG_JUST_CHECK         = 0x0000000000000008;
const CastFlags CASTFLAG_UN_CONST           = 0x0000000000000010;
const CastFlags CASTFLAG_AUTO_BOOL          = 0x0000000000000020;
const CastFlags CASTFLAG_NO_COLLECT         = 0x0000000000000040;
const CastFlags CASTFLAG_COMMUTATIVE        = 0x0000000000000080;
const CastFlags CASTFLAG_INDEX              = 0x0000000000000100;
const CastFlags CASTFLAG_FORCE_UN_CONST     = 0x0000000000000200;
const CastFlags CASTFLAG_FOR_COMPARE        = 0x0000000000000400;
const CastFlags CASTFLAG_UFCS               = 0x0000000000000800;
const CastFlags CASTFLAG_COERCE             = 0x0000000000001000;
const CastFlags CASTFLAG_TRY_COERCE         = 0x0000000000002000;
const CastFlags CASTFLAG_AUTO_OP_CAST       = 0x0000000000004000;
const CastFlags CASTFLAG_STRICT             = 0x0000000000008000;
const CastFlags CASTFLAG_CAST               = 0x0000000000010000;
const CastFlags CASTFLAG_FOR_AFFECT         = 0x0000000000020000;
const CastFlags CASTFLAG_ACCEPT_PENDING     = 0x0000000000040000;
const CastFlags CASTFLAG_LITERAL_SUFFIX     = 0x0000000000080000;
const CastFlags CASTFLAG_NO_LAST_MINUTE     = 0x0000000000100000;
const CastFlags CASTFLAG_FOR_GENERIC        = 0x0000000000200000;
const CastFlags CASTFLAG_PARAMS             = 0x0000000000400000;
const CastFlags CASTFLAG_NO_IMPLICIT        = 0x0000000000800000;
const CastFlags CASTFLAG_FOR_VAR_INIT       = 0x0000000001000000;
const CastFlags CASTFLAG_PTR_REF            = 0x0000000002000000;
const CastFlags CASTFLAG_NO_TUPLE_TO_STRUCT = 0x0000000004000000;
const CastFlags CASTFLAG_ACCEPT_MOVE_REF    = 0x0000000008000000;
const CastFlags CASTFLAG_EXACT              = 0x0000000010000000;
const CastFlags CASTFLAG_CAN_OVERFLOW       = 0x0000000020000000;
const CastFlags CASTFLAG_EXACT_TUPLE_STRUCT = 0x0000000040000000;

using CastFlagsResult = Flags<uint32_t>;
const CastFlagsResult CASTFLAG_RESULT_STRUCT_CONVERT      = 0x00000001;
const CastFlagsResult CASTFLAG_RESULT_AUTO_OP_CAST        = 0x00000002;
const CastFlagsResult CASTFLAG_RESULT_AUTO_OP_AFFECT      = 0x00000004;
const CastFlagsResult CASTFLAG_RESULT_AUTO_MOVE_OP_AFFECT = 0x00000008;
const CastFlagsResult CASTFLAG_RESULT_GUESS_MOVE          = 0x00000010;
const CastFlagsResult CASTFLAG_RESULT_FORCE_REF           = 0x00000020;
const CastFlagsResult CASTFLAG_RESULT_UNTYPED_CONVERT     = 0x00000040;
const CastFlagsResult CASTFLAG_RESULT_COERCE              = 0x00000080;
const CastFlagsResult CASTFLAG_RESULT_GEN_AUTO_OP_CAST    = 0x00000100;
const CastFlagsResult CASTFLAG_RESULT_FROM_REF            = 0x00000200;
const CastFlagsResult CASTFLAG_RESULT_CONST_COERCE        = 0x00000400;
...
constexpr uint32_t CONCRETE_FORCE_ALIAS = 0x00000010;
