...
struct ByteCodeRun
{
    ...
    static void  executeShiftLeft(JobContext* context, Register* rdest, const Register& rleft, const Register& rright, uint32_t numBits);
    static void  executeShiftRight(JobContext* context, Register* rdest, const Register& rleft, const Register& rright, uint32_t numBits, bool isSigned);
