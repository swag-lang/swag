...
#define MK_BINOPEQ8_CAB(__op)                           \
    ...
    {                                                   \
        MK_IMMB_8(RCX);                                 \
        pp.emit_Op8_Indirect(0, RCX, RAX, __op);        \
    }
...
#define MK_BINOPEQ8_SCAB(__op)                                         \
    ...
    {                                                                  \
        MK_IMMB_8(RAX);                                                \
        pp.emit_Op8_Indirect(offsetStack + ip->a.u32, RAX, RDI, __op); \
    }
...
#define MK_BINOPEQ16_CAB(__op)                          \
    ...
    {                                                   \
        MK_IMMB_16(RCX);                                \
        pp.emit_Op16_Indirect(0, RCX, RAX, __op);       \
    }
...
#define MK_BINOPEQ16_SCAB(__op)                                         \
    ...
    {                                                                   \
        MK_IMMB_16(RAX);                                                \
        pp.emit_Op16_Indirect(offsetStack + ip->a.u32, RAX, RDI, __op); \
    }
...
#define MK_BINOPEQ32_CAB(__op)                            \
    ...
    {                                                     \
        MK_IMMB_32(RCX);                                  \
        pp.emit_Op32_Indirect(0, RCX, RAX, __op);         \
    }
...
#define MK_BINOPEQ32_SCAB(__op)                                         \
    ...
    {                                                                   \
        MK_IMMB_32(RAX);                                                \
        pp.emit_Op32_Indirect(offsetStack + ip->a.u32, RAX, RDI, __op); \
    }
...
#define MK_JMPCMP_8(__op)                                         \
    ...
    {                                                             \
        ...
        if (ip->flags & BCI_IMM_C)                                \
            ...
            pp.emit_Load8_Indirect(regOffset(ip->c.u32), RCX);    \
...
#define MK_JMPCMP_16(__op)                                          \
    ...
    {                                                               \
        ...
        if (ip->flags & BCI_IMM_C)                                  \
            ...
            pp.emit_Load16_Indirect(regOffset(ip->c.u32), RCX);     \
...
#define MK_JMPCMP_32(__op)                                          \
    ...
    {                                                               \
        ...
        if (ip->flags & BCI_IMM_C)                                  \
            ...
            pp.emit_Load32_Indirect(regOffset(ip->c.u32), RCX);     \
...
#define MK_JMPCMP_64(__op)                                                                   \
    ...
    {                                                                                        \
        ...
        if (ip->flags & BCI_IMM_C)                                                           \
            ...
            pp.emit_Load64_Indirect(regOffset(ip->c.u32), RCX);                              \
