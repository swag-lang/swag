...
bool BackendX64::emitFunctionBody(const BuildParameters& buildParameters, Module* moduleToGen, ByteCode* bc)
{
    ...
    for (uint32_t i = 0; i < bc->numInstructions; i++, ip++)
    {
        ...
        case ByteCodeOp::CastS8S16:
            BackendX64Inst::emit_LoadS8S16_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
        ...
        case ByteCodeOp::CastS8S64:
            BackendX64Inst::emit_LoadS8S64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            BackendX64Inst::emit_Store64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            break;
        case ByteCodeOp::CastS16S64:
            BackendX64Inst::emit_LoadS16S64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            BackendX64Inst::emit_Store64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            break;
        case ByteCodeOp::CastS32S64:
            BackendX64Inst::emit_LoadS32S64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            BackendX64Inst::emit_Store64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            break;
        ...
        case ByteCodeOp::DecPointer64:
            ...
            {
                BackendX64Inst::emit_Load64_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
                BackendX64Inst::emit_Sub64_Immediate(pp, ip->b.u64, RAX, RCX);
                BackendX64Inst::emit_Store64_Indirect(pp, regOffset(ip->c.u32), RAX, RDI);
            }
            else
            {
