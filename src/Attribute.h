...
static const uint64_t ATTRIBUTE_NOT_GENERIC         = 0x0000020000000000;
...
static const uint64_t ATTRIBUTE_EXPOSE_MASK   = ATTRIBUTE_PUBLIC | ATTRIBUTE_PROTECTED | ATTRIBUTE_PRIVATE;
