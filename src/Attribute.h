...
static const uint64_t ATTRIBUTE_EXPORT_TYPE_OP         = 0x0000010000000000;
static const uint64_t ATTRIBUTE_EXPORT_TYPE_FIELDS     = 0x0000020000000000;
static const uint64_t ATTRIBUTE_EXPORT_TYPE_METHODS    = 0x0000040000000000;
static const uint64_t ATTRIBUTE_EXPORT_TYPE_PARAMETERS = 0x0000080000000000;
static const uint64_t ATTRIBUTE_EXPORT_TYPE_ALL        = ATTRIBUTE_EXPORT_TYPE_OP | ATTRIBUTE_EXPORT_TYPE_FIELDS | ATTRIBUTE_EXPORT_TYPE_METHODS | ATTRIBUTE_EXPORT_TYPE_PARAMETERS;
