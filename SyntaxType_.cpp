...
{
    auto node         = Ast::newNode(&sourceFile->poolFactory->astNode, AstNodeKind::TypeDecl, currentScope, parent, false);
...
{
    auto node         = Ast::newNode(&sourceFile->poolFactory->astNode, AstNodeKind::Type, currentScope, parent, false);
