...
bool BackendX64::emitFunctionBody(const BuildParameters& buildParameters, Module* moduleToGen, ByteCode* bc)
{
    ...
    for (uint32_t i = 0; i < bc->numInstructions; i++, ip++)
    {
        ...
        case ByteCodeOp::CopyRBtoRA:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->b.u32), RAX, RDI);
        ...
        case ByteCodeOp::CastBool16:
            ...
            BackendX64Inst::emit_Move16_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
        ...
        case ByteCodeOp::BinOpShiftLeftU32:
            ...
            BackendX64Inst::emit_Move32_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            BackendX64Inst::emit_Move8_Indirect(pp, regOffset(ip->b.u32), RCX, RDI);
        ...
        case ByteCodeOp::AffectOpXOrEqS8:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->a.u32), RBX, RDI);
            BackendX64Inst::emit_Move8_Indirect(pp, regOffset(ip->b.u32), RAX, RDI);
        ...
        case ByteCodeOp::AffectOpXOrEqS32:
            //CONCAT_STR_2(concat, "*(__s16_t*)(r[", ip->a.u32, "].pointer) ^= r[", ip->b.u32, "].s16;");
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->a.u32), RBX, RDI);
            BackendX64Inst::emit_Move32_Indirect(pp, regOffset(ip->b.u32), RAX, RDI);
        ...
        case ByteCodeOp::AffectOpMulEqS8:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->b.u32), RBX, RDI);
        ...
        case ByteCodeOp::AffectOpMulEqF32:
            ...
            BackendX64Inst::emit_MoveF32_Indirect(pp, regOffset(ip->b.u32), XMM1, RDI);
        ...
        case ByteCodeOp::AffectOpMulEqF64:
            ...
            BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(ip->b.u32), XMM1, RDI);
        ...
        case ByteCodeOp::AffectOpModuloEqS16:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->a.u32), RBX, RDI);
            BackendX64Inst::emit_Move_DX_At_RBX(pp);
            break;
        case ByteCodeOp::AffectOpModuloEqS32:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->a.u32), RBX, RDI);
            BackendX64Inst::emit_Move_EDX_At_RBX(pp);
            break;
        ...
        case ByteCodeOp::CompareOpGreaterU32:
            ...
            BackendX64Inst::emit_Move32_Indirect(pp, regOffset(ip->a.u32), RAX, RDI);
            BackendX64Inst::emit_Move32_Indirect(pp, regOffset(ip->b.u32), RBX, RDI);
        ...
        case ByteCodeOp::CompareOpGreaterF32:
            ...
            BackendX64Inst::emit_MoveF32_Indirect(pp, regOffset(ip->a.u32), XMM1, RDI);
        ...
        case ByteCodeOp::CompareOpGreaterF64:
            ...
            BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(ip->b.u32), XMM0, RDI);
            BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(ip->a.u32), XMM1, RDI);
        ...
        case ByteCodeOp::NegF64:
            ...
            BackendX64Inst::emit_Move_RAX_At_Stack(pp, offsetFLT);
            BackendX64Inst::emit_MoveF64_Indirect(pp, offsetFLT, XMM1, RDI);
        ...
        case ByteCodeOp::IntrinsicSetContext:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->a.u32), RDX, RDI);
        ...
        case ByteCodeOp::IntrinsicAlloc:
            ...
            BackendX64Inst::emit_Move32_Indirect(pp, regOffset(ip->b.u32), RCX, RDI);
            emitCall(pp, "malloc");
            BackendX64Inst::emit_Move_RAX_At_Reg(pp, ip->a.u32);
            break;
        ...
        case ByteCodeOp::CopyRCtoRT:
            ...
            BackendX64Inst::emit_Move64_Indirect(pp, regOffset(ip->b.u32), RAX, RDI);
            BackendX64Inst::emit_Move_RAX_At_Stack(pp, offsetRT + (ip->a.u32 * sizeof(Register)));
            break;
        ...
        case ByteCodeOp::CopySPVaargs:
            ...
            {
                BackendX64Inst::emit_Move64_Indirect(pp, regOffset(pushRAParams[idxParam]), RAX, RDI);
        ...
        {
            BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(ip->b.u32), XMM0, RDI);
            BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(ip->c.u32), XMM1, RDI);
            switch ((TokenId) ip->d.u32)
            {
            case TokenId::IntrinsicPow:
                emitCall(pp, "pow");
...
bool BackendX64::emitForeignCallParameters(X64PerThread& pp, uint32_t& exceededStack, Module* moduleToGen, ByteCodeInstruction* ip, uint32_t offsetRT, TypeInfoFuncAttr* typeFuncBC, VectorNative<uint32_t>& pushRAParams)
{
    ...
    for (int i = 0; i < min(4, (int) paramsRegisters.size()); i++)
    {
        ...
        else if (type->flags & TYPEINFO_INTEGER)
        {
            ...
            {
            case 0:
                BackendX64Inst::emit_Move64_Indirect(pp, regOffset(r), RCX, RDI);
                break;
            case 1:
        ...
        else if (type->flags & TYPEINFO_FLOAT)
        {
            ...
            {
            case 0:
                BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(r), XMM0, RDI);
                break;
            case 1:
                BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(r), XMM1, RDI);
                break;
            case 2:
                BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(r), XMM2, RDI);
                break;
            case 3:
                BackendX64Inst::emit_MoveF64_Indirect(pp, regOffset(r), XMM3, RDI);
                break;
            }
        }
    }
