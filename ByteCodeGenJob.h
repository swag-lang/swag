...
struct ByteCodeGenJob : public Job
{
    ...
    static void emitOpCallUser(ByteCodeGenContext* context, AstFuncDecl* funcDecl, ByteCode* bc = nullptr, uint32_t offset = 0);
    ...
    static bool emitCall(ByteCodeGenContext* context, AstNode* allParams, AstFuncDecl* funcNode, AstVarDecl* varNode, RegisterList& varNodeRegisters, bool foreign);
    ...
    static bool generateStruct_opPostFromMove(ByteCodeGenContext* context, TypeInfoStruct* typeInfo);
