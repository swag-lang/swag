...
{
    auto node         = Ast::newNode(&sourceFile->poolFactory->astNode, AstNodeType::CompilerAssert, currentScope, parent, false);
...
{
    auto node         = Ast::newNode(&sourceFile->poolFactory->astNode, AstNodeType::CompilerPrint, currentScope, parent, false);
...
{
    auto node         = Ast::newNode(&sourceFile->poolFactory->astNode, AstNodeType::CompilerRun, currentScope, parent, false);
